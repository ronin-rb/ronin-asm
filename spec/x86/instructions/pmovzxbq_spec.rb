...
require 'spec_helper'
require 'ronin/asm/x86/instructions/pmovzxbq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PMOVZXBQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pmovzxbq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pmovzxbq" do
      expect(subject.name).to eq(:pmovzxbq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "pmovzxbq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem16" do
      ...
      let(:bin_file_name) { "pmovzxbq_xmm_mem16.bin" }
