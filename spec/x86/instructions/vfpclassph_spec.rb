...
describe Ronin::ASM::X86::Instructions::VFPCLASSPH do
  ...
  describe "#name" do
    it "must return :vfpclassph" do
      expect(subject.name).to eq(:vfpclassph)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, mem128/mem16bcst, imm8" do
      let(:operands) { [k_k(0), mem128_mem16_bcst(1), imm8(2)] }

      let(:bin_file_name) { "vfpclassph_k{k}_mem128mem16bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, mem128/mem16bcst, imm8" do
      let(:operands) { [k(0), mem128_mem16_bcst(1), imm8(2)] }

      let(:bin_file_name) { "vfpclassph_k_mem128mem16bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, mem256/mem16bcst, imm8" do
      let(:operands) { [k_k(0), mem256_mem16_bcst(1), imm8(2)] }

      let(:bin_file_name) { "vfpclassph_k{k}_mem256mem16bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, mem256/mem16bcst, imm8" do
      let(:operands) { [k(0), mem256_mem16_bcst(1), imm8(2)] }

      let(:bin_file_name) { "vfpclassph_k_mem256mem16bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, mem512/mem16bcst, imm8" do
      let(:operands) { [k_k(0), mem512_mem16_bcst(1), imm8(2)] }

      let(:bin_file_name) { "vfpclassph_k{k}_mem512mem16bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, mem512/mem16bcst, imm8" do
      let(:operands) { [k(0), mem512_mem16_bcst(1), imm8(2)] }

      let(:bin_file_name) { "vfpclassph_k_mem512mem16bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, imm8" do
      ...
      let(:bin_file_name) { "vfpclassph_k{k}_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, imm8" do
      ...
      let(:bin_file_name) { "vfpclassph_k_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vfpclassph_k{k}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, imm8" do
      ...
      let(:bin_file_name) { "vfpclassph_k_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vfpclassph_k{k}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, imm8" do
      ...
      let(:bin_file_name) { "vfpclassph_k_zmm_imm8.bin" }
