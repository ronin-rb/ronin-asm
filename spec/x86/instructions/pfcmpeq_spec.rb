...
require 'spec_helper'
require 'ronin/asm/x86/instructions/pfcmpeq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PFCMPEQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pfcmpeq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pfcmpeq" do
      expect(subject.name).to eq(:pfcmpeq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pfcmpeq_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pfcmpeq_mmx_mem64.bin" }
