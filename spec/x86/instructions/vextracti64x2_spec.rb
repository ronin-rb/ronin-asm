...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vextracti64x2'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VEXTRACTI64X2 do
  ...
  describe "#name" do
    it "must return :vextracti64x2" do
      expect(subject.name).to eq(:vextracti64x2)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_xmm{k}{z}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_mem128{k}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_xmm{k}{z}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_mem128{k}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_xmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_xmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_mem128_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x2_mem128_zmm_imm8.bin" }
