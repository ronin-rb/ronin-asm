...
describe Ronin::ASM::X86::Instructions::VEXTRACTF128 do
  ...
  describe "#name" do
    it "must return :vextractf128" do
      expect(subject.name).to eq(:vextractf128)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextractf128_xmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextractf128_mem128_ymm_imm8.bin" }
