...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vpcomw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPCOMW do
  ...
  describe "#name" do
    it "must return :vpcomw" do
      expect(subject.name).to eq(:vpcomw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcomw_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpcomw_xmm_xmm_mem128_imm8.bin" }
