...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vcvtph2uqq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VCVTPH2UQQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands of types zmm{k}{z}, xmm, {er}" do
      let(:operands) { [zmm_k_z(0), xmm(1), er(2)] }
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtph2uqq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtph2uqq" do
      expect(subject.name).to eq(:vcvtph2uqq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem32/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_xmm{k}{z}_mem32mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_ymm{k}{z}_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_zmm{k}{z}_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_xmm_mem32mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_ymm_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_zmm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2uqq_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm, {er}" do
      let(:operands) { [zmm_k_z(0), xmm(1), er(2)] }

      let(:bin_file_name) { "vcvtph2uqq_zmm{k}{z}_xmm_{er}.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm, {er}" do
      let(:operands) { [zmm(0), xmm(1), er(2)] }

      let(:bin_file_name) { "vcvtph2uqq_zmm_xmm_{er}.bin" }
