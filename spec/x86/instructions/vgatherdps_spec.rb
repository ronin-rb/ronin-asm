...
describe Ronin::ASM::X86::Instructions::VGATHERDPS do
  ...
  describe "#name" do
    it "must return :vgatherdps" do
      expect(subject.name).to eq(:vgatherdps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}, vm32x" do
      ...
      let(:bin_file_name) { "vgatherdps_xmm{k}_vm32x.bin" }
    ...
    context "when #operands contains operands of types ymm{k}, vm32y" do
      ...
      let(:bin_file_name) { "vgatherdps_ymm{k}_vm32y.bin" }
    ...
    context "when #operands contains operands of types zmm{k}, vm32z" do
      ...
      let(:bin_file_name) { "vgatherdps_zmm{k}_vm32z.bin" }
    ...
    context "when #operands contains operands of types xmm, vm32x, xmm" do
      ...
      let(:bin_file_name) { "vgatherdps_xmm_vm32x_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, vm32y, ymm" do
      ...
      let(:bin_file_name) { "vgatherdps_ymm_vm32y_ymm.bin" }
