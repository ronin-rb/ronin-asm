...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vcvtneobf162ps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VCVTNEOBF162PS do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtneobf162ps #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtneobf162ps" do
      expect(subject.name).to eq(:vcvtneobf162ps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "vcvtneobf162ps_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256" do
      ...
      let(:bin_file_name) { "vcvtneobf162ps_ymm_mem256.bin" }
