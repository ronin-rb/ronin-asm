...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vpcmpeqd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPCMPEQD do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpcmpeqd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k{k}_xmm_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types k, xmm, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k_xmm_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k{k}_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k{k}_ymm_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types k, ymm, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k_ymm_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, ymm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k{k}_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types k, ymm, ymm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, mem512/mem32bcst" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k{k}_zmm_mem512mem32bcst.bin" }
    ...
    context "when #operands contains operands of types k, zmm, mem512/mem32bcst" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k_zmm_mem512mem32bcst.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, zmm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k{k}_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types k, zmm, zmm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_k_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpcmpeqd_xmm_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm" do
      ...
      let(:bin_file_name) { "vpcmpeqd_ymm_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256" do
      ...
      let(:bin_file_name) { "vpcmpeqd_ymm_ymm_mem256.bin" }
