...
require 'spec_helper'
require 'ronin/asm/x86/instructions/cvttsd2si'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CVTTSD2SI do
  ...
  describe "#name" do
    it "must return :cvttsd2si" do
      expect(subject.name).to eq(:cvttsd2si)
    end
  end
