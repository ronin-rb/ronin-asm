...
require 'spec_helper'
require 'ronin/asm/x86/instructions/mulss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::MULSS do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: mulss #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :mulss" do
      expect(subject.name).to eq(:mulss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "mulss_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "mulss_xmm_mem32.bin" }
