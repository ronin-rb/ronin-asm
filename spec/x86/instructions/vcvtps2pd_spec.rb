...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vcvtps2pd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VCVTPS2PD do
  ...
  describe "#name" do
    it "must return :vcvtps2pd" do
      expect(subject.name).to eq(:vcvtps2pd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem64/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2pd_xmm{k}{z}_mem64mem32bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2pd_ymm{k}{z}_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2pd_zmm{k}{z}_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtps2pd_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtps2pd_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtps2pd_zmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2pd_xmm_mem64mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtps2pd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64" do
      ...
      let(:bin_file_name) { "vcvtps2pd_xmm_mem64.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2pd_ymm_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvtps2pd_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128" do
      ...
      let(:bin_file_name) { "vcvtps2pd_ymm_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2pd_zmm_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtps2pd_zmm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm, {sae}" do
      ...
      let(:bin_file_name) { "vcvtps2pd_zmm{k}{z}_ymm_{sae}.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm, {sae}" do
      ...
      let(:bin_file_name) { "vcvtps2pd_zmm_ymm_{sae}.bin" }
