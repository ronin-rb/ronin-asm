...
require 'spec_helper'
require 'ronin/asm/x86/instructions/mul'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::MUL do
  ...
  describe "#name" do
    it "must return :mul" do
      expect(subject.name).to eq(:mul)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8" do
      ...
      let(:bin_file_name) { "mul_reg8.bin" }
    ...
    context "when #operands contains operands of types reg16" do
      ...
      let(:bin_file_name) { "mul_reg16.bin" }
    ...
    context "when #operands contains operands of types reg32" do
      ...
      let(:bin_file_name) { "mul_reg32.bin" }
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "mul_mem8.bin" }
    ...
    context "when #operands contains operands of types mem16" do
      ...
      let(:bin_file_name) { "mul_mem16.bin" }
    ...
    context "when #operands contains operands of types mem32" do
      ...
      let(:bin_file_name) { "mul_mem32.bin" }
