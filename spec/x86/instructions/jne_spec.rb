...
require 'spec_helper'
require 'ronin/asm/x86/instructions/jne'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::JNE do
  ...
  describe "#name" do
    it "must return :jne" do
      expect(subject.name).to eq(:jne)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types rel8" do
      ...
      let(:bin_file_name) { "jne_rel8.bin" }
    ...
    context "when #operands contains operands of types rel32" do
      ...
      let(:bin_file_name) { "jne_rel32.bin" }
