...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vbroadcastf64x2'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VBROADCASTF64X2 do
  ...
  describe "#name" do
    it "must return :vbroadcastf64x2" do
      expect(subject.name).to eq(:vbroadcastf64x2)
    end
  end
