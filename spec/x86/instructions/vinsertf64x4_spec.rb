...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vinsertf64x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VINSERTF64X4 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vinsertf64x4 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vinsertf64x4" do
      expect(subject.name).to eq(:vinsertf64x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vinsertf64x4_zmm{k}{z}_zmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vinsertf64x4_zmm{k}{z}_zmm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vinsertf64x4_zmm_zmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vinsertf64x4_zmm_zmm_mem256_imm8.bin" }
