...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vrndscalesh'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VRNDSCALESH do
  ...
  describe "#name" do
    it "must return :vrndscalesh" do
      expect(subject.name).to eq(:vrndscalesh)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vrndscalesh_xmm{k}{z}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem16, imm8" do
      ...
      let(:bin_file_name) { "vrndscalesh_xmm{k}{z}_xmm_mem16_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vrndscalesh_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem16, imm8" do
      ...
      let(:bin_file_name) { "vrndscalesh_xmm_xmm_mem16_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vrndscalesh_xmm{k}{z}_xmm_xmm_{sae}_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vrndscalesh_xmm_xmm_xmm_{sae}_imm8.bin" }
