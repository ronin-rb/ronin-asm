...
require 'spec_helper'
require 'ronin/asm/x86/instructions/pextrd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PEXTRD do
  ...
  describe "#name" do
    it "must return :pextrd" do
      expect(subject.name).to eq(:pextrd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm, imm8" do
      ...
      let(:bin_file_name) { "pextrd_reg32_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem32, xmm, imm8" do
      ...
      let(:bin_file_name) { "pextrd_mem32_xmm_imm8.bin" }
