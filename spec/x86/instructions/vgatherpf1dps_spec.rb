...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vgatherpf1dps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VGATHERPF1DPS do
  ...
  describe "#name" do
    it "must return :vgatherpf1dps" do
      expect(subject.name).to eq(:vgatherpf1dps)
    end
  end
