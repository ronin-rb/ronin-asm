...
require 'spec_helper'
require 'ronin/asm/x86/instructions/movntq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::MOVNTQ do
  ...
  describe "#name" do
    it "must return :movntq" do
      expect(subject.name).to eq(:movntq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem64, mmx" do
      ...
      let(:bin_file_name) { "movntq_mem64_mmx.bin" }
