...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vmovntdqa'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VMOVNTDQA do
  ...
  describe "#name" do
    it "must return :vmovntdqa" do
      expect(subject.name).to eq(:vmovntdqa)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "vmovntdqa_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256" do
      ...
      let(:bin_file_name) { "vmovntdqa_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512" do
      ...
      let(:bin_file_name) { "vmovntdqa_zmm_mem512.bin" }
