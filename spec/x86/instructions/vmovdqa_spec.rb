...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vmovdqa'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VMOVDQA do
  ...
  describe "#name" do
    it "must return :vmovdqa" do
      expect(subject.name).to eq(:vmovdqa)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vmovdqa_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "vmovdqa_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm" do
      ...
      let(:bin_file_name) { "vmovdqa_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256" do
      ...
      let(:bin_file_name) { "vmovdqa_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types mem128, xmm" do
      ...
      let(:bin_file_name) { "vmovdqa_mem128_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256, ymm" do
      ...
      let(:bin_file_name) { "vmovdqa_mem256_ymm.bin" }
