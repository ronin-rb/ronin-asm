...
require 'spec_helper'
require 'ronin/asm/x86/instructions/pmovzxdq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PMOVZXDQ do
  ...
  describe "#name" do
    it "must return :pmovzxdq" do
      expect(subject.name).to eq(:pmovzxdq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "pmovzxdq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64" do
      ...
      let(:bin_file_name) { "pmovzxdq_xmm_mem64.bin" }
