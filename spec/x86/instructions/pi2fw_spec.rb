...
require 'spec_helper'
require 'ronin/asm/x86/instructions/pi2fw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PI2FW do
  ...
  describe "#name" do
    it "must return :pi2fw" do
      expect(subject.name).to eq(:pi2fw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pi2fw_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pi2fw_mmx_mem64.bin" }
