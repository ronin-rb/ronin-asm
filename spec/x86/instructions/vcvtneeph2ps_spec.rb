...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vcvtneeph2ps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VCVTNEEPH2PS do
  ...
  describe "#name" do
    it "must return :vcvtneeph2ps" do
      expect(subject.name).to eq(:vcvtneeph2ps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "vcvtneeph2ps_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256" do
      ...
      let(:bin_file_name) { "vcvtneeph2ps_ymm_mem256.bin" }
