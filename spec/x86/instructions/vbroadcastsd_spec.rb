...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vbroadcastsd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VBROADCASTSD do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vbroadcastsd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vbroadcastsd" do
      expect(subject.name).to eq(:vbroadcastsd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastsd_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastsd_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastsd_ymm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastsd_zmm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastsd_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastsd_ymm_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastsd_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastsd_zmm_mem64.bin" }
