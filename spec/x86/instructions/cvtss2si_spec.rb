...
require 'spec_helper'
require 'ronin/asm/x86/instructions/cvtss2si'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CVTSS2SI do
  ...
  describe "#name" do
    it "must return :cvtss2si" do
      expect(subject.name).to eq(:cvtss2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "cvtss2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "cvtss2si_reg32_mem32.bin" }
