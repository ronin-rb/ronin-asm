...
require 'spec_helper'
require 'ronin/asm/x86/instructions/psraw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PSRAW do
  ...
  describe "#name" do
    it "must return :psraw" do
      expect(subject.name).to eq(:psraw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, imm8" do
      ...
      let(:bin_file_name) { "psraw_mmx_imm8.bin" }
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "psraw_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "psraw_mmx_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, imm8" do
      ...
      let(:bin_file_name) { "psraw_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "psraw_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "psraw_xmm_mem128.bin" }
