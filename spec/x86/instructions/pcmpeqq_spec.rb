...
require 'spec_helper'
require 'ronin/asm/x86/instructions/pcmpeqq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::PCMPEQQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pcmpeqq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pcmpeqq" do
      expect(subject.name).to eq(:pcmpeqq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "pcmpeqq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "pcmpeqq_xmm_mem128.bin" }
