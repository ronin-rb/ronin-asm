...
require 'spec_helper'
require 'ronin/asm/x86/instructions/sets'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::SETS do
  ...
  describe "#name" do
    it "must return :sets" do
      expect(subject.name).to eq(:sets)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8" do
      ...
      let(:bin_file_name) { "sets_reg8.bin" }
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "sets_mem8.bin" }
