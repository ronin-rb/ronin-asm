...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vshufi32x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VSHUFI32X4 do
  ...
  describe "#name" do
    it "must return :vshufi32x4" do
      expect(subject.name).to eq(:vshufi32x4)
    end
  end
