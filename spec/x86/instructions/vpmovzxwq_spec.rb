...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vpmovzxwq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPMOVZXWQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovzxwq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovzxwq" do
      expect(subject.name).to eq(:vpmovzxwq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwq_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem32" do
      ...
      let(:bin_file_name) { "vpmovzxwq_xmm{k}{z}_mem32.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vpmovzxwq_ymm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vpmovzxwq_zmm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "vpmovzxwq_xmm_mem32.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem64" do
      ...
      let(:bin_file_name) { "vpmovzxwq_ymm_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwq_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem128" do
      ...
      let(:bin_file_name) { "vpmovzxwq_zmm_mem128.bin" }
