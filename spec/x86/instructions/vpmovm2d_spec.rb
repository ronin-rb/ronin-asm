...
describe Ronin::ASM::X86::Instructions::VPMOVM2D do
  ...
  describe "#name" do
    it "must return :vpmovm2d" do
      expect(subject.name).to eq(:vpmovm2d)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, k" do
      ...
      let(:bin_file_name) { "vpmovm2d_xmm_k.bin" }
    ...
    context "when #operands contains operands of types ymm, k" do
      ...
      let(:bin_file_name) { "vpmovm2d_ymm_k.bin" }
    ...
    context "when #operands contains operands of types zmm, k" do
      ...
      let(:bin_file_name) { "vpmovm2d_zmm_k.bin" }
