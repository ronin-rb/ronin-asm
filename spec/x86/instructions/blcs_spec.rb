...
require 'spec_helper'
require 'ronin/asm/x86/instructions/blcs'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::BLCS do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: blcs #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :blcs" do
      expect(subject.name).to eq(:blcs)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, reg32" do
      ...
      let(:bin_file_name) { "blcs_reg32_reg32.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "blcs_reg32_mem32.bin" }
