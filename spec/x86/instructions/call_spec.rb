...
require 'spec_helper'
require 'ronin/asm/x86/instructions/call'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CALL do
  ...
  describe "#name" do
    it "must return :call" do
      expect(subject.name).to eq(:call)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32" do
      ...
      let(:bin_file_name) { "call_reg32.bin" }
    ...
    context "when #operands contains operands of types mem32" do
      ...
      let(:bin_file_name) { "call_mem32.bin" }
