...
require 'spec_helper'
require 'ronin/asm/x86/instructions/knotq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::KNOTQ do
  ...
  describe "#name" do
    it "must return :knotq" do
      expect(subject.name).to eq(:knotq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k, k" do
      ...
      let(:bin_file_name) { "knotq_k_k.bin" }
