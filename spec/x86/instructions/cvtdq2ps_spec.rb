...
require 'spec_helper'
require 'ronin/asm/x86/instructions/cvtdq2ps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CVTDQ2PS do
  ...
  describe "#name" do
    it "must return :cvtdq2ps" do
      expect(subject.name).to eq(:cvtdq2ps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "cvtdq2ps_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "cvtdq2ps_xmm_mem128.bin" }
