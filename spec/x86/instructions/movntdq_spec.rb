...
require 'spec_helper'
require 'ronin/asm/x86/instructions/movntdq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::MOVNTDQ do
  ...
  describe "#name" do
    it "must return :movntdq" do
      expect(subject.name).to eq(:movntdq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem128, xmm" do
      ...
      let(:bin_file_name) { "movntdq_mem128_xmm.bin" }
