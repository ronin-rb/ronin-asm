...
require 'spec_helper'
require 'ronin/asm/x86/instructions/jbe'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::JBE do
  ...
  describe "#name" do
    it "must return :jbe" do
      expect(subject.name).to eq(:jbe)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types rel8" do
      ...
      let(:bin_file_name) { "jbe_rel8.bin" }
    ...
    context "when #operands contains operands of types rel32" do
      ...
      let(:bin_file_name) { "jbe_rel32.bin" }
