...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vbroadcasti64x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VBROADCASTI64X4 do
  ...
  describe "#name" do
    it "must return :vbroadcasti64x4" do
      expect(subject.name).to eq(:vbroadcasti64x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256" do
      ...
      let(:bin_file_name) { "vbroadcasti64x4_zmm{k}{z}_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256" do
      ...
      let(:bin_file_name) { "vbroadcasti64x4_zmm_mem256.bin" }
