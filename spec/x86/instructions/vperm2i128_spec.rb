...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vperm2i128'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPERM2I128 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vperm2i128 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vperm2i128" do
      expect(subject.name).to eq(:vperm2i128)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vperm2i128_ymm_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vperm2i128_ymm_ymm_mem256_imm8.bin" }
