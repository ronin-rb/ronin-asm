...
require 'spec_helper'
require 'ronin/asm/x86/instructions/kshiftld'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::KSHIFTLD do
  ...
  describe "#name" do
    it "must return :kshiftld" do
      expect(subject.name).to eq(:kshiftld)
    end
  end
