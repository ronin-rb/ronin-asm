...
require 'spec_helper'
require 'ronin/asm/x86/instructions/jge'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::JGE do
  ...
  describe "#name" do
    it "must return :jge" do
      expect(subject.name).to eq(:jge)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types rel8" do
      ...
      let(:bin_file_name) { "jge_rel8.bin" }
    ...
    context "when #operands contains operands of types rel32" do
      ...
      let(:bin_file_name) { "jge_rel32.bin" }
