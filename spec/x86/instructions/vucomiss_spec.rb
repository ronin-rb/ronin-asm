...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vucomiss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VUCOMISS do
  ...
  describe "#name" do
    it "must return :vucomiss" do
      expect(subject.name).to eq(:vucomiss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vucomiss_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "vucomiss_xmm_mem32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vucomiss_xmm_xmm_{sae}.bin" }
