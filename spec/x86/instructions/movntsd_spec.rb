...
require 'spec_helper'
require 'ronin/asm/x86/instructions/movntsd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::MOVNTSD do
  ...
  describe "#name" do
    it "must return :movntsd" do
      expect(subject.name).to eq(:movntsd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem64, xmm" do
      ...
      let(:bin_file_name) { "movntsd_mem64_xmm.bin" }
