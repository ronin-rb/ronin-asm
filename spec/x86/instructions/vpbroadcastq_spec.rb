...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vpbroadcastq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPBROADCASTQ do
  ...
  describe "#name" do
    it "must return :vpbroadcastq" do
      expect(subject.name).to eq(:vpbroadcastq)
    end
  end
