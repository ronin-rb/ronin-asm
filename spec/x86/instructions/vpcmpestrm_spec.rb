...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vpcmpestrm'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPCMPESTRM do
  ...
  describe "#name" do
    it "must return :vpcmpestrm" do
      expect(subject.name).to eq(:vpcmpestrm)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpestrm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpcmpestrm_xmm_mem128_imm8.bin" }
