...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vbroadcastf32x8'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VBROADCASTF32X8 do
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256" do
      ...
      let(:bin_file_name) { "vbroadcastf32x8_zmm{k}{z}_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256" do
      ...
      let(:bin_file_name) { "vbroadcastf32x8_zmm_mem256.bin" }
