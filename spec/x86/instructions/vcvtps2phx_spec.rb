...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vcvtps2phx'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VCVTPS2PHX do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtps2phx #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtps2phx" do
      expect(subject.name).to eq(:vcvtps2phx)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm{k}{z}_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm{k}{z}_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem512/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2phx_ymm{k}{z}_mem512mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vcvtps2phx_ymm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtps2phx_xmm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem512/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvtps2phx_ymm_mem512mem32bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, zmm" do
      ...
      let(:bin_file_name) { "vcvtps2phx_ymm_zmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtps2phx_ymm{k}{z}_zmm_{er}.bin" }
    ...
    context "when #operands contains operands of types ymm, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtps2phx_ymm_zmm_{er}.bin" }
