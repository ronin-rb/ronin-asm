...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vrsqrtsh'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VRSQRTSH do
  ...
  describe "#name" do
    it "must return :vrsqrtsh" do
      expect(subject.name).to eq(:vrsqrtsh)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm" do
      ...
      let(:bin_file_name) { "vrsqrtsh_xmm{k}{z}_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem16" do
      ...
      let(:bin_file_name) { "vrsqrtsh_xmm{k}{z}_xmm_mem16.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vrsqrtsh_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem16" do
      ...
      let(:bin_file_name) { "vrsqrtsh_xmm_xmm_mem16.bin" }
