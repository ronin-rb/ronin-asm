...
require 'spec_helper'
require 'ronin/asm/x86/instructions/cmovnle'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CMOVNLE do
  ...
  describe "#name" do
    it "must return :cmovnle" do
      expect(subject.name).to eq(:cmovnle)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg16, reg16" do
      ...
      let(:bin_file_name) { "cmovnle_reg16_reg16.bin" }
    ...
    context "when #operands contains operands of types reg16, mem16" do
      ...
      let(:bin_file_name) { "cmovnle_reg16_mem16.bin" }
    ...
    context "when #operands contains operands of types reg32, reg32" do
      ...
      let(:bin_file_name) { "cmovnle_reg32_reg32.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "cmovnle_reg32_mem32.bin" }
