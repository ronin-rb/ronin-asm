...
describe Ronin::ASM::X86::Instructions::VEXTRACTI64X4 do
  ...
  describe "#name" do
    it "must return :vextracti64x4" do
      expect(subject.name).to eq(:vextracti64x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x4_ymm{k}{z}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem256{k}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x4_mem256{k}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x4_ymm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem256, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti64x4_mem256_zmm_imm8.bin" }
