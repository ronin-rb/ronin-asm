...
require 'spec_helper'
require 'ronin/asm/x86/instructions/cvtsi2sd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CVTSI2SD do
  ...
  describe "#name" do
    it "must return :cvtsi2sd" do
      expect(subject.name).to eq(:cvtsi2sd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, reg32" do
      ...
      let(:bin_file_name) { "cvtsi2sd_xmm_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "cvtsi2sd_xmm_mem32.bin" }
