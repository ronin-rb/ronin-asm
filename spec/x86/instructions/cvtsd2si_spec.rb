...
require 'spec_helper'
require 'ronin/asm/x86/instructions/cvtsd2si'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::CVTSD2SI do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: cvtsd2si #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :cvtsd2si" do
      expect(subject.name).to eq(:cvtsd2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "cvtsd2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem64" do
      ...
      let(:bin_file_name) { "cvtsd2si_reg32_mem64.bin" }
