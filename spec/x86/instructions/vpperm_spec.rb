...
require 'spec_helper'
require 'ronin/asm/x86/instructions/vpperm'

require_relative '../helpers/operands'

describe Ronin::ASM::X86::Instructions::VPPERM do
  ...
  describe "#name" do
    it "must return :vpperm" do
      expect(subject.name).to eq(:vpperm)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpperm_xmm_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpperm_xmm_xmm_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128, xmm" do
      ...
      let(:bin_file_name) { "vpperm_xmm_xmm_mem128_xmm.bin" }
