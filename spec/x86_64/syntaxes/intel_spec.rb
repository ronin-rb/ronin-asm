require 'spec_helper'
require 'ronin/asm/x86_64/syntaxes/intel'
...
describe Ronin::ASM::X86_64::Syntaxes::Intel do
  it "must inherit from Ronin::ASM::X86::Syntaxes::Intel" do
    expect(described_class).to be < Ronin::ASM::X86::Syntaxes::Intel
  end
