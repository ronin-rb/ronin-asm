...
describe Ronin::ASM::X86_64::Instructions::CMPXCHG16B do
  ...
  describe "#name" do
    it "must return :cmpxchg16b" do
      expect(subject.name).to eq(:cmpxchg16b)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem128" do
      let(:operands) { [mem128(0)] }

      let(:bin_file_name) { "cmpxchg16b_mem128.bin" }
