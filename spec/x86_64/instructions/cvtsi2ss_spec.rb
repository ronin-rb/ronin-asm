...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/cvtsi2ss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::CVTSI2SS do
  ...
  describe "#initialize" do
    it "must set #name to :cvtsi2ss" do
      expect(subject.name).to be(:cvtsi2ss)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: cvtsi2ss #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :cvtsi2ss" do
      expect(subject.name).to eq(:cvtsi2ss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, reg32" do
      ...
      let(:bin_file_name) { "cvtsi2ss_xmm_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, reg64" do
      ...
      let(:bin_file_name) { "cvtsi2ss_xmm_reg64.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "cvtsi2ss_xmm_mem32.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64" do
      ...
      let(:bin_file_name) { "cvtsi2ss_xmm_mem64.bin" }
