...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpsraw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPSRAW do
  ...
  describe "#initialize" do
    it "must set #name to :vpsraw" do
      expect(subject.name).to be(:vpsraw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpsraw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpsraw" do
      expect(subject.name).to eq(:vpsraw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_xmm{k}{z}_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpsraw_xmm{k}{z}_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpsraw_xmm{k}{z}_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_ymm{k}{z}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, xmm" do
      ...
      let(:bin_file_name) { "vpsraw_ymm{k}{z}_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem128" do
      ...
      let(:bin_file_name) { "vpsraw_ymm{k}{z}_ymm_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_zmm{k}{z}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, xmm" do
      ...
      let(:bin_file_name) { "vpsraw_zmm{k}{z}_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem128" do
      ...
      let(:bin_file_name) { "vpsraw_zmm{k}{z}_zmm_mem128.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128, imm8" do
      let(:operands) { [xmm_k_z(0), mem128(1), imm8(2)] }

      let(:bin_file_name) { "vpsraw_xmm{k}{z}_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256, imm8" do
      let(:operands) { [ymm_k_z(0), mem256(1), imm8(2)] }

      let(:bin_file_name) { "vpsraw_ymm{k}{z}_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512, imm8" do
      let(:operands) { [zmm_k_z(0), mem512(1), imm8(2)] }

      let(:bin_file_name) { "vpsraw_zmm{k}{z}_mem512_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpsraw_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpsraw_xmm_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, xmm" do
      ...
      let(:bin_file_name) { "vpsraw_ymm_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem128" do
      ...
      let(:bin_file_name) { "vpsraw_ymm_ymm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, xmm" do
      ...
      let(:bin_file_name) { "vpsraw_zmm_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem128" do
      ...
      let(:bin_file_name) { "vpsraw_zmm_zmm_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512, imm8" do
      ...
      let(:bin_file_name) { "vpsraw_zmm_mem512_imm8.bin" }
