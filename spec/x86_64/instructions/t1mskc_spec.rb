...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/t1mskc'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::T1MSKC do
  ...
  describe "#initialize" do
    it "must set #name to :t1mskc" do
      expect(subject.name).to be(:t1mskc)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: t1mskc #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :t1mskc" do
      expect(subject.name).to eq(:t1mskc)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, reg32" do
      ...
      let(:bin_file_name) { "t1mskc_reg32_reg32.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "t1mskc_reg32_mem32.bin" }
    ...
    context "when #operands contains operands of types reg64, reg64" do
      ...
      let(:bin_file_name) { "t1mskc_reg64_reg64.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "t1mskc_reg64_mem64.bin" }
