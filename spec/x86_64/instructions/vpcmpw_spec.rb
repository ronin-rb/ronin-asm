...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpcmpw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPCMPW do
  ...
  describe "#initialize" do
    it "must set #name to :vpcmpw" do
      expect(subject.name).to be(:vpcmpw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpcmpw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpcmpw" do
      expect(subject.name).to eq(:vpcmpw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k{k}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k{k}_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k{k}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k{k}_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k{k}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, mem512, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k{k}_zmm_mem512_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, mem512, imm8" do
      ...
      let(:bin_file_name) { "vpcmpw_k_zmm_mem512_imm8.bin" }
