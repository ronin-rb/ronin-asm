...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovq2m'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVQ2M do
  ...
  describe "#name" do
    it "must return :vpmovq2m" do
      expect(subject.name).to eq(:vpmovq2m)
    end
  end
