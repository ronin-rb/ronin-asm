...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/movaps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::MOVAPS do
  ...
  describe "#name" do
    it "must return :movaps" do
      expect(subject.name).to eq(:movaps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "movaps_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "movaps_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types mem128, xmm" do
      ...
      let(:bin_file_name) { "movaps_mem128_xmm.bin" }
