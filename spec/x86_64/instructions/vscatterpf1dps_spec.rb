...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vscatterpf1dps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSCATTERPF1DPS do
  ...
  describe "#name" do
    it "must return :vscatterpf1dps" do
      expect(subject.name).to eq(:vscatterpf1dps)
    end
  end
