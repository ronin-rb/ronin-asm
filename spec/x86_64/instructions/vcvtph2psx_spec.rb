...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtph2psx'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTPH2PSX do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtph2psx" do
      expect(subject.name).to be(:vcvtph2psx)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtph2psx #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtph2psx" do
      expect(subject.name).to eq(:vcvtph2psx)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2psx_xmm{k}{z}_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2psx_ymm{k}{z}_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2psx_zmm{k}{z}_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2psx_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2psx_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtph2psx_zmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2psx_xmm_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2psx_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2psx_ymm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2psx_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2psx_zmm_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtph2psx_zmm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm, {sae}" do
      ...
      let(:bin_file_name) { "vcvtph2psx_zmm{k}{z}_ymm_{sae}.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm, {sae}" do
      ...
      let(:bin_file_name) { "vcvtph2psx_zmm_ymm_{sae}.bin" }
