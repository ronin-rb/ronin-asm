...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vbroadcastf32x2'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VBROADCASTF32X2 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vbroadcastf32x2 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_ymm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_zmm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_ymm_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem64" do
      ...
      let(:bin_file_name) { "vbroadcastf32x2_zmm_mem64.bin" }
