...
describe Ronin::ASM::X86_64::Instructions::VCVTPH2UDQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtph2udq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtph2udq" do
      expect(subject.name).to eq(:vcvtph2udq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2udq_xmm{k}{z}_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2udq_ymm{k}{z}_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2udq_zmm{k}{z}_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2udq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2udq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtph2udq_zmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2udq_xmm_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2udq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2udq_ymm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2udq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2udq_zmm_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtph2udq_zmm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm, {er}" do
      ...
      let(:bin_file_name) { "vcvtph2udq_zmm{k}{z}_ymm_{er}.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm, {er}" do
      ...
      let(:bin_file_name) { "vcvtph2udq_zmm_ymm_{er}.bin" }
