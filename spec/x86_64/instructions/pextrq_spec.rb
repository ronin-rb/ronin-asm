...
describe Ronin::ASM::X86_64::Instructions::PEXTRQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pextrq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg64, xmm, imm8" do
      ...
      let(:bin_file_name) { "pextrq_reg64_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem64, xmm, imm8" do
      ...
      let(:bin_file_name) { "pextrq_mem64_xmm_imm8.bin" }
