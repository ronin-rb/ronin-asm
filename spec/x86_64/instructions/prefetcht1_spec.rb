...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/prefetcht1'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PREFETCHT1 do
  ...
  describe "#name" do
    it "must return :prefetcht1" do
      expect(subject.name).to eq(:prefetcht1)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "prefetcht1_mem8.bin" }
