...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpsubw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPSUBW do
  ...
  describe "#initialize" do
    it "must set #name to :vpsubw" do
      expect(subject.name).to be(:vpsubw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpsubw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpsubw_xmm{k}{z}_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpsubw_xmm{k}{z}_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, ymm" do
      ...
      let(:bin_file_name) { "vpsubw_ymm{k}{z}_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem256" do
      ...
      let(:bin_file_name) { "vpsubw_ymm{k}{z}_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, zmm" do
      ...
      let(:bin_file_name) { "vpsubw_zmm{k}{z}_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem512" do
      ...
      let(:bin_file_name) { "vpsubw_zmm{k}{z}_zmm_mem512.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpsubw_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpsubw_xmm_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm" do
      ...
      let(:bin_file_name) { "vpsubw_ymm_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256" do
      ...
      let(:bin_file_name) { "vpsubw_ymm_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, zmm" do
      ...
      let(:bin_file_name) { "vpsubw_zmm_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem512" do
      ...
      let(:bin_file_name) { "vpsubw_zmm_zmm_mem512.bin" }
