...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vrangesd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VRANGESD do
  ...
  describe "#initialize" do
    it "must set #name to :vrangesd" do
      expect(subject.name).to be(:vrangesd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vrangesd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vrangesd" do
      expect(subject.name).to eq(:vrangesd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vrangesd_xmm{k}{z}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem64, imm8" do
      ...
      let(:bin_file_name) { "vrangesd_xmm{k}{z}_xmm_mem64_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vrangesd_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem64, imm8" do
      ...
      let(:bin_file_name) { "vrangesd_xmm_xmm_mem64_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vrangesd_xmm{k}{z}_xmm_xmm_{sae}_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vrangesd_xmm_xmm_xmm_{sae}_imm8.bin" }
