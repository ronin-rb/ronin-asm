...
describe Ronin::ASM::X86_64::Instructions::VFPCLASSSD do
  ...
  describe "#name" do
    it "must return :vfpclasssd" do
      expect(subject.name).to eq(:vfpclasssd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, imm8" do
      ...
      let(:bin_file_name) { "vfpclasssd_k{k}_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, imm8" do
      ...
      let(:bin_file_name) { "vfpclasssd_k_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, mem64, imm8" do
      let(:operands) { [k_k(0), mem64(1), imm8(2)] }

      let(:bin_file_name) { "vfpclasssd_k{k}_mem64_imm8.bin" }
    ...
    context "when #operands contains operands of types k, mem64, imm8" do
      let(:operands) { [k(0), mem64(1), imm8(2)] }

      let(:bin_file_name) { "vfpclasssd_k_mem64_imm8.bin" }
