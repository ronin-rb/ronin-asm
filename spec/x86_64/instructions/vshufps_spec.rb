...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vshufps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSHUFPS do
  ...
  describe "#name" do
    it "must return :vshufps" do
      expect(subject.name).to eq(:vshufps)
    end
  end
