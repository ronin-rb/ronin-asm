...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vmovhpd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VMOVHPD do
  ...
  describe "#name" do
    it "must return :vmovhpd" do
      expect(subject.name).to eq(:vmovhpd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem64, xmm" do
      ...
      let(:bin_file_name) { "vmovhpd_mem64_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem64" do
      ...
      let(:bin_file_name) { "vmovhpd_xmm_xmm_mem64.bin" }
