...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvttsh2si'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTTSH2SI do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvttsh2si #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvttsh2si" do
      expect(subject.name).to eq(:vcvttsh2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvttsh2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem16" do
      ...
      let(:bin_file_name) { "vcvttsh2si_reg32_mem16.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvttsh2si_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem16" do
      let(:operands) { [reg64(0), mem16(1)] }

      let(:bin_file_name) { "vcvttsh2si_reg64_mem16.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttsh2si_reg32_xmm_{sae}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttsh2si_reg64_xmm_{sae}.bin" }
