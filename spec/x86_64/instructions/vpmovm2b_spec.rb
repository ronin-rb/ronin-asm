...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovm2b'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVM2B do
  ...
  describe "#name" do
    it "must return :vpmovm2b" do
      expect(subject.name).to eq(:vpmovm2b)
    end
  end
