...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtuqq2ph'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTUQQ2PH do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtuqq2ph" do
      expect(subject.name).to be(:vcvtuqq2ph)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtuqq2ph #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtuqq2ph" do
      expect(subject.name).to eq(:vcvtuqq2ph)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_mem128mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem256/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_mem256mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem512/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_mem512mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_mem128mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, mem256/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_mem256mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, mem512/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_mem512mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, zmm" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm{k}{z}_zmm_{er}.bin" }
    ...
    context "when #operands contains operands of types xmm, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtuqq2ph_xmm_zmm_{er}.bin" }
