...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpcmpuq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPCMPUQ do
  ...
  describe "#initialize" do
    it "must set #name to :vpcmpuq" do
      expect(subject.name).to be(:vpcmpuq)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpcmpuq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpcmpuq" do
      expect(subject.name).to eq(:vpcmpuq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, mem128/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k{k}_xmm_mem128mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, mem128/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k_xmm_mem128mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k{k}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, mem256/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k{k}_ymm_mem256mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, mem256/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k_ymm_mem256mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k{k}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, mem512/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k{k}_zmm_mem512mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, mem512/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k_zmm_mem512mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k{k}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuq_k_zmm_zmm_imm8.bin" }
