...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/cmovl'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::CMOVL do
  ...
  describe "#initialize" do
    it "must set #name to :cmovl" do
      expect(subject.name).to be(:cmovl)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: cmovl #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :cmovl" do
      expect(subject.name).to eq(:cmovl)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg64, reg64" do
      ...
      let(:bin_file_name) { "cmovl_reg64_reg64.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "cmovl_reg64_mem64.bin" }
