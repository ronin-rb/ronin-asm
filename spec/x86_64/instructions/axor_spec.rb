...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/axor'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::AXOR do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: axor #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :axor" do
      expect(subject.name).to eq(:axor)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem32, reg32" do
      ...
      let(:bin_file_name) { "axor_mem32_reg32.bin" }
    ...
    context "when #operands contains operands of types mem64, reg64" do
      ...
      let(:bin_file_name) { "axor_mem64_reg64.bin" }
