...
describe Ronin::ASM::X86_64::Instructions::VSHA512RNDS2 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vsha512rnds2 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vsha512rnds2" do
      expect(subject.name).to eq(:vsha512rnds2)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm, ymm, xmm" do
      ...
      let(:bin_file_name) { "vsha512rnds2_ymm_ymm_xmm.bin" }
