...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovsqw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVSQW do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovsqw" do
      expect(subject.name).to be(:vpmovsqw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovsqw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovsqw" do
      expect(subject.name).to eq(:vpmovsqw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types mem32{k}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_mem32{k}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vpmovsqw_xmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types mem64{k}, ymm" do
      ...
      let(:bin_file_name) { "vpmovsqw_mem64{k}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_xmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, zmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_mem128{k}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm" do
      ...
      let(:bin_file_name) { "vpmovsqw_xmm_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, zmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_xmm_zmm.bin" }
    ...
    context "when #operands contains operands of types mem32, xmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_mem32_xmm.bin" }
    ...
    context "when #operands contains operands of types mem64, ymm" do
      ...
      let(:bin_file_name) { "vpmovsqw_mem64_ymm.bin" }
    ...
    context "when #operands contains operands of types mem128, zmm" do
      ...
      let(:bin_file_name) { "vpmovsqw_mem128_zmm.bin" }
