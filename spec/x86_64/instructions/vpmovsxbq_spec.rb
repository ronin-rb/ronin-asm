...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovsxbq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVSXBQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovsxbq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovsxbq" do
      expect(subject.name).to eq(:vpmovsxbq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxbq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxbq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxbq_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem16" do
      ...
      let(:bin_file_name) { "vpmovsxbq_xmm{k}{z}_mem16.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem32" do
      ...
      let(:bin_file_name) { "vpmovsxbq_ymm{k}{z}_mem32.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vpmovsxbq_zmm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxbq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem16" do
      ...
      let(:bin_file_name) { "vpmovsxbq_xmm_mem16.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxbq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem32" do
      ...
      let(:bin_file_name) { "vpmovsxbq_ymm_mem32.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxbq_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem64" do
      ...
      let(:bin_file_name) { "vpmovsxbq_zmm_mem64.bin" }
