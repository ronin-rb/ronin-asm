...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtusi2ss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTUSI2SS do
  ...
  describe "#name" do
    it "must return :vcvtusi2ss" do
      expect(subject.name).to eq(:vcvtusi2ss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, reg32" do
      ...
      let(:bin_file_name) { "vcvtusi2ss_xmm_xmm_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, reg64" do
      ...
      let(:bin_file_name) { "vcvtusi2ss_xmm_xmm_reg64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem32" do
      ...
      let(:bin_file_name) { "vcvtusi2ss_xmm_xmm_mem32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem64" do
      ...
      let(:bin_file_name) { "vcvtusi2ss_xmm_xmm_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, {er}, reg32" do
      ...
      let(:bin_file_name) { "vcvtusi2ss_xmm_xmm_{er}_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, {er}, reg64" do
      ...
      let(:bin_file_name) { "vcvtusi2ss_xmm_xmm_{er}_reg64.bin" }
