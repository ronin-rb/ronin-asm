...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vfixupimmss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VFIXUPIMMSS do
  ...
  describe "#name" do
    it "must return :vfixupimmss" do
      expect(subject.name).to eq(:vfixupimmss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vfixupimmss_xmm{k}{z}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem32, imm8" do
      ...
      let(:bin_file_name) { "vfixupimmss_xmm{k}{z}_xmm_mem32_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vfixupimmss_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem32, imm8" do
      ...
      let(:bin_file_name) { "vfixupimmss_xmm_xmm_mem32_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vfixupimmss_xmm{k}{z}_xmm_xmm_{sae}_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vfixupimmss_xmm_xmm_xmm_{sae}_imm8.bin" }
