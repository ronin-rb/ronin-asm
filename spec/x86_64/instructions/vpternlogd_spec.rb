...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpternlogd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPTERNLOGD do
  ...
  describe "#initialize" do
    it "must set #name to :vpternlogd" do
      expect(subject.name).to be(:vpternlogd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpternlogd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpternlogd" do
      expect(subject.name).to eq(:vpternlogd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem128/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_xmm{k}{z}_xmm_mem128mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_xmm{k}{z}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem256/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_ymm{k}{z}_ymm_mem256mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_ymm{k}{z}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem512/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_zmm{k}{z}_zmm_mem512mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_zmm{k}{z}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_xmm_xmm_mem128mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_ymm_ymm_mem256mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_ymm_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem512/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_zmm_zmm_mem512mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpternlogd_zmm_zmm_zmm_imm8.bin" }
