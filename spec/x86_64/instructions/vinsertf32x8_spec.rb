...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vinsertf32x8'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VINSERTF32X8 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vinsertf32x8 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vinsertf32x8_zmm{k}{z}_zmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vinsertf32x8_zmm{k}{z}_zmm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vinsertf32x8_zmm_zmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vinsertf32x8_zmm_zmm_mem256_imm8.bin" }
