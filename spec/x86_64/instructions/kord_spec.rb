...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/kord'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::KORD do
  ...
  describe "#name" do
    it "must return :kord" do
      expect(subject.name).to eq(:kord)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k, k, k" do
      ...
      let(:bin_file_name) { "kord_k_k_k.bin" }
