...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtqq2ps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTQQ2PS do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtqq2ps" do
      expect(subject.name).to be(:vcvtqq2ps)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtqq2ps #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtqq2ps" do
      expect(subject.name).to eq(:vcvtqq2ps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm{k}{z}_mem128mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem256/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm{k}{z}_mem256mem64bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem512/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_ymm{k}{z}_mem512mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_ymm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm_mem128mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, mem256/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm_mem256mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_xmm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem512/mem64bcst" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_ymm_mem512mem64bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, zmm" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_ymm_zmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_ymm{k}{z}_zmm_{er}.bin" }
    ...
    context "when #operands contains operands of types ymm, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtqq2ps_ymm_zmm_{er}.bin" }
