...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovusqw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVUSQW do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovusqw" do
      expect(subject.name).to be(:vpmovusqw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovusqw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovusqw" do
      expect(subject.name).to eq(:vpmovusqw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types mem32{k}, xmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_mem32{k}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vpmovusqw_xmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types mem64{k}, ymm" do
      ...
      let(:bin_file_name) { "vpmovusqw_mem64{k}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_xmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, zmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_mem128{k}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm" do
      ...
      let(:bin_file_name) { "vpmovusqw_xmm_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, zmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_xmm_zmm.bin" }
    ...
    context "when #operands contains operands of types mem32, xmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_mem32_xmm.bin" }
    ...
    context "when #operands contains operands of types mem64, ymm" do
      ...
      let(:bin_file_name) { "vpmovusqw_mem64_ymm.bin" }
    ...
    context "when #operands contains operands of types mem128, zmm" do
      ...
      let(:bin_file_name) { "vpmovusqw_mem128_zmm.bin" }
