...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpcmpistri'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPCMPISTRI do
  ...
  describe "#initialize" do
    it "must set #name to :vpcmpistri" do
      expect(subject.name).to be(:vpcmpistri)
    end
  ...
  describe "#name" do
    it "must return :vpcmpistri" do
      expect(subject.name).to eq(:vpcmpistri)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpistri_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpcmpistri_xmm_mem128_imm8.bin" }
