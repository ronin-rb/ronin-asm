...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vsm3rnds2'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSM3RNDS2 do
  ...
  describe "#name" do
    it "must return :vsm3rnds2" do
      expect(subject.name).to eq(:vsm3rnds2)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vsm3rnds2_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vsm3rnds2_xmm_xmm_mem128_imm8.bin" }
