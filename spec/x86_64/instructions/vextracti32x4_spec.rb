...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vextracti32x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VEXTRACTI32X4 do
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_xmm{k}{z}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_mem128{k}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_xmm{k}{z}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_mem128{k}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_xmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_xmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_mem128_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128, zmm, imm8" do
      ...
      let(:bin_file_name) { "vextracti32x4_mem128_zmm_imm8.bin" }
