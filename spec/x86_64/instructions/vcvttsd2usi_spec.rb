...
describe Ronin::ASM::X86_64::Instructions::VCVTTSD2USI do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvttsd2usi #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvttsd2usi" do
      expect(subject.name).to eq(:vcvttsd2usi)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvttsd2usi_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem64" do
      ...
      let(:bin_file_name) { "vcvttsd2usi_reg32_mem64.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvttsd2usi_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "vcvttsd2usi_reg64_mem64.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttsd2usi_reg32_xmm_{sae}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttsd2usi_reg64_xmm_{sae}.bin" }
