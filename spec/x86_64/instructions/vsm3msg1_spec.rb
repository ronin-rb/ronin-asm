...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vsm3msg1'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSM3MSG1 do
  ...
  describe "#initialize" do
    it "must set #name to :vsm3msg1" do
      expect(subject.name).to be(:vsm3msg1)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vsm3msg1 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vsm3msg1" do
      expect(subject.name).to eq(:vsm3msg1)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vsm3msg1_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vsm3msg1_xmm_xmm_mem128.bin" }
