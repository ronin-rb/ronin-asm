...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/punpckldq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PUNPCKLDQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: punpckldq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :punpckldq" do
      expect(subject.name).to eq(:punpckldq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "punpckldq_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem32" do
      ...
      let(:bin_file_name) { "punpckldq_mmx_mem32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "punpckldq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "punpckldq_xmm_mem128.bin" }
