...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpgatherqq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPGATHERQQ do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpgatherqq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpgatherqq" do
      expect(subject.name).to eq(:vpgatherqq)
    end
  end
