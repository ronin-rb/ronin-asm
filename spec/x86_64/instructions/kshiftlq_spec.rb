...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/kshiftlq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::KSHIFTLQ do
  ...
  describe "#name" do
    it "must return :kshiftlq" do
      expect(subject.name).to eq(:kshiftlq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k, k, imm8" do
      ...
      let(:bin_file_name) { "kshiftlq_k_k_imm8.bin" }
