...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovsxwq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVSXWQ do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovsxwq" do
      expect(subject.name).to be(:vpmovsxwq)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovsxwq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovsxwq" do
      expect(subject.name).to eq(:vpmovsxwq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxwq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxwq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxwq_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem32" do
      ...
      let(:bin_file_name) { "vpmovsxwq_xmm{k}{z}_mem32.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vpmovsxwq_ymm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vpmovsxwq_zmm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxwq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "vpmovsxwq_xmm_mem32.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxwq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem64" do
      ...
      let(:bin_file_name) { "vpmovsxwq_ymm_mem64.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovsxwq_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem128" do
      ...
      let(:bin_file_name) { "vpmovsxwq_zmm_mem128.bin" }
