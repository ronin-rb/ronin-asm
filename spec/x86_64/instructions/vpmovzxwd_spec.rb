...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovzxwd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVZXWD do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovzxwd" do
      expect(subject.name).to be(:vpmovzxwd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovzxwd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovzxwd" do
      expect(subject.name).to eq(:vpmovzxwd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwd_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwd_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vpmovzxwd_zmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vpmovzxwd_xmm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vpmovzxwd_ymm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256" do
      ...
      let(:bin_file_name) { "vpmovzxwd_zmm{k}{z}_mem256.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64" do
      ...
      let(:bin_file_name) { "vpmovzxwd_xmm_mem64.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxwd_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128" do
      ...
      let(:bin_file_name) { "vpmovzxwd_ymm_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm" do
      ...
      let(:bin_file_name) { "vpmovzxwd_zmm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256" do
      ...
      let(:bin_file_name) { "vpmovzxwd_zmm_mem256.bin" }
