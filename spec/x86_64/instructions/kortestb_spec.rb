...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/kortestb'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::KORTESTB do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: kortestb #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k, k" do
      ...
      let(:bin_file_name) { "kortestb_k_k.bin" }
