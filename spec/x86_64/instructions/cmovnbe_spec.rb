...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/cmovnbe'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::CMOVNBE do
  ...
  describe "#initialize" do
    it "must set #name to :cmovnbe" do
      expect(subject.name).to be(:cmovnbe)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: cmovnbe #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg16, reg16" do
      ...
      let(:bin_file_name) { "cmovnbe_reg16_reg16.bin" }
    ...
    context "when #operands contains operands of types reg16, mem16" do
      ...
      let(:bin_file_name) { "cmovnbe_reg16_mem16.bin" }
    ...
    context "when #operands contains operands of types reg32, reg32" do
      ...
      let(:bin_file_name) { "cmovnbe_reg32_reg32.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "cmovnbe_reg32_mem32.bin" }
    ...
    context "when #operands contains operands of types reg64, reg64" do
      ...
      let(:bin_file_name) { "cmovnbe_reg64_reg64.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "cmovnbe_reg64_mem64.bin" }
