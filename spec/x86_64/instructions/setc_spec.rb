...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/setc'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::SETC do
  ...
  describe "#name" do
    it "must return :setc" do
      expect(subject.name).to eq(:setc)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8" do
      ...
      let(:bin_file_name) { "setc_reg8.bin" }
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "setc_mem8.bin" }
