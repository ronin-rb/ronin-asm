...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vextracti128'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VEXTRACTI128 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vextracti128 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vextracti128" do
      expect(subject.name).to eq(:vextracti128)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti128_xmm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem128, ymm, imm8" do
      ...
      let(:bin_file_name) { "vextracti128_mem128_ymm_imm8.bin" }
