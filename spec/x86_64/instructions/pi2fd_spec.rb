...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pi2fd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PI2FD do
  ...
  describe "#initialize" do
    it "must set #name to :pi2fd" do
      expect(subject.name).to be(:pi2fd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pi2fd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pi2fd" do
      expect(subject.name).to eq(:pi2fd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pi2fd_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pi2fd_mmx_mem64.bin" }
