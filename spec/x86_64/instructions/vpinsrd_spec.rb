...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpinsrd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPINSRD do
  ...
  describe "#name" do
    it "must return :vpinsrd" do
      expect(subject.name).to eq(:vpinsrd)
    end
  end
