...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vsm3msg2'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSM3MSG2 do
  ...
  describe "#initialize" do
    it "must set #name to :vsm3msg2" do
      expect(subject.name).to be(:vsm3msg2)
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vsm3msg2_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vsm3msg2_xmm_xmm_mem128.bin" }
