...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/blendvps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::BLENDVPS do
  ...
  describe "#name" do
    it "must return :blendvps" do
      expect(subject.name).to eq(:blendvps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm0" do
      ...
      let(:bin_file_name) { "blendvps_xmm_xmm_xmm0.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128, xmm0" do
      ...
      let(:bin_file_name) { "blendvps_xmm_mem128_xmm0.bin" }
