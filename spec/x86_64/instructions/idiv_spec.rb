...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/idiv'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::IDIV do
  ...
  describe "#initialize" do
    it "must set #name to :idiv" do
      expect(subject.name).to be(:idiv)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: idiv #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :idiv" do
      expect(subject.name).to eq(:idiv)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8" do
      ...
      let(:bin_file_name) { "idiv_reg8.bin" }
    ...
    context "when #operands contains operands of types reg16" do
      ...
      let(:bin_file_name) { "idiv_reg16.bin" }
    ...
    context "when #operands contains operands of types reg32" do
      ...
      let(:bin_file_name) { "idiv_reg32.bin" }
    ...
    context "when #operands contains operands of types reg64" do
      ...
      let(:bin_file_name) { "idiv_reg64.bin" }
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "idiv_mem8.bin" }
    ...
    context "when #operands contains operands of types mem16" do
      ...
      let(:bin_file_name) { "idiv_mem16.bin" }
    ...
    context "when #operands contains operands of types mem32" do
      ...
      let(:bin_file_name) { "idiv_mem32.bin" }
    ...
    context "when #operands contains operands of types mem64" do
      ...
      let(:bin_file_name) { "idiv_mem64.bin" }
