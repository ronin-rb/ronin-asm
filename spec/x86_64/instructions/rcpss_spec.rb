...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/rcpss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::RCPSS do
  ...
  describe "#initialize" do
    it "must set #name to :rcpss" do
      expect(subject.name).to be(:rcpss)
    end
  ...
  describe "#name" do
    it "must return :rcpss" do
      expect(subject.name).to eq(:rcpss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "rcpss_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "rcpss_xmm_mem32.bin" }
