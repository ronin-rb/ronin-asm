...
describe Ronin::ASM::X86_64::Instructions::VCVTSS2SI do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtss2si #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtss2si" do
      expect(subject.name).to eq(:vcvtss2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvtss2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "vcvtss2si_reg32_mem32.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvtss2si_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem32" do
      ...
      let(:bin_file_name) { "vcvtss2si_reg64_mem32.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtss2si_reg32_xmm_{er}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtss2si_reg64_xmm_{er}.bin" }
