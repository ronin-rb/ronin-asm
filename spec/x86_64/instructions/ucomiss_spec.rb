...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/ucomiss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::UCOMISS do
  ...
  describe "#initialize" do
    it "must set #name to :ucomiss" do
      expect(subject.name).to be(:ucomiss)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: ucomiss #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "ucomiss_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "ucomiss_xmm_mem32.bin" }
