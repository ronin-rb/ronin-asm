...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pxor'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PXOR do
  ...
  describe "#name" do
    it "must return :pxor" do
      expect(subject.name).to eq(:pxor)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pxor_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pxor_mmx_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "pxor_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "pxor_xmm_mem128.bin" }
