...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcompresspd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCOMPRESSPD do
  ...
  describe "#initialize" do
    it "must set #name to :vcompresspd" do
      expect(subject.name).to be(:vcompresspd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcompresspd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcompresspd" do
      expect(subject.name).to eq(:vcompresspd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcompresspd_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, xmm" do
      ...
      let(:bin_file_name) { "vcompresspd_mem128{k}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcompresspd_ymm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types mem256{k}, ymm" do
      ...
      let(:bin_file_name) { "vcompresspd_mem256{k}_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vcompresspd_zmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types mem512{k}, zmm" do
      ...
      let(:bin_file_name) { "vcompresspd_mem512{k}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcompresspd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm" do
      ...
      let(:bin_file_name) { "vcompresspd_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm" do
      ...
      let(:bin_file_name) { "vcompresspd_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types mem128, xmm" do
      ...
      let(:bin_file_name) { "vcompresspd_mem128_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256, ymm" do
      ...
      let(:bin_file_name) { "vcompresspd_mem256_ymm.bin" }
    ...
    context "when #operands contains operands of types mem512, zmm" do
      ...
      let(:bin_file_name) { "vcompresspd_mem512_zmm.bin" }
