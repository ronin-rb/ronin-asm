...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vgatherdpd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VGATHERDPD do
  ...
  describe "#name" do
    it "must return :vgatherdpd" do
      expect(subject.name).to eq(:vgatherdpd)
    end
  end
