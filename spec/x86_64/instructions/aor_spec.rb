...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/aor'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::AOR do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: aor #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem32, reg32" do
      ...
      let(:bin_file_name) { "aor_mem32_reg32.bin" }
    ...
    context "when #operands contains operands of types mem64, reg64" do
      ...
      let(:bin_file_name) { "aor_mem64_reg64.bin" }
