...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vmovdqu8'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VMOVDQU8 do
  ...
  describe "#initialize" do
    it "must set #name to :vmovdqu8" do
      expect(subject.name).to be(:vmovdqu8)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vmovdqu8 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vmovdqu8" do
      expect(subject.name).to eq(:vmovdqu8)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem128{k}, xmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_mem128{k}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256{k}, ymm" do
      ...
      let(:bin_file_name) { "vmovdqu8_mem256{k}_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vmovdqu8_ymm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types mem512{k}, zmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_mem512{k}_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_zmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vmovdqu8_xmm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256" do
      ...
      let(:bin_file_name) { "vmovdqu8_ymm{k}{z}_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512" do
      ...
      let(:bin_file_name) { "vmovdqu8_zmm{k}{z}_mem512.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "vmovdqu8_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm" do
      ...
      let(:bin_file_name) { "vmovdqu8_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256" do
      ...
      let(:bin_file_name) { "vmovdqu8_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512" do
      ...
      let(:bin_file_name) { "vmovdqu8_zmm_mem512.bin" }
    ...
    context "when #operands contains operands of types mem128, xmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_mem128_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256, ymm" do
      ...
      let(:bin_file_name) { "vmovdqu8_mem256_ymm.bin" }
    ...
    context "when #operands contains operands of types mem512, zmm" do
      ...
      let(:bin_file_name) { "vmovdqu8_mem512_zmm.bin" }
