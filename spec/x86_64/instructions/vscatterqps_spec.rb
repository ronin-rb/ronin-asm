...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vscatterqps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSCATTERQPS do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vscatterqps #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vscatterqps" do
      expect(subject.name).to eq(:vscatterqps)
    end
  end
