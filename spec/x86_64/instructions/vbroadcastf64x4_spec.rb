...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vbroadcastf64x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VBROADCASTF64X4 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vbroadcastf64x4 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vbroadcastf64x4" do
      expect(subject.name).to eq(:vbroadcastf64x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256" do
      ...
      let(:bin_file_name) { "vbroadcastf64x4_zmm{k}{z}_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256" do
      ...
      let(:bin_file_name) { "vbroadcastf64x4_zmm_mem256.bin" }
