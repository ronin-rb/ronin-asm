...
describe Ronin::ASM::X86_64::Instructions::VCVTSD2USI do
  ...
  describe "#name" do
    it "must return :vcvtsd2usi" do
      expect(subject.name).to eq(:vcvtsd2usi)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvtsd2usi_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem64" do
      ...
      let(:bin_file_name) { "vcvtsd2usi_reg32_mem64.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvtsd2usi_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "vcvtsd2usi_reg64_mem64.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsd2usi_reg32_xmm_{er}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsd2usi_reg64_xmm_{er}.bin" }
