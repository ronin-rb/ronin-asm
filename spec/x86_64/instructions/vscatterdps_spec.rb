...
describe Ronin::ASM::X86_64::Instructions::VSCATTERDPS do
  ...
  describe "#name" do
    it "must return :vscatterdps" do
      expect(subject.name).to eq(:vscatterdps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types vm32x{k}, xmm" do
      ...
      let(:bin_file_name) { "vscatterdps_vm32x{k}_xmm.bin" }
    ...
    context "when #operands contains operands of types vm32y{k}, ymm" do
      ...
      let(:bin_file_name) { "vscatterdps_vm32y{k}_ymm.bin" }
    ...
    context "when #operands contains operands of types vm32z{k}, zmm" do
      ...
      let(:bin_file_name) { "vscatterdps_vm32z{k}_zmm.bin" }
