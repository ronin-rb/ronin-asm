...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtph2dq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTPH2DQ do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtph2dq" do
      expect(subject.name).to be(:vcvtph2dq)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtph2dq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtph2dq" do
      expect(subject.name).to eq(:vcvtph2dq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2dq_xmm{k}{z}_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2dq_ymm{k}{z}_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2dq_zmm{k}{z}_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2dq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2dq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtph2dq_zmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2dq_xmm_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2dq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2dq_ymm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2dq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2dq_zmm_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm" do
      ...
      let(:bin_file_name) { "vcvtph2dq_zmm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm, {er}" do
      ...
      let(:bin_file_name) { "vcvtph2dq_zmm{k}{z}_ymm_{er}.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm, {er}" do
      ...
      let(:bin_file_name) { "vcvtph2dq_zmm_ymm_{er}.bin" }
