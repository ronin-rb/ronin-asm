...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovm2q'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVM2Q do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovm2q" do
      expect(subject.name).to be(:vpmovm2q)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovm2q #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovm2q" do
      expect(subject.name).to eq(:vpmovm2q)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, k" do
      ...
      let(:bin_file_name) { "vpmovm2q_xmm_k.bin" }
    ...
    context "when #operands contains operands of types ymm, k" do
      ...
      let(:bin_file_name) { "vpmovm2q_ymm_k.bin" }
    ...
    context "when #operands contains operands of types zmm, k" do
      ...
      let(:bin_file_name) { "vpmovm2q_zmm_k.bin" }
