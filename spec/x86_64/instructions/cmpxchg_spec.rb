...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/cmpxchg'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::CMPXCHG do
  ...
  describe "#name" do
    it "must return :cmpxchg" do
      expect(subject.name).to eq(:cmpxchg)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8, reg8" do
      ...
      let(:bin_file_name) { "cmpxchg_reg8_reg8.bin" }
    ...
    context "when #operands contains operands of types reg16, reg16" do
      ...
      let(:bin_file_name) { "cmpxchg_reg16_reg16.bin" }
    ...
    context "when #operands contains operands of types reg32, reg32" do
      ...
      let(:bin_file_name) { "cmpxchg_reg32_reg32.bin" }
    ...
    context "when #operands contains operands of types reg64, reg64" do
      ...
      let(:bin_file_name) { "cmpxchg_reg64_reg64.bin" }
    ...
    context "when #operands contains operands of types mem8, reg8" do
      ...
      let(:bin_file_name) { "cmpxchg_mem8_reg8.bin" }
    ...
    context "when #operands contains operands of types mem16, reg16" do
      ...
      let(:bin_file_name) { "cmpxchg_mem16_reg16.bin" }
    ...
    context "when #operands contains operands of types mem32, reg32" do
      ...
      let(:bin_file_name) { "cmpxchg_mem32_reg32.bin" }
    ...
    context "when #operands contains operands of types mem64, reg64" do
      ...
      let(:bin_file_name) { "cmpxchg_mem64_reg64.bin" }
