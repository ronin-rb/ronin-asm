...
describe Ronin::ASM::X86_64::Instructions::VCVTSH2SI do
  ...
  describe "#name" do
    it "must return :vcvtsh2si" do
      expect(subject.name).to eq(:vcvtsh2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvtsh2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem16" do
      ...
      let(:bin_file_name) { "vcvtsh2si_reg32_mem16.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvtsh2si_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem16" do
      ...
      let(:bin_file_name) { "vcvtsh2si_reg64_mem16.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsh2si_reg32_xmm_{er}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsh2si_reg64_xmm_{er}.bin" }
