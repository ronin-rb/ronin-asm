...
describe Ronin::ASM::X86_64::Instructions::VPMOVB2M do
  ...
  describe "#name" do
    it "must return :vpmovb2m" do
      expect(subject.name).to eq(:vpmovb2m)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k, xmm" do
      ...
      let(:bin_file_name) { "vpmovb2m_k_xmm.bin" }
    ...
    context "when #operands contains operands of types k, ymm" do
      ...
      let(:bin_file_name) { "vpmovb2m_k_ymm.bin" }
    ...
    context "when #operands contains operands of types k, zmm" do
      ...
      let(:bin_file_name) { "vpmovb2m_k_zmm.bin" }
