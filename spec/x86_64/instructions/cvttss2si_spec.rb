...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/cvttss2si'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::CVTTSS2SI do
  ...
  describe "#name" do
    it "must return :cvttss2si" do
      expect(subject.name).to eq(:cvttss2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "cvttss2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "cvttss2si_reg32_mem32.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "cvttss2si_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem32" do
      ...
      let(:bin_file_name) { "cvttss2si_reg64_mem32.bin" }
