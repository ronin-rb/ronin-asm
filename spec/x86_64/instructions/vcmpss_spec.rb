...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcmpss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCMPSS do
  ...
  describe "#initialize" do
    ...
    context "when given operands of types k{k}, xmm, mem32, imm8" do
      let(:operands) { [k_k(0), xmm(1), mem32(2), imm8(3)] }
    ...
    context "when given operands of types k, xmm, mem32, imm8" do
      let(:operands) { [k(0), xmm(1), mem32(2), imm8(3)] }
  ...
  describe "#name" do
    it "must return :vcmpss" do
      expect(subject.name).to eq(:vcmpss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vcmpss_k{k}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vcmpss_k_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, mem32, imm8" do
      let(:operands) { [k_k(0), xmm(1), mem32(2), imm8(3)] }

      let(:bin_file_name) { "vcmpss_k{k}_xmm_mem32_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, mem32, imm8" do
      let(:operands) { [k(0), xmm(1), mem32(2), imm8(3)] }

      let(:bin_file_name) { "vcmpss_k_xmm_mem32_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vcmpss_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem32, imm8" do
      ...
      let(:bin_file_name) { "vcmpss_xmm_xmm_mem32_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vcmpss_k{k}_xmm_xmm_{sae}_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vcmpss_k_xmm_xmm_{sae}_imm8.bin" }
