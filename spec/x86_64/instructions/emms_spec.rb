...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/emms'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::EMMS do
  ...
  describe "#name" do
    it "must return :emms" do
      expect(subject.name).to eq(:emms)
    end
  end
