...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vinserti64x2'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VINSERTI64X2 do
  ...
  describe "#initialize" do
    it "must set #name to :vinserti64x2" do
      expect(subject.name).to be(:vinserti64x2)
    end
  ...
  describe "#name" do
    it "must return :vinserti64x2" do
      expect(subject.name).to eq(:vinserti64x2)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_ymm{k}{z}_ymm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_ymm{k}{z}_ymm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_zmm{k}{z}_zmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_zmm{k}{z}_zmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_ymm_ymm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_ymm_ymm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_zmm_zmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti64x2_zmm_zmm_mem128_imm8.bin" }
