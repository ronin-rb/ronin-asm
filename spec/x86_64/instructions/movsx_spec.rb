...
describe Ronin::ASM::X86_64::Instructions::MOVSX do
  ...
  describe "#name" do
    it "must return :movsx" do
      expect(subject.name).to eq(:movsx)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg16, reg8" do
      ...
      let(:bin_file_name) { "movsx_reg16_reg8.bin" }
    ...
    context "when #operands contains operands of types reg16, mem8" do
      ...
      let(:bin_file_name) { "movsx_reg16_mem8.bin" }
    ...
    context "when #operands contains operands of types reg32, reg8" do
      ...
      let(:bin_file_name) { "movsx_reg32_reg8.bin" }
    ...
    context "when #operands contains operands of types reg32, reg16" do
      ...
      let(:bin_file_name) { "movsx_reg32_reg16.bin" }
    ...
    context "when #operands contains operands of types reg32, mem8" do
      ...
      let(:bin_file_name) { "movsx_reg32_mem8.bin" }
    ...
    context "when #operands contains operands of types reg32, mem16" do
      ...
      let(:bin_file_name) { "movsx_reg32_mem16.bin" }
    ...
    context "when #operands contains operands of types reg64, reg8" do
      ...
      let(:bin_file_name) { "movsx_reg64_reg8.bin" }
    ...
    context "when #operands contains operands of types reg64, reg16" do
      let(:operands) { [reg64(0), reg16(1)] }

      let(:bin_file_name) { "movsx_reg64_reg16.bin" }
    ...
    context "when #operands contains operands of types reg64, mem8" do
      ...
      let(:bin_file_name) { "movsx_reg64_mem8.bin" }
    ...
    context "when #operands contains operands of types reg64, mem16" do
      ...
      let(:bin_file_name) { "movsx_reg64_mem16.bin" }
