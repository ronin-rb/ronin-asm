...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovwb'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVWB do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovwb" do
      expect(subject.name).to be(:vpmovwb)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovwb #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovwb" do
      expect(subject.name).to eq(:vpmovwb)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovwb_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types mem64{k}, xmm" do
      ...
      let(:bin_file_name) { "vpmovwb_mem64{k}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vpmovwb_xmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types mem128{k}, ymm" do
      ...
      let(:bin_file_name) { "vpmovwb_mem128{k}_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vpmovwb_ymm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types mem256{k}, zmm" do
      ...
      let(:bin_file_name) { "vpmovwb_mem256{k}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovwb_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, ymm" do
      ...
      let(:bin_file_name) { "vpmovwb_xmm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, zmm" do
      ...
      let(:bin_file_name) { "vpmovwb_ymm_zmm.bin" }
    ...
    context "when #operands contains operands of types mem64, xmm" do
      ...
      let(:bin_file_name) { "vpmovwb_mem64_xmm.bin" }
    ...
    context "when #operands contains operands of types mem128, ymm" do
      ...
      let(:bin_file_name) { "vpmovwb_mem128_ymm.bin" }
    ...
    context "when #operands contains operands of types mem256, zmm" do
      ...
      let(:bin_file_name) { "vpmovwb_mem256_zmm.bin" }
