...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vperm2f128'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPERM2F128 do
  ...
  describe "#name" do
    it "must return :vperm2f128" do
      expect(subject.name).to eq(:vperm2f128)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vperm2f128_ymm_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vperm2f128_ymm_ymm_mem256_imm8.bin" }
