...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vgatherpf0qpd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VGATHERPF0QPD do
  ...
  describe "#initialize" do
    it "must set #name to :vgatherpf0qpd" do
      expect(subject.name).to be(:vgatherpf0qpd)
    end
  ...
  describe "#name" do
    it "must return :vgatherpf0qpd" do
      expect(subject.name).to eq(:vgatherpf0qpd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types vm64z{k}" do
      ...
      let(:bin_file_name) { "vgatherpf0qpd_vm64z{k}.bin" }
