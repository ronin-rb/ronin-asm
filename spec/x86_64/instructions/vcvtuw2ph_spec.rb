...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtuw2ph'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTUW2PH do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtuw2ph" do
      expect(subject.name).to be(:vcvtuw2ph)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtuw2ph #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtuw2ph" do
      expect(subject.name).to eq(:vcvtuw2ph)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_xmm{k}{z}_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_ymm{k}{z}_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_zmm{k}{z}_mem512mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_ymm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_zmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_xmm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_ymm_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_zmm_mem512mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_zmm{k}{z}_zmm_{er}.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtuw2ph_zmm_zmm_{er}.bin" }
