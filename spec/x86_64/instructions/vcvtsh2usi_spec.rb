...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtsh2usi'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTSH2USI do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtsh2usi #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtsh2usi" do
      expect(subject.name).to eq(:vcvtsh2usi)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvtsh2usi_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem16" do
      ...
      let(:bin_file_name) { "vcvtsh2usi_reg32_mem16.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvtsh2usi_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem16" do
      ...
      let(:bin_file_name) { "vcvtsh2usi_reg64_mem16.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsh2usi_reg32_xmm_{er}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsh2usi_reg64_xmm_{er}.bin" }
