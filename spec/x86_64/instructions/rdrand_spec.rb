...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/rdrand'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::RDRAND do
  ...
  describe "#initialize" do
    it "must set #name to :rdrand" do
      expect(subject.name).to be(:rdrand)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: rdrand #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg16" do
      ...
      let(:bin_file_name) { "rdrand_reg16.bin" }
    ...
    context "when #operands contains operands of types reg32" do
      ...
      let(:bin_file_name) { "rdrand_reg32.bin" }
    ...
    context "when #operands contains operands of types reg64" do
      ...
      let(:bin_file_name) { "rdrand_reg64.bin" }
