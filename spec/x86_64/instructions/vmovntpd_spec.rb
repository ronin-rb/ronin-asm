...
describe Ronin::ASM::X86_64::Instructions::VMOVNTPD do
  ...
  describe "#name" do
    it "must return :vmovntpd" do
      expect(subject.name).to eq(:vmovntpd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem128, xmm" do
      ...
      let(:bin_file_name) { "vmovntpd_mem128_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256, ymm" do
      ...
      let(:bin_file_name) { "vmovntpd_mem256_ymm.bin" }
    ...
    context "when #operands contains operands of types mem512, zmm" do
      ...
      let(:bin_file_name) { "vmovntpd_mem512_zmm.bin" }
