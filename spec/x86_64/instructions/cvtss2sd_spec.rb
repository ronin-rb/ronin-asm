...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/cvtss2sd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::CVTSS2SD do
  ...
  describe "#initialize" do
    it "must set #name to :cvtss2sd" do
      expect(subject.name).to be(:cvtss2sd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: cvtss2sd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "cvtss2sd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "cvtss2sd_xmm_mem32.bin" }
