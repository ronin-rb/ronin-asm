...
describe Ronin::ASM::X86_64::Instructions::VCVTSI2SH do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtsi2sh #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtsi2sh" do
      expect(subject.name).to eq(:vcvtsi2sh)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, reg32" do
      ...
      let(:bin_file_name) { "vcvtsi2sh_xmm_xmm_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, reg64" do
      ...
      let(:bin_file_name) { "vcvtsi2sh_xmm_xmm_reg64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem32" do
      ...
      let(:bin_file_name) { "vcvtsi2sh_xmm_xmm_mem32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem64" do
      ...
      let(:bin_file_name) { "vcvtsi2sh_xmm_xmm_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, {er}, reg32" do
      ...
      let(:bin_file_name) { "vcvtsi2sh_xmm_xmm_{er}_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, {er}, reg64" do
      ...
      let(:bin_file_name) { "vcvtsi2sh_xmm_xmm_{er}_reg64.bin" }
