...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/punpcklbw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PUNPCKLBW do
  ...
  describe "#name" do
    it "must return :punpcklbw" do
      expect(subject.name).to eq(:punpcklbw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "punpcklbw_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem32" do
      ...
      let(:bin_file_name) { "punpcklbw_mmx_mem32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "punpcklbw_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "punpcklbw_xmm_mem128.bin" }
