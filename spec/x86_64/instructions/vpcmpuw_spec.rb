...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpcmpuw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPCMPUW do
  ...
  describe "#initialize" do
    it "must set #name to :vpcmpuw" do
      expect(subject.name).to be(:vpcmpuw)
    end
    ...
    context "when given operands of types k{k}, xmm, mem128, imm8" do
      let(:operands) { [k_k(0), xmm(1), mem128(2), imm8(3)] }
    ...
    context "when given operands of types k, xmm, mem128, imm8" do
      let(:operands) { [k(0), xmm(1), mem128(2), imm8(3)] }
    ...
    context "when given operands of types k{k}, ymm, mem256, imm8" do
      let(:operands) { [k_k(0), ymm(1), mem256(2), imm8(3)] }
    ...
    context "when given operands of types k, ymm, mem256, imm8" do
      let(:operands) { [k(0), ymm(1), mem256(2), imm8(3)] }
    ...
    context "when given operands of types k{k}, zmm, mem512, imm8" do
      let(:operands) { [k_k(0), zmm(1), mem512(2), imm8(3)] }
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpcmpuw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpcmpuw" do
      expect(subject.name).to eq(:vpcmpuw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuw_k{k}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuw_k_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, mem128, imm8" do
      let(:operands) { [k_k(0), xmm(1), mem128(2), imm8(3)] }

      let(:bin_file_name) { "vpcmpuw_k{k}_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, mem128, imm8" do
      let(:operands) { [k(0), xmm(1), mem128(2), imm8(3)] }

      let(:bin_file_name) { "vpcmpuw_k_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuw_k{k}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuw_k_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, mem256, imm8" do
      let(:operands) { [k_k(0), ymm(1), mem256(2), imm8(3)] }

      let(:bin_file_name) { "vpcmpuw_k{k}_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, mem256, imm8" do
      let(:operands) { [k(0), ymm(1), mem256(2), imm8(3)] }

      let(:bin_file_name) { "vpcmpuw_k_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuw_k{k}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpcmpuw_k_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, mem512, imm8" do
      let(:operands) { [k_k(0), zmm(1), mem512(2), imm8(3)] }

      let(:bin_file_name) { "vpcmpuw_k{k}_zmm_mem512_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, mem512, imm8" do
      let(:operands) { [k(0), zmm(1), mem512(2), imm8(3)] }

      let(:bin_file_name) { "vpcmpuw_k_zmm_mem512_imm8.bin" }
