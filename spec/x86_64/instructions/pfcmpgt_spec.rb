...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pfcmpgt'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PFCMPGT do
  ...
  describe "#initialize" do
    it "must set #name to :pfcmpgt" do
      expect(subject.name).to be(:pfcmpgt)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pfcmpgt #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pfcmpgt" do
      expect(subject.name).to eq(:pfcmpgt)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pfcmpgt_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pfcmpgt_mmx_mem64.bin" }
