...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpbroadcastb'

require_relative 'operand_examples'

describe Ronin::ASM::X86_64::Instructions::VPBROADCASTB do
