...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pfmul'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PFMUL do
  ...
  describe "#initialize" do
    it "must set #name to :pfmul" do
      expect(subject.name).to be(:pfmul)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pfmul #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pfmul" do
      expect(subject.name).to eq(:pfmul)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pfmul_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pfmul_mmx_mem64.bin" }
