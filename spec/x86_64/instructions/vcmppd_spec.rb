...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcmppd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCMPPD do
  ...
  describe "#name" do
    it "must return :vcmppd" do
      expect(subject.name).to eq(:vcmppd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k{k}, xmm, mem128/mem64bcst, imm8" do
      let(:operands) { [k_k(0), xmm(1), mem128_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vcmppd_k{k}_xmm_mem128mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, mem128/mem64bcst, imm8" do
      let(:operands) { [k(0), xmm(1), mem128_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vcmppd_k_xmm_mem128mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k{k}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, mem256/mem64bcst, imm8" do
      let(:operands) { [k_k(0), ymm(1), mem256_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vcmppd_k{k}_ymm_mem256mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, mem256/mem64bcst, imm8" do
      let(:operands) { [k(0), ymm(1), mem256_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vcmppd_k_ymm_mem256mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k{k}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, mem512/mem64bcst, imm8" do
      let(:operands) { [k_k(0), zmm(1), mem512_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vcmppd_k{k}_zmm_mem512mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, mem512/mem64bcst, imm8" do
      let(:operands) { [k(0), zmm(1), mem512_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vcmppd_k_zmm_mem512mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k{k}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_xmm_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_ymm_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_ymm_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types k{k}, zmm, zmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k{k}_zmm_zmm_{sae}_imm8.bin" }
    ...
    context "when #operands contains operands of types k, zmm, zmm, {sae}, imm8" do
      ...
      let(:bin_file_name) { "vcmppd_k_zmm_zmm_{sae}_imm8.bin" }
