...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtph2pd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTPH2PD do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtph2pd" do
      expect(subject.name).to be(:vcvtph2pd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtph2pd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtph2pd" do
      expect(subject.name).to eq(:vcvtph2pd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem32/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2pd_xmm{k}{z}_mem32mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2pd_ymm{k}{z}_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2pd_zmm{k}{z}_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2pd_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2pd_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2pd_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2pd_xmm_mem32mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2pd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem64/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2pd_ymm_mem64mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2pd_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vcvtph2pd_zmm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vcvtph2pd_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvtph2pd_zmm{k}{z}_xmm_{sae}.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvtph2pd_zmm_xmm_{sae}.bin" }
