...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpbroadcastw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPBROADCASTW do
  ...
  describe "#name" do
    it "must return :vpbroadcastw" do
      expect(subject.name).to eq(:vpbroadcastw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, reg32" do
      ...
      let(:bin_file_name) { "vpbroadcastw_xmm{k}{z}_reg32.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, reg32" do
      ...
      let(:bin_file_name) { "vpbroadcastw_ymm{k}{z}_reg32.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, reg32" do
      ...
      let(:bin_file_name) { "vpbroadcastw_zmm{k}{z}_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpbroadcastw_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpbroadcastw_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpbroadcastw_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem16" do
      let(:operands) { [xmm_k_z(0), mem16(1)] }

      let(:bin_file_name) { "vpbroadcastw_xmm{k}{z}_mem16.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem16" do
      let(:operands) { [ymm_k_z(0), mem16(1)] }

      let(:bin_file_name) { "vpbroadcastw_ymm{k}{z}_mem16.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem16" do
      let(:operands) { [zmm_k_z(0), mem16(1)] }

      let(:bin_file_name) { "vpbroadcastw_zmm{k}{z}_mem16.bin" }
    ...
    context "when #operands contains operands of types xmm, reg32" do
      ...
      let(:bin_file_name) { "vpbroadcastw_xmm_reg32.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpbroadcastw_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem16" do
      ...
      let(:bin_file_name) { "vpbroadcastw_xmm_mem16.bin" }
    ...
    context "when #operands contains operands of types ymm, reg32" do
      ...
      let(:bin_file_name) { "vpbroadcastw_ymm_reg32.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vpbroadcastw_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem16" do
      ...
      let(:bin_file_name) { "vpbroadcastw_ymm_mem16.bin" }
    ...
    context "when #operands contains operands of types zmm, reg32" do
      ...
      let(:bin_file_name) { "vpbroadcastw_zmm_reg32.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vpbroadcastw_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem16" do
      let(:operands) { [zmm(0), mem16(1)] }

      let(:bin_file_name) { "vpbroadcastw_zmm_mem16.bin" }
