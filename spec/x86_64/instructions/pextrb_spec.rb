...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pextrb'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PEXTRB do
  ...
  describe "#name" do
    it "must return :pextrb" do
      expect(subject.name).to eq(:pextrb)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm, imm8" do
      ...
      let(:bin_file_name) { "pextrb_reg32_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types mem8, xmm, imm8" do
      ...
      let(:bin_file_name) { "pextrb_mem8_xmm_imm8.bin" }
