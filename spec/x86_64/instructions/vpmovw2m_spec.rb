...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovw2m'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVW2M do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovw2m" do
      expect(subject.name).to be(:vpmovw2m)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovw2m #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types k, xmm" do
      ...
      let(:bin_file_name) { "vpmovw2m_k_xmm.bin" }
    ...
    context "when #operands contains operands of types k, ymm" do
      ...
      let(:bin_file_name) { "vpmovw2m_k_ymm.bin" }
    ...
    context "when #operands contains operands of types k, zmm" do
      ...
      let(:bin_file_name) { "vpmovw2m_k_zmm.bin" }
