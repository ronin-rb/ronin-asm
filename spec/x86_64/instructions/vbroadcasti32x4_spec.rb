...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vbroadcasti32x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VBROADCASTI32X4 do
  ...
  describe "#name" do
    it "must return :vbroadcasti32x4" do
      expect(subject.name).to eq(:vbroadcasti32x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vbroadcasti32x4_ymm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vbroadcasti32x4_zmm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128" do
      ...
      let(:bin_file_name) { "vbroadcasti32x4_ymm_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm, mem128" do
      ...
      let(:bin_file_name) { "vbroadcasti32x4_zmm_mem128.bin" }
