...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpslldq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPSLLDQ do
  ...
  describe "#name" do
    it "must return :vpslldq" do
      expect(subject.name).to eq(:vpslldq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpslldq_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpslldq_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpslldq_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vpslldq_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpslldq_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512, imm8" do
      ...
      let(:bin_file_name) { "vpslldq_zmm_mem512_imm8.bin" }
