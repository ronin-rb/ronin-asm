...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvttps2qq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTTPS2QQ do
  ...
  describe "#initialize" do
    it "must set #name to :vcvttps2qq" do
      expect(subject.name).to be(:vcvttps2qq)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvttps2qq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvttps2qq" do
      expect(subject.name).to eq(:vcvttps2qq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem64/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvttps2qq_xmm{k}{z}_mem64mem32bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvttps2qq_ymm{k}{z}_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvttps2qq_zmm{k}{z}_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvttps2qq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vcvttps2qq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vcvttps2qq_zmm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem64/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvttps2qq_xmm_mem64mem32bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vcvttps2qq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvttps2qq_ymm_mem128mem32bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vcvttps2qq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem256/mem32bcst" do
      ...
      let(:bin_file_name) { "vcvttps2qq_zmm_mem256mem32bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm" do
      ...
      let(:bin_file_name) { "vcvttps2qq_zmm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, ymm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttps2qq_zmm{k}{z}_ymm_{sae}.bin" }
    ...
    context "when #operands contains operands of types zmm, ymm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttps2qq_zmm_ymm_{sae}.bin" }
