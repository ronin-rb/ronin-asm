...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vinserti32x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VINSERTI32X4 do
  ...
  describe "#name" do
    it "must return :vinserti32x4" do
      expect(subject.name).to eq(:vinserti32x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_ymm{k}{z}_ymm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_ymm{k}{z}_ymm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_zmm{k}{z}_zmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_zmm{k}{z}_zmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_ymm_ymm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_ymm_ymm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_zmm_zmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vinserti32x4_zmm_zmm_mem128_imm8.bin" }
