...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpsrldq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPSRLDQ do
  ...
  describe "#name" do
    it "must return :vpsrldq" do
      expect(subject.name).to eq(:vpsrldq)
    end
  end
