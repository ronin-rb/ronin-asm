...
describe Ronin::ASM::X86_64::Instructions::IMUL do
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg64" do
      ...
      let(:bin_file_name) { "imul_reg64.bin" }
    ...
    context "when #operands contains operands of types mem64" do
      ...
      let(:bin_file_name) { "imul_mem64.bin" }
    ...
    context "when #operands contains operands of types reg64, reg64" do
      ...
      let(:bin_file_name) { "imul_reg64_reg64.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "imul_reg64_mem64.bin" }
    ...
    context "when #operands contains operands of types reg64, reg64, imm8" do
      ...
      let(:bin_file_name) { "imul_reg64_reg64_imm8.bin" }
    ...
    context "when #operands contains operands of types reg64, reg64, imm32" do
      ...
      let(:bin_file_name) { "imul_reg64_reg64_imm32.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64, imm8" do
      let(:operands) { [reg64(0), mem64(1), imm8(2)] }

      let(:bin_file_name) { "imul_reg64_mem64_imm8.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64, imm32" do
      ...
      let(:bin_file_name) { "imul_reg64_mem64_imm32.bin" }
