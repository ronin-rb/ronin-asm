...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pavgusb'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PAVGUSB do
  ...
  describe "#initialize" do
    it "must set #name to :pavgusb" do
      expect(subject.name).to be(:pavgusb)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pavgusb #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pavgusb" do
      expect(subject.name).to eq(:pavgusb)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pavgusb_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pavgusb_mmx_mem64.bin" }
