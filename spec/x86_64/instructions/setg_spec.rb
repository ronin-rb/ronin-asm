...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/setg'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::SETG do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: setg #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :setg" do
      expect(subject.name).to eq(:setg)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8" do
      ...
      let(:bin_file_name) { "setg_reg8.bin" }
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "setg_mem8.bin" }
