...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vshuff32x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSHUFF32X4 do
  ...
  describe "#initialize" do
    it "must set #name to :vshuff32x4" do
      expect(subject.name).to be(:vshuff32x4)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vshuff32x4 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vshuff32x4" do
      expect(subject.name).to eq(:vshuff32x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem256/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_ymm{k}{z}_ymm_mem256mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_ymm{k}{z}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem512/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_zmm{k}{z}_zmm_mem512mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_zmm{k}{z}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_ymm_ymm_mem256mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_ymm_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem512/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_zmm_zmm_mem512mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vshuff32x4_zmm_zmm_zmm_imm8.bin" }
