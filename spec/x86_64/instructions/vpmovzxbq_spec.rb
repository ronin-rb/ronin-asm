...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpmovzxbq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPMOVZXBQ do
  ...
  describe "#initialize" do
    it "must set #name to :vpmovzxbq" do
      expect(subject.name).to be(:vpmovzxbq)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpmovzxbq #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpmovzxbq" do
      expect(subject.name).to eq(:vpmovzxbq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxbq_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxbq_ymm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxbq_zmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem16" do
      ...
      let(:bin_file_name) { "vpmovzxbq_xmm{k}{z}_mem16.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem32" do
      ...
      let(:bin_file_name) { "vpmovzxbq_ymm{k}{z}_mem32.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem64" do
      ...
      let(:bin_file_name) { "vpmovzxbq_zmm{k}{z}_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxbq_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem16" do
      ...
      let(:bin_file_name) { "vpmovzxbq_xmm_mem16.bin" }
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxbq_ymm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem32" do
      ...
      let(:bin_file_name) { "vpmovzxbq_ymm_mem32.bin" }
    ...
    context "when #operands contains operands of types zmm, xmm" do
      ...
      let(:bin_file_name) { "vpmovzxbq_zmm_xmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem64" do
      ...
      let(:bin_file_name) { "vpmovzxbq_zmm_mem64.bin" }
