...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvttph2udq'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTTPH2UDQ do
  ...
  describe "#name" do
    it "must return :vcvttph2udq" do
      expect(subject.name).to eq(:vcvttph2udq)
    end
  end
