...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vfmaddsd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VFMADDSD do
  ...
  describe "#initialize" do
    it "must set #name to :vfmaddsd" do
      expect(subject.name).to be(:vfmaddsd)
    end
  ...
  describe "#name" do
    it "must return :vfmaddsd" do
      expect(subject.name).to eq(:vfmaddsd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vfmaddsd_xmm_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, mem64" do
      ...
      let(:bin_file_name) { "vfmaddsd_xmm_xmm_xmm_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem64, xmm" do
      ...
      let(:bin_file_name) { "vfmaddsd_xmm_xmm_mem64_xmm.bin" }
