...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vldmxcsr'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VLDMXCSR do
  ...
  describe "#name" do
    it "must return :vldmxcsr" do
      expect(subject.name).to eq(:vldmxcsr)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mem32" do
      ...
      let(:bin_file_name) { "vldmxcsr_mem32.bin" }
