...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pfrcp'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PFRCP do
  ...
  describe "#initialize" do
    it "must set #name to :pfrcp" do
      expect(subject.name).to be(:pfrcp)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pfrcp #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :pfrcp" do
      expect(subject.name).to eq(:pfrcp)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pfrcp_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pfrcp_mmx_mem64.bin" }
