...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vsha512msg1'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSHA512MSG1 do
  ...
  describe "#name" do
    it "must return :vsha512msg1" do
      expect(subject.name).to eq(:vsha512msg1)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm, xmm" do
      ...
      let(:bin_file_name) { "vsha512msg1_ymm_xmm.bin" }
