...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpexpandw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPEXPANDW do
  ...
  describe "#initialize" do
    it "must set #name to :vpexpandw" do
      expect(subject.name).to be(:vpexpandw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpexpandw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpexpandw" do
      expect(subject.name).to eq(:vpexpandw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vpexpandw_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vpexpandw_ymm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vpexpandw_zmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vpexpandw_xmm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256" do
      ...
      let(:bin_file_name) { "vpexpandw_ymm{k}{z}_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512" do
      ...
      let(:bin_file_name) { "vpexpandw_zmm{k}{z}_mem512.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vpexpandw_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128" do
      ...
      let(:bin_file_name) { "vpexpandw_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm" do
      ...
      let(:bin_file_name) { "vpexpandw_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256" do
      ...
      let(:bin_file_name) { "vpexpandw_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm" do
      ...
      let(:bin_file_name) { "vpexpandw_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512" do
      ...
      let(:bin_file_name) { "vpexpandw_zmm_mem512.bin" }
