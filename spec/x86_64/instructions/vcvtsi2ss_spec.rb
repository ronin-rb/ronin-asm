...
describe Ronin::ASM::X86_64::Instructions::VCVTSI2SS do
  ...
  describe "#name" do
    it "must return :vcvtsi2ss" do
      expect(subject.name).to eq(:vcvtsi2ss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, reg64" do
      ...
      let(:bin_file_name) { "vcvtsi2ss_xmm_xmm_reg64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem64" do
      ...
      let(:bin_file_name) { "vcvtsi2ss_xmm_xmm_mem64.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, {er}, reg64" do
      ...
      let(:bin_file_name) { "vcvtsi2ss_xmm_xmm_{er}_reg64.bin" }
