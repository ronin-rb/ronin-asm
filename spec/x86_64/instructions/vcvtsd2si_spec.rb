...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vcvtsd2si'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VCVTSD2SI do
  ...
  describe "#initialize" do
    it "must set #name to :vcvtsd2si" do
      expect(subject.name).to be(:vcvtsd2si)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vcvtsd2si #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vcvtsd2si" do
      expect(subject.name).to eq(:vcvtsd2si)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvtsd2si_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem64" do
      ...
      let(:bin_file_name) { "vcvtsd2si_reg32_mem64.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvtsd2si_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem64" do
      ...
      let(:bin_file_name) { "vcvtsd2si_reg64_mem64.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsd2si_reg32_xmm_{er}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {er}" do
      ...
      let(:bin_file_name) { "vcvtsd2si_reg64_xmm_{er}.bin" }
