...
describe Ronin::ASM::X86_64::Instructions::VGATHERQPS do
  ...
  describe "#name" do
    it "must return :vgatherqps" do
      expect(subject.name).to eq(:vgatherqps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}, vm64x" do
      ...
      let(:bin_file_name) { "vgatherqps_xmm{k}_vm64x.bin" }
    ...
    context "when #operands contains operands of types xmm{k}, vm64y" do
      ...
      let(:bin_file_name) { "vgatherqps_xmm{k}_vm64y.bin" }
    ...
    context "when #operands contains operands of types ymm{k}, vm64z" do
      ...
      let(:bin_file_name) { "vgatherqps_ymm{k}_vm64z.bin" }
    ...
    context "when #operands contains operands of types xmm, vm64x, xmm" do
      ...
      let(:bin_file_name) { "vgatherqps_xmm_vm64x_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, vm64y, xmm" do
      ...
      let(:bin_file_name) { "vgatherqps_xmm_vm64y_xmm.bin" }
