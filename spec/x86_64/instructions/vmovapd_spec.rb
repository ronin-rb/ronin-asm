...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vmovapd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VMOVAPD do
  ...
  describe "#name" do
    it "must return :vmovapd" do
      expect(subject.name).to eq(:vmovapd)
    end
  end
