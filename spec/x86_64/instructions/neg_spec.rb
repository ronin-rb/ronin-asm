...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/neg'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::NEG do
  ...
  describe "#initialize" do
    it "must set #name to :neg" do
      expect(subject.name).to be(:neg)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: neg #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :neg" do
      expect(subject.name).to eq(:neg)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg8" do
      ...
      let(:bin_file_name) { "neg_reg8.bin" }
    ...
    context "when #operands contains operands of types reg16" do
      ...
      let(:bin_file_name) { "neg_reg16.bin" }
    ...
    context "when #operands contains operands of types reg32" do
      ...
      let(:bin_file_name) { "neg_reg32.bin" }
    ...
    context "when #operands contains operands of types reg64" do
      ...
      let(:bin_file_name) { "neg_reg64.bin" }
    ...
    context "when #operands contains operands of types mem8" do
      ...
      let(:bin_file_name) { "neg_mem8.bin" }
    ...
    context "when #operands contains operands of types mem16" do
      ...
      let(:bin_file_name) { "neg_mem16.bin" }
    ...
    context "when #operands contains operands of types mem32" do
      ...
      let(:bin_file_name) { "neg_mem32.bin" }
    ...
    context "when #operands contains operands of types mem64" do
      ...
      let(:bin_file_name) { "neg_mem64.bin" }
