...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pmovsxbd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PMOVSXBD do
  ...
  describe "#name" do
    it "must return :pmovsxbd" do
      expect(subject.name).to eq(:pmovsxbd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "pmovsxbd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem32" do
      ...
      let(:bin_file_name) { "pmovsxbd_xmm_mem32.bin" }
