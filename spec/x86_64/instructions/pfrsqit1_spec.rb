...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pfrsqit1'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PFRSQIT1 do
  ...
  describe "#initialize" do
    it "must set #name to :pfrsqit1" do
      expect(subject.name).to be(:pfrsqit1)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: pfrsqit1 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types mmx, mmx" do
      ...
      let(:bin_file_name) { "pfrsqit1_mmx_mmx.bin" }
    ...
    context "when #operands contains operands of types mmx, mem64" do
      ...
      let(:bin_file_name) { "pfrsqit1_mmx_mem64.bin" }
