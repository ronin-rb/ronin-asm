...
describe Ronin::ASM::X86_64::Instructions::VCVTTSS2USI do
  ...
  describe "#name" do
    it "must return :vcvttss2usi" do
      expect(subject.name).to eq(:vcvttss2usi)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "vcvttss2usi_reg32_xmm.bin" }
    ...
    context "when #operands contains operands of types reg32, mem32" do
      ...
      let(:bin_file_name) { "vcvttss2usi_reg32_mem32.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm" do
      ...
      let(:bin_file_name) { "vcvttss2usi_reg64_xmm.bin" }
    ...
    context "when #operands contains operands of types reg64, mem32" do
      ...
      let(:bin_file_name) { "vcvttss2usi_reg64_mem32.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttss2usi_reg32_xmm_{sae}.bin" }
    ...
    context "when #operands contains operands of types reg64, xmm, {sae}" do
      ...
      let(:bin_file_name) { "vcvttss2usi_reg64_xmm_{sae}.bin" }
