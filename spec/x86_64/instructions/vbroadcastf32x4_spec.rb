...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vbroadcastf32x4'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VBROADCASTF32X4 do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vbroadcastf32x4 #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vbroadcastf32x4" do
      expect(subject.name).to eq(:vbroadcastf32x4)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vbroadcastf32x4_ymm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem128" do
      ...
      let(:bin_file_name) { "vbroadcastf32x4_zmm{k}{z}_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, mem128" do
      ...
      let(:bin_file_name) { "vbroadcastf32x4_ymm_mem128.bin" }
    ...
    context "when #operands contains operands of types zmm, mem128" do
      ...
      let(:bin_file_name) { "vbroadcastf32x4_zmm_mem128.bin" }
