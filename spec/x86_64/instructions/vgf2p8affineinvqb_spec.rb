...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vgf2p8affineinvqb'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VGF2P8AFFINEINVQB do
  ...
  describe "#initialize" do
    it "must set #name to :vgf2p8affineinvqb" do
      expect(subject.name).to be(:vgf2p8affineinvqb)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vgf2p8affineinvqb #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vgf2p8affineinvqb" do
      expect(subject.name).to eq(:vgf2p8affineinvqb)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem128/mem64bcst, imm8" do
      let(:operands) { [xmm_k_z(0), xmm(1), mem128_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vgf2p8affineinvqb_xmm{k}{z}_xmm_mem128mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_xmm{k}{z}_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem256/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_ymm{k}{z}_ymm_mem256mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_ymm{k}{z}_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem512/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_zmm{k}{z}_zmm_mem512mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_zmm{k}{z}_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128/mem64bcst, imm8" do
      let(:operands) { [xmm(0), xmm(1), mem128_mem64_bcst(2), imm8(3)] }

      let(:bin_file_name) { "vgf2p8affineinvqb_xmm_xmm_mem128mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_xmm_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_xmm_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_ymm_ymm_mem256mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_ymm_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_ymm_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem512/mem64bcst, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_zmm_zmm_mem512mem64bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vgf2p8affineinvqb_zmm_zmm_zmm_imm8.bin" }
