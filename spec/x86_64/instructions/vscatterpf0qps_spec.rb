...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vscatterpf0qps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VSCATTERPF0QPS do
  ...
  describe "#name" do
    it "must return :vscatterpf0qps" do
      expect(subject.name).to eq(:vscatterpf0qps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types vm64z{k}" do
      ...
      let(:bin_file_name) { "vscatterpf0qps_vm64z{k}.bin" }
