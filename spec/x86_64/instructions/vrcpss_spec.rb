...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vrcpss'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VRCPSS do
  ...
  describe "#initialize" do
    it "must set #name to :vrcpss" do
      expect(subject.name).to be(:vrcpss)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vrcpss #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vrcpss" do
      expect(subject.name).to eq(:vrcpss)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vrcpss_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem32" do
      ...
      let(:bin_file_name) { "vrcpss_xmm_xmm_mem32.bin" }
