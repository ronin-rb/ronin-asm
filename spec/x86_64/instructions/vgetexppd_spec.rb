...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vgetexppd'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VGETEXPPD do
  ...
  describe "#initialize" do
    it "must set #name to :vgetexppd" do
      expect(subject.name).to be(:vgetexppd)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vgetexppd #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vgetexppd" do
      expect(subject.name).to eq(:vgetexppd)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128/mem64bcst" do
      ...
      let(:bin_file_name) { "vgetexppd_xmm{k}{z}_mem128mem64bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256/mem64bcst" do
      ...
      let(:bin_file_name) { "vgetexppd_ymm{k}{z}_mem256mem64bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512/mem64bcst" do
      ...
      let(:bin_file_name) { "vgetexppd_zmm{k}{z}_mem512mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm" do
      ...
      let(:bin_file_name) { "vgetexppd_xmm{k}{z}_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm" do
      ...
      let(:bin_file_name) { "vgetexppd_ymm{k}{z}_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm" do
      ...
      let(:bin_file_name) { "vgetexppd_zmm{k}{z}_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128/mem64bcst" do
      ...
      let(:bin_file_name) { "vgetexppd_xmm_mem128mem64bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm" do
      ...
      let(:bin_file_name) { "vgetexppd_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256/mem64bcst" do
      ...
      let(:bin_file_name) { "vgetexppd_ymm_mem256mem64bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm" do
      ...
      let(:bin_file_name) { "vgetexppd_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512/mem64bcst" do
      ...
      let(:bin_file_name) { "vgetexppd_zmm_mem512mem64bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm" do
      ...
      let(:bin_file_name) { "vgetexppd_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, {sae}" do
      ...
      let(:bin_file_name) { "vgetexppd_zmm{k}{z}_zmm_{sae}.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, {sae}" do
      ...
      let(:bin_file_name) { "vgetexppd_zmm_zmm_{sae}.bin" }
