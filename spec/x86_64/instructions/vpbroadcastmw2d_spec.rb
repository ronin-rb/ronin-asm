...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpbroadcastmw2d'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPBROADCASTMW2D do
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, k" do
      ...
      let(:bin_file_name) { "vpbroadcastmw2d_xmm_k.bin" }
    ...
    context "when #operands contains operands of types ymm, k" do
      ...
      let(:bin_file_name) { "vpbroadcastmw2d_ymm_k.bin" }
    ...
    context "when #operands contains operands of types zmm, k" do
      ...
      let(:bin_file_name) { "vpbroadcastmw2d_zmm_k.bin" }
