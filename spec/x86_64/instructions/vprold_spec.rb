...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vprold'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPROLD do
  ...
  describe "#initialize" do
    it "must set #name to :vprold" do
      expect(subject.name).to be(:vprold)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vprold #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vprold" do
      expect(subject.name).to eq(:vprold)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vprold_xmm{k}{z}_mem128mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vprold_ymm{k}{z}_mem256mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vprold_zmm{k}{z}_mem512mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, imm8" do
      ...
      let(:bin_file_name) { "vprold_xmm{k}{z}_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vprold_ymm{k}{z}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vprold_zmm{k}{z}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vprold_xmm_mem128mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vprold_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vprold_ymm_mem256mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vprold_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512/mem32bcst, imm8" do
      ...
      let(:bin_file_name) { "vprold_zmm_mem512mem32bcst_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vprold_zmm_zmm_imm8.bin" }
