...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vpshuflw'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VPSHUFLW do
  ...
  describe "#initialize" do
    it "must set #name to :vpshuflw" do
      expect(subject.name).to be(:vpshuflw)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vpshuflw #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vpshuflw" do
      expect(subject.name).to eq(:vpshuflw)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_xmm{k}{z}_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_ymm{k}{z}_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_zmm{k}{z}_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_xmm{k}{z}_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, mem256, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_ymm{k}{z}_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, mem512, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_zmm{k}{z}_mem512_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_xmm_xmm_imm8.bin" }
    ...
    context "when #operands contains operands of types xmm, mem128, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_xmm_mem128_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_ymm_ymm_imm8.bin" }
    ...
    context "when #operands contains operands of types ymm, mem256, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_ymm_mem256_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_zmm_zmm_imm8.bin" }
    ...
    context "when #operands contains operands of types zmm, mem512, imm8" do
      ...
      let(:bin_file_name) { "vpshuflw_zmm_mem512_imm8.bin" }
