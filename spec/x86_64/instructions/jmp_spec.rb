...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/jmp'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::JMP do
  ...
  describe "#name" do
    it "must return :jmp" do
      expect(subject.name).to eq(:jmp)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types rel8" do
      ...
      let(:bin_file_name) { "jmp_rel8.bin" }
    ...
    context "when #operands contains operands of types rel32" do
      ...
      let(:bin_file_name) { "jmp_rel32.bin" }
    ...
    context "when #operands contains operands of types reg64" do
      ...
      let(:bin_file_name) { "jmp_reg64.bin" }
    ...
    context "when #operands contains operands of types mem64" do
      ...
      let(:bin_file_name) { "jmp_mem64.bin" }
