...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/pmovmskb'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::PMOVMSKB do
  ...
  describe "#initialize" do
    it "must set #name to :pmovmskb" do
      expect(subject.name).to be(:pmovmskb)
    end
  ...
  describe "#name" do
    it "must return :pmovmskb" do
      expect(subject.name).to eq(:pmovmskb)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types reg32, mmx" do
      ...
      let(:bin_file_name) { "pmovmskb_reg32_mmx.bin" }
    ...
    context "when #operands contains operands of types reg32, xmm" do
      ...
      let(:bin_file_name) { "pmovmskb_reg32_xmm.bin" }
