...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vmaskmovps'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VMASKMOVPS do
  ...
  describe "#initialize" do
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vmaskmovps #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vmaskmovps" do
      expect(subject.name).to eq(:vmaskmovps)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vmaskmovps_xmm_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256" do
      ...
      let(:bin_file_name) { "vmaskmovps_ymm_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types mem128, xmm, xmm" do
      ...
      let(:bin_file_name) { "vmaskmovps_mem128_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256, ymm, ymm" do
      ...
      let(:bin_file_name) { "vmaskmovps_mem256_ymm_ymm.bin" }
