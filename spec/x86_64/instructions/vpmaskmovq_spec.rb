...
describe Ronin::ASM::X86_64::Instructions::VPMASKMOVQ do
  ...
  describe "#name" do
    it "must return :vpmaskmovq" do
      expect(subject.name).to eq(:vpmaskmovq)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm, xmm, mem128" do
      ...
      let(:bin_file_name) { "vpmaskmovq_xmm_xmm_mem128.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256" do
      ...
      let(:bin_file_name) { "vpmaskmovq_ymm_ymm_mem256.bin" }
    ...
    context "when #operands contains operands of types mem128, xmm, xmm" do
      ...
      let(:bin_file_name) { "vpmaskmovq_mem128_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types mem256, ymm, ymm" do
      ...
      let(:bin_file_name) { "vpmaskmovq_mem256_ymm_ymm.bin" }
