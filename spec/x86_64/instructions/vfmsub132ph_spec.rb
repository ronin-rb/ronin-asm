...
require 'spec_helper'
require 'ronin/asm/x86_64/instructions/vfmsub132ph'

require_relative '../helpers/operands'

describe Ronin::ASM::X86_64::Instructions::VFMSUB132PH do
  ...
  describe "#initialize" do
    it "must set #name to :vfmsub132ph" do
      expect(subject.name).to be(:vfmsub132ph)
    end
    ...
    context "when given operands that do not match any of the instruction's forms" do
      ...
      it do
        ...
        }.to raise_error(ArgumentError,"incompatible operands given for instruction: vfmsub132ph #{operands.map(&:type).join(', ')}")
      end
    end
  ...
  describe "#name" do
    it "must return :vfmsub132ph" do
      expect(subject.name).to eq(:vfmsub132ph)
    end
  end
  ...
  describe "#encode", :compatibility do
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vfmsub132ph_xmm{k}{z}_xmm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm{k}{z}, xmm, xmm" do
      ...
      let(:bin_file_name) { "vfmsub132ph_xmm{k}{z}_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vfmsub132ph_ymm{k}{z}_ymm_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm{k}{z}, ymm, ymm" do
      ...
      let(:bin_file_name) { "vfmsub132ph_ymm{k}{z}_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, mem512/mem16bcst" do
      ...
      let(:bin_file_name) { "vfmsub132ph_zmm{k}{z}_zmm_mem512mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, zmm" do
      ...
      let(:bin_file_name) { "vfmsub132ph_zmm{k}{z}_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, mem128/mem16bcst" do
      ...
      let(:bin_file_name) { "vfmsub132ph_xmm_xmm_mem128mem16bcst.bin" }
    ...
    context "when #operands contains operands of types xmm, xmm, xmm" do
      ...
      let(:bin_file_name) { "vfmsub132ph_xmm_xmm_xmm.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, mem256/mem16bcst" do
      ...
      let(:bin_file_name) { "vfmsub132ph_ymm_ymm_mem256mem16bcst.bin" }
    ...
    context "when #operands contains operands of types ymm, ymm, ymm" do
      ...
      let(:bin_file_name) { "vfmsub132ph_ymm_ymm_ymm.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, mem512/mem16bcst" do
      ...
      let(:bin_file_name) { "vfmsub132ph_zmm_zmm_mem512mem16bcst.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, zmm" do
      ...
      let(:bin_file_name) { "vfmsub132ph_zmm_zmm_zmm.bin" }
    ...
    context "when #operands contains operands of types zmm{k}{z}, zmm, zmm, {er}" do
      ...
      let(:bin_file_name) { "vfmsub132ph_zmm{k}{z}_zmm_zmm_{er}.bin" }
    ...
    context "when #operands contains operands of types zmm, zmm, zmm, {er}" do
      ...
      let(:bin_file_name) { "vfmsub132ph_zmm_zmm_zmm_{er}.bin" }
