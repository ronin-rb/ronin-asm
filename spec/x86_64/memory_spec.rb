...
describe Ronin::ASM::X86_64::Memory do
  ...
  describe "#type_of?" do
    ...
    context "when given :sibmem" do
      context "when only #index is set" do
        ...
        it "must return true" do
          expect(subject.type_of?(:sibmem)).to be(true)
        end
      end
      ...
      context "when #index and #scale are not set" do
        ...
        it "must return false" do
          expect(subject.type_of?(:sibmem)).to be(false)
        end
      end
    end
  ...
  describe "#to_s" do
    it "must call Ronin::ASM::X86_64::Syntaxes::Intel.format_memory" do
      expect(subject.to_s).to eq(
        Ronin::ASM::X86_64::Syntaxes::Intel.format_memory(subject)
      )
    end
  end
end
