...
describe Ronin::ASM::X86_64 do
  ...
  describe "#oword" do
    context "when given an Integer" do
      it "must return a Ronin::ASM::X86_64::Immediate" do
        expect(subject.oword(1)).to be_a(Ronin::ASM::X86_64::Immediate)
      end
  ...
  describe "#yword" do
    context "when given an Integer" do
      it "must return a Ronin::ASM::X86_64::Immediate" do
        expect(subject.yword(1)).to be_a(Ronin::ASM::X86_64::Immediate)
      end
  ...
  describe "#zword" do
    context "when given an Integer" do
      it "must return a Ronin::ASM::X86_64::Immediate" do
        expect(subject.zword(1)).to be_a(Ronin::ASM::X86_64::Immediate)
      end
