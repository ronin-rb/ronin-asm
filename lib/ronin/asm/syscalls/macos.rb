  ...
  module ASM
    module Syscalls
      ...
      module MacOS
        ...
        def sys_close_syscall(fd) = syscall_macro(6,fd)
        ...
        def sys_chdir_syscall(path) = syscall_macro(12,path)
        ...
        def sys_fchdir_syscall(fd) = syscall_macro(13,fd)
        ...
        def getfsstat_syscall(buf,bufsize,flags) = syscall_macro(18,buf,bufsize,flags)
        ...
        def kill_syscall(pid,signum,posix) = syscall_macro(37,pid,signum,posix)
        ...
        def sys_dup_syscall(fd) = syscall_macro(41,fd)
        ...
        def sigprocmask_syscall(how,mask,omask) = syscall_macro(48,how,mask,omask)
        ...
        def sigpending_syscall(osv) = syscall_macro(52,osv)
        ...
        def sigaltstack_syscall(nss,oss) = syscall_macro(53,nss,oss)
        ...
        def reboot_syscall(opt,msg) = syscall_macro(55,opt,msg)
        ...
        def execve_syscall(fname,argp,envp) = syscall_macro(59,fname,argp,envp)
        ...
        def swapon_syscall = syscall_macro(85)
        ...
        def sys_getdtablesize_syscall = syscall_macro(89)
        ...
        def sys_dup2_syscall(from,to) = syscall_macro(90,from,to)
        ...
        def sys_fcntl_syscall(fd,cmd,arg) = syscall_macro(92,fd,cmd,arg)
        ...
        def gettimeofday_syscall(tp,tzp,mach_absolute_time) = syscall_macro(116,tp,tzp,mach_absolute_time)
        ...
        def sys_flock_syscall(fd,how) = syscall_macro(131,fd,how)
        ...
        def futimes_syscall(fd,tptr) = syscall_macro(139,fd,tptr)
        ...
        def gethostuuid_syscall(uuid_buf,timeoutp) = syscall_macro(142,uuid_buf,timeoutp)
        ...
        def getpgid_syscall(pid) = syscall_macro(151,pid)
        ...
        def setprivexec_syscall(flag) = syscall_macro(152,flag)
        ...
        def pread_syscall(fd,buf,nbyte,offset) = syscall_macro(153,fd,buf,nbyte,offset)
        ...
        def pwrite_syscall(fd,buf,nbyte,offset) = syscall_macro(154,fd,buf,nbyte,offset)
        ...
        def unmount_syscall(path,flags) = syscall_macro(159,path,flags)
        ...
        def quotactl_syscall(path,cmd,uid,arg) = syscall_macro(165,path,cmd,uid,arg)
        ...
        def mount_syscall(type,path,flags,data) = syscall_macro(167,type,path,flags,data)
        ...
        def csops_syscall(pid,ops,useraddr,usersize) = syscall_macro(169,pid,ops,useraddr,usersize)
        ...
        def csops_audittoken_syscall(pid,ops,useraddr,usersize,uaudittoken) = syscall_macro(170,pid,ops,useraddr,usersize,uaudittoken)
        ...
        def waitid_syscall(idtype,id,infop,options) = syscall_macro(173,idtype,id,infop,options)
        ...
        def sigreturn_syscall(uctx,infostyle,token) = syscall_macro(184,uctx,infostyle,token)
        ...
        def fdatasync_syscall(fd) = syscall_macro(187,fd)
        ...
        def sys_fstat_syscall(fd,ub) = syscall_macro(189,fd,ub)
        ...
        def sys_fpathconf_syscall(fd,name) = syscall_macro(192,fd,name)
        ...
        def mmap_syscall(addr,len,prot,flags,fd,pos) = syscall_macro(197,addr,len,prot,flags,fd,pos)
        ...
        def lseek_syscall(fd,offset,whence) = syscall_macro(199,fd,offset,whence)
        ...
        def truncate_syscall(path,length) = syscall_macro(200,path,length)
        ...
        def ftruncate_syscall(fd,length) = syscall_macro(201,fd,length)
        ...
        def fsgetpath_ext_syscall(buf,bufsize,fsid,objid,options) = syscall_macro(217,buf,bufsize,fsid,objid,options)
        ...
        def getattrlist_syscall(path,alist,attributeBuffer,bufferSize,options) = syscall_macro(220,path,alist,attributeBuffer,bufferSize,options)
        ...
        def setattrlist_syscall(path,alist,attributeBuffer,bufferSize,options) = syscall_macro(221,path,alist,attributeBuffer,bufferSize,options)
        ...
        def getdirentriesattr_syscall(fd,alist,buffer,buffersize,count,basep,newstate,options) = syscall_macro(222,fd,alist,buffer,buffersize,count,basep,newstate,options)
        ...
        def exchangedata_syscall(path1,path2,options) = syscall_macro(223,path1,path2,options)
        ...
        def searchfs_syscall(path,searchblock,nummatches,scriptcode,options,state) = syscall_macro(225,path,searchblock,nummatches,scriptcode,options,state)
        ...
        def delete_syscall(path) = syscall_macro(226,path)
        ...
        def copyfile_syscall(from,to,mode,flags) = syscall_macro(227,from,to,mode,flags)
        ...
        def fgetattrlist_syscall(fd,alist,attributeBuffer,bufferSize,options) = syscall_macro(228,fd,alist,attributeBuffer,bufferSize,options)
        ...
        def fsetattrlist_syscall(fd,alist,attributeBuffer,bufferSize,options) = syscall_macro(229,fd,alist,attributeBuffer,bufferSize,options)
        ...
        def poll_syscall(fds,nfds,timeout) = syscall_macro(230,fds,nfds,timeout)
        ...
        def getxattr_syscall(path,attrname,value,size,position,options) = syscall_macro(234,path,attrname,value,size,position,options)
        ...
        def fgetxattr_syscall(fd,attrname,value,size,position,options) = syscall_macro(235,fd,attrname,value,size,position,options)
        ...
        def setxattr_syscall(path,attrname,value,size,position,options) = syscall_macro(236,path,attrname,value,size,position,options)
        ...
        def fsetxattr_syscall(fd,attrname,value,size,position,options) = syscall_macro(237,fd,attrname,value,size,position,options)
        ...
        def removexattr_syscall(path,attrname,options) = syscall_macro(238,path,attrname,options)
        ...
        def fremovexattr_syscall(fd,attrname,options) = syscall_macro(239,fd,attrname,options)
        ...
        def listxattr_syscall(path,namebuf,bufsize,options) = syscall_macro(240,path,namebuf,bufsize,options)
        ...
        def flistxattr_syscall(fd,namebuf,bufsize,options) = syscall_macro(241,fd,namebuf,bufsize,options)
        ...
        def fsctl_syscall(path,cmd,data,options) = syscall_macro(242,path,cmd,data,options)
        ...
        def initgroups_syscall(gidsetsize,gidset,gmuid) = syscall_macro(243,gidsetsize,gidset,gmuid)
        ...
        def posix_spawn_syscall(pid,path,adesc,argv,envp) = syscall_macro(244,pid,path,adesc,argv,envp)
        ...
        def ffsctl_syscall(fd,cmd,data,options) = syscall_macro(245,fd,cmd,data,options)
        ...
        def semsys_syscall(which,a2,a3,a4,a5) = syscall_macro(251,which,a2,a3,a4,a5)
        ...
        def msgsys_syscall(which,a2,a3,a4,a5) = syscall_macro(252,which,a2,a3,a4,a5)
        ...
        def shmsys_syscall(which,a2,a3,a4) = syscall_macro(253,which,a2,a3,a4)
        ...
        def semctl_syscall(semid,semnum,cmd,arg) = syscall_macro(254,semid,semnum,cmd,arg)
        ...
        def semget_syscall(key,nsems,semflg) = syscall_macro(255,key,nsems,semflg)
        ...
        def semop_syscall(semid,sops,nsops) = syscall_macro(256,semid,sops,nsops)
        ...
        def msgctl_syscall(msqid,cmd,buf) = syscall_macro(258,msqid,cmd,buf)
        ...
        def msgget_syscall(key,msgflg) = syscall_macro(259,key,msgflg)
        ...
        def msgsnd_syscall(msqid,msgp,msgsz,msgflg) = syscall_macro(260,msqid,msgp,msgsz,msgflg)
        ...
        def msgrcv_syscall(msqid,msgp,msgsz,msgtyp,msgflg) = syscall_macro(261,msqid,msgp,msgsz,msgtyp,msgflg)
        ...
        def shmat_syscall(shmid,shmaddr,shmflg) = syscall_macro(262,shmid,shmaddr,shmflg)
        ...
        def shmctl_syscall(shmid,cmd,buf) = syscall_macro(263,shmid,cmd,buf)
        ...
        def shmdt_syscall(shmaddr) = syscall_macro(264,shmaddr)
        ...
        def shmget_syscall(key,size,shmflg) = syscall_macro(265,key,size,shmflg)
        ...
        def shm_open_syscall(name,oflag,mode) = syscall_macro(266,name,oflag,mode)
        ...
        def shm_unlink_syscall(name) = syscall_macro(267,name)
        ...
        def sem_open_syscall(name,oflag,mode,value) = syscall_macro(268,name,oflag,mode,value)
        ...
        def sem_close_syscall(sem) = syscall_macro(269,sem)
        ...
        def sem_unlink_syscall(name) = syscall_macro(270,name)
        ...
        def sem_wait_syscall(sem) = syscall_macro(271,sem)
        ...
        def sem_trywait_syscall(sem) = syscall_macro(272,sem)
        ...
        def sem_post_syscall(sem) = syscall_macro(273,sem)
        ...
        def sys_sysctlbyname_syscall(name,namelen,old,oldlenp,new,newlen) = syscall_macro(274,name,namelen,old,oldlenp,new,newlen)
        ...
        def open_extended_syscall(path,flags,uid,gid,mode,xsecurity) = syscall_macro(277,path,flags,uid,gid,mode,xsecurity)
        ...
        def umask_extended_syscall(newmask,xsecurity) = syscall_macro(278,newmask,xsecurity)
        ...
        def stat_extended_syscall(path,ub,xsecurity,xsecurity_size) = syscall_macro(279,path,ub,xsecurity,xsecurity_size)
        ...
        def lstat_extended_syscall(path,ub,xsecurity,xsecurity_size) = syscall_macro(280,path,ub,xsecurity,xsecurity_size)
        ...
        def sys_fstat_extended_syscall(fd,ub,xsecurity,xsecurity_size) = syscall_macro(281,fd,ub,xsecurity,xsecurity_size)
        ...
        def chmod_extended_syscall(path,uid,gid,mode,xsecurity) = syscall_macro(282,path,uid,gid,mode,xsecurity)
        ...
        def fchmod_extended_syscall(fd,uid,gid,mode,xsecurity) = syscall_macro(283,fd,uid,gid,mode,xsecurity)
        ...
        def access_extended_syscall(entries,size,results,uid) = syscall_macro(284,entries,size,results,uid)
        ...
        def sys_settid_syscall(uid,gid) = syscall_macro(285,uid,gid)
        ...
        def gettid_syscall(uidp,gidp) = syscall_macro(286,uidp,gidp)
        ...
        def setsgroups_syscall(setlen,guidset) = syscall_macro(287,setlen,guidset)
        ...
        def getsgroups_syscall(setlen,guidset) = syscall_macro(288,setlen,guidset)
        ...
        def setwgroups_syscall(setlen,guidset) = syscall_macro(289,setlen,guidset)
        ...
        def getwgroups_syscall(setlen,guidset) = syscall_macro(290,setlen,guidset)
        ...
        def mkfifo_extended_syscall(path,uid,gid,mode,xsecurity) = syscall_macro(291,path,uid,gid,mode,xsecurity)
        ...
        def mkdir_extended_syscall(path,uid,gid,mode,xsecurity) = syscall_macro(292,path,uid,gid,mode,xsecurity)
        ...
        def identitysvc_syscall(opcode,message) = syscall_macro(293,opcode,message)
        ...
        def sys_settid_with_pid_syscall(pid,assume) = syscall_macro(311,pid,assume)
        ...
        def lio_listio_syscall(mode,aiocblist,nent,sigp) = syscall_macro(320,mode,aiocblist,nent,sigp)
        ...
        def iopolicysys_syscall(cmd,arg) = syscall_macro(322,cmd,arg)
        ...
        def munlockall_syscall(how) = syscall_macro(325,how)
        ...
        def issetugid_syscall = syscall_macro(327)
        ...
        def __pthread_kill_syscall(thread_port,sig) = syscall_macro(328,thread_port,sig)
        ...
        def __pthread_sigmask_syscall(how,set,oset) = syscall_macro(329,how,set,oset)
        ...
        def __sigwait_syscall(set,sig) = syscall_macro(330,set,sig)
        ...
        def __semwait_signal_syscall(cond_sem,mutex_sem,timeout,relative,tv_sec,tv_nsec) = syscall_macro(334,cond_sem,mutex_sem,timeout,relative,tv_sec,tv_nsec)
        ...
        def proc_info_syscall(callnum,pid,flavor,arg,buffer,buffersize) = syscall_macro(336,callnum,pid,flavor,arg,buffer,buffersize)
        ...
        def sendfile_syscall(fd,s,offset,nbytes,hdtr,flags) = syscall_macro(337,fd,s,offset,nbytes,hdtr,flags)
        ...
        def stat64_syscall(path,ub) = syscall_macro(338,path,ub)
        ...
        def sys_fstat64_syscall(fd,ub) = syscall_macro(339,fd,ub)
        ...
        def lstat64_syscall(path,ub) = syscall_macro(340,path,ub)
        ...
        def stat64_extended_syscall(path,ub,xsecurity,xsecurity_size) = syscall_macro(341,path,ub,xsecurity,xsecurity_size)
        ...
        def lstat64_extended_syscall(path,ub,xsecurity,xsecurity_size) = syscall_macro(342,path,ub,xsecurity,xsecurity_size)
        ...
        def sys_fstat64_extended_syscall(fd,ub,xsecurity,xsecurity_size) = syscall_macro(343,fd,ub,xsecurity,xsecurity_size)
        ...
        def getdirentries64_syscall(fd,buf,bufsize,position) = syscall_macro(344,fd,buf,bufsize,position)
        ...
        def statfs64_syscall(path,buf) = syscall_macro(345,path,buf)
        ...
        def fstatfs64_syscall(fd,buf) = syscall_macro(346,fd,buf)
        ...
        def getfsstat64_syscall(buf,bufsize,flags) = syscall_macro(347,buf,bufsize,flags)
        ...
        def audit_syscall(record,length) = syscall_macro(350,record,length)
        ...
        def auditon_syscall(cmd,data,length) = syscall_macro(351,cmd,data,length)
        ...
        def getauid_syscall(auid) = syscall_macro(353,auid)
        ...
        def setauid_syscall(auid) = syscall_macro(354,auid)
        ...
        def getaudit_addr_syscall(auditinfo_addr,length) = syscall_macro(357,auditinfo_addr,length)
        ...
        def setaudit_addr_syscall(auditinfo_addr,length) = syscall_macro(358,auditinfo_addr,length)
        ...
        def auditctl_syscall(path) = syscall_macro(359,path)
        ...
        def lchown_syscall(path,owner,group) = syscall_macro(364,path,owner,group)
        ...
        def workq_open_syscall = syscall_macro(367)
        ...
        def workq_kernreturn_syscall(options,item,affinity,prio) = syscall_macro(368,options,item,affinity,prio)
        ...
        def ledger_syscall(cmd,arg1,arg2,arg3) = syscall_macro(373,cmd,arg1,arg2,arg3)
        ...
        def __mac_execve_syscall(fname,argp,envp,mac_p) = syscall_macro(380,fname,argp,envp,mac_p)
        ...
        def __mac_syscall_syscall(policy,call,arg) = syscall_macro(381,policy,call,arg)
        ...
        def __mac_get_file_syscall(path_p,mac_p) = syscall_macro(382,path_p,mac_p)
        ...
        def __mac_set_file_syscall(path_p,mac_p) = syscall_macro(383,path_p,mac_p)
        ...
        def __mac_get_link_syscall(path_p,mac_p) = syscall_macro(384,path_p,mac_p)
        ...
        def __mac_set_link_syscall(path_p,mac_p) = syscall_macro(385,path_p,mac_p)
        ...
        def __mac_get_proc_syscall(mac_p) = syscall_macro(386,mac_p)
        ...
        def __mac_set_proc_syscall(mac_p) = syscall_macro(387,mac_p)
        ...
        def __mac_get_fd_syscall(fd,mac_p) = syscall_macro(388,fd,mac_p)
        ...
        def __mac_set_fd_syscall(fd,mac_p) = syscall_macro(389,fd,mac_p)
        ...
        def __mac_get_pid_syscall(pid,mac_p) = syscall_macro(390,pid,mac_p)
        ...
        def pselect_syscall(nd,in_,ou,ex,ts,mask) = syscall_macro(394,nd,in_,ou,ex,ts,mask)
        ...
        def pselect_nocancel_syscall(nd,in_,ou,ex,ts,mask) = syscall_macro(395,nd,in_,ou,ex,ts,mask)
        ...
        def open_nocancel_syscall(path,flags,mode) = syscall_macro(398,path,flags,mode)
        ...
        def sys_close_nocancel_syscall(fd) = syscall_macro(399,fd)
        ...
        def wait4_nocancel_syscall(pid,status,options,rusage) = syscall_macro(400,pid,status,options,rusage)
        ...
        def recvmsg_nocancel_syscall(s,msg,flags) = syscall_macro(401,s,msg,flags)
        ...
        def sendmsg_nocancel_syscall(s,msg,flags) = syscall_macro(402,s,msg,flags)
        ...
        def recvfrom_nocancel_syscall(s,buf,len,flags,from,fromlenaddr) = syscall_macro(403,s,buf,len,flags,from,fromlenaddr)
        ...
        def accept_nocancel_syscall(s,name,anamelen) = syscall_macro(404,s,name,anamelen)
        ...
        def msync_nocancel_syscall(addr,len,flags) = syscall_macro(405,addr,len,flags)
        ...
        def sys_fcntl_nocancel_syscall(fd,cmd,arg) = syscall_macro(406,fd,cmd,arg)
        ...
        def select_nocancel_syscall(nd,in_,ou,ex,tv) = syscall_macro(407,nd,in_,ou,ex,tv)
        ...
        def fsync_nocancel_syscall(fd) = syscall_macro(408,fd)
        ...
        def connect_nocancel_syscall(s,name,namelen) = syscall_macro(409,s,name,namelen)
        ...
        def readv_nocancel_syscall(fd,iovp,iovcnt) = syscall_macro(411,fd,iovp,iovcnt)
        ...
        def writev_nocancel_syscall(fd,iovp,iovcnt) = syscall_macro(412,fd,iovp,iovcnt)
        ...
        def sendto_nocancel_syscall(s,buf,len,flags,to,tolen) = syscall_macro(413,s,buf,len,flags,to,tolen)
        ...
        def pread_nocancel_syscall(fd,buf,nbyte,offset) = syscall_macro(414,fd,buf,nbyte,offset)
        ...
        def pwrite_nocancel_syscall(fd,buf,nbyte,offset) = syscall_macro(415,fd,buf,nbyte,offset)
        ...
        def waitid_nocancel_syscall(idtype,id,infop,options) = syscall_macro(416,idtype,id,infop,options)
        ...
        def poll_nocancel_syscall(fds,nfds,timeout) = syscall_macro(417,fds,nfds,timeout)
        ...
        def msgsnd_nocancel_syscall(msqid,msgp,msgsz,msgflg) = syscall_macro(418,msqid,msgp,msgsz,msgflg)
        ...
        def msgrcv_nocancel_syscall(msqid,msgp,msgsz,msgtyp,msgflg) = syscall_macro(419,msqid,msgp,msgsz,msgtyp,msgflg)
        ...
        def sem_wait_nocancel_syscall(sem) = syscall_macro(420,sem)
        ...
        def __sigwait_nocancel_syscall(set,sig) = syscall_macro(422,set,sig)
        ...
        def __semwait_signal_nocancel_syscall(cond_sem,mutex_sem,timeout,relative,tv_sec,tv_nsec) = syscall_macro(423,cond_sem,mutex_sem,timeout,relative,tv_sec,tv_nsec)
        ...
        def __mac_mount_syscall(type,path,flags,data,mac_p) = syscall_macro(424,type,path,flags,data,mac_p)
        ...
        def __mac_get_mount_syscall(path,mac_p) = syscall_macro(425,path,mac_p)
        ...
        def __mac_getfsstat_syscall(buf,bufsize,mac,macsize,flags) = syscall_macro(426,buf,bufsize,mac,macsize,flags)
        ...
        def fsgetpath_syscall(buf,bufsize,fsid,objid) = syscall_macro(427,buf,bufsize,fsid,objid)
        ...
        def guarded_open_np_syscall(path,guard,guardflags,flags,mode) = syscall_macro(441,path,guard,guardflags,flags,mode)
        ...
        def guarded_close_np_syscall(fd,guard) = syscall_macro(442,fd,guard)
        ...
        def guarded_kqueue_np_syscall(guard,guardflags) = syscall_macro(443,guard,guardflags)
        ...
        def usrctl_syscall(flags) = syscall_macro(445,flags)
        ...
        def connectx_syscall(socket,endpoints,associd,flags,iov,iovcnt,len,connid) = syscall_macro(447,socket,endpoints,associd,flags,iov,iovcnt,len,connid)
        ...
        def socket_delegate_syscall(domain,type,protocol,epid) = syscall_macro(450,domain,type,protocol,epid)
        ...
        def necp_match_policy_syscall(parameters,parameters_size,returned_result) = syscall_macro(460,parameters,parameters_size,returned_result)
        ...
        def getattrlistbulk_syscall(dirfd,alist,attributeBuffer,bufferSize,options) = syscall_macro(461,dirfd,alist,attributeBuffer,bufferSize,options)
        ...
        def clonefileat_syscall(src_dirfd,src,dst_dirfd,dst,flags) = syscall_macro(462,src_dirfd,src,dst_dirfd,dst,flags)
        ...
        def openat_syscall(fd,path,flags,mode) = syscall_macro(463,fd,path,flags,mode)
        ...
        def openat_nocancel_syscall(fd,path,flags,mode) = syscall_macro(464,fd,path,flags,mode)
        ...
        def renameat_syscall(fromfd,from,tofd,to) = syscall_macro(465,fromfd,from,tofd,to)
        ...
        def faccessat_syscall(fd,path,amode,flag) = syscall_macro(466,fd,path,amode,flag)
        ...
        def fchmodat_syscall(fd,path,mode,flag) = syscall_macro(467,fd,path,mode,flag)
        ...
        def fchownat_syscall(fd,path,uid,gid,flag) = syscall_macro(468,fd,path,uid,gid,flag)
        ...
        def fstatat_syscall(fd,path,ub,flag) = syscall_macro(469,fd,path,ub,flag)
        ...
        def fstatat64_syscall(fd,path,ub,flag) = syscall_macro(470,fd,path,ub,flag)
        ...
        def linkat_syscall(fd1,path,fd2,link,flag) = syscall_macro(471,fd1,path,fd2,link,flag)
        ...
        def unlinkat_syscall(fd,path,flag) = syscall_macro(472,fd,path,flag)
        ...
        def readlinkat_syscall(fd,path,buf,bufsize) = syscall_macro(473,fd,path,buf,bufsize)
        ...
        def symlinkat_syscall(path1,fd,path2) = syscall_macro(474,path1,fd,path2)
        ...
        def mkdirat_syscall(fd,path,mode) = syscall_macro(475,fd,path,mode)
        ...
        def getattrlistat_syscall(fd,path,alist,attributeBuffer,bufferSize,options) = syscall_macro(476,fd,path,alist,attributeBuffer,bufferSize,options)
        ...
        def openbyid_np_syscall(fsid,objid,oflags) = syscall_macro(479,fsid,objid,oflags)
        ...
        def guarded_pwrite_np_syscall(fd,guard,buf,nbyte,offset) = syscall_macro(486,fd,guard,buf,nbyte,offset)
        ...
        def guarded_writev_np_syscall(fd,guard,iovp,iovcnt) = syscall_macro(487,fd,guard,iovp,iovcnt)
        ...
        def renameatx_np_syscall(fromfd,from,tofd,to,flags) = syscall_macro(488,fromfd,from,tofd,to,flags)
        ...
        def mremap_encrypted_syscall(addr,len,cryptid,cputype,cpusubtype) = syscall_macro(489,addr,len,cryptid,cputype,cpusubtype)
        ...
        def netagent_trigger_syscall(agent_uuid,agent_uuidlen) = syscall_macro(490,agent_uuid,agent_uuidlen)
        ...
        def stack_snapshot_with_config_syscall(stackshot_config_version,stackshot_config,stackshot_config_size) = syscall_macro(491,stackshot_config_version,stackshot_config,stackshot_config_size)
        ...
        def microstackshot_syscall(tracebuf,tracebuf_size,flags) = syscall_macro(492,tracebuf,tracebuf_size,flags)
        ...
        def persona_syscall(operation,flags,info,id,idlen,path) = syscall_macro(494,operation,flags,info,id,idlen,path)
        ...
        def necp_client_action_syscall(necp_fd,action,client_id,client_id_len,buffer,buffer_size) = syscall_macro(502,necp_fd,action,client_id,client_id_len,buffer,buffer_size)
        ...
        def __nexus_open_syscall(init,init_len) = syscall_macro(503,init,init_len)
        ...
        def __nexus_register_syscall(ctl,reg,reg_len,prov_uuid,prov_uuid_len) = syscall_macro(504,ctl,reg,reg_len,prov_uuid,prov_uuid_len)
        ...
        def __nexus_deregister_syscall(ctl,prov_uuid,prov_uuid_len) = syscall_macro(505,ctl,prov_uuid,prov_uuid_len)
        ...
        def __nexus_create_syscall(ctl,prov_uuid,prov_uuid_len,nx_uuid,nx_uuid_len) = syscall_macro(506,ctl,prov_uuid,prov_uuid_len,nx_uuid,nx_uuid_len)
        ...
        def __nexus_destroy_syscall(ctl,nx_uuid,nx_uuid_len) = syscall_macro(507,ctl,nx_uuid,nx_uuid_len)
        ...
        def __nexus_get_opt_syscall(ctl,opt,aoptval,aoptlen) = syscall_macro(508,ctl,opt,aoptval,aoptlen)
        ...
        def __nexus_set_opt_syscall(ctl,opt,aoptval,optlen) = syscall_macro(509,ctl,opt,aoptval,optlen)
        ...
        def __channel_open_syscall(init,init_len) = syscall_macro(510,init,init_len)
        ...
        def __channel_get_info_syscall(c,cinfo,cinfolen) = syscall_macro(511,c,cinfo,cinfolen)
        ...
        def __channel_sync_syscall(c,mode,flags) = syscall_macro(512,c,mode,flags)
        ...
        def __channel_get_opt_syscall(c,opt,aoptval,aoptlen) = syscall_macro(513,c,opt,aoptval,aoptlen)
        ...
        def __channel_set_opt_syscall(c,opt,aoptval,optlen) = syscall_macro(514,c,opt,aoptval,optlen)
        ...
        def fclonefileat_syscall(src_fd,dst_dirfd,dst,flags) = syscall_macro(517,src_fd,dst_dirfd,dst,flags)
        ...
        def terminate_with_payload_syscall(pid,reason_namespace,reason_code,payload,payload_size,reason_string,reason_flags) = syscall_macro(520,pid,reason_namespace,reason_code,payload,payload_size,reason_string,reason_flags)
        ...
        def abort_with_payload_syscall(reason_namespace,reason_code,payload,payload_size,reason_string,reason_flags) = syscall_macro(521,reason_namespace,reason_code,payload,payload_size,reason_string,reason_flags)
        ...
        def necp_session_action_syscall(necp_fd,action,in_buffer,in_buffer_length,out_buffer,out_buffer_length) = syscall_macro(523,necp_fd,action,in_buffer,in_buffer_length,out_buffer,out_buffer_length)
        ...
        def setattrlistat_syscall(fd,path,alist,attributeBuffer,bufferSize,options) = syscall_macro(524,fd,path,alist,attributeBuffer,bufferSize,options)
        ...
        def net_qos_guideline_syscall(param,param_len) = syscall_macro(525,param,param_len)
        ...
        def fmount_syscall(type,fd,flags,data) = syscall_macro(526,type,fd,flags,data)
        ...
        def kqueue_workloop_ctl_syscall(cmd,options,addr,sz) = syscall_macro(530,cmd,options,addr,sz)
        ...
        def task_inspect_for_pid_syscall(target_tport,pid,t) = syscall_macro(538,target_tport,pid,t)
        ...
        def task_read_for_pid_syscall(target_tport,pid,t) = syscall_macro(539,target_tport,pid,t)
        ...
        def sys_preadv_syscall(fd,iovp,iovcnt,offset) = syscall_macro(540,fd,iovp,iovcnt,offset)
        ...
        def sys_pwritev_syscall(fd,iovp,iovcnt,offset) = syscall_macro(541,fd,iovp,iovcnt,offset)
        ...
        def sys_preadv_nocancel_syscall(fd,iovp,iovcnt,offset) = syscall_macro(542,fd,iovp,iovcnt,offset)
        ...
        def sys_pwritev_nocancel_syscall(fd,iovp,iovcnt,offset) = syscall_macro(543,fd,iovp,iovcnt,offset)
        ...
        def proc_info_extended_id_syscall(callnum,pid,flavor,flags,ext_id,arg,buffer,buffersize) = syscall_macro(545,callnum,pid,flavor,flags,ext_id,arg,buffer,buffersize)
        ...
        def tracker_action_syscall(action,buffer,buffer_size) = syscall_macro(546,action,buffer,buffer_size)
        ...
        def debug_syscall_reject_syscall(packed_selectors) = syscall_macro(547,packed_selectors)
        ...
        def sys_debug_syscall_reject_config_syscall(packed_selectors1,packed_selectors2,flags) = syscall_macro(548,packed_selectors1,packed_selectors2,flags)
        ...
        def freadlink_syscall(fd,buf,bufsize) = syscall_macro(551,fd,buf,bufsize)
        ...
        def mkfifoat_syscall(fd,path,mode) = syscall_macro(553,fd,path,mode)
        ...
        def mknodat_syscall(fd,path,mode,dev) = syscall_macro(554,fd,path,mode,dev)
      end
    end
  end
end
