  ...
  module ASM
    module Syscalls
      ...
      module OpenBSD
        ...
        def getentropy_syscall(buf,nbyte) = syscall(7,buf,nbyte)
        ...
        def __tfork_syscall(param,psize) = syscall(8,param,psize)
        ...
        def wait4_syscall(pid,status,options,rusage) = syscall(11,pid,status,options,rusage)
        ...
        def fstatat_syscall(fd,path,buf,flag) = syscall(42,fd,path,buf,flag)
        ...
        def mmap_syscall(addr,len,prot,flags,fd,pos) = syscall(49,addr,len,prot,flags,fd,pos)
        ...
        def fstat_syscall(fd,sb) = syscall(53,fd,sb)
        ...
        def setitimer_syscall(which,itv,oitv) = syscall(69,which,itv,oitv)
        # Macro to call the `getitimer` syscall.
        # @param [Register, Integer] which
        # @param [Register, Integer] itv
        # @see https://man.openbsd.org/getitimer.2
        def getitimer_syscall(which,itv) = syscall(70,which,itv)
        ...
        def select_syscall(nd,in_,ou,ex,tv) = syscall(71,nd,in_,ou,ex,tv)
        ...
        def kevent_syscall(fd,changelist,nchanges,eventlist,nevents,timeout) = syscall(72,fd,changelist,nchanges,eventlist,nevents,timeout)
        ...
        def utimes_syscall(path,tptr) = syscall(76,path,tptr)
        # Macro to call the `futimes` syscall.
        # @param [Register, Integer] fd
        # @param [Register, Integer] tptr
        # @see https://man.openbsd.org/futimes.2
        def futimes_syscall(fd,tptr) = syscall(77,fd,tptr)
        ...
        def mquery_syscall(addr,len,prot,flags,fd,pos) = syscall(78,addr,len,prot,flags,fd,pos)
        ...
        def futex_syscall(f,op,val,timeout,g) = syscall(83,f,op,val,timeout,g)
        ...
        def nanosleep_syscall(rqtp,rmtp) = syscall(91,rqtp,rmtp)
        ...
        def accept4_syscall(s,name,anamelen,flags) = syscall(93,s,name,anamelen,flags)
        ...
        def __thrsleep_syscall(ident,clock_id,tp,lock,abort) = syscall(94,ident,clock_id,tp,lock,abort)
        ...
        def getdents_syscall(fd,buf,buflen) = syscall(99,fd,buf,buflen)
        ...
        def pipe2_syscall(fdp,flags) = syscall(101,fdp,flags)
        # Macro to call the `dup3` syscall.
        # @param [Register, Integer] from
        # @param [Register, Integer] to
        # @param [Register, Integer] flags
        # @see https://man.openbsd.org/dup3.2
        def dup3_syscall(from,to,flags) = syscall(102,from,to,flags)
        ...
        def chflagsat_syscall(fd,path,flags,atflags) = syscall(107,fd,path,flags,atflags)
        ...
        def pledge_syscall(promises,execpromises) = syscall(108,promises,execpromises)
        ...
        def ppoll_syscall(fds,nfds,ts,mask) = syscall(109,fds,nfds,ts,mask)
        ...
        def pselect_syscall(nd,in_,ou,ex,ts,mask) = syscall(110,nd,in_,ou,ex,ts,mask)
        ...
        def sendsyslog_syscall(buf,nbyte,flags) = syscall(112,buf,nbyte,flags)
        # Macro to call the `unveil` syscall.
        # @param [Register, Integer] path
        # @param [Register, Integer] permissions
        # @see https://man.openbsd.org/unveil.2
        def unveil_syscall(path,permissions) = syscall(114,path,permissions)
        ...
        def __realpath_syscall(pathname,resolved) = syscall(115,pathname,resolved)
        ...
        def recvmmsg_syscall(s,mmsg,vlen,flags,timeout) = syscall(116,s,mmsg,vlen,flags,timeout)
        ...
        def sendmmsg_syscall(s,mmsg,vlen,flags) = syscall(117,s,mmsg,vlen,flags)
        ...
        def thrkill_syscall(tid,signum,tcb) = syscall(119,tid,signum,tcb)
        ...
        def kill_syscall(pid,signum) = syscall(122,pid,signum)
        ...
        def getlogin_r_syscall(namebuf,namelen) = syscall(141,namebuf,namelen)
        # Macro to call the `getthrname` syscall.
        # @param [Register, Integer] tid
        # @param [Register, Integer] name
        # @param [Register, Integer] len
        # @see https://man.openbsd.org/getthrname.2
        def getthrname_syscall(tid,name,len) = syscall(142,tid,name,len)
        # Macro to call the `setthrname` syscall.
        # @param [Register, Integer] tid
        # @param [Register, Integer] name
        # @see https://man.openbsd.org/setthrname.2
        def setthrname_syscall(tid,name) = syscall(143,tid,name)
        ...
        def ypconnect_syscall(type) = syscall(150,type)
        ...
        def pinsyscalls_syscall(base,len,pins,npins) = syscall(158,base,len,pins,npins)
        # Macro to call the `mimmutable` syscall.
        # @param [Register, Integer] addr
        # @param [Register, Integer] len
        # @see https://man.openbsd.org/mimmutable.2
        def mimmutable_syscall(addr,len) = syscall(159,addr,len)
        ...
        def waitid_syscall(idtype,id,info,options) = syscall(160,idtype,id,info,options)
        ...
        def __tmpfd_syscall(flags) = syscall(164,flags)
        ...
        def lseek_syscall(fd,offset,whence) = syscall(166,fd,offset,whence)
        # Macro to call the `truncate` syscall.
        # @param [Register, Integer] path
        # @param [Register, Integer] length
        # @see https://man.openbsd.org/truncate.2
        def truncate_syscall(path,length) = syscall(167,path,length)
        # Macro to call the `ftruncate` syscall.
        # @param [Register, Integer] fd
        # @param [Register, Integer] length
        # @see https://man.openbsd.org/ftruncate.2
        def ftruncate_syscall(fd,length) = syscall(168,fd,length)
        ...
        def pread_syscall(fd,buf,nbyte,offset) = syscall(169,fd,buf,nbyte,offset)
        ...
        def pwrite_syscall(fd,buf,nbyte,offset) = syscall(170,fd,buf,nbyte,offset)
        ...
        def preadv_syscall(fd,iovp,iovcnt,offset) = syscall(171,fd,iovp,iovcnt,offset)
        ...
        def pwritev_syscall(fd,iovp,iovcnt,offset) = syscall(172,fd,iovp,iovcnt,offset)
        ...
        def profil_syscall(buf,buflen,samplesize,offset,scale,dirfd) = syscall(175,buf,buflen,samplesize,offset,scale,dirfd)
        ...
        def pathconfat_syscall(fd,path,name,flag) = syscall(190,fd,path,name,flag)
        ...
        def swapctl_syscall(cmd,arg,misc) = syscall(193,cmd,arg,misc)
        ...
        def utrace_syscall(label,addr,len) = syscall(209,label,addr,len)
        ...
        def poll_syscall(fds,nfds,timeout) = syscall(252,fds,nfds,timeout)
        ...
        def sigaltstack_syscall(nss,oss) = syscall(288,nss,oss)
        # Macro to call the `shmget` syscall.
        # @param [Register, Integer] key
        # @param [Register, Integer] size
        # @param [Register, Integer] shmflg
        # @see https://man.openbsd.org/shmget.2
        def shmget_syscall(key,size,shmflg) = syscall(289,key,size,shmflg)
        ...
        def semop_syscall(semid,sops,nsops) = syscall(290,semid,sops,nsops)
        # Macro to call the `fhstat` syscall.
        # @param [Register, Integer] fhp
        # @param [Register, Integer] sb
        # @see https://man.openbsd.org/fhstat.2
        def fhstat_syscall(fhp,sb) = syscall(294,fhp,sb)
        ...
        def faccessat_syscall(fd,path,amode,flag) = syscall(313,fd,path,amode,flag)
        ...
        def fchmodat_syscall(fd,path,mode,flag) = syscall(314,fd,path,mode,flag)
        ...
        def fchownat_syscall(fd,path,uid,gid,flag) = syscall(315,fd,path,uid,gid,flag)
        ...
        def linkat_syscall(fd1,path1,fd2,path2,flag) = syscall(317,fd1,path1,fd2,path2,flag)
        # Macro to call the `mkdirat` syscall.
        # @param [Register, Integer] fd
        # @param [Register, Integer] path
        # @param [Register, Integer] mode
        # @see https://man.openbsd.org/mkdirat.2
        def mkdirat_syscall(fd,path,mode) = syscall(318,fd,path,mode)
        # Macro to call the `mkfifoat` syscall.
        # @param [Register, Integer] fd
        # @param [Register, Integer] path
        # @param [Register, Integer] mode
        # @see https://man.openbsd.org/mkfifoat.2
        def mkfifoat_syscall(fd,path,mode) = syscall(319,fd,path,mode)
        ...
        def mknodat_syscall(fd,path,mode,dev) = syscall(320,fd,path,mode,dev)
        ...
        def openat_syscall(fd,path,flags,*mode) = syscall(321,fd,path,flags,*mode)
        ...
        def readlinkat_syscall(fd,path,buf,count) = syscall(322,fd,path,buf,count)
