    ...
    module Syscalls
      module Linux
        ...
        module X86
          ...
          def read_syscall(fd,buf,count) = syscall_macro(3,fd,buf,count)
          # Macro to call the `write` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] buf
          # @param [Register, Integer] count
          # @see https://www.man7.org/linux/man-pages/man2/write.2.html
          def write_syscall(fd,buf,count) = syscall_macro(4,fd,buf,count)
          ...
          def open_syscall(filename,flags,mode) = syscall_macro(5,filename,flags,mode)
          ...
          def waitpid_syscall(pid,stat_addr,options) = syscall_macro(7,pid,stat_addr,options)
          # Macro to call the `creat` syscall.
          # @param [Register, Integer] pathname
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/creat.2.html
          def creat_syscall(pathname,mode) = syscall_macro(8,pathname,mode)
          ...
          def link_syscall(oldname,newname) = syscall_macro(9,oldname,newname)
          # Macro to call the `unlink` syscall.
          # @param [Register, Integer] pathname
          # @see https://www.man7.org/linux/man-pages/man2/unlink.2.html
          def unlink_syscall(pathname) = syscall_macro(10,pathname)
          ...
          def oldstat_syscall(filename,statbuf) = syscall_macro(18,filename,statbuf)
          ...
          def stime_syscall(tptr) = syscall_macro(25,tptr)
          ...
          def sigpending_syscall(uset) = syscall_macro(73,uset)
          ...
          def sethostname_syscall(name,len) = syscall_macro(74,name,len)
          ...
          def setrlimit_syscall(resource,rlim) = syscall_macro(75,resource,rlim)
          # Macro to call the `getrlimit` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/getrlimit.2.html
          def getrlimit_syscall = syscall_macro(76)
          ...
          def getrusage_syscall(who,ru) = syscall_macro(77,who,ru)
          ...
          def symlink_syscall(old,new) = syscall_macro(83,old,new)
          # Macro to call the `oldlstat` syscall.
          # @param [Register, Integer] filename
          # @param [Register, Integer] statbuf
          # @see https://www.man7.org/linux/man-pages/man2/oldlstat.2.html
          def oldlstat_syscall(filename,statbuf) = syscall_macro(84,filename,statbuf)
          ...
          def readlink_syscall(path,buf,bufsiz) = syscall_macro(85,path,buf,bufsiz)
          # Macro to call the `uselib` syscall.
          # @param [Register, Integer] library
          # @see https://www.man7.org/linux/man-pages/man2/uselib.2.html
          def uselib_syscall(library) = syscall_macro(86,library)
          ...
          def swapon_syscall(specialfile,swap_flags) = syscall_macro(87,specialfile,swap_flags)
          ...
          def reboot_syscall(magic1,magic2,cmd,arg) = syscall_macro(88,magic1,magic2,cmd,arg)
          ...
          def getpriority_syscall(which,who) = syscall_macro(96,which,who)
          ...
          def ioperm_syscall(from,num,on) = syscall_macro(101,from,num,on)
          ...
          def socketcall_syscall(call,args) = syscall_macro(102,call,args)
          ...
          def adjtimex_syscall(txc_p) = syscall_macro(124,txc_p)
          ...
          def mprotect_syscall(start,len,prot) = syscall_macro(125,start,len,prot)
          ...
          def sigprocmask_syscall(how,set,oset) = syscall_macro(126,how,set,oset)
          # Macro to call the `create_module` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/create_module.2.html
          def create_module_syscall = syscall_macro(127)
          ...
          def init_module_syscall(umod,len,uargs) = syscall_macro(128,umod,len,uargs)
          ...
          def delete_module_syscall(name_user,flags) = syscall_macro(129,name_user,flags)
          # Macro to call the `get_kernel_syms` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/get_kernel_syms.2.html
          def get_kernel_syms_syscall = syscall_macro(130)
          ...
          def _llseek_syscall(fd,offset_high,offset_low,result,whence) = syscall_macro(140,fd,offset_high,offset_low,result,whence)
          ...
          def getdents_syscall(fd,dirent,count) = syscall_macro(141,fd,dirent,count)
          ...
          def _newselect_syscall(n,inp,outp,exp,tvp) = syscall_macro(142,n,inp,outp,exp,tvp)
          # Macro to call the `flock` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] cmd
          # @see https://www.man7.org/linux/man-pages/man2/flock.2.html
          def flock_syscall(fd,cmd) = syscall_macro(143,fd,cmd)
          # Macro to call the `msync` syscall.
          # @param [Register, Integer] start
          # @param [Register, Integer] len
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/msync.2.html
          def msync_syscall(start,len,flags) = syscall_macro(144,start,len,flags)
          ...
          def sched_setparam_syscall(pid,param) = syscall_macro(154,pid,param)
          # Macro to call the `sched_getparam` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] param
          # @see https://www.man7.org/linux/man-pages/man2/sched_getparam.2.html
          def sched_getparam_syscall(pid,param) = syscall_macro(155,pid,param)
          ...
          def sched_get_priority_max_syscall(policy) = syscall_macro(159,policy)
          ...
          def sched_get_priority_min_syscall(policy) = syscall_macro(160,policy)
          ...
          def sched_rr_get_interval_syscall(pid,interval) = syscall_macro(161,pid,interval)
          ...
          def nanosleep_syscall(rqtp,rmtp) = syscall_macro(162,rqtp,rmtp)
          ...
          def prctl_syscall(option,arg2,arg3,arg4,arg5) = syscall_macro(172,option,arg2,arg3,arg4,arg5)
          # Macro to call the `rt_sigreturn` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigreturn.2.html
          def rt_sigreturn_syscall = syscall_macro(173)
          ...
          def rt_sigaction_syscall(arg1,arg2,arg3,arg4) = syscall_macro(174,arg1,arg2,arg3,arg4)
          ...
          def rt_sigprocmask_syscall(how,set,oset,sigsetsize) = syscall_macro(175,how,set,oset,sigsetsize)
          # Macro to call the `rt_sigpending` syscall.
          # @param [Register, Integer] set
          # @param [Register, Integer] sigsetsize
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigpending.2.html
          def rt_sigpending_syscall(set,sigsetsize) = syscall_macro(176,set,sigsetsize)
          ...
          def rt_sigtimedwait_syscall(uthese,uinfo,uts,sigsetsize) = syscall_macro(177,uthese,uinfo,uts,sigsetsize)
          # Macro to call the `rt_sigqueueinfo` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] sig
          # @param [Register, Integer] uinfo
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigqueueinfo.2.html
          def rt_sigqueueinfo_syscall(pid,sig,uinfo) = syscall_macro(178,pid,sig,uinfo)
          ...
          def capget_syscall(header,dataptr) = syscall_macro(184,header,dataptr)
          # Macro to call the `capset` syscall.
          # @param [Register, Integer] header
          # @param [Register, Integer] data
          # @see https://www.man7.org/linux/man-pages/man2/capset.2.html
          def capset_syscall(header,data) = syscall_macro(185,header,data)
          ...
          def sigaltstack_syscall(uss,uoss) = syscall_macro(186,uss,uoss)
          ...
          def setreuid32_syscall(ruid,euid) = syscall_macro(203,ruid,euid)
          ...
          def setregid32_syscall(rgid,egid) = syscall_macro(204,rgid,egid)
          ...
          def getgroups32_syscall(gidsetsize,grouplist) = syscall_macro(205,gidsetsize,grouplist)
          # Macro to call the `setgroups32` syscall.
          # @param [Register, Integer] gidsetsize
          # @param [Register, Integer] grouplist
          # @see https://www.man7.org/linux/man-pages/man2/setgroups32.2.html
          def setgroups32_syscall(gidsetsize,grouplist) = syscall_macro(206,gidsetsize,grouplist)
          # Macro to call the `fchown32` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] user
          # @param [Register, Integer] group
          # @see https://www.man7.org/linux/man-pages/man2/fchown32.2.html
          def fchown32_syscall(fd,user,group) = syscall_macro(207,fd,user,group)
          ...
          def setresuid32_syscall(ruid,euid,suid) = syscall_macro(208,ruid,euid,suid)
          # Macro to call the `getresuid32` syscall.
          # @param [Register, Integer] ruid
          # @param [Register, Integer] euid
          # @param [Register, Integer] suid
          # @see https://www.man7.org/linux/man-pages/man2/getresuid32.2.html
          def getresuid32_syscall(ruid,euid,suid) = syscall_macro(209,ruid,euid,suid)
          ...
          def pivot_root_syscall(new_root,put_old) = syscall_macro(217,new_root,put_old)
          # Macro to call the `mincore` syscall.
          # @param [Register, Integer] start
          # @param [Register, Integer] len
          # @param [Register, Integer] vec
          # @see https://www.man7.org/linux/man-pages/man2/mincore.2.html
          def mincore_syscall(start,len,vec) = syscall_macro(218,start,len,vec)
          ...
          def setxattr_syscall(path,name,value,size,flags) = syscall_macro(226,path,name,value,size,flags)
          ...
          def lsetxattr_syscall(path,name,value,size,flags) = syscall_macro(227,path,name,value,size,flags)
          ...
          def fsetxattr_syscall(fd,name,value,size,flags) = syscall_macro(228,fd,name,value,size,flags)
          ...
          def getxattr_syscall(path,name,value,size) = syscall_macro(229,path,name,value,size)
          ...
          def lgetxattr_syscall(path,name,value,size) = syscall_macro(230,path,name,value,size)
          ...
          def fgetxattr_syscall(fd,name,value,size) = syscall_macro(231,fd,name,value,size)
          ...
          def sendfile64_syscall(out_fd,in_fd,offset,count) = syscall_macro(239,out_fd,in_fd,offset,count)
          ...
          def futex_syscall(uaddr,op,val,utime,uaddr2,val3) = syscall_macro(240,uaddr,op,val,utime,uaddr2,val3)
          ...
          def io_setup_syscall(nr_reqs,ctx) = syscall_macro(245,nr_reqs,ctx)
          # Macro to call the `io_destroy` syscall.
          # @param [Register, Integer] ctx
          # @see https://www.man7.org/linux/man-pages/man2/io_destroy.2.html
          def io_destroy_syscall(ctx) = syscall_macro(246,ctx)
          ...
          def io_getevents_syscall(ctx_id,min_nr,nr,events,timeout) = syscall_macro(247,ctx_id,min_nr,nr,events,timeout)
          # Macro to call the `io_submit` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/io_submit.2.html
          def io_submit_syscall(arg1,arg2,arg3) = syscall_macro(248,arg1,arg2,arg3)
          ...
          def epoll_ctl_syscall(epfd,op,fd,event) = syscall_macro(255,epfd,op,fd,event)
          ...
          def epoll_wait_syscall(epfd,events,maxevents,timeout) = syscall_macro(256,epfd,events,maxevents,timeout)
          ...
          def remap_file_pages_syscall(start,size,prot,pgoff,flags) = syscall_macro(257,start,size,prot,pgoff,flags)
          ...
          def set_tid_address_syscall(tidptr) = syscall_macro(258,tidptr)
          ...
          def timer_create_syscall(which_clock,timer_event_spec,created_timer_id) = syscall_macro(259,which_clock,timer_event_spec,created_timer_id)
          ...
          def timer_settime_syscall(timer_id,flags,new,old) = syscall_macro(260,timer_id,flags,new,old)
          ...
          def clock_settime_syscall(which_clock,tp) = syscall_macro(264,which_clock,tp)
          # Macro to call the `clock_gettime` syscall.
          # @param [Register, Integer] which_clock
          # @param [Register, Integer] tp
          # @see https://www.man7.org/linux/man-pages/man2/clock_gettime.2.html
          def clock_gettime_syscall(which_clock,tp) = syscall_macro(265,which_clock,tp)
          # Macro to call the `clock_getres` syscall.
          # @param [Register, Integer] which_clock
          # @param [Register, Integer] tp
          # @see https://www.man7.org/linux/man-pages/man2/clock_getres.2.html
          def clock_getres_syscall(which_clock,tp) = syscall_macro(266,which_clock,tp)
          ...
          def mbind_syscall(start,len,mode,nmask,maxnode,flags) = syscall_macro(274,start,len,mode,nmask,maxnode,flags)
          ...
          def get_mempolicy_syscall(policy,nmask,maxnode,addr,flags) = syscall_macro(275,policy,nmask,maxnode,addr,flags)
          # Macro to call the `set_mempolicy` syscall.
          # @param [Register, Integer] mode
          # @param [Register, Integer] nmask
          # @param [Register, Integer] maxnode
          # @see https://www.man7.org/linux/man-pages/man2/set_mempolicy.2.html
          def set_mempolicy_syscall(mode,nmask,maxnode) = syscall_macro(276,mode,nmask,maxnode)
          ...
          def mq_open_syscall(name,oflag,mode,attr) = syscall_macro(277,name,oflag,mode,attr)
          # Macro to call the `mq_unlink` syscall.
          # @param [Register, Integer] name
          # @see https://www.man7.org/linux/man-pages/man2/mq_unlink.2.html
          def mq_unlink_syscall(name) = syscall_macro(278,name)
          ...
          def mq_timedsend_syscall(mqdes,u_msg_ptr,msg_len,msg_prio,u_abs_timeout) = syscall_macro(279,mqdes,u_msg_ptr,msg_len,msg_prio,u_abs_timeout)
          ...
          def mq_timedreceive_syscall(mqdes,u_msg_ptr,msg_len,u_msg_prio,u_abs_timeout) = syscall_macro(280,mqdes,u_msg_ptr,msg_len,u_msg_prio,u_abs_timeout)
          ...
          def mq_notify_syscall(mqdes,notification) = syscall_macro(281,mqdes,notification)
          ...
          def mq_getsetattr_syscall(mqdes,mqstat,omqstat) = syscall_macro(282,mqdes,mqstat,omqstat)
          ...
          def kexec_load_syscall(entry,nr_segments,segments,flags) = syscall_macro(283,entry,nr_segments,segments,flags)
          ...
          def waitid_syscall(which,pid,infop,options,ru) = syscall_macro(284,which,pid,infop,options,ru)
          ...
          def add_key_syscall(_type,_description,_payload,plen,destringid) = syscall_macro(286,_type,_description,_payload,plen,destringid)
          ...
          def request_key_syscall(_type,_description,_callout_info,destringid) = syscall_macro(287,_type,_description,_callout_info,destringid)
          ...
          def keyctl_syscall(cmd,arg2,arg3,arg4,arg5) = syscall_macro(288,cmd,arg2,arg3,arg4,arg5)
          ...
          def inotify_rm_watch_syscall(fd,wd) = syscall_macro(293,fd,wd)
          ...
          def migrate_pages_syscall(pid,maxnode,from,to) = syscall_macro(294,pid,maxnode,from,to)
          ...
          def openat_syscall(dfd,filename,flags,mode) = syscall_macro(295,dfd,filename,flags,mode)
          # Macro to call the `mkdirat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] pathname
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/mkdirat.2.html
          def mkdirat_syscall(dfd,pathname,mode) = syscall_macro(296,dfd,pathname,mode)
          ...
          def mknodat_syscall(dfd,filename,mode,dev) = syscall_macro(297,dfd,filename,mode,dev)
          ...
          def fchownat_syscall(dfd,filename,user,group,flag) = syscall_macro(298,dfd,filename,user,group,flag)
          # Macro to call the `futimesat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] filename
          # @param [Register, Integer] t
          # @see https://www.man7.org/linux/man-pages/man2/futimesat.2.html
          def futimesat_syscall(dfd,filename,t) = syscall_macro(299,dfd,filename,t)
          ...
          def fstatat64_syscall(dfd,filename,statbuf,flag) = syscall_macro(300,dfd,filename,statbuf,flag)
          # Macro to call the `unlinkat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] pathname
          # @param [Register, Integer] flag
          # @see https://www.man7.org/linux/man-pages/man2/unlinkat.2.html
          def unlinkat_syscall(dfd,pathname,flag) = syscall_macro(301,dfd,pathname,flag)
          ...
          def renameat_syscall(olddfd,oldname,newdfd,newname) = syscall_macro(302,olddfd,oldname,newdfd,newname)
          ...
          def linkat_syscall(olddfd,oldname,newdfd,newname,flags) = syscall_macro(303,olddfd,oldname,newdfd,newname,flags)
          # Macro to call the `symlinkat` syscall.
          # @param [Register, Integer] oldname
          # @param [Register, Integer] newdfd
          # @param [Register, Integer] newname
          # @see https://www.man7.org/linux/man-pages/man2/symlinkat.2.html
          def symlinkat_syscall(oldname,newdfd,newname) = syscall_macro(304,oldname,newdfd,newname)
          ...
          def readlinkat_syscall(dfd,path,buf,bufsiz) = syscall_macro(305,dfd,path,buf,bufsiz)
          # Macro to call the `fchmodat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] filename
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/fchmodat.2.html
          def fchmodat_syscall(dfd,filename,mode) = syscall_macro(306,dfd,filename,mode)
          # Macro to call the `faccessat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] filename
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/faccessat.2.html
          def faccessat_syscall(dfd,filename,mode) = syscall_macro(307,dfd,filename,mode)
          ...
          def pselect6_syscall(arg1,arg2,arg3,arg4,arg5,arg6) = syscall_macro(308,arg1,arg2,arg3,arg4,arg5,arg6)
          ...
          def ppoll_syscall(arg1,arg2,arg3,arg4,arg5) = syscall_macro(309,arg1,arg2,arg3,arg4,arg5)
          ...
          def unshare_syscall(unshare_flags) = syscall_macro(310,unshare_flags)
          ...
          def set_robust_list_syscall(head,len) = syscall_macro(311,head,len)
          ...
          def get_robust_list_syscall(pid,head_ptr,len_ptr) = syscall_macro(312,pid,head_ptr,len_ptr)
          ...
          def splice_syscall(fd_in,off_in,fd_out,off_out,len,flags) = syscall_macro(313,fd_in,off_in,fd_out,off_out,len,flags)
          # Macro to call the `sync_file_range` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/sync_file_range.2.html
          def sync_file_range_syscall = syscall_macro(314)
          ...
          def tee_syscall(fdin,fdout,len,flags) = syscall_macro(315,fdin,fdout,len,flags)
          ...
          def vmsplice_syscall(fd,iov,nr_segs,flags) = syscall_macro(316,fd,iov,nr_segs,flags)
          ...
          def move_pages_syscall(pid,nr_pages,pages,nodes,status,flags) = syscall_macro(317,pid,nr_pages,pages,nodes,status,flags)
          ...
          def getcpu_syscall(cpu,node,cache) = syscall_macro(318,cpu,node,cache)
          ...
          def epoll_pwait_syscall(epfd,events,maxevents,timeout,sigmask,sigsetsize) = syscall_macro(319,epfd,events,maxevents,timeout,sigmask,sigsetsize)
          ...
          def utimensat_syscall(dfd,filename,t,flags) = syscall_macro(320,dfd,filename,t,flags)
          ...
          def signalfd_syscall(ufd,user_mask,sizemask) = syscall_macro(321,ufd,user_mask,sizemask)
          ...
          def timerfd_settime_syscall(ufd,flags,utmr,otmr) = syscall_macro(325,ufd,flags,utmr,otmr)
          # Macro to call the `timerfd_gettime` syscall.
          # @param [Register, Integer] ufd
          # @param [Register, Integer] otmr
          # @see https://www.man7.org/linux/man-pages/man2/timerfd_gettime.2.html
          def timerfd_gettime_syscall(ufd,otmr) = syscall_macro(326,ufd,otmr)
          ...
          def preadv_syscall(fd,vec,vlen,pos_l,pos_h) = syscall_macro(333,fd,vec,vlen,pos_l,pos_h)
          ...
          def pwritev_syscall(fd,vec,vlen,pos_l,pos_h) = syscall_macro(334,fd,vec,vlen,pos_l,pos_h)
          ...
          def rt_tgsigqueueinfo_syscall(tgid,pid,sig,uinfo) = syscall_macro(335,tgid,pid,sig,uinfo)
          ...
          def perf_event_open_syscall(attr_uptr,pid,cpu,group_fd,flags) = syscall_macro(336,attr_uptr,pid,cpu,group_fd,flags)
          ...
          def recvmmsg_syscall(fd,msg,vlen,flags,timeout) = syscall_macro(337,fd,msg,vlen,flags,timeout)
          ...
          def fanotify_init_syscall(flags,event_f_flags) = syscall_macro(338,flags,event_f_flags)
          ...
          def fanotify_mark_syscall(fanotify_fd,flags,mask,fd,pathname) = syscall_macro(339,fanotify_fd,flags,mask,fd,pathname)
          ...
          def prlimit64_syscall(pid,resource,new_rlim,old_rlim) = syscall_macro(340,pid,resource,new_rlim,old_rlim)
          ...
          def name_to_handle_at_syscall(dfd,name,handle,mnt_id,flag) = syscall_macro(341,dfd,name,handle,mnt_id,flag)
          ...
          def open_by_handle_at_syscall(mountdirfd,handle,flags) = syscall_macro(342,mountdirfd,handle,flags)
          ...
          def clock_adjtime_syscall(which_clock,tx) = syscall_macro(343,which_clock,tx)
          # Macro to call the `syncfs` syscall.
          # @param [Register, Integer] fd
          # @see https://www.man7.org/linux/man-pages/man2/syncfs.2.html
          def syncfs_syscall(fd) = syscall_macro(344,fd)
          ...
          def sendmmsg_syscall(fd,msg,vlen,flags) = syscall_macro(345,fd,msg,vlen,flags)
          # Macro to call the `setns` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] nstype
          # @see https://www.man7.org/linux/man-pages/man2/setns.2.html
          def setns_syscall(fd,nstype) = syscall_macro(346,fd,nstype)
          ...
          def process_vm_readv_syscall(pid,lvec,liovcnt,rvec,riovcnt,flags) = syscall_macro(347,pid,lvec,liovcnt,rvec,riovcnt,flags)
          ...
          def process_vm_writev_syscall(pid,lvec,liovcnt,rvec,riovcnt,flags) = syscall_macro(348,pid,lvec,liovcnt,rvec,riovcnt,flags)
          ...
          def kcmp_syscall(pid1,pid2,type,idx1,idx2) = syscall_macro(349,pid1,pid2,type,idx1,idx2)
          # Macro to call the `finit_module` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] uargs
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/finit_module.2.html
          def finit_module_syscall(fd,uargs,flags) = syscall_macro(350,fd,uargs,flags)
          # Macro to call the `sched_setattr` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] attr
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/sched_setattr.2.html
          def sched_setattr_syscall(pid,attr,flags) = syscall_macro(351,pid,attr,flags)
          ...
          def sched_getattr_syscall(pid,attr,size,flags) = syscall_macro(352,pid,attr,size,flags)
          ...
          def renameat2_syscall(olddfd,oldname,newdfd,newname,flags) = syscall_macro(353,olddfd,oldname,newdfd,newname,flags)
          # Macro to call the `seccomp` syscall.
          # @param [Register, Integer] op
          # @param [Register, Integer] flags
          # @param [Register, Integer] uargs
          # @see https://www.man7.org/linux/man-pages/man2/seccomp.2.html
          def seccomp_syscall(op,flags,uargs) = syscall_macro(354,op,flags,uargs)
          # Macro to call the `getrandom` syscall.
          # @param [Register, Integer] buf
          # @param [Register, Integer] count
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/getrandom.2.html
          def getrandom_syscall(buf,count,flags) = syscall_macro(355,buf,count,flags)
          ...
          def memfd_create_syscall(uname_ptr,flags) = syscall_macro(356,uname_ptr,flags)
          # Macro to call the `bpf` syscall.
          # @param [Register, Integer] cmd
          # @param [Register, Integer] attr
          # @param [Register, Integer] size
          # @see https://www.man7.org/linux/man-pages/man2/bpf.2.html
          def bpf_syscall(cmd,attr,size) = syscall_macro(357,cmd,attr,size)
          ...
          def execveat_syscall(dfd,filename,argv,envp,flags) = syscall_macro(358,dfd,filename,argv,envp,flags)
          # Macro to call the `socket` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/socket.2.html
          def socket_syscall(arg1,arg2,arg3) = syscall_macro(359,arg1,arg2,arg3)
          ...
          def socketpair_syscall(arg1,arg2,arg3,arg4) = syscall_macro(360,arg1,arg2,arg3,arg4)
          # Macro to call the `bind` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/bind.2.html
          def bind_syscall(arg1,arg2,arg3) = syscall_macro(361,arg1,arg2,arg3)
          # Macro to call the `connect` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/connect.2.html
          def connect_syscall(arg1,arg2,arg3) = syscall_macro(362,arg1,arg2,arg3)
          # Macro to call the `listen` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @see https://www.man7.org/linux/man-pages/man2/listen.2.html
          def listen_syscall(arg1,arg2) = syscall_macro(363,arg1,arg2)
          ...
          def accept4_syscall(arg1,arg2,arg3,arg4) = syscall_macro(364,arg1,arg2,arg3,arg4)
          ...
          def getsockopt_syscall(fd,level,optname,optval,optlen) = syscall_macro(365,fd,level,optname,optval,optlen)
          ...
          def setsockopt_syscall(fd,level,optname,optval,optlen) = syscall_macro(366,fd,level,optname,optval,optlen)
          # Macro to call the `getsockname` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/getsockname.2.html
          def getsockname_syscall(arg1,arg2,arg3) = syscall_macro(367,arg1,arg2,arg3)
          # Macro to call the `getpeername` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/getpeername.2.html
          def getpeername_syscall(arg1,arg2,arg3) = syscall_macro(368,arg1,arg2,arg3)
          ...
          def sendto_syscall(arg1,arg2,arg3,arg4,arg5,arg6) = syscall_macro(369,arg1,arg2,arg3,arg4,arg5,arg6)
          # Macro to call the `sendmsg` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] msg
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/sendmsg.2.html
          def sendmsg_syscall(fd,msg,flags) = syscall_macro(370,fd,msg,flags)
          ...
          def membarrier_syscall(cmd,flags,cpu_id) = syscall_macro(375,cmd,flags,cpu_id)
          # Macro to call the `mlock2` syscall.
          # @param [Register, Integer] start
          # @param [Register, Integer] len
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/mlock2.2.html
          def mlock2_syscall(start,len,flags) = syscall_macro(376,start,len,flags)
          ...
          def copy_file_range_syscall(fd_in,off_in,fd_out,off_out,len,flags) = syscall_macro(377,fd_in,off_in,fd_out,off_out,len,flags)
          ...
          def preadv2_syscall(fd,vec,vlen,pos_l,pos_h,flags) = syscall_macro(378,fd,vec,vlen,pos_l,pos_h,flags)
          ...
          def pwritev2_syscall(fd,vec,vlen,pos_l,pos_h,flags) = syscall_macro(379,fd,vec,vlen,pos_l,pos_h,flags)
          ...
          def pkey_mprotect_syscall(start,len,prot,pkey) = syscall_macro(380,start,len,prot,pkey)
          ...
          def pkey_alloc_syscall(flags,init_val) = syscall_macro(381,flags,init_val)
          # Macro to call the `pkey_free` syscall.
          # @param [Register, Integer] pkey
          # @see https://www.man7.org/linux/man-pages/man2/pkey_free.2.html
          def pkey_free_syscall(pkey) = syscall_macro(382,pkey)
          ...
          def statx_syscall(dfd,path,flags,mask,buffer) = syscall_macro(383,dfd,path,flags,mask,buffer)
          # Macro to call the `arch_prctl` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/arch_prctl.2.html
          def arch_prctl_syscall = syscall_macro(384)
          ...
          def io_pgetevents_syscall(ctx_id,min_nr,nr,events,timeout,sig) = syscall_macro(385,ctx_id,min_nr,nr,events,timeout,sig)
          ...
          def rseq_syscall(rseq,rseq_len,flags,sig) = syscall_macro(386,rseq,rseq_len,flags,sig)
          ...
          def semget_syscall(key,nsems,semflg) = syscall_macro(393,key,nsems,semflg)
          ...
          def semctl_syscall(semid,semnum,cmd,arg) = syscall_macro(394,semid,semnum,cmd,arg)
          # Macro to call the `shmget` syscall.
          # @param [Register, Integer] key
          # @param [Register, Integer] size
          # @param [Register, Integer] flag
          # @see https://www.man7.org/linux/man-pages/man2/shmget.2.html
          def shmget_syscall(key,size,flag) = syscall_macro(395,key,size,flag)
          # Macro to call the `shmctl` syscall.
          # @param [Register, Integer] shmid
          # @param [Register, Integer] cmd
          # @param [Register, Integer] buf
          # @see https://www.man7.org/linux/man-pages/man2/shmctl.2.html
          def shmctl_syscall(shmid,cmd,buf) = syscall_macro(396,shmid,cmd,buf)
          ...
          def msgsnd_syscall(msqid,msgp,msgsz,msgflg) = syscall_macro(400,msqid,msgp,msgsz,msgflg)
          ...
          def clock_nanosleep_time64_syscall(which_clock,flags,rqtp,rmtp) = syscall_macro(407,which_clock,flags,rqtp,rmtp)
          # Macro to call the `timer_gettime64` syscall.
          # @param [Register, Integer] timer_id
          # @param [Register, Integer] setting
          # @see https://www.man7.org/linux/man-pages/man2/timer_gettime64.2.html
          def timer_gettime64_syscall(timer_id,setting) = syscall_macro(408,timer_id,setting)
          ...
          def timer_settime64_syscall(timer_id,flags,new_setting,old_setting) = syscall_macro(409,timer_id,flags,new_setting,old_setting)
          # Macro to call the `timerfd_gettime64` syscall.
          # @param [Register, Integer] ufd
          # @param [Register, Integer] otmr
          # @see https://www.man7.org/linux/man-pages/man2/timerfd_gettime64.2.html
          def timerfd_gettime64_syscall(ufd,otmr) = syscall_macro(410,ufd,otmr)
          ...
          def timerfd_settime64_syscall(ufd,flags,utmr,otmr) = syscall_macro(411,ufd,flags,utmr,otmr)
          ...
          def utimensat_time64_syscall(dfd,filename,utimes,flags) = syscall_macro(412,dfd,filename,utimes,flags)
          ...
          def pselect6_time64_syscall(arg1,arg2,arg3,arg4,arg5,arg6) = syscall_macro(413,arg1,arg2,arg3,arg4,arg5,arg6)
          ...
          def ppoll_time64_syscall(arg1,arg2,arg3,arg4,arg5) = syscall_macro(414,arg1,arg2,arg3,arg4,arg5)
          ...
          def io_pgetevents_time64_syscall(ctx_id,min_nr,nr,events,timeout,sig) = syscall_macro(416,ctx_id,min_nr,nr,events,timeout,sig)
          ...
          def recvmmsg_time64_syscall(fd,msg,vlen,flags,timeout) = syscall_macro(417,fd,msg,vlen,flags,timeout)
          ...
          def mq_timedsend_time64_syscall(mqdes,msg_ptr,msg_len,msg_prio,abs_timeout) = syscall_macro(418,mqdes,msg_ptr,msg_len,msg_prio,abs_timeout)
          ...
          def mq_timedreceive_time64_syscall(mqdes,msg_ptr,msg_len,msg_prio,abs_timeout) = syscall_macro(419,mqdes,msg_ptr,msg_len,msg_prio,abs_timeout)
          ...
          def semtimedop_time64_syscall(semid,sops,nsops,timeout) = syscall_macro(420,semid,sops,nsops,timeout)
          ...
          def rt_sigtimedwait_time64_syscall(uthese,uinfo,uts,sigsetsize) = syscall_macro(421,uthese,uinfo,uts,sigsetsize)
          ...
          def futex_time64_syscall(uaddr,op,val,utime,uaddr2,val3) = syscall_macro(422,uaddr,op,val,utime,uaddr2,val3)
          ...
          def sched_rr_get_interval_time64_syscall(pid,interval) = syscall_macro(423,pid,interval)
