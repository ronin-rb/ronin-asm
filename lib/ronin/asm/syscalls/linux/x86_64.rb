    ...
    module Syscalls
      module Linux
        ...
        module X86_64
          ...
          def read_syscall(fd,buf,count) = syscall(0,fd,buf,count)
          # Macro to call the `write` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] buf
          # @param [Register, Integer] count
          # @see https://www.man7.org/linux/man-pages/man2/write.2.html
          def write_syscall(fd,buf,count) = syscall(1,fd,buf,count)
          ...
          def poll_syscall(ufds,nfds,timeout) = syscall(7,ufds,nfds,timeout)
          ...
          def lseek_syscall(fd,offset,whence) = syscall(8,fd,offset,whence)
          # Macro to call the `mmap` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/mmap.2.html
          def mmap_syscall = syscall(9)
          ...
          def rt_sigaction_syscall(arg1,arg2,arg3,arg4) = syscall(13,arg1,arg2,arg3,arg4)
          ...
          def rt_sigprocmask_syscall(how,set,oset,sigsetsize) = syscall(14,how,set,oset,sigsetsize)
          # Macro to call the `rt_sigreturn` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigreturn.2.html
          def rt_sigreturn_syscall = syscall(15)
          ...
          def ioctl_syscall(fd,cmd,arg) = syscall(16,fd,cmd,arg)
          ...
          def pread64_syscall(fd,buf,count,pos) = syscall(17,fd,buf,count,pos)
          ...
          def pwrite64_syscall(fd,buf,count,pos) = syscall(18,fd,buf,count,pos)
          ...
          def select_syscall(n,inp,outp,exp,tvp) = syscall(23,n,inp,outp,exp,tvp)
          # Macro to call the `sched_yield` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/sched_yield.2.html
          def sched_yield_syscall = syscall(24)
          ...
          def mremap_syscall(addr,old_len,new_len,flags,new_addr) = syscall(25,addr,old_len,new_len,flags,new_addr)
          # Macro to call the `msync` syscall.
          # @param [Register, Integer] start
          # @param [Register, Integer] len
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/msync.2.html
          def msync_syscall(start,len,flags) = syscall(26,start,len,flags)
          # Macro to call the `mincore` syscall.
          # @param [Register, Integer] start
          # @param [Register, Integer] len
          # @param [Register, Integer] vec
          # @see https://www.man7.org/linux/man-pages/man2/mincore.2.html
          def mincore_syscall(start,len,vec) = syscall(27,start,len,vec)
          ...
          def madvise_syscall(start,len,behavior) = syscall(28,start,len,behavior)
          ...
          def shmget_syscall(key,size,flag) = syscall(29,key,size,flag)
          ...
          def nanosleep_syscall(rqtp,rmtp) = syscall(35,rqtp,rmtp)
          ...
          def setitimer_syscall(which,value,ovalue) = syscall(38,which,value,ovalue)
          # Macro to call the `getpid` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/getpid.2.html
          def getpid_syscall = syscall(39)
          ...
          def sendto_syscall(arg1,arg2,arg3,arg4,arg5,arg6) = syscall(44,arg1,arg2,arg3,arg4,arg5,arg6)
          ...
          def socketpair_syscall(arg1,arg2,arg3,arg4) = syscall(53,arg1,arg2,arg3,arg4)
          ...
          def setsockopt_syscall(fd,level,optname,optval,optlen) = syscall(54,fd,level,optname,optval,optlen)
          ...
          def getsockopt_syscall(fd,level,optname,optval,optlen) = syscall(55,fd,level,optname,optval,optlen)
          ...
          def semget_syscall(key,nsems,semflg) = syscall(64,key,nsems,semflg)
          ...
          def semop_syscall(semid,sops,nsops) = syscall(65,semid,sops,nsops)
          ...
          def msgsnd_syscall(msqid,msgp,msgsz,msgflg) = syscall(69,msqid,msgp,msgsz,msgflg)
          ...
          def truncate_syscall(path,length) = syscall(76,path,length)
          # Macro to call the `ftruncate` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] length
          # @see https://www.man7.org/linux/man-pages/man2/ftruncate.2.html
          def ftruncate_syscall(fd,length) = syscall(77,fd,length)
          ...
          def symlink_syscall(old,new) = syscall(88,old,new)
          ...
          def gettimeofday_syscall(tv,tz) = syscall(96,tv,tz)
          ...
          def getrlimit_syscall(resource,rlim) = syscall(97,resource,rlim)
          ...
          def ptrace_syscall(request,pid,addr,data) = syscall(101,request,pid,addr,data)
          # Macro to call the `getuid` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/getuid.2.html
          def getuid_syscall = syscall(102)
          ...
          def setreuid_syscall(ruid,euid) = syscall(113,ruid,euid)
          ...
          def setregid_syscall(rgid,egid) = syscall(114,rgid,egid)
          ...
          def getgroups_syscall(gidsetsize,grouplist) = syscall(115,gidsetsize,grouplist)
          # Macro to call the `setgroups` syscall.
          # @param [Register, Integer] gidsetsize
          # @param [Register, Integer] grouplist
          # @see https://www.man7.org/linux/man-pages/man2/setgroups.2.html
          def setgroups_syscall(gidsetsize,grouplist) = syscall(116,gidsetsize,grouplist)
          ...
          def setresuid_syscall(ruid,euid,suid) = syscall(117,ruid,euid,suid)
          # Macro to call the `getresuid` syscall.
          # @param [Register, Integer] ruid
          # @param [Register, Integer] euid
          # @param [Register, Integer] suid
          # @see https://www.man7.org/linux/man-pages/man2/getresuid.2.html
          def getresuid_syscall(ruid,euid,suid) = syscall(118,ruid,euid,suid)
          ...
          def rt_sigtimedwait_syscall(uthese,uinfo,uts,sigsetsize) = syscall(128,uthese,uinfo,uts,sigsetsize)
          # Macro to call the `rt_sigqueueinfo` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] sig
          # @param [Register, Integer] uinfo
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigqueueinfo.2.html
          def rt_sigqueueinfo_syscall(pid,sig,uinfo) = syscall(129,pid,sig,uinfo)
          ...
          def rt_sigsuspend_syscall(unewset,sigsetsize) = syscall(130,unewset,sigsetsize)
          ...
          def setpriority_syscall(which,who,niceval) = syscall(141,which,who,niceval)
          ...
          def sched_setparam_syscall(pid,param) = syscall(142,pid,param)
          # Macro to call the `sched_getparam` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] param
          # @see https://www.man7.org/linux/man-pages/man2/sched_getparam.2.html
          def sched_getparam_syscall(pid,param) = syscall(143,pid,param)
          ...
          def sched_setscheduler_syscall(pid,policy,param) = syscall(144,pid,policy,param)
          # Macro to call the `sched_getscheduler` syscall.
          # @param [Register, Integer] pid
          # @see https://www.man7.org/linux/man-pages/man2/sched_getscheduler.2.html
          def sched_getscheduler_syscall(pid) = syscall(145,pid)
          ...
          def sched_get_priority_max_syscall(policy) = syscall(146,policy)
          ...
          def sched_get_priority_min_syscall(policy) = syscall(147,policy)
          ...
          def pivot_root_syscall(new_root,put_old) = syscall(155,new_root,put_old)
          # Macro to call the `_sysctl` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/_sysctl.2.html
          def _sysctl_syscall = syscall(156)
          ...
          def prctl_syscall(option,arg2,arg3,arg4,arg5) = syscall(157,option,arg2,arg3,arg4,arg5)
          # Macro to call the `arch_prctl` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/arch_prctl.2.html
          def arch_prctl_syscall = syscall(158)
          ...
          def mount_syscall(dev_name,dir_name,type,flags,data) = syscall(165,dev_name,dir_name,type,flags,data)
          # Macro to call the `umount2` syscall.
          # @param [Register, Integer] name
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/umount2.2.html
          def umount2_syscall(name,flags) = syscall(166,name,flags)
          ...
          def swapon_syscall(specialfile,swap_flags) = syscall(167,specialfile,swap_flags)
          # Macro to call the `swapoff` syscall.
          # @param [Register, Integer] specialfile
          # @see https://www.man7.org/linux/man-pages/man2/swapoff.2.html
          def swapoff_syscall(specialfile) = syscall(168,specialfile)
          ...
          def init_module_syscall(umod,len,uargs) = syscall(175,umod,len,uargs)
          ...
          def setxattr_syscall(path,name,value,size,flags) = syscall(188,path,name,value,size,flags)
          ...
          def lsetxattr_syscall(path,name,value,size,flags) = syscall(189,path,name,value,size,flags)
          ...
          def fsetxattr_syscall(fd,name,value,size,flags) = syscall(190,fd,name,value,size,flags)
          ...
          def getxattr_syscall(path,name,value,size) = syscall(191,path,name,value,size)
          ...
          def lgetxattr_syscall(path,name,value,size) = syscall(192,path,name,value,size)
          ...
          def fgetxattr_syscall(fd,name,value,size) = syscall(193,fd,name,value,size)
          ...
          def futex_syscall(uaddr,op,val,utime,uaddr2,val3) = syscall(202,uaddr,op,val,utime,uaddr2,val3)
          ...
          def io_setup_syscall(nr_reqs,ctx) = syscall(206,nr_reqs,ctx)
          # Macro to call the `io_destroy` syscall.
          # @param [Register, Integer] ctx
          # @see https://www.man7.org/linux/man-pages/man2/io_destroy.2.html
          def io_destroy_syscall(ctx) = syscall(207,ctx)
          ...
          def io_getevents_syscall(ctx_id,min_nr,nr,events,timeout) = syscall(208,ctx_id,min_nr,nr,events,timeout)
          # Macro to call the `io_submit` syscall.
          # @param [Register, Integer] arg1
          # @param [Register, Integer] arg2
          # @param [Register, Integer] arg3
          # @see https://www.man7.org/linux/man-pages/man2/io_submit.2.html
          def io_submit_syscall(arg1,arg2,arg3) = syscall(209,arg1,arg2,arg3)
          ...
          def remap_file_pages_syscall(start,size,prot,pgoff,flags) = syscall(216,start,size,prot,pgoff,flags)
          # Macro to call the `getdents64` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] dirent
          # @param [Register, Integer] count
          # @see https://www.man7.org/linux/man-pages/man2/getdents64.2.html
          def getdents64_syscall(fd,dirent,count) = syscall(217,fd,dirent,count)
          ...
          def semtimedop_syscall(semid,sops,nsops,timeout) = syscall(220,semid,sops,nsops,timeout)
          ...
          def fadvise64_syscall(fd,offset,len,advice) = syscall(221,fd,offset,len,advice)
          ...
          def timer_create_syscall(which_clock,timer_event_spec,created_timer_id) = syscall(222,which_clock,timer_event_spec,created_timer_id)
          ...
          def timer_settime_syscall(timer_id,flags,new_setting,old_setting) = syscall(223,timer_id,flags,new_setting,old_setting)
          ...
          def clock_nanosleep_syscall(which_clock,flags,rqtp,rmtp) = syscall(230,which_clock,flags,rqtp,rmtp)
          # Macro to call the `exit_group` syscall.
          # @param [Register, Integer] error_code
          # @see https://www.man7.org/linux/man-pages/man2/exit_group.2.html
          def exit_group_syscall(error_code) = syscall(231,error_code)
          ...
          def epoll_wait_syscall(epfd,events,maxevents,timeout) = syscall(232,epfd,events,maxevents,timeout)
          ...
          def mbind_syscall(start,len,mode,nmask,maxnode,flags) = syscall(237,start,len,mode,nmask,maxnode,flags)
          # Macro to call the `set_mempolicy` syscall.
          # @param [Register, Integer] mode
          # @param [Register, Integer] nmask
          # @param [Register, Integer] maxnode
          # @see https://www.man7.org/linux/man-pages/man2/set_mempolicy.2.html
          def set_mempolicy_syscall(mode,nmask,maxnode) = syscall(238,mode,nmask,maxnode)
          ...
          def get_mempolicy_syscall(policy,nmask,maxnode,addr,flags) = syscall(239,policy,nmask,maxnode,addr,flags)
          ...
          def mq_open_syscall(name,oflag,mode,attr) = syscall(240,name,oflag,mode,attr)
          # Macro to call the `mq_unlink` syscall.
          # @param [Register, Integer] name
          # @see https://www.man7.org/linux/man-pages/man2/mq_unlink.2.html
          def mq_unlink_syscall(name) = syscall(241,name)
          ...
          def mq_timedsend_syscall(mqdes,msg_ptr,msg_len,msg_prio,abs_timeout) = syscall(242,mqdes,msg_ptr,msg_len,msg_prio,abs_timeout)
          ...
          def mq_timedreceive_syscall(mqdes,msg_ptr,msg_len,msg_prio,abs_timeout) = syscall(243,mqdes,msg_ptr,msg_len,msg_prio,abs_timeout)
          ...
          def mq_notify_syscall(mqdes,notification) = syscall(244,mqdes,notification)
          ...
          def mq_getsetattr_syscall(mqdes,mqstat,omqstat) = syscall(245,mqdes,mqstat,omqstat)
          ...
          def kexec_load_syscall(entry,nr_segments,segments,flags) = syscall(246,entry,nr_segments,segments,flags)
          ...
          def waitid_syscall(which,pid,infop,options,ru) = syscall(247,which,pid,infop,options,ru)
          ...
          def add_key_syscall(_type,_description,_payload,plen,destringid) = syscall(248,_type,_description,_payload,plen,destringid)
          ...
          def request_key_syscall(_type,_description,_callout_info,destringid) = syscall(249,_type,_description,_callout_info,destringid)
          ...
          def keyctl_syscall(cmd,arg2,arg3,arg4,arg5) = syscall(250,cmd,arg2,arg3,arg4,arg5)
          ...
          def inotify_rm_watch_syscall(fd,wd) = syscall(255,fd,wd)
          ...
          def migrate_pages_syscall(pid,maxnode,from,to) = syscall(256,pid,maxnode,from,to)
          ...
          def openat_syscall(dfd,filename,flags,mode) = syscall(257,dfd,filename,flags,mode)
          # Macro to call the `mkdirat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] pathname
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/mkdirat.2.html
          def mkdirat_syscall(dfd,pathname,mode) = syscall(258,dfd,pathname,mode)
          ...
          def mknodat_syscall(dfd,filename,mode,dev) = syscall(259,dfd,filename,mode,dev)
          ...
          def fchownat_syscall(dfd,filename,user,group,flag) = syscall(260,dfd,filename,user,group,flag)
          # Macro to call the `futimesat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] filename
          # @param [Register, Integer] utimes
          # @see https://www.man7.org/linux/man-pages/man2/futimesat.2.html
          def futimesat_syscall(dfd,filename,utimes) = syscall(261,dfd,filename,utimes)
          ...
          def newfstatat_syscall(dfd,filename,statbuf,flag) = syscall(262,dfd,filename,statbuf,flag)
          # Macro to call the `unlinkat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] pathname
          # @param [Register, Integer] flag
          # @see https://www.man7.org/linux/man-pages/man2/unlinkat.2.html
          def unlinkat_syscall(dfd,pathname,flag) = syscall(263,dfd,pathname,flag)
          ...
          def renameat_syscall(olddfd,oldname,newdfd,newname) = syscall(264,olddfd,oldname,newdfd,newname)
          ...
          def linkat_syscall(olddfd,oldname,newdfd,newname,flags) = syscall(265,olddfd,oldname,newdfd,newname,flags)
          # Macro to call the `symlinkat` syscall.
          # @param [Register, Integer] oldname
          # @param [Register, Integer] newdfd
          # @param [Register, Integer] newname
          # @see https://www.man7.org/linux/man-pages/man2/symlinkat.2.html
          def symlinkat_syscall(oldname,newdfd,newname) = syscall(266,oldname,newdfd,newname)
          ...
          def readlinkat_syscall(dfd,path,buf,bufsiz) = syscall(267,dfd,path,buf,bufsiz)
          # Macro to call the `fchmodat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] filename
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/fchmodat.2.html
          def fchmodat_syscall(dfd,filename,mode) = syscall(268,dfd,filename,mode)
          # Macro to call the `faccessat` syscall.
          # @param [Register, Integer] dfd
          # @param [Register, Integer] filename
          # @param [Register, Integer] mode
          # @see https://www.man7.org/linux/man-pages/man2/faccessat.2.html
          def faccessat_syscall(dfd,filename,mode) = syscall(269,dfd,filename,mode)
          ...
          def pselect6_syscall(arg1,arg2,arg3,arg4,arg5,arg6) = syscall(270,arg1,arg2,arg3,arg4,arg5,arg6)
          ...
          def ppoll_syscall(arg1,arg2,arg3,arg4,arg5) = syscall(271,arg1,arg2,arg3,arg4,arg5)
          ...
          def unshare_syscall(unshare_flags) = syscall(272,unshare_flags)
          ...
          def set_robust_list_syscall(head,len) = syscall(273,head,len)
          ...
          def get_robust_list_syscall(pid,head_ptr,len_ptr) = syscall(274,pid,head_ptr,len_ptr)
          ...
          def splice_syscall(fd_in,off_in,fd_out,off_out,len,flags) = syscall(275,fd_in,off_in,fd_out,off_out,len,flags)
          ...
          def tee_syscall(fdin,fdout,len,flags) = syscall(276,fdin,fdout,len,flags)
          ...
          def sync_file_range_syscall(fd,offset,nbytes,flags) = syscall(277,fd,offset,nbytes,flags)
          ...
          def vmsplice_syscall(fd,iov,nr_segs,flags) = syscall(278,fd,iov,nr_segs,flags)
          ...
          def move_pages_syscall(pid,nr_pages,pages,nodes,status,flags) = syscall(279,pid,nr_pages,pages,nodes,status,flags)
          ...
          def utimensat_syscall(dfd,filename,utimes,flags) = syscall(280,dfd,filename,utimes,flags)
          ...
          def epoll_pwait_syscall(epfd,events,maxevents,timeout,sigmask,sigsetsize) = syscall(281,epfd,events,maxevents,timeout,sigmask,sigsetsize)
          ...
          def signalfd_syscall(ufd,user_mask,sizemask) = syscall(282,ufd,user_mask,sizemask)
          ...
          def timerfd_create_syscall(clockid,flags) = syscall(283,clockid,flags)
          # Macro to call the `eventfd` syscall.
          # @param [Register, Integer] count
          # @see https://www.man7.org/linux/man-pages/man2/eventfd.2.html
          def eventfd_syscall(count) = syscall(284,count)
          ...
          def fallocate_syscall(fd,mode,offset,len) = syscall(285,fd,mode,offset,len)
          ...
          def timerfd_settime_syscall(ufd,flags,utmr,otmr) = syscall(286,ufd,flags,utmr,otmr)
          # Macro to call the `timerfd_gettime` syscall.
          # @param [Register, Integer] ufd
          # @param [Register, Integer] otmr
          # @see https://www.man7.org/linux/man-pages/man2/timerfd_gettime.2.html
          def timerfd_gettime_syscall(ufd,otmr) = syscall(287,ufd,otmr)
          ...
          def accept4_syscall(arg1,arg2,arg3,arg4) = syscall(288,arg1,arg2,arg3,arg4)
          ...
          def preadv_syscall(fd,vec,vlen,pos_l,pos_h) = syscall(295,fd,vec,vlen,pos_l,pos_h)
          ...
          def pwritev_syscall(fd,vec,vlen,pos_l,pos_h) = syscall(296,fd,vec,vlen,pos_l,pos_h)
          ...
          def rt_tgsigqueueinfo_syscall(tgid,pid,sig,uinfo) = syscall(297,tgid,pid,sig,uinfo)
          ...
          def perf_event_open_syscall(attr_uptr,pid,cpu,group_fd,flags) = syscall(298,attr_uptr,pid,cpu,group_fd,flags)
          ...
          def recvmmsg_syscall(fd,msg,vlen,flags,timeout) = syscall(299,fd,msg,vlen,flags,timeout)
          ...
          def fanotify_init_syscall(flags,event_f_flags) = syscall(300,flags,event_f_flags)
          ...
          def fanotify_mark_syscall(fanotify_fd,flags,mask,fd,pathname) = syscall(301,fanotify_fd,flags,mask,fd,pathname)
          ...
          def prlimit64_syscall(pid,resource,new_rlim,old_rlim) = syscall(302,pid,resource,new_rlim,old_rlim)
          ...
          def name_to_handle_at_syscall(dfd,name,handle,mnt_id,flag) = syscall(303,dfd,name,handle,mnt_id,flag)
          ...
          def open_by_handle_at_syscall(mountdirfd,handle,flags) = syscall(304,mountdirfd,handle,flags)
          ...
          def clock_adjtime_syscall(which_clock,tx) = syscall(305,which_clock,tx)
          # Macro to call the `syncfs` syscall.
          # @param [Register, Integer] fd
          # @see https://www.man7.org/linux/man-pages/man2/syncfs.2.html
          def syncfs_syscall(fd) = syscall(306,fd)
          ...
          def sendmmsg_syscall(fd,msg,vlen,flags) = syscall(307,fd,msg,vlen,flags)
          # Macro to call the `setns` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] nstype
          # @see https://www.man7.org/linux/man-pages/man2/setns.2.html
          def setns_syscall(fd,nstype) = syscall(308,fd,nstype)
          ...
          def getcpu_syscall(cpu,node,cache) = syscall(309,cpu,node,cache)
          ...
          def process_vm_readv_syscall(pid,lvec,liovcnt,rvec,riovcnt,flags) = syscall(310,pid,lvec,liovcnt,rvec,riovcnt,flags)
          ...
          def process_vm_writev_syscall(pid,lvec,liovcnt,rvec,riovcnt,flags) = syscall(311,pid,lvec,liovcnt,rvec,riovcnt,flags)
          ...
          def kcmp_syscall(pid1,pid2,type,idx1,idx2) = syscall(312,pid1,pid2,type,idx1,idx2)
          # Macro to call the `finit_module` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] uargs
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/finit_module.2.html
          def finit_module_syscall(fd,uargs,flags) = syscall(313,fd,uargs,flags)
          # Macro to call the `sched_setattr` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] attr
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/sched_setattr.2.html
          def sched_setattr_syscall(pid,attr,flags) = syscall(314,pid,attr,flags)
          ...
          def sched_getattr_syscall(pid,attr,size,flags) = syscall(315,pid,attr,size,flags)
          ...
          def renameat2_syscall(olddfd,oldname,newdfd,newname,flags) = syscall(316,olddfd,oldname,newdfd,newname,flags)
          # Macro to call the `seccomp` syscall.
          # @param [Register, Integer] op
          # @param [Register, Integer] flags
          # @param [Register, Integer] uargs
          # @see https://www.man7.org/linux/man-pages/man2/seccomp.2.html
          def seccomp_syscall(op,flags,uargs) = syscall(317,op,flags,uargs)
          # Macro to call the `getrandom` syscall.
          # @param [Register, Integer] buf
          # @param [Register, Integer] count
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/getrandom.2.html
          def getrandom_syscall(buf,count,flags) = syscall(318,buf,count,flags)
          ...
          def memfd_create_syscall(uname_ptr,flags) = syscall(319,uname_ptr,flags)
          ...
          def kexec_file_load_syscall(kernel_fd,initrd_fd,cmdline_len,cmdline_ptr,flags) = syscall(320,kernel_fd,initrd_fd,cmdline_len,cmdline_ptr,flags)
          # Macro to call the `bpf` syscall.
          # @param [Register, Integer] cmd
          # @param [Register, Integer] attr
          # @param [Register, Integer] size
          # @see https://www.man7.org/linux/man-pages/man2/bpf.2.html
          def bpf_syscall(cmd,attr,size) = syscall(321,cmd,attr,size)
          ...
          def execveat_syscall(dfd,filename,argv,envp,flags) = syscall(322,dfd,filename,argv,envp,flags)
          # Macro to call the `userfaultfd` syscall.
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/userfaultfd.2.html
          def userfaultfd_syscall(flags) = syscall(323,flags)
          ...
          def membarrier_syscall(cmd,flags,cpu_id) = syscall(324,cmd,flags,cpu_id)
          # Macro to call the `mlock2` syscall.
          # @param [Register, Integer] start
          # @param [Register, Integer] len
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/mlock2.2.html
          def mlock2_syscall(start,len,flags) = syscall(325,start,len,flags)
          ...
          def copy_file_range_syscall(fd_in,off_in,fd_out,off_out,len,flags) = syscall(326,fd_in,off_in,fd_out,off_out,len,flags)
          ...
          def preadv2_syscall(fd,vec,vlen,pos_l,pos_h,flags) = syscall(327,fd,vec,vlen,pos_l,pos_h,flags)
          ...
          def pwritev2_syscall(fd,vec,vlen,pos_l,pos_h,flags) = syscall(328,fd,vec,vlen,pos_l,pos_h,flags)
          ...
          def pkey_mprotect_syscall(start,len,prot,pkey) = syscall(329,start,len,prot,pkey)
          ...
          def pkey_alloc_syscall(flags,init_val) = syscall(330,flags,init_val)
          # Macro to call the `pkey_free` syscall.
          # @param [Register, Integer] pkey
          # @see https://www.man7.org/linux/man-pages/man2/pkey_free.2.html
          def pkey_free_syscall(pkey) = syscall(331,pkey)
          ...
          def statx_syscall(dfd,path,flags,mask,buffer) = syscall(332,dfd,path,flags,mask,buffer)
          ...
          def io_pgetevents_syscall(ctx_id,min_nr,nr,events,timeout,sig) = syscall(333,ctx_id,min_nr,nr,events,timeout,sig)
          ...
          def rseq_syscall(rseq,rseq_len,flags,sig) = syscall(334,rseq,rseq_len,flags,sig)
          # Macro to call the `uretprobe` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/uretprobe.2.html
          def uretprobe_syscall = syscall(335)
          ...
          # Macro to call the `rt_sigaction` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigaction.2.html
          def rt_sigaction_syscall = syscall(512)
          # Macro to call the `rt_sigreturn` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigreturn.2.html
          def rt_sigreturn_syscall = syscall(513)
          # Macro to call the `ioctl` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/ioctl.2.html
          def ioctl_syscall = syscall(514)
          # Macro to call the `readv` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] vec
          # @param [Register, Integer] vlen
          # @see https://www.man7.org/linux/man-pages/man2/readv.2.html
          def readv_syscall(fd,vec,vlen) = syscall(515,fd,vec,vlen)
          # Macro to call the `writev` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] vec
          # @param [Register, Integer] vlen
          # @see https://www.man7.org/linux/man-pages/man2/writev.2.html
          def writev_syscall(fd,vec,vlen) = syscall(516,fd,vec,vlen)
          # Macro to call the `recvfrom` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/recvfrom.2.html
          def recvfrom_syscall = syscall(517)
          # Macro to call the `sendmsg` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/sendmsg.2.html
          def sendmsg_syscall = syscall(518)
          # Macro to call the `recvmsg` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/recvmsg.2.html
          def recvmsg_syscall = syscall(519)
          # Macro to call the `execve` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/execve.2.html
          def execve_syscall = syscall(520)
          # Macro to call the `ptrace` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/ptrace.2.html
          def ptrace_syscall = syscall(521)
          # Macro to call the `rt_sigpending` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigpending.2.html
          def rt_sigpending_syscall = syscall(522)
          # Macro to call the `rt_sigtimedwait` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigtimedwait.2.html
          def rt_sigtimedwait_syscall = syscall(523)
          # Macro to call the `rt_sigqueueinfo` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_sigqueueinfo.2.html
          def rt_sigqueueinfo_syscall = syscall(524)
          # Macro to call the `sigaltstack` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/sigaltstack.2.html
          def sigaltstack_syscall = syscall(525)
          # Macro to call the `timer_create` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/timer_create.2.html
          def timer_create_syscall = syscall(526)
          # Macro to call the `mq_notify` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/mq_notify.2.html
          def mq_notify_syscall = syscall(527)
          # Macro to call the `kexec_load` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/kexec_load.2.html
          def kexec_load_syscall = syscall(528)
          # Macro to call the `waitid` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/waitid.2.html
          def waitid_syscall = syscall(529)
          # Macro to call the `set_robust_list` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/set_robust_list.2.html
          def set_robust_list_syscall = syscall(530)
          # Macro to call the `get_robust_list` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/get_robust_list.2.html
          def get_robust_list_syscall = syscall(531)
          # Macro to call the `vmsplice` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] iov
          # @param [Register, Integer] nr_segs
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/vmsplice.2.html
          def vmsplice_syscall(fd,iov,nr_segs,flags) = syscall(532,fd,iov,nr_segs,flags)
          # Macro to call the `move_pages` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] nr_pages
          # @param [Register, Integer] pages
          ...
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/move_pages.2.html
          def move_pages_syscall(pid,nr_pages,pages,nodes,status,flags) = syscall(533,pid,nr_pages,pages,nodes,status,flags)
          # Macro to call the `preadv` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/preadv.2.html
          def preadv_syscall = syscall(534)
          # Macro to call the `pwritev` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/pwritev.2.html
          def pwritev_syscall = syscall(535)
          # Macro to call the `rt_tgsigqueueinfo` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/rt_tgsigqueueinfo.2.html
          def rt_tgsigqueueinfo_syscall = syscall(536)
          # Macro to call the `recvmmsg` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/recvmmsg.2.html
          def recvmmsg_syscall = syscall(537)
          # Macro to call the `sendmmsg` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/sendmmsg.2.html
          def sendmmsg_syscall = syscall(538)
          # Macro to call the `process_vm_readv` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] lvec
          # @param [Register, Integer] liovcnt
          ...
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/process_vm_readv.2.html
          def process_vm_readv_syscall(pid,lvec,liovcnt,rvec,riovcnt,flags) = syscall(539,pid,lvec,liovcnt,rvec,riovcnt,flags)
          # Macro to call the `process_vm_writev` syscall.
          # @param [Register, Integer] pid
          # @param [Register, Integer] lvec
          # @param [Register, Integer] liovcnt
          ...
          # @param [Register, Integer] flags
          # @see https://www.man7.org/linux/man-pages/man2/process_vm_writev.2.html
          def process_vm_writev_syscall(pid,lvec,liovcnt,rvec,riovcnt,flags) = syscall(540,pid,lvec,liovcnt,rvec,riovcnt,flags)
          # Macro to call the `setsockopt` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] level
          # @param [Register, Integer] optname
          ...
          # @param [Register, Integer] optlen
          # @see https://www.man7.org/linux/man-pages/man2/setsockopt.2.html
          def setsockopt_syscall(fd,level,optname,optval,optlen) = syscall(541,fd,level,optname,optval,optlen)
          # Macro to call the `getsockopt` syscall.
          # @param [Register, Integer] fd
          # @param [Register, Integer] level
          # @param [Register, Integer] optname
          ...
          # @param [Register, Integer] optlen
          # @see https://www.man7.org/linux/man-pages/man2/getsockopt.2.html
          def getsockopt_syscall(fd,level,optname,optval,optlen) = syscall(542,fd,level,optname,optval,optlen)
          # Macro to call the `io_setup` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/io_setup.2.html
          def io_setup_syscall = syscall(543)
          # Macro to call the `io_submit` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/io_submit.2.html
          def io_submit_syscall = syscall(544)
          # Macro to call the `execveat` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/execveat.2.html
          def execveat_syscall = syscall(545)
          # Macro to call the `preadv2` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/preadv2.2.html
          def preadv2_syscall = syscall(546)
          # Macro to call the `pwritev2` syscall.
          # @see https://www.man7.org/linux/man-pages/man2/pwritev2.2.html
          def pwritev2_syscall = syscall(547)
        end
      end
    end
  end
