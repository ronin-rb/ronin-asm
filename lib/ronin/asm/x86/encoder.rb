  ...
  module ASM
    module X86
      ...
      class Encoder < ASM::Encoder
        ...
        #
        # @param [Register, nil] r
        #   The register operand.
        #
        # @param [Memory, Register, nil] x
        #   The memory operand with {Memory#index index} set.
        #
        # @param [Memory, Register, nil] b
        ...
        def write_vex(type: , w: nil, l: nil, m_mmmm: , pp: , r: nil, x: nil, b: nil, vvvv: nil)
          if type == :vex && ((x.nil? || x == 0) && (b.nil? || b == 0) && (w.nil? || w == 0) || (m_mmmm == 0b00001))
        ...
        def write_vex_two_byte(r: nil, vvvv: nil, l: nil, pp: )
          ...
          if r && r.kind_of?(Register) && r.number.bit_length < 4
        ...
        def write_vex_three_byte(type: , w: nil, l: nil, m_mmmm: , pp: , r: nil, x: nil, b: nil, vvvv: nil)
          ...
          # second byte
          if r.nil? || (r.kind_of?(Register) && r.number.bit_length < 4)
            # VEX.R is encoded as the inverted version of REX.R
            byte2 |= 0b10000000
          end

          if x.nil? || (x.kind_of?(Memory) && (x.index.nil? || x.index.number.bit_length < 4))
            # VEX.X is encoded as the inverted version of REX.X
            byte2 |= 0b01000000
          end

          if b.nil? || ((b.kind_of?(Register) && b.number.bit_length < 4) ||
