  ...
  module ASM
    module X86
      module Instructions
        ...
        #   adc byte([eax]), bl
        #   adc word([eax]), 0x02
        #   adc word([eax]), word(0x0002)
        #   adc word([eax]), bx
        #   adc dword([eax]), 0x02
        #   adc dword([eax]), dword(0x00000002)
        #   adc dword([eax]), ebx
        ...
        #   add byte([eax]), bl
        #   add word([eax]), 0x02
        #   add word([eax]), word(0x0002)
        #   add word([eax]), bx
        #   add dword([eax]), 0x02
        #   add dword([eax]), dword(0x00000002)
        #   add dword([eax]), ebx
        ...
        #   aeskeygenassist xmm0, oword([ebx]), 0x03
        ...
        #   and byte([eax]), bl
        #   and word([eax]), 0x02
        #   and word([eax]), word(0x0002)
        #   and word([eax]), bx
        #   and dword([eax]), 0x02
        #   and dword([eax]), dword(0x00000002)
        #   and dword([eax]), ebx
        ...
        #   bextr eax, ebx, ecx
        #   bextr eax, dword([ebx]), dword(0x00000003)
        #   bextr eax, dword([ebx]), ecx
        ...
        #   cmp byte([eax]), bl
        #   cmp word([eax]), 0x02
        #   cmp word([eax]), word(0x0002)
        #   cmp word([eax]), bx
        #   cmp dword([eax]), 0x02
        #   cmp dword([eax]), dword(0x00000002)
        #   cmp dword([eax]), ebx
        ...
        #   gf2p8affineinvqb xmm0, oword([ebx]), 0x03
        ...
        #   gf2p8affineqb xmm0, oword([ebx]), 0x03
        ...
        #   imul ax, word([ebx]), 0x03
        #   imul ax, word([ebx]), word(0x0003)
        #   imul eax, ebx, 0x03
        #   imul eax, ebx, dword(0x00000003)
        #   imul eax, dword([ebx]), 0x03
        #   imul eax, dword([ebx]), dword(0x00000003)
        ...
        #   mov byte([eax]), 0x02
        #   mov byte([eax]), bl
        #   mov word([eax]), word(0x0002)
        #   mov word([eax]), bx
        #   mov dword([eax]), dword(0x00000002)
        #   mov dword([eax]), ebx
        ...
        # @example
        #   movapd xmm0, xmm1
        #   movapd xmm0, oword([ebx])
        #   movapd oword([eax]), xmm1
        ...
        # @example
        #   movaps xmm0, xmm1
        #   movaps xmm0, oword([ebx])
        #   movaps oword([eax]), xmm1
        ...
        # @example
        #   movdqa xmm0, xmm1
        #   movdqa xmm0, oword([ebx])
        #   movdqa oword([eax]), xmm1
        ...
        # @example
        #   movupd xmm0, xmm1
        #   movupd xmm0, oword([ebx])
        #   movupd oword([eax]), xmm1
        ...
        # @example
        #   movups xmm0, xmm1
        #   movups xmm0, oword([ebx])
        #   movups oword([eax]), xmm1
        ...
        #   or byte([eax]), bl
        #   or word([eax]), 0x02
        #   or word([eax]), word(0x0002)
        #   or word([eax]), bx
        #   or dword([eax]), 0x02
        #   or dword([eax]), dword(0x00000002)
        #   or dword([eax]), ebx
        ...
        # @example
        #   packssdw mm0, mm1
        #   packssdw mm0, qword([ebx])
        #   packssdw xmm0, xmm1
        #   packssdw xmm0, oword([ebx])
        ...
        # @example
        #   packsswb mm0, mm1
        #   packsswb mm0, qword([ebx])
        #   packsswb xmm0, xmm1
        #   packsswb xmm0, oword([ebx])
        ...
        # @example
        #   packuswb mm0, mm1
        #   packuswb mm0, qword([ebx])
        #   packuswb xmm0, xmm1
        #   packuswb xmm0, oword([ebx])
        ...
        # @example
        #   paddsb mm0, mm1
        #   paddsb mm0, qword([ebx])
        #   paddsb xmm0, xmm1
        #   paddsb xmm0, oword([ebx])
        ...
        # @example
        #   paddsw mm0, mm1
        #   paddsw mm0, qword([ebx])
        #   paddsw xmm0, xmm1
        #   paddsw xmm0, oword([ebx])
        ...
        # @example
        #   paddusb mm0, mm1
        #   paddusb mm0, qword([ebx])
        #   paddusb xmm0, xmm1
        #   paddusb xmm0, oword([ebx])
        ...
        # @example
        #   paddusw mm0, mm1
        #   paddusw mm0, qword([ebx])
        #   paddusw xmm0, xmm1
        #   paddusw xmm0, oword([ebx])
        ...
        #   palignr mm0, qword([ebx]), 0x03
        #   palignr xmm0, xmm1, 0x03
        #   palignr xmm0, oword([ebx]), 0x03
        ...
        # @example
        #   pcmpeqb mm0, mm1
        #   pcmpeqb mm0, qword([ebx])
        #   pcmpeqb xmm0, xmm1
        #   pcmpeqb xmm0, oword([ebx])
        ...
        # @example
        #   pcmpeqd mm0, mm1
        #   pcmpeqd mm0, qword([ebx])
        #   pcmpeqd xmm0, xmm1
        #   pcmpeqd xmm0, oword([ebx])
        ...
        # @example
        #   pcmpeqw mm0, mm1
        #   pcmpeqw mm0, qword([ebx])
        #   pcmpeqw xmm0, xmm1
        #   pcmpeqw xmm0, oword([ebx])
        ...
        # @example
        #   pcmpgtb mm0, mm1
        #   pcmpgtb mm0, qword([ebx])
        #   pcmpgtb xmm0, xmm1
        #   pcmpgtb xmm0, oword([ebx])
        ...
        # @example
        #   pcmpgtd mm0, mm1
        #   pcmpgtd mm0, qword([ebx])
        #   pcmpgtd xmm0, xmm1
        #   pcmpgtd xmm0, oword([ebx])
        ...
        # @example
        #   pcmpgtw mm0, mm1
        #   pcmpgtw mm0, qword([ebx])
        #   pcmpgtw xmm0, xmm1
        #   pcmpgtw xmm0, oword([ebx])
        ...
        # @example
        #   phaddd mm0, mm1
        #   phaddd mm0, qword([ebx])
        #   phaddd xmm0, xmm1
        #   phaddd xmm0, oword([ebx])
        ...
        # @example
        #   phaddsw mm0, mm1
        #   phaddsw mm0, qword([ebx])
        #   phaddsw xmm0, xmm1
        #   phaddsw xmm0, oword([ebx])
        ...
        # @example
        #   phaddw mm0, mm1
        #   phaddw mm0, qword([ebx])
        #   phaddw xmm0, xmm1
        #   phaddw xmm0, oword([ebx])
        ...
        # @example
        #   phsubd mm0, mm1
        #   phsubd mm0, qword([ebx])
        #   phsubd xmm0, xmm1
        #   phsubd xmm0, oword([ebx])
        ...
        # @example
        #   phsubsw mm0, mm1
        #   phsubsw mm0, qword([ebx])
        #   phsubsw xmm0, xmm1
        #   phsubsw xmm0, oword([ebx])
        ...
        # @example
        #   phsubw mm0, mm1
        #   phsubw mm0, qword([ebx])
        #   phsubw xmm0, xmm1
        #   phsubw xmm0, oword([ebx])
        ...
        # @example
        #   pmaddubsw mm0, mm1
        #   pmaddubsw mm0, qword([ebx])
        #   pmaddubsw xmm0, xmm1
        #   pmaddubsw xmm0, oword([ebx])
        ...
        # @example
        #   pmaddwd mm0, mm1
        #   pmaddwd mm0, qword([ebx])
        #   pmaddwd xmm0, xmm1
        #   pmaddwd xmm0, oword([ebx])
        ...
        # @example
        #   pmaxsw mm0, mm1
        #   pmaxsw mm0, qword([ebx])
        #   pmaxsw xmm0, xmm1
        #   pmaxsw xmm0, oword([ebx])
        ...
        # @example
        #   pmaxub mm0, mm1
        #   pmaxub mm0, qword([ebx])
        #   pmaxub xmm0, xmm1
        #   pmaxub xmm0, oword([ebx])
        ...
        # @example
        #   pminsw mm0, mm1
        #   pminsw mm0, qword([ebx])
        #   pminsw xmm0, xmm1
        #   pminsw xmm0, oword([ebx])
        ...
        # @example
        #   pminub mm0, mm1
        #   pminub mm0, qword([ebx])
        #   pminub xmm0, xmm1
        #   pminub xmm0, oword([ebx])
        ...
        # @example
        #   pmulhrsw mm0, mm1
        #   pmulhrsw mm0, qword([ebx])
        #   pmulhrsw xmm0, xmm1
        #   pmulhrsw xmm0, oword([ebx])
        ...
        # @example
        #   pmulhuw mm0, mm1
        #   pmulhuw mm0, qword([ebx])
        #   pmulhuw xmm0, xmm1
        #   pmulhuw xmm0, oword([ebx])
        ...
        # @example
        #   pmulhw mm0, mm1
        #   pmulhw mm0, qword([ebx])
        #   pmulhw xmm0, xmm1
        #   pmulhw xmm0, oword([ebx])
        ...
        # @example
        #   pmullw mm0, mm1
        #   pmullw mm0, qword([ebx])
        #   pmullw xmm0, xmm1
        #   pmullw xmm0, oword([ebx])
        ...
        # @example
        #   pmuludq mm0, mm1
        #   pmuludq mm0, qword([ebx])
        #   pmuludq xmm0, xmm1
        #   pmuludq xmm0, oword([ebx])
        ...
        # @example
        #   psadbw mm0, mm1
        #   psadbw mm0, qword([ebx])
        #   psadbw xmm0, xmm1
        #   psadbw xmm0, oword([ebx])
        ...
        # @example
        #   pshufb mm0, mm1
        #   pshufb mm0, qword([ebx])
        #   pshufb xmm0, xmm1
        #   pshufb xmm0, oword([ebx])
        ...
        # @example
        #   psignb mm0, mm1
        #   psignb mm0, qword([ebx])
        #   psignb xmm0, xmm1
        #   psignb xmm0, oword([ebx])
        ...
        # @example
        #   psignd mm0, mm1
        #   psignd mm0, qword([ebx])
        #   psignd xmm0, xmm1
        #   psignd xmm0, oword([ebx])
        ...
        # @example
        #   psignw mm0, mm1
        #   psignw mm0, qword([ebx])
        #   psignw xmm0, xmm1
        #   psignw xmm0, oword([ebx])
        ...
        # @example
        #   psubsb mm0, mm1
        #   psubsb mm0, qword([ebx])
        #   psubsb xmm0, xmm1
        #   psubsb xmm0, oword([ebx])
        ...
        # @example
        #   psubsw mm0, mm1
        #   psubsw mm0, qword([ebx])
        #   psubsw xmm0, xmm1
        #   psubsw xmm0, oword([ebx])
        ...
        # @example
        #   psubusb mm0, mm1
        #   psubusb mm0, qword([ebx])
        #   psubusb xmm0, xmm1
        #   psubusb xmm0, oword([ebx])
        ...
        # @example
        #   psubusw mm0, mm1
        #   psubusw mm0, qword([ebx])
        #   psubusw xmm0, xmm1
        #   psubusw xmm0, oword([ebx])
        ...
        # @example
        #   punpckhbw mm0, mm1
        #   punpckhbw mm0, qword([ebx])
        #   punpckhbw xmm0, xmm1
        #   punpckhbw xmm0, oword([ebx])
        ...
        # @example
        #   punpckhdq mm0, mm1
        #   punpckhdq mm0, qword([ebx])
        #   punpckhdq xmm0, xmm1
        #   punpckhdq xmm0, oword([ebx])
        ...
        # @example
        #   punpckhwd mm0, mm1
        #   punpckhwd mm0, qword([ebx])
        #   punpckhwd xmm0, xmm1
        #   punpckhwd xmm0, oword([ebx])
        ...
        # @example
        #   punpcklbw mm0, mm1
        #   punpcklbw mm0, dword([ebx])
        #   punpcklbw xmm0, xmm1
        #   punpcklbw xmm0, oword([ebx])
        ...
        # @example
        #   punpckldq mm0, mm1
        #   punpckldq mm0, dword([ebx])
        #   punpckldq xmm0, xmm1
        #   punpckldq xmm0, oword([ebx])
        ...
        # @example
        #   punpcklwd mm0, mm1
        #   punpcklwd mm0, dword([ebx])
        #   punpcklwd xmm0, xmm1
        #   punpcklwd xmm0, oword([ebx])
        ...
        #   sbb byte([eax]), bl
        #   sbb word([eax]), 0x02
        #   sbb word([eax]), word(0x0002)
        #   sbb word([eax]), bx
        #   sbb dword([eax]), 0x02
        #   sbb dword([eax]), dword(0x00000002)
        #   sbb dword([eax]), ebx
        ...
        #   sha256rnds2 xmm0, oword([ebx]), xmm0
        ...
        #   shld eax, ebx, 0x03
        #   shld eax, ebx, cl
        #   shld word([eax]), bx, 0x03
        #   shld word([eax]), bx, cl
        #   shld dword([eax]), ebx, 0x03
        ...
        #   shrd eax, ebx, 0x03
        #   shrd eax, ebx, cl
        #   shrd word([eax]), bx, 0x03
        #   shrd word([eax]), bx, cl
        #   shrd dword([eax]), ebx, 0x03
        ...
        #   sub byte([eax]), bl
        #   sub word([eax]), 0x02
        #   sub word([eax]), word(0x0002)
        #   sub word([eax]), bx
        #   sub dword([eax]), 0x02
        #   sub dword([eax]), dword(0x00000002)
        #   sub dword([eax]), ebx
        ...
        #   test byte([eax]), 0x02
        #   test byte([eax]), bl
        #   test word([eax]), word(0x0002)
        #   test word([eax]), bx
        #   test dword([eax]), dword(0x00000002)
        #   test dword([eax]), ebx
        ...
        # @example
        #   vaddpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vaddpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vaddpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vaddpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vaddpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vaddpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vaddpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vaddpd xmm0, xmm1, xmm2
        #   vaddpd xmm0, xmm1, xmm2
        #   vaddpd xmm0, xmm1, oword([ecx])
        #   vaddpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vaddpd ymm0, ymm1, ymm2
        #   vaddpd ymm0, ymm1, ymm2
        #   vaddpd ymm0, ymm1, yword([ecx])
        #   vaddpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vaddph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vaddph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vaddph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vaddph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vaddph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vaddph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vaddph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vaddph xmm0, xmm1, xmm2
        #   vaddph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vaddph ymm0, ymm1, ymm2
        #   vaddph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vaddps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vaddps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vaddps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vaddps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vaddps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vaddps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vaddps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vaddps xmm0, xmm1, xmm2
        #   vaddps xmm0, xmm1, xmm2
        #   vaddps xmm0, xmm1, oword([ecx])
        #   vaddps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vaddps ymm0, ymm1, ymm2
        #   vaddps ymm0, ymm1, ymm2
        #   vaddps ymm0, ymm1, yword([ecx])
        #   vaddps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vaddsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vaddsd xmm0, xmm1, xmm2
        #   vaddsd xmm0, xmm1, xmm2
        #   vaddsd xmm0, xmm1, qword([ecx])
        #   vaddsd xmm0, xmm1, qword([ecx])
        ...
        #   vaddsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vaddsh xmm0, xmm1, xmm2
        #   vaddsh xmm0, xmm1, word([ecx])
        ...
        #   vaddss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vaddss xmm0, xmm1, xmm2
        #   vaddss xmm0, xmm1, xmm2
        #   vaddss xmm0, xmm1, dword([ecx])
        #   vaddss xmm0, xmm1, dword([ecx])
        ...
        #   vaddsubpd xmm0, xmm1, oword([ecx])
        #   vaddsubpd ymm0, ymm1, ymm2
        #   vaddsubpd ymm0, ymm1, yword([ecx])
        ...
        #   vaddsubps xmm0, xmm1, oword([ecx])
        #   vaddsubps ymm0, ymm1, ymm2
        #   vaddsubps ymm0, ymm1, yword([ecx])
        ...
        #   vaesdec xmm0, xmm1, xmm2
        #   vaesdec xmm0, xmm1, oword([ecx])
        #   vaesdec xmm0, xmm1, oword([ecx])
        #   vaesdec ymm0, ymm1, ymm2
        #   vaesdec ymm0, ymm1, ymm2
        #   vaesdec ymm0, ymm1, yword([ecx])
        #   vaesdec ymm0, ymm1, yword([ecx])
        #   vaesdec zmm0, zmm1, zmm2
        #   vaesdec zmm0, zmm1, zword([ecx])
        ...
        #   vaesdeclast xmm0, xmm1, xmm2
        #   vaesdeclast xmm0, xmm1, oword([ecx])
        #   vaesdeclast xmm0, xmm1, oword([ecx])
        #   vaesdeclast ymm0, ymm1, ymm2
        #   vaesdeclast ymm0, ymm1, ymm2
        #   vaesdeclast ymm0, ymm1, yword([ecx])
        #   vaesdeclast ymm0, ymm1, yword([ecx])
        #   vaesdeclast zmm0, zmm1, zmm2
        #   vaesdeclast zmm0, zmm1, zword([ecx])
        ...
        #   vaesenc xmm0, xmm1, xmm2
        #   vaesenc xmm0, xmm1, oword([ecx])
        #   vaesenc xmm0, xmm1, oword([ecx])
        #   vaesenc ymm0, ymm1, ymm2
        #   vaesenc ymm0, ymm1, ymm2
        #   vaesenc ymm0, ymm1, yword([ecx])
        #   vaesenc ymm0, ymm1, yword([ecx])
        #   vaesenc zmm0, zmm1, zmm2
        #   vaesenc zmm0, zmm1, zword([ecx])
        ...
        #   vaesenclast xmm0, xmm1, xmm2
        #   vaesenclast xmm0, xmm1, oword([ecx])
        #   vaesenclast xmm0, xmm1, oword([ecx])
        #   vaesenclast ymm0, ymm1, ymm2
        #   vaesenclast ymm0, ymm1, ymm2
        #   vaesenclast ymm0, ymm1, yword([ecx])
        #   vaesenclast ymm0, ymm1, yword([ecx])
        #   vaesenclast zmm0, zmm1, zmm2
        #   vaesenclast zmm0, zmm1, zword([ecx])
        ...
        #   vaeskeygenassist xmm0, oword([ebx]), 0x03
        ...
        # @example
        #   valignd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   valignd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   valignd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   valignd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   valignd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   valignd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   valignd xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   valignd xmm0, xmm1, xmm2, 0x04
        #   valignd ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   valignd ymm0, ymm1, ymm2, 0x04
        #   valignd zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   valignq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   valignq opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   valignq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   valignq opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   valignq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   valignq opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   valignq xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   valignq xmm0, xmm1, xmm2, 0x04
        #   valignq ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   valignq ymm0, ymm1, ymm2, 0x04
        #   valignq zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vandnpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vandnpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vandnpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vandnpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vandnpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vandnpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vandnpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vandnpd xmm0, xmm1, xmm2
        #   vandnpd xmm0, xmm1, xmm2
        #   vandnpd xmm0, xmm1, oword([ecx])
        #   vandnpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vandnpd ymm0, ymm1, ymm2
        #   vandnpd ymm0, ymm1, ymm2
        #   vandnpd ymm0, ymm1, yword([ecx])
        #   vandnpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vandnps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vandnps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vandnps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vandnps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vandnps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vandnps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vandnps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vandnps xmm0, xmm1, xmm2
        #   vandnps xmm0, xmm1, xmm2
        #   vandnps xmm0, xmm1, oword([ecx])
        #   vandnps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vandnps ymm0, ymm1, ymm2
        #   vandnps ymm0, ymm1, ymm2
        #   vandnps ymm0, ymm1, yword([ecx])
        #   vandnps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vandpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vandpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vandpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vandpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vandpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vandpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vandpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vandpd xmm0, xmm1, xmm2
        #   vandpd xmm0, xmm1, xmm2
        #   vandpd xmm0, xmm1, oword([ecx])
        #   vandpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vandpd ymm0, ymm1, ymm2
        #   vandpd ymm0, ymm1, ymm2
        #   vandpd ymm0, ymm1, yword([ecx])
        #   vandpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vandps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vandps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vandps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vandps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vandps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vandps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vandps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vandps xmm0, xmm1, xmm2
        #   vandps xmm0, xmm1, xmm2
        #   vandps xmm0, xmm1, oword([ecx])
        #   vandps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vandps ymm0, ymm1, ymm2
        #   vandps ymm0, ymm1, ymm2
        #   vandps ymm0, ymm1, yword([ecx])
        #   vandps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vbcstnebf162ps xmm0, word([ebx])
        #   vbcstnebf162ps ymm0, word([ebx])
        ...
        # @example
        #   vbcstnesh2ps xmm0, word([ebx])
        #   vbcstnesh2ps ymm0, word([ebx])
        ...
        # @example
        #   vblendmpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vblendmpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vblendmpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vblendmpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vblendmpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vblendmpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vblendmpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vblendmpd xmm0, xmm1, xmm2
        #   vblendmpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vblendmpd ymm0, ymm1, ymm2
        #   vblendmpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vblendmps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vblendmps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vblendmps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vblendmps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vblendmps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vblendmps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vblendmps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vblendmps xmm0, xmm1, xmm2
        #   vblendmps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vblendmps ymm0, ymm1, ymm2
        #   vblendmps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vblendpd xmm0, xmm1, oword([ecx]), 0x04
        #   vblendpd ymm0, ymm1, ymm2, 0x04
        #   vblendpd ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vblendps xmm0, xmm1, oword([ecx]), 0x04
        #   vblendps ymm0, ymm1, ymm2, 0x04
        #   vblendps ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vblendvpd xmm0, xmm1, oword([ecx]), xmm3
        #   vblendvpd ymm0, ymm1, ymm2, ymm3
        #   vblendvpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vblendvps xmm0, xmm1, oword([ecx]), xmm3
        #   vblendvps ymm0, ymm1, ymm2, ymm3
        #   vblendvps ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vbroadcastf32x2 opmask(ymm0, k1, zero: true), qword([ebx])
        #   vbroadcastf32x2 opmask(zmm0, k1, zero: true), qword([ebx])
        #   vbroadcastf32x2 ymm0, xmm1
        #   vbroadcastf32x2 ymm0, qword([ebx])
        #   vbroadcastf32x2 zmm0, xmm1
        #   vbroadcastf32x2 zmm0, qword([ebx])
        ...
        # @example
        #   vbroadcastf32x4 opmask(ymm0, k1, zero: true), oword([ebx])
        #   vbroadcastf32x4 opmask(zmm0, k1, zero: true), oword([ebx])
        #   vbroadcastf32x4 ymm0, oword([ebx])
        #   vbroadcastf32x4 zmm0, oword([ebx])
        ...
        # @example
        #   vbroadcastf32x8 opmask(zmm0, k1, zero: true), yword([ebx])
        #   vbroadcastf32x8 zmm0, yword([ebx])
        ...
        # @example
        #   vbroadcastf64x2 opmask(ymm0, k1, zero: true), oword([ebx])
        #   vbroadcastf64x2 opmask(zmm0, k1, zero: true), oword([ebx])
        #   vbroadcastf64x2 ymm0, oword([ebx])
        #   vbroadcastf64x2 zmm0, oword([ebx])
        ...
        # @example
        #   vbroadcastf64x4 opmask(zmm0, k1, zero: true), yword([ebx])
        #   vbroadcastf64x4 zmm0, yword([ebx])
        ...
        #   vbroadcasti32x2 opmask(xmm0, k1, zero: true), qword([ebx])
        #   vbroadcasti32x2 opmask(ymm0, k1, zero: true), qword([ebx])
        #   vbroadcasti32x2 opmask(zmm0, k1, zero: true), qword([ebx])
        #   vbroadcasti32x2 xmm0, xmm1
        #   vbroadcasti32x2 xmm0, qword([ebx])
        #   vbroadcasti32x2 ymm0, xmm1
        #   vbroadcasti32x2 ymm0, qword([ebx])
        #   vbroadcasti32x2 zmm0, xmm1
        #   vbroadcasti32x2 zmm0, qword([ebx])
        ...
        # @example
        #   vbroadcasti32x4 opmask(ymm0, k1, zero: true), oword([ebx])
        #   vbroadcasti32x4 opmask(zmm0, k1, zero: true), oword([ebx])
        #   vbroadcasti32x4 ymm0, oword([ebx])
        #   vbroadcasti32x4 zmm0, oword([ebx])
        ...
        # @example
        #   vbroadcasti32x8 opmask(zmm0, k1, zero: true), yword([ebx])
        #   vbroadcasti32x8 zmm0, yword([ebx])
        ...
        # @example
        #   vbroadcasti64x2 opmask(ymm0, k1, zero: true), oword([ebx])
        #   vbroadcasti64x2 opmask(zmm0, k1, zero: true), oword([ebx])
        #   vbroadcasti64x2 ymm0, oword([ebx])
        #   vbroadcasti64x2 zmm0, oword([ebx])
        ...
        # @example
        #   vbroadcasti64x4 opmask(zmm0, k1, zero: true), yword([ebx])
        #   vbroadcasti64x4 zmm0, yword([ebx])
        ...
        #   vbroadcastsd opmask(ymm0, k1, zero: true), qword([ebx])
        #   vbroadcastsd opmask(zmm0, k1, zero: true), qword([ebx])
        #   vbroadcastsd ymm0, xmm1
        #   vbroadcastsd ymm0, xmm1
        #   vbroadcastsd ymm0, qword([ebx])
        #   vbroadcastsd ymm0, qword([ebx])
        #   vbroadcastsd zmm0, xmm1
        #   vbroadcastsd zmm0, qword([ebx])
        ...
        #   vbroadcastss opmask(ymm0, k1, zero: true), dword([ebx])
        #   vbroadcastss opmask(zmm0, k1, zero: true), dword([ebx])
        #   vbroadcastss xmm0, xmm1
        #   vbroadcastss xmm0, dword([ebx])
        #   vbroadcastss ymm0, xmm1
        #   vbroadcastss ymm0, xmm1
        #   vbroadcastss ymm0, dword([ebx])
        #   vbroadcastss ymm0, dword([ebx])
        #   vbroadcastss zmm0, xmm1
        #   vbroadcastss zmm0, dword([ebx])
        ...
        # @example
        #   vcmppd opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vcmppd k1, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vcmppd opmask(k1, k2), xmm1, xmm2, 0x04
        #   vcmppd k1, xmm1, xmm2, 0x04
        #   vcmppd opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vcmppd k1, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vcmppd opmask(k1, k2), ymm1, ymm2, 0x04
        #   vcmppd k1, ymm1, ymm2, 0x04
        #   vcmppd opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vcmppd k1, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vcmppd opmask(k1, k2), zmm1, zmm2, 0x04
        #   vcmppd k1, zmm1, zmm2, 0x04
        #   vcmppd xmm0, xmm1, xmm2, 0x04
        #   vcmppd xmm0, xmm1, oword([ecx]), 0x04
        #   vcmppd ymm0, ymm1, ymm2, 0x04
        #   vcmppd ymm0, ymm1, yword([ecx]), 0x04
        ...
        # @example
        #   vcmpph opmask(k1, k2), xmm1, bcst(word([ecx]), {1=>8}), 0x04
        #   vcmpph k1, xmm1, bcst(word([ecx]), {1=>8}), 0x04
        #   vcmpph opmask(k1, k2), xmm1, xmm2, 0x04
        #   vcmpph k1, xmm1, xmm2, 0x04
        #   vcmpph opmask(k1, k2), ymm1, bcst(word([ecx]), {1=>16}), 0x04
        #   vcmpph k1, ymm1, bcst(word([ecx]), {1=>16}), 0x04
        #   vcmpph opmask(k1, k2), ymm1, ymm2, 0x04
        #   vcmpph k1, ymm1, ymm2, 0x04
        #   vcmpph opmask(k1, k2), zmm1, bcst(word([ecx]), {1=>32}), 0x04
        #   vcmpph k1, zmm1, bcst(word([ecx]), {1=>32}), 0x04
        ...
        # @example
        #   vcmpps opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vcmpps k1, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vcmpps opmask(k1, k2), xmm1, xmm2, 0x04
        #   vcmpps k1, xmm1, xmm2, 0x04
        #   vcmpps opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vcmpps k1, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vcmpps opmask(k1, k2), ymm1, ymm2, 0x04
        #   vcmpps k1, ymm1, ymm2, 0x04
        #   vcmpps opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vcmpps k1, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vcmpps opmask(k1, k2), zmm1, zmm2, 0x04
        #   vcmpps k1, zmm1, zmm2, 0x04
        #   vcmpps xmm0, xmm1, xmm2, 0x04
        #   vcmpps xmm0, xmm1, oword([ecx]), 0x04
        #   vcmpps ymm0, ymm1, ymm2, 0x04
        #   vcmpps ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vcmpsd opmask(k1, k2), xmm1, qword([ecx]), 0x04
        #   vcmpsd k1, xmm1, qword([ecx]), 0x04
        #   vcmpsd xmm0, xmm1, xmm2, 0x04
        #   vcmpsd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vcmpsh opmask(k1, k2), xmm1, word([ecx]), 0x04
        #   vcmpsh k1, xmm1, word([ecx]), 0x04
        ...
        #   vcmpss opmask(k1, k2), xmm1, dword([ecx]), 0x04
        #   vcmpss k1, xmm1, dword([ecx]), 0x04
        #   vcmpss xmm0, xmm1, xmm2, 0x04
        #   vcmpss xmm0, xmm1, dword([ecx]), 0x04
        ...
        #   vcompresspd opmask(oword([eax]), k1), xmm1
        #   vcompresspd opmask(ymm0, k1, zero: true), ymm1
        #   vcompresspd opmask(yword([eax]), k1), ymm1
        #   vcompresspd opmask(zmm0, k1, zero: true), zmm1
        #   vcompresspd opmask(zword([eax]), k1), zmm1
        #   vcompresspd xmm0, xmm1
        #   vcompresspd ymm0, ymm1
        #   vcompresspd zmm0, zmm1
        #   vcompresspd oword([eax]), xmm1
        #   vcompresspd yword([eax]), ymm1
        #   vcompresspd zword([eax]), zmm1
        ...
        #   vcompressps opmask(oword([eax]), k1), xmm1
        #   vcompressps opmask(ymm0, k1, zero: true), ymm1
        #   vcompressps opmask(yword([eax]), k1), ymm1
        #   vcompressps opmask(zmm0, k1, zero: true), zmm1
        #   vcompressps opmask(zword([eax]), k1), zmm1
        #   vcompressps xmm0, xmm1
        #   vcompressps ymm0, ymm1
        #   vcompressps zmm0, zmm1
        #   vcompressps oword([eax]), xmm1
        #   vcompressps yword([eax]), ymm1
        #   vcompressps zword([eax]), zmm1
        ...
        # @example
        #   vcvtdq2pd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvtdq2pd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtdq2pd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtdq2pd opmask(xmm0, k1, zero: true), xmm1
        #   vcvtdq2pd opmask(ymm0, k1, zero: true), xmm1
        #   vcvtdq2pd opmask(zmm0, k1, zero: true), ymm1
        #   vcvtdq2pd xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvtdq2pd xmm0, xmm1
        #   vcvtdq2pd xmm0, xmm1
        #   vcvtdq2pd xmm0, qword([ebx])
        #   vcvtdq2pd ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvtdq2pd ymm0, xmm1
        #   vcvtdq2pd ymm0, xmm1
        #   vcvtdq2pd ymm0, oword([ebx])
        #   vcvtdq2pd zmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtdq2pd zmm0, ymm1
        ...
        # @example
        #   vcvtdq2ph opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtdq2ph opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtdq2ph opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtdq2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtdq2ph opmask(xmm0, k1, zero: true), ymm1
        #   vcvtdq2ph opmask(ymm0, k1, zero: true), zmm1
        #   vcvtdq2ph xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtdq2ph xmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtdq2ph xmm0, xmm1
        #   vcvtdq2ph xmm0, ymm1
        #   vcvtdq2ph ymm0, bcst(dword([ebx]), {1=>16})
        #   vcvtdq2ph ymm0, zmm1
        ...
        # @example
        #   vcvtdq2ps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtdq2ps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtdq2ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtdq2ps opmask(xmm0, k1, zero: true), xmm1
        #   vcvtdq2ps opmask(ymm0, k1, zero: true), ymm1
        #   vcvtdq2ps opmask(zmm0, k1, zero: true), zmm1
        #   vcvtdq2ps xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtdq2ps xmm0, xmm1
        #   vcvtdq2ps xmm0, xmm1
        #   vcvtdq2ps xmm0, oword([ebx])
        #   vcvtdq2ps ymm0, bcst(dword([ebx]), {1=>8})
        #   vcvtdq2ps ymm0, ymm1
        #   vcvtdq2ps ymm0, ymm1
        #   vcvtdq2ps ymm0, yword([ebx])
        #   vcvtdq2ps zmm0, bcst(dword([ebx]), {1=>16})
        #   vcvtdq2ps zmm0, zmm1
        ...
        # @example
        #   vcvtne2ps2bf16 opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vcvtne2ps2bf16 opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vcvtne2ps2bf16 opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vcvtne2ps2bf16 opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vcvtne2ps2bf16 opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vcvtne2ps2bf16 opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vcvtne2ps2bf16 xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vcvtne2ps2bf16 xmm0, xmm1, xmm2
        #   vcvtne2ps2bf16 ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vcvtne2ps2bf16 ymm0, ymm1, ymm2
        #   vcvtne2ps2bf16 zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vcvtneebf162ps xmm0, oword([ebx])
        #   vcvtneebf162ps ymm0, yword([ebx])
        ...
        # @example
        #   vcvtneeph2ps xmm0, oword([ebx])
        #   vcvtneeph2ps ymm0, yword([ebx])
        ...
        # @example
        #   vcvtneobf162ps xmm0, oword([ebx])
        #   vcvtneobf162ps ymm0, yword([ebx])
        ...
        # @example
        #   vcvtneoph2ps xmm0, oword([ebx])
        #   vcvtneoph2ps ymm0, yword([ebx])
        ...
        # @example
        #   vcvtneps2bf16 opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtneps2bf16 opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtneps2bf16 opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        ...
        #   vcvtneps2bf16 xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtneps2bf16 xmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtneps2bf16 xmm0, xmm1
        #   vcvtneps2bf16 xmm0, xmm1
        #   vcvtneps2bf16 xmm0, ymm1
        #   vcvtneps2bf16 xmm0, ymm1
        #   vcvtneps2bf16 xmm0, oword([ebx])
        #   vcvtneps2bf16 xmm0, yword([ebx])
        #   vcvtneps2bf16 ymm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvtpd2dq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtpd2dq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtpd2dq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtpd2dq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtpd2dq opmask(xmm0, k1, zero: true), ymm1
        #   vcvtpd2dq opmask(ymm0, k1, zero: true), zmm1
        #   vcvtpd2dq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtpd2dq xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtpd2dq xmm0, xmm1
        #   vcvtpd2dq xmm0, xmm1
        #   vcvtpd2dq xmm0, ymm1
        #   vcvtpd2dq xmm0, ymm1
        #   vcvtpd2dq xmm0, oword([ebx])
        #   vcvtpd2dq xmm0, yword([ebx])
        #   vcvtpd2dq ymm0, bcst(qword([ebx]), {1=>8})
        #   vcvtpd2dq ymm0, zmm1
        ...
        # @example
        #   vcvtpd2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtpd2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtpd2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtpd2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtpd2ph opmask(xmm0, k1, zero: true), ymm1
        #   vcvtpd2ph opmask(xmm0, k1, zero: true), zmm1
        #   vcvtpd2ph xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtpd2ph xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtpd2ph xmm0, bcst(qword([ebx]), {1=>8})
        #   vcvtpd2ph xmm0, xmm1
        #   vcvtpd2ph xmm0, ymm1
        #   vcvtpd2ph xmm0, zmm1
        ...
        # @example
        #   vcvtpd2ps opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtpd2ps opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtpd2ps opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtpd2ps opmask(xmm0, k1, zero: true), xmm1
        #   vcvtpd2ps opmask(xmm0, k1, zero: true), ymm1
        #   vcvtpd2ps opmask(ymm0, k1, zero: true), zmm1
        #   vcvtpd2ps xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtpd2ps xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtpd2ps xmm0, xmm1
        #   vcvtpd2ps xmm0, xmm1
        #   vcvtpd2ps xmm0, ymm1
        #   vcvtpd2ps xmm0, ymm1
        #   vcvtpd2ps xmm0, oword([ebx])
        #   vcvtpd2ps xmm0, yword([ebx])
        #   vcvtpd2ps ymm0, bcst(qword([ebx]), {1=>8})
        #   vcvtpd2ps ymm0, zmm1
        ...
        # @example
        #   vcvtpd2qq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtpd2qq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtpd2qq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtpd2qq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtpd2qq opmask(ymm0, k1, zero: true), ymm1
        #   vcvtpd2qq opmask(zmm0, k1, zero: true), zmm1
        #   vcvtpd2qq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtpd2qq xmm0, xmm1
        #   vcvtpd2qq ymm0, bcst(qword([ebx]), {1=>4})
        #   vcvtpd2qq ymm0, ymm1
        #   vcvtpd2qq zmm0, bcst(qword([ebx]), {1=>8})
        #   vcvtpd2qq zmm0, zmm1
        ...
        # @example
        #   vcvtpd2udq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtpd2udq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtpd2udq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtpd2udq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtpd2udq opmask(xmm0, k1, zero: true), ymm1
        #   vcvtpd2udq opmask(ymm0, k1, zero: true), zmm1
        #   vcvtpd2udq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtpd2udq xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtpd2udq xmm0, xmm1
        #   vcvtpd2udq xmm0, ymm1
        #   vcvtpd2udq ymm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtpd2uqq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtpd2uqq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtpd2uqq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtpd2uqq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtpd2uqq opmask(ymm0, k1, zero: true), ymm1
        #   vcvtpd2uqq opmask(zmm0, k1, zero: true), zmm1
        #   vcvtpd2uqq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtpd2uqq xmm0, xmm1
        #   vcvtpd2uqq ymm0, bcst(qword([ebx]), {1=>4})
        #   vcvtpd2uqq ymm0, ymm1
        #   vcvtpd2uqq zmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtph2dq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvtph2dq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2dq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtph2dq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2dq opmask(ymm0, k1, zero: true), xmm1
        #   vcvtph2dq opmask(zmm0, k1, zero: true), ymm1
        #   vcvtph2dq xmm0, bcst(word([ebx]), {1=>4})
        #   vcvtph2dq xmm0, xmm1
        #   vcvtph2dq ymm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2dq ymm0, xmm1
        #   vcvtph2dq zmm0, bcst(word([ebx]), {1=>16})
        #   vcvtph2dq zmm0, ymm1
        ...
        # @example
        #   vcvtph2pd opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>2})
        #   vcvtph2pd opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvtph2pd opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2pd opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2pd opmask(ymm0, k1, zero: true), xmm1
        #   vcvtph2pd opmask(zmm0, k1, zero: true), xmm1
        #   vcvtph2pd xmm0, bcst(word([ebx]), {1=>2})
        #   vcvtph2pd xmm0, xmm1
        #   vcvtph2pd ymm0, bcst(word([ebx]), {1=>4})
        #   vcvtph2pd ymm0, xmm1
        #   vcvtph2pd zmm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2pd zmm0, xmm1
        ...
        #   vcvtph2ps opmask(xmm0, k1, zero: true), qword([ebx])
        #   vcvtph2ps opmask(ymm0, k1, zero: true), oword([ebx])
        #   vcvtph2ps opmask(zmm0, k1, zero: true), yword([ebx])
        #   vcvtph2ps xmm0, xmm1
        #   vcvtph2ps xmm0, xmm1
        #   vcvtph2ps xmm0, qword([ebx])
        #   vcvtph2ps xmm0, qword([ebx])
        #   vcvtph2ps ymm0, xmm1
        #   vcvtph2ps ymm0, xmm1
        #   vcvtph2ps ymm0, oword([ebx])
        #   vcvtph2ps ymm0, oword([ebx])
        #   vcvtph2ps zmm0, ymm1
        #   vcvtph2ps zmm0, yword([ebx])
        ...
        # @example
        #   vcvtph2psx opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvtph2psx opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2psx opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtph2psx opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2psx opmask(ymm0, k1, zero: true), xmm1
        #   vcvtph2psx opmask(zmm0, k1, zero: true), ymm1
        #   vcvtph2psx xmm0, bcst(word([ebx]), {1=>4})
        #   vcvtph2psx xmm0, xmm1
        #   vcvtph2psx ymm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2psx ymm0, xmm1
        #   vcvtph2psx zmm0, bcst(word([ebx]), {1=>16})
        ...
        # @example
        #   vcvtph2qq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>2})
        #   vcvtph2qq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvtph2qq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2qq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2qq opmask(ymm0, k1, zero: true), xmm1
        #   vcvtph2qq opmask(zmm0, k1, zero: true), xmm1
        #   vcvtph2qq xmm0, bcst(word([ebx]), {1=>2})
        #   vcvtph2qq xmm0, xmm1
        #   vcvtph2qq ymm0, bcst(word([ebx]), {1=>4})
        #   vcvtph2qq ymm0, xmm1
        #   vcvtph2qq zmm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2qq zmm0, xmm1
        ...
        # @example
        #   vcvtph2udq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvtph2udq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2udq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtph2udq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2udq opmask(ymm0, k1, zero: true), xmm1
        #   vcvtph2udq opmask(zmm0, k1, zero: true), ymm1
        #   vcvtph2udq xmm0, bcst(word([ebx]), {1=>4})
        #   vcvtph2udq xmm0, xmm1
        #   vcvtph2udq ymm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2udq ymm0, xmm1
        #   vcvtph2udq zmm0, bcst(word([ebx]), {1=>16})
        ...
        # @example
        #   vcvtph2uqq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>2})
        #   vcvtph2uqq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvtph2uqq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2uqq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2uqq opmask(ymm0, k1, zero: true), xmm1
        #   vcvtph2uqq opmask(zmm0, k1, zero: true), xmm1
        #   vcvtph2uqq xmm0, bcst(word([ebx]), {1=>2})
        #   vcvtph2uqq xmm0, xmm1
        #   vcvtph2uqq ymm0, bcst(word([ebx]), {1=>4})
        #   vcvtph2uqq ymm0, xmm1
        #   vcvtph2uqq zmm0, bcst(word([ebx]), {1=>8})
        ...
        # @example
        #   vcvtph2uw opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2uw opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtph2uw opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vcvtph2uw opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2uw opmask(ymm0, k1, zero: true), ymm1
        #   vcvtph2uw opmask(zmm0, k1, zero: true), zmm1
        #   vcvtph2uw xmm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2uw xmm0, xmm1
        #   vcvtph2uw ymm0, bcst(word([ebx]), {1=>16})
        #   vcvtph2uw ymm0, ymm1
        #   vcvtph2uw zmm0, bcst(word([ebx]), {1=>32})
        #   vcvtph2uw zmm0, zmm1
        ...
        # @example
        #   vcvtph2w opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtph2w opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtph2w opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vcvtph2w opmask(xmm0, k1, zero: true), xmm1
        #   vcvtph2w opmask(ymm0, k1, zero: true), ymm1
        #   vcvtph2w opmask(zmm0, k1, zero: true), zmm1
        #   vcvtph2w xmm0, bcst(word([ebx]), {1=>8})
        #   vcvtph2w xmm0, xmm1
        #   vcvtph2w ymm0, bcst(word([ebx]), {1=>16})
        #   vcvtph2w ymm0, ymm1
        #   vcvtph2w zmm0, bcst(word([ebx]), {1=>32})
        #   vcvtph2w zmm0, zmm1
        ...
        # @example
        #   vcvtps2dq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtps2dq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtps2dq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtps2dq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtps2dq opmask(ymm0, k1, zero: true), ymm1
        #   vcvtps2dq opmask(zmm0, k1, zero: true), zmm1
        #   vcvtps2dq xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtps2dq xmm0, xmm1
        #   vcvtps2dq xmm0, xmm1
        #   vcvtps2dq xmm0, oword([ebx])
        #   vcvtps2dq ymm0, bcst(dword([ebx]), {1=>8})
        #   vcvtps2dq ymm0, ymm1
        #   vcvtps2dq ymm0, ymm1
        #   vcvtps2dq ymm0, yword([ebx])
        #   vcvtps2dq zmm0, bcst(dword([ebx]), {1=>16})
        #   vcvtps2dq zmm0, zmm1
        ...
        # @example
        #   vcvtps2pd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvtps2pd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtps2pd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtps2pd opmask(xmm0, k1, zero: true), xmm1
        #   vcvtps2pd opmask(ymm0, k1, zero: true), xmm1
        #   vcvtps2pd opmask(zmm0, k1, zero: true), ymm1
        #   vcvtps2pd xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvtps2pd xmm0, xmm1
        #   vcvtps2pd xmm0, xmm1
        #   vcvtps2pd xmm0, qword([ebx])
        #   vcvtps2pd ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvtps2pd ymm0, xmm1
        #   vcvtps2pd ymm0, xmm1
        #   vcvtps2pd ymm0, oword([ebx])
        #   vcvtps2pd zmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtps2pd zmm0, ymm1
        ...
        #   vcvtps2ph opmask(qword([eax]), k1), xmm1, 0x03
        #   vcvtps2ph opmask(xmm0, k1, zero: true), ymm1, 0x03
        #   vcvtps2ph opmask(oword([eax]), k1), ymm1, 0x03
        #   vcvtps2ph opmask(ymm0, k1, zero: true), zmm1, 0x03
        #   vcvtps2ph opmask(yword([eax]), k1), zmm1, 0x03
        #   vcvtps2ph xmm0, xmm1, 0x03
        #   vcvtps2ph xmm0, xmm1, 0x03
        #   vcvtps2ph xmm0, ymm1, 0x03
        #   vcvtps2ph xmm0, ymm1, 0x03
        #   vcvtps2ph ymm0, zmm1, 0x03
        #   vcvtps2ph qword([eax]), xmm1, 0x03
        #   vcvtps2ph qword([eax]), xmm1, 0x03
        #   vcvtps2ph oword([eax]), ymm1, 0x03
        #   vcvtps2ph oword([eax]), ymm1, 0x03
        #   vcvtps2ph yword([eax]), zmm1, 0x03
        ...
        # @example
        #   vcvtps2phx opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtps2phx opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtps2phx opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtps2phx opmask(xmm0, k1, zero: true), xmm1
        #   vcvtps2phx opmask(xmm0, k1, zero: true), ymm1
        #   vcvtps2phx opmask(ymm0, k1, zero: true), zmm1
        #   vcvtps2phx xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtps2phx xmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtps2phx xmm0, xmm1
        #   vcvtps2phx xmm0, ymm1
        #   vcvtps2phx ymm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvtps2qq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvtps2qq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtps2qq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtps2qq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtps2qq opmask(ymm0, k1, zero: true), xmm1
        #   vcvtps2qq opmask(zmm0, k1, zero: true), ymm1
        #   vcvtps2qq xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvtps2qq xmm0, xmm1
        #   vcvtps2qq ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvtps2qq ymm0, xmm1
        #   vcvtps2qq zmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtps2qq zmm0, ymm1
        ...
        # @example
        #   vcvtps2udq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtps2udq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtps2udq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtps2udq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtps2udq opmask(ymm0, k1, zero: true), ymm1
        #   vcvtps2udq opmask(zmm0, k1, zero: true), zmm1
        #   vcvtps2udq xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtps2udq xmm0, xmm1
        #   vcvtps2udq ymm0, bcst(dword([ebx]), {1=>8})
        #   vcvtps2udq ymm0, ymm1
        #   vcvtps2udq zmm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvtps2uqq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvtps2uqq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtps2uqq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtps2uqq opmask(xmm0, k1, zero: true), xmm1
        #   vcvtps2uqq opmask(ymm0, k1, zero: true), xmm1
        #   vcvtps2uqq opmask(zmm0, k1, zero: true), ymm1
        #   vcvtps2uqq xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvtps2uqq xmm0, xmm1
        #   vcvtps2uqq ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvtps2uqq ymm0, xmm1
        #   vcvtps2uqq zmm0, bcst(dword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtqq2pd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtqq2pd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtqq2pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtqq2pd opmask(xmm0, k1, zero: true), xmm1
        #   vcvtqq2pd opmask(ymm0, k1, zero: true), ymm1
        #   vcvtqq2pd opmask(zmm0, k1, zero: true), zmm1
        #   vcvtqq2pd xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtqq2pd xmm0, xmm1
        #   vcvtqq2pd ymm0, bcst(qword([ebx]), {1=>4})
        #   vcvtqq2pd ymm0, ymm1
        #   vcvtqq2pd zmm0, bcst(qword([ebx]), {1=>8})
        #   vcvtqq2pd zmm0, zmm1
        ...
        # @example
        #   vcvtqq2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtqq2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtqq2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtqq2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtqq2ph opmask(xmm0, k1, zero: true), ymm1
        #   vcvtqq2ph opmask(xmm0, k1, zero: true), zmm1
        #   vcvtqq2ph xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtqq2ph xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtqq2ph xmm0, bcst(qword([ebx]), {1=>8})
        #   vcvtqq2ph xmm0, xmm1
        #   vcvtqq2ph xmm0, ymm1
        #   vcvtqq2ph xmm0, zmm1
        ...
        # @example
        #   vcvtqq2ps opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtqq2ps opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtqq2ps opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtqq2ps opmask(xmm0, k1, zero: true), xmm1
        #   vcvtqq2ps opmask(xmm0, k1, zero: true), ymm1
        #   vcvtqq2ps opmask(ymm0, k1, zero: true), zmm1
        #   vcvtqq2ps xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtqq2ps xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtqq2ps xmm0, xmm1
        #   vcvtqq2ps xmm0, ymm1
        #   vcvtqq2ps ymm0, bcst(qword([ebx]), {1=>8})
        #   vcvtqq2ps ymm0, zmm1
        ...
        #   vcvtsd2sh opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vcvtsd2sh xmm0, xmm1, xmm2
        #   vcvtsd2sh xmm0, xmm1, qword([ecx])
        ...
        #   vcvtsd2ss opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vcvtsd2ss xmm0, xmm1, xmm2
        #   vcvtsd2ss xmm0, xmm1, xmm2
        #   vcvtsd2ss xmm0, xmm1, qword([ecx])
        #   vcvtsd2ss xmm0, xmm1, qword([ecx])
        ...
        #   vcvtsh2sd opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vcvtsh2sd xmm0, xmm1, xmm2
        #   vcvtsh2sd xmm0, xmm1, word([ecx])
        ...
        #   vcvtsh2ss opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vcvtsh2ss xmm0, xmm1, xmm2
        #   vcvtsh2ss xmm0, xmm1, word([ecx])
        ...
        #   vcvtss2sd opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vcvtss2sd xmm0, xmm1, xmm2
        #   vcvtss2sd xmm0, xmm1, xmm2
        #   vcvtss2sd xmm0, xmm1, dword([ecx])
        #   vcvtss2sd xmm0, xmm1, dword([ecx])
        ...
        #   vcvtss2sh opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vcvtss2sh xmm0, xmm1, xmm2
        #   vcvtss2sh xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vcvttpd2dq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvttpd2dq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvttpd2dq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvttpd2dq opmask(xmm0, k1, zero: true), xmm1
        #   vcvttpd2dq opmask(xmm0, k1, zero: true), ymm1
        #   vcvttpd2dq opmask(ymm0, k1, zero: true), zmm1
        #   vcvttpd2dq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvttpd2dq xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvttpd2dq xmm0, xmm1
        #   vcvttpd2dq xmm0, xmm1
        #   vcvttpd2dq xmm0, ymm1
        #   vcvttpd2dq xmm0, ymm1
        #   vcvttpd2dq xmm0, oword([ebx])
        #   vcvttpd2dq xmm0, yword([ebx])
        #   vcvttpd2dq ymm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvttpd2qq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvttpd2qq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvttpd2qq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvttpd2qq opmask(xmm0, k1, zero: true), xmm1
        #   vcvttpd2qq opmask(ymm0, k1, zero: true), ymm1
        #   vcvttpd2qq opmask(zmm0, k1, zero: true), zmm1
        #   vcvttpd2qq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvttpd2qq xmm0, xmm1
        #   vcvttpd2qq ymm0, bcst(qword([ebx]), {1=>4})
        #   vcvttpd2qq ymm0, ymm1
        #   vcvttpd2qq zmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvttpd2udq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvttpd2udq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvttpd2udq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        ...
        #   vcvttpd2udq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvttpd2udq xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvttpd2udq xmm0, xmm1
        #   vcvttpd2udq xmm0, ymm1
        #   vcvttpd2udq ymm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvttpd2uqq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvttpd2uqq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvttpd2uqq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        ...
        #   vcvttpd2uqq xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvttpd2uqq xmm0, xmm1
        #   vcvttpd2uqq ymm0, bcst(qword([ebx]), {1=>4})
        #   vcvttpd2uqq ymm0, ymm1
        #   vcvttpd2uqq zmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvttph2dq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvttph2dq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvttph2dq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvttph2dq opmask(xmm0, k1, zero: true), xmm1
        #   vcvttph2dq opmask(ymm0, k1, zero: true), xmm1
        #   vcvttph2dq opmask(zmm0, k1, zero: true), ymm1
        #   vcvttph2dq xmm0, bcst(word([ebx]), {1=>4})
        #   vcvttph2dq xmm0, xmm1
        #   vcvttph2dq ymm0, bcst(word([ebx]), {1=>8})
        #   vcvttph2dq ymm0, xmm1
        #   vcvttph2dq zmm0, bcst(word([ebx]), {1=>16})
        ...
        # @example
        #   vcvttph2qq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>2})
        #   vcvttph2qq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvttph2qq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvttph2qq opmask(xmm0, k1, zero: true), xmm1
        #   vcvttph2qq opmask(ymm0, k1, zero: true), xmm1
        #   vcvttph2qq opmask(zmm0, k1, zero: true), xmm1
        #   vcvttph2qq xmm0, bcst(word([ebx]), {1=>2})
        #   vcvttph2qq xmm0, xmm1
        #   vcvttph2qq ymm0, bcst(word([ebx]), {1=>4})
        #   vcvttph2qq ymm0, xmm1
        #   vcvttph2qq zmm0, bcst(word([ebx]), {1=>8})
        ...
        # @example
        #   vcvttph2udq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvttph2udq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvttph2udq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        ...
        #   vcvttph2udq xmm0, bcst(word([ebx]), {1=>4})
        #   vcvttph2udq xmm0, xmm1
        #   vcvttph2udq ymm0, bcst(word([ebx]), {1=>8})
        #   vcvttph2udq ymm0, xmm1
        #   vcvttph2udq zmm0, bcst(word([ebx]), {1=>16})
        ...
        # @example
        #   vcvttph2uqq opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>2})
        #   vcvttph2uqq opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>4})
        #   vcvttph2uqq opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        ...
        #   vcvttph2uqq xmm0, bcst(word([ebx]), {1=>2})
        #   vcvttph2uqq xmm0, xmm1
        #   vcvttph2uqq ymm0, bcst(word([ebx]), {1=>4})
        #   vcvttph2uqq ymm0, xmm1
        #   vcvttph2uqq zmm0, bcst(word([ebx]), {1=>8})
        ...
        # @example
        #   vcvttph2uw opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvttph2uw opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvttph2uw opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vcvttph2uw opmask(xmm0, k1, zero: true), xmm1
        #   vcvttph2uw opmask(ymm0, k1, zero: true), ymm1
        #   vcvttph2uw opmask(zmm0, k1, zero: true), zmm1
        #   vcvttph2uw xmm0, bcst(word([ebx]), {1=>8})
        #   vcvttph2uw xmm0, xmm1
        #   vcvttph2uw ymm0, bcst(word([ebx]), {1=>16})
        #   vcvttph2uw ymm0, ymm1
        #   vcvttph2uw zmm0, bcst(word([ebx]), {1=>32})
        ...
        # @example
        #   vcvttph2w opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvttph2w opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvttph2w opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vcvttph2w opmask(xmm0, k1, zero: true), xmm1
        #   vcvttph2w opmask(ymm0, k1, zero: true), ymm1
        #   vcvttph2w opmask(zmm0, k1, zero: true), zmm1
        #   vcvttph2w xmm0, bcst(word([ebx]), {1=>8})
        #   vcvttph2w xmm0, xmm1
        #   vcvttph2w ymm0, bcst(word([ebx]), {1=>16})
        #   vcvttph2w ymm0, ymm1
        #   vcvttph2w zmm0, bcst(word([ebx]), {1=>32})
        #   vcvttph2w zmm0, zmm1
        ...
        # @example
        #   vcvttps2dq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvttps2dq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvttps2dq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvttps2dq opmask(xmm0, k1, zero: true), xmm1
        #   vcvttps2dq opmask(ymm0, k1, zero: true), ymm1
        #   vcvttps2dq opmask(zmm0, k1, zero: true), zmm1
        #   vcvttps2dq xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvttps2dq xmm0, xmm1
        #   vcvttps2dq xmm0, xmm1
        #   vcvttps2dq xmm0, oword([ebx])
        #   vcvttps2dq ymm0, bcst(dword([ebx]), {1=>8})
        #   vcvttps2dq ymm0, ymm1
        #   vcvttps2dq ymm0, ymm1
        #   vcvttps2dq ymm0, yword([ebx])
        #   vcvttps2dq zmm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvttps2qq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvttps2qq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvttps2qq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvttps2qq opmask(xmm0, k1, zero: true), xmm1
        #   vcvttps2qq opmask(ymm0, k1, zero: true), xmm1
        #   vcvttps2qq opmask(zmm0, k1, zero: true), ymm1
        #   vcvttps2qq xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvttps2qq xmm0, xmm1
        #   vcvttps2qq ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvttps2qq ymm0, xmm1
        #   vcvttps2qq zmm0, bcst(dword([ebx]), {1=>8})
        ...
        # @example
        #   vcvttps2udq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvttps2udq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvttps2udq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        ...
        #   vcvttps2udq xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvttps2udq xmm0, xmm1
        #   vcvttps2udq ymm0, bcst(dword([ebx]), {1=>8})
        #   vcvttps2udq ymm0, ymm1
        #   vcvttps2udq zmm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvttps2uqq opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvttps2uqq opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvttps2uqq opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        ...
        #   vcvttps2uqq xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvttps2uqq xmm0, xmm1
        #   vcvttps2uqq ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvttps2uqq ymm0, xmm1
        #   vcvttps2uqq zmm0, bcst(dword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtudq2pd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>2})
        #   vcvtudq2pd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtudq2pd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtudq2pd opmask(xmm0, k1, zero: true), xmm1
        #   vcvtudq2pd opmask(ymm0, k1, zero: true), xmm1
        #   vcvtudq2pd opmask(zmm0, k1, zero: true), ymm1
        #   vcvtudq2pd xmm0, bcst(dword([ebx]), {1=>2})
        #   vcvtudq2pd xmm0, xmm1
        #   vcvtudq2pd ymm0, bcst(dword([ebx]), {1=>4})
        #   vcvtudq2pd ymm0, xmm1
        #   vcvtudq2pd zmm0, bcst(dword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtudq2ph opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtudq2ph opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtudq2ph opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtudq2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtudq2ph opmask(xmm0, k1, zero: true), ymm1
        #   vcvtudq2ph opmask(ymm0, k1, zero: true), zmm1
        #   vcvtudq2ph xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtudq2ph xmm0, bcst(dword([ebx]), {1=>8})
        #   vcvtudq2ph xmm0, xmm1
        #   vcvtudq2ph xmm0, ymm1
        #   vcvtudq2ph ymm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvtudq2ps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vcvtudq2ps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vcvtudq2ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vcvtudq2ps opmask(xmm0, k1, zero: true), xmm1
        #   vcvtudq2ps opmask(ymm0, k1, zero: true), ymm1
        #   vcvtudq2ps opmask(zmm0, k1, zero: true), zmm1
        #   vcvtudq2ps xmm0, bcst(dword([ebx]), {1=>4})
        #   vcvtudq2ps xmm0, xmm1
        #   vcvtudq2ps ymm0, bcst(dword([ebx]), {1=>8})
        #   vcvtudq2ps ymm0, ymm1
        #   vcvtudq2ps zmm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vcvtuqq2pd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtuqq2pd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtuqq2pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtuqq2pd opmask(xmm0, k1, zero: true), xmm1
        #   vcvtuqq2pd opmask(ymm0, k1, zero: true), ymm1
        #   vcvtuqq2pd opmask(zmm0, k1, zero: true), zmm1
        #   vcvtuqq2pd xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtuqq2pd xmm0, xmm1
        #   vcvtuqq2pd ymm0, bcst(qword([ebx]), {1=>4})
        #   vcvtuqq2pd ymm0, ymm1
        #   vcvtuqq2pd zmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtuqq2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtuqq2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtuqq2ph opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtuqq2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtuqq2ph opmask(xmm0, k1, zero: true), ymm1
        #   vcvtuqq2ph opmask(xmm0, k1, zero: true), zmm1
        #   vcvtuqq2ph xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtuqq2ph xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtuqq2ph xmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vcvtuqq2ps opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vcvtuqq2ps opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vcvtuqq2ps opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vcvtuqq2ps opmask(xmm0, k1, zero: true), xmm1
        #   vcvtuqq2ps opmask(xmm0, k1, zero: true), ymm1
        #   vcvtuqq2ps opmask(ymm0, k1, zero: true), zmm1
        #   vcvtuqq2ps xmm0, bcst(qword([ebx]), {1=>2})
        #   vcvtuqq2ps xmm0, bcst(qword([ebx]), {1=>4})
        #   vcvtuqq2ps xmm0, xmm1
        #   vcvtuqq2ps xmm0, ymm1
        #   vcvtuqq2ps ymm0, bcst(qword([ebx]), {1=>8})
        ...
        #   vcvtusi2sd xmm0, xmm1, dword([ecx])
        ...
        #   vcvtusi2sh xmm0, xmm1, dword([ecx])
        ...
        #   vcvtusi2ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vcvtuw2ph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtuw2ph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtuw2ph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vcvtuw2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtuw2ph opmask(ymm0, k1, zero: true), ymm1
        #   vcvtuw2ph opmask(zmm0, k1, zero: true), zmm1
        #   vcvtuw2ph xmm0, bcst(word([ebx]), {1=>8})
        #   vcvtuw2ph xmm0, xmm1
        #   vcvtuw2ph ymm0, bcst(word([ebx]), {1=>16})
        #   vcvtuw2ph ymm0, ymm1
        #   vcvtuw2ph zmm0, bcst(word([ebx]), {1=>32})
        #   vcvtuw2ph zmm0, zmm1
        ...
        # @example
        #   vcvtw2ph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vcvtw2ph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vcvtw2ph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vcvtw2ph opmask(xmm0, k1, zero: true), xmm1
        #   vcvtw2ph opmask(ymm0, k1, zero: true), ymm1
        #   vcvtw2ph opmask(zmm0, k1, zero: true), zmm1
        #   vcvtw2ph xmm0, bcst(word([ebx]), {1=>8})
        #   vcvtw2ph xmm0, xmm1
        #   vcvtw2ph ymm0, bcst(word([ebx]), {1=>16})
        #   vcvtw2ph ymm0, ymm1
        #   vcvtw2ph zmm0, bcst(word([ebx]), {1=>32})
        #   vcvtw2ph zmm0, zmm1
        ...
        #   vdbpsadbw opmask(xmm0, k1, zero: true), xmm1, oword([ecx]), 0x04
        #   vdbpsadbw opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vdbpsadbw opmask(ymm0, k1, zero: true), ymm1, yword([ecx]), 0x04
        #   vdbpsadbw opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vdbpsadbw opmask(zmm0, k1, zero: true), zmm1, zword([ecx]), 0x04
        #   vdbpsadbw xmm0, xmm1, xmm2, 0x04
        #   vdbpsadbw xmm0, xmm1, oword([ecx]), 0x04
        #   vdbpsadbw ymm0, ymm1, ymm2, 0x04
        #   vdbpsadbw ymm0, ymm1, yword([ecx]), 0x04
        #   vdbpsadbw zmm0, zmm1, zmm2, 0x04
        #   vdbpsadbw zmm0, zmm1, zword([ecx]), 0x04
        ...
        # @example
        #   vdivpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vdivpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vdivpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vdivpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vdivpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vdivpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vdivpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vdivpd xmm0, xmm1, xmm2
        #   vdivpd xmm0, xmm1, xmm2
        #   vdivpd xmm0, xmm1, oword([ecx])
        #   vdivpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vdivpd ymm0, ymm1, ymm2
        #   vdivpd ymm0, ymm1, ymm2
        #   vdivpd ymm0, ymm1, yword([ecx])
        #   vdivpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vdivph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vdivph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vdivph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vdivph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vdivph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vdivph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vdivph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vdivph xmm0, xmm1, xmm2
        #   vdivph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vdivph ymm0, ymm1, ymm2
        #   vdivph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vdivps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vdivps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vdivps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vdivps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vdivps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vdivps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vdivps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vdivps xmm0, xmm1, xmm2
        #   vdivps xmm0, xmm1, xmm2
        #   vdivps xmm0, xmm1, oword([ecx])
        #   vdivps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vdivps ymm0, ymm1, ymm2
        #   vdivps ymm0, ymm1, ymm2
        #   vdivps ymm0, ymm1, yword([ecx])
        #   vdivps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vdivsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vdivsd xmm0, xmm1, xmm2
        #   vdivsd xmm0, xmm1, xmm2
        #   vdivsd xmm0, xmm1, qword([ecx])
        #   vdivsd xmm0, xmm1, qword([ecx])
        ...
        #   vdivsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vdivsh xmm0, xmm1, xmm2
        #   vdivsh xmm0, xmm1, word([ecx])
        ...
        #   vdivss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vdivss xmm0, xmm1, xmm2
        #   vdivss xmm0, xmm1, xmm2
        #   vdivss xmm0, xmm1, dword([ecx])
        #   vdivss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vdpbf16ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vdpbf16ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vdpbf16ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vdpbf16ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vdpbf16ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vdpbf16ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vdpbf16ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vdpbf16ps xmm0, xmm1, xmm2
        #   vdpbf16ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vdpbf16ps ymm0, ymm1, ymm2
        #   vdpbf16ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vdppd xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vdpps xmm0, xmm1, oword([ecx]), 0x04
        #   vdpps ymm0, ymm1, ymm2, 0x04
        #   vdpps ymm0, ymm1, yword([ecx]), 0x04
        ...
        # @example
        #   vexp2pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vexp2pd opmask(zmm0, k1, zero: true), zmm1
        #   vexp2pd zmm0, bcst(qword([ebx]), {1=>8})
        #   vexp2pd zmm0, zmm1
        ...
        # @example
        #   vexp2ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vexp2ps opmask(zmm0, k1, zero: true), zmm1
        #   vexp2ps zmm0, bcst(dword([ebx]), {1=>16})
        #   vexp2ps zmm0, zmm1
        ...
        #   vexpandpd opmask(xmm0, k1, zero: true), oword([ebx])
        #   vexpandpd opmask(ymm0, k1, zero: true), yword([ebx])
        #   vexpandpd opmask(zmm0, k1, zero: true), zword([ebx])
        #   vexpandpd xmm0, xmm1
        #   vexpandpd xmm0, oword([ebx])
        #   vexpandpd ymm0, ymm1
        #   vexpandpd ymm0, yword([ebx])
        #   vexpandpd zmm0, zmm1
        #   vexpandpd zmm0, zword([ebx])
        ...
        #   vexpandps opmask(xmm0, k1, zero: true), oword([ebx])
        #   vexpandps opmask(ymm0, k1, zero: true), yword([ebx])
        #   vexpandps opmask(zmm0, k1, zero: true), zword([ebx])
        #   vexpandps xmm0, xmm1
        #   vexpandps xmm0, oword([ebx])
        #   vexpandps ymm0, ymm1
        #   vexpandps ymm0, yword([ebx])
        #   vexpandps zmm0, zmm1
        #   vexpandps zmm0, zword([ebx])
        ...
        #   vextractf128 oword([eax]), ymm1, 0x03
        ...
        #   vextractf32x4 opmask(oword([eax]), k1), ymm1, 0x03
        #   vextractf32x4 opmask(xmm0, k1, zero: true), zmm1, 0x03
        #   vextractf32x4 opmask(oword([eax]), k1), zmm1, 0x03
        #   vextractf32x4 xmm0, ymm1, 0x03
        #   vextractf32x4 xmm0, zmm1, 0x03
        #   vextractf32x4 oword([eax]), ymm1, 0x03
        #   vextractf32x4 oword([eax]), zmm1, 0x03
        ...
        #   vextractf32x8 opmask(yword([eax]), k1), zmm1, 0x03
        #   vextractf32x8 ymm0, zmm1, 0x03
        #   vextractf32x8 yword([eax]), zmm1, 0x03
        ...
        #   vextractf64x2 opmask(oword([eax]), k1), ymm1, 0x03
        #   vextractf64x2 opmask(xmm0, k1, zero: true), zmm1, 0x03
        #   vextractf64x2 opmask(oword([eax]), k1), zmm1, 0x03
        #   vextractf64x2 xmm0, ymm1, 0x03
        #   vextractf64x2 xmm0, zmm1, 0x03
        #   vextractf64x2 oword([eax]), ymm1, 0x03
        #   vextractf64x2 oword([eax]), zmm1, 0x03
        ...
        #   vextractf64x4 opmask(yword([eax]), k1), zmm1, 0x03
        #   vextractf64x4 ymm0, zmm1, 0x03
        #   vextractf64x4 yword([eax]), zmm1, 0x03
        ...
        #   vextracti128 oword([eax]), ymm1, 0x03
        ...
        #   vextracti32x4 opmask(oword([eax]), k1), ymm1, 0x03
        #   vextracti32x4 opmask(xmm0, k1, zero: true), zmm1, 0x03
        #   vextracti32x4 opmask(oword([eax]), k1), zmm1, 0x03
        #   vextracti32x4 xmm0, ymm1, 0x03
        #   vextracti32x4 xmm0, zmm1, 0x03
        #   vextracti32x4 oword([eax]), ymm1, 0x03
        #   vextracti32x4 oword([eax]), zmm1, 0x03
        ...
        #   vextracti32x8 opmask(yword([eax]), k1), zmm1, 0x03
        #   vextracti32x8 ymm0, zmm1, 0x03
        #   vextracti32x8 yword([eax]), zmm1, 0x03
        ...
        #   vextracti64x2 opmask(oword([eax]), k1), ymm1, 0x03
        #   vextracti64x2 opmask(xmm0, k1, zero: true), zmm1, 0x03
        #   vextracti64x2 opmask(oword([eax]), k1), zmm1, 0x03
        #   vextracti64x2 xmm0, ymm1, 0x03
        #   vextracti64x2 xmm0, zmm1, 0x03
        #   vextracti64x2 oword([eax]), ymm1, 0x03
        #   vextracti64x2 oword([eax]), zmm1, 0x03
        ...
        #   vextracti64x4 opmask(yword([eax]), k1), zmm1, 0x03
        #   vextracti64x4 ymm0, zmm1, 0x03
        #   vextracti64x4 yword([eax]), zmm1, 0x03
        ...
        #   vextractps eax, xmm1, 0x03
        #   vextractps dword([eax]), xmm1, 0x03
        #   vextractps dword([eax]), xmm1, 0x03
        ...
        # @example
        #   vfcmaddcph opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfcmaddcph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfcmaddcph opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfcmaddcph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfcmaddcph opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfcmaddcph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfcmaddcph xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfcmaddcph xmm0, xmm1, xmm2
        #   vfcmaddcph ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfcmaddcph ymm0, ymm1, ymm2
        #   vfcmaddcph zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfcmaddcsh opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfcmaddcsh xmm0, xmm1, xmm2
        #   vfcmaddcsh xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfcmulcph opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfcmulcph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfcmulcph opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfcmulcph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfcmulcph opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfcmulcph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfcmulcph xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfcmulcph xmm0, xmm1, xmm2
        #   vfcmulcph ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfcmulcph ymm0, ymm1, ymm2
        #   vfcmulcph zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfcmulcsh opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfcmulcsh xmm0, xmm1, xmm2
        #   vfcmulcsh xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfixupimmpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vfixupimmpd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vfixupimmpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vfixupimmpd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vfixupimmpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vfixupimmpd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vfixupimmpd xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vfixupimmpd xmm0, xmm1, xmm2, 0x04
        #   vfixupimmpd ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vfixupimmpd ymm0, ymm1, ymm2, 0x04
        #   vfixupimmpd zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vfixupimmps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vfixupimmps opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vfixupimmps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vfixupimmps opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vfixupimmps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vfixupimmps opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vfixupimmps xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vfixupimmps xmm0, xmm1, xmm2, 0x04
        #   vfixupimmps ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vfixupimmps ymm0, ymm1, ymm2, 0x04
        #   vfixupimmps zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        #   vfixupimmsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx]), 0x04
        #   vfixupimmsd xmm0, xmm1, xmm2, 0x04
        #   vfixupimmsd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vfixupimmss opmask(xmm0, k1, zero: true), xmm1, dword([ecx]), 0x04
        #   vfixupimmss xmm0, xmm1, xmm2, 0x04
        #   vfixupimmss xmm0, xmm1, dword([ecx]), 0x04
        ...
        # @example
        #   vfmadd132pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmadd132pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd132pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmadd132pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd132pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmadd132pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd132pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmadd132pd xmm0, xmm1, xmm2
        #   vfmadd132pd xmm0, xmm1, xmm2
        #   vfmadd132pd xmm0, xmm1, oword([ecx])
        #   vfmadd132pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmadd132pd ymm0, ymm1, ymm2
        #   vfmadd132pd ymm0, ymm1, ymm2
        #   vfmadd132pd ymm0, ymm1, yword([ecx])
        #   vfmadd132pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmadd132ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmadd132ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd132ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmadd132ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd132ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmadd132ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd132ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmadd132ph xmm0, xmm1, xmm2
        #   vfmadd132ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmadd132ph ymm0, ymm1, ymm2
        #   vfmadd132ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmadd132ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmadd132ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd132ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmadd132ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd132ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmadd132ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd132ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmadd132ps xmm0, xmm1, xmm2
        #   vfmadd132ps xmm0, xmm1, xmm2
        #   vfmadd132ps xmm0, xmm1, oword([ecx])
        #   vfmadd132ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmadd132ps ymm0, ymm1, ymm2
        #   vfmadd132ps ymm0, ymm1, ymm2
        #   vfmadd132ps ymm0, ymm1, yword([ecx])
        #   vfmadd132ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmadd132sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfmadd132sd xmm0, xmm1, xmm2
        #   vfmadd132sd xmm0, xmm1, xmm2
        #   vfmadd132sd xmm0, xmm1, qword([ecx])
        #   vfmadd132sd xmm0, xmm1, qword([ecx])
        ...
        #   vfmadd132ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmadd132ss xmm0, xmm1, xmm2
        #   vfmadd132ss xmm0, xmm1, xmm2
        #   vfmadd132ss xmm0, xmm1, dword([ecx])
        #   vfmadd132ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfmadd213pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmadd213pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd213pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmadd213pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd213pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmadd213pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd213pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmadd213pd xmm0, xmm1, xmm2
        #   vfmadd213pd xmm0, xmm1, xmm2
        #   vfmadd213pd xmm0, xmm1, oword([ecx])
        #   vfmadd213pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmadd213pd ymm0, ymm1, ymm2
        #   vfmadd213pd ymm0, ymm1, ymm2
        #   vfmadd213pd ymm0, ymm1, yword([ecx])
        #   vfmadd213pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmadd213ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmadd213ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd213ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmadd213ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd213ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmadd213ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd213ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmadd213ph xmm0, xmm1, xmm2
        #   vfmadd213ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmadd213ph ymm0, ymm1, ymm2
        #   vfmadd213ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmadd213ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmadd213ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd213ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmadd213ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd213ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmadd213ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd213ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmadd213ps xmm0, xmm1, xmm2
        #   vfmadd213ps xmm0, xmm1, xmm2
        #   vfmadd213ps xmm0, xmm1, oword([ecx])
        #   vfmadd213ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmadd213ps ymm0, ymm1, ymm2
        #   vfmadd213ps ymm0, ymm1, ymm2
        #   vfmadd213ps ymm0, ymm1, yword([ecx])
        #   vfmadd213ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmadd213sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfmadd213sd xmm0, xmm1, xmm2
        #   vfmadd213sd xmm0, xmm1, xmm2
        #   vfmadd213sd xmm0, xmm1, qword([ecx])
        #   vfmadd213sd xmm0, xmm1, qword([ecx])
        ...
        #   vfmadd213ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmadd213ss xmm0, xmm1, xmm2
        #   vfmadd213ss xmm0, xmm1, xmm2
        #   vfmadd213ss xmm0, xmm1, dword([ecx])
        #   vfmadd213ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfmadd231pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmadd231pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd231pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmadd231pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd231pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmadd231pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd231pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmadd231pd xmm0, xmm1, xmm2
        #   vfmadd231pd xmm0, xmm1, xmm2
        #   vfmadd231pd xmm0, xmm1, oword([ecx])
        #   vfmadd231pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmadd231pd ymm0, ymm1, ymm2
        #   vfmadd231pd ymm0, ymm1, ymm2
        #   vfmadd231pd ymm0, ymm1, yword([ecx])
        #   vfmadd231pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmadd231ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmadd231ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd231ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmadd231ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd231ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmadd231ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd231ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmadd231ph xmm0, xmm1, xmm2
        #   vfmadd231ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmadd231ph ymm0, ymm1, ymm2
        #   vfmadd231ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmadd231ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmadd231ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmadd231ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmadd231ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmadd231ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmadd231ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmadd231ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmadd231ps xmm0, xmm1, xmm2
        #   vfmadd231ps xmm0, xmm1, xmm2
        #   vfmadd231ps xmm0, xmm1, oword([ecx])
        #   vfmadd231ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmadd231ps ymm0, ymm1, ymm2
        #   vfmadd231ps ymm0, ymm1, ymm2
        #   vfmadd231ps ymm0, ymm1, yword([ecx])
        #   vfmadd231ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmadd231sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfmadd231sd xmm0, xmm1, xmm2
        #   vfmadd231sd xmm0, xmm1, xmm2
        #   vfmadd231sd xmm0, xmm1, qword([ecx])
        #   vfmadd231sd xmm0, xmm1, qword([ecx])
        ...
        #   vfmadd231ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmadd231ss xmm0, xmm1, xmm2
        #   vfmadd231ss xmm0, xmm1, xmm2
        #   vfmadd231ss xmm0, xmm1, dword([ecx])
        #   vfmadd231ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfmaddcph opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddcph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddcph opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddcph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddcph opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmaddcph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddcph xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddcph xmm0, xmm1, xmm2
        #   vfmaddcph ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddcph ymm0, ymm1, ymm2
        #   vfmaddcph zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmaddcsh opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmaddcsh xmm0, xmm1, xmm2
        #   vfmaddcsh xmm0, xmm1, dword([ecx])
        ...
        #   vfmaddpd xmm0, xmm1, xmm2, oword([edx])
        #   vfmaddpd xmm0, xmm1, oword([ecx]), xmm3
        #   vfmaddpd ymm0, ymm1, ymm2, ymm3
        #   vfmaddpd ymm0, ymm1, ymm2, yword([edx])
        #   vfmaddpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmaddps xmm0, xmm1, xmm2, oword([edx])
        #   vfmaddps xmm0, xmm1, oword([ecx]), xmm3
        #   vfmaddps ymm0, ymm1, ymm2, ymm3
        #   vfmaddps ymm0, ymm1, ymm2, yword([edx])
        #   vfmaddps ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmaddsd xmm0, xmm1, xmm2, qword([edx])
        #   vfmaddsd xmm0, xmm1, qword([ecx]), xmm3
        ...
        #   vfmaddss xmm0, xmm1, xmm2, dword([edx])
        #   vfmaddss xmm0, xmm1, dword([ecx]), xmm3
        ...
        # @example
        #   vfmaddsub132pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmaddsub132pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub132pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmaddsub132pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub132pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmaddsub132pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub132pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmaddsub132pd xmm0, xmm1, xmm2
        #   vfmaddsub132pd xmm0, xmm1, xmm2
        #   vfmaddsub132pd xmm0, xmm1, oword([ecx])
        #   vfmaddsub132pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmaddsub132pd ymm0, ymm1, ymm2
        #   vfmaddsub132pd ymm0, ymm1, ymm2
        #   vfmaddsub132pd ymm0, ymm1, yword([ecx])
        #   vfmaddsub132pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmaddsub132ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmaddsub132ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub132ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmaddsub132ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub132ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmaddsub132ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub132ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmaddsub132ph xmm0, xmm1, xmm2
        #   vfmaddsub132ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmaddsub132ph ymm0, ymm1, ymm2
        #   vfmaddsub132ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmaddsub132ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddsub132ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub132ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddsub132ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub132ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmaddsub132ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub132ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddsub132ps xmm0, xmm1, xmm2
        #   vfmaddsub132ps xmm0, xmm1, xmm2
        #   vfmaddsub132ps xmm0, xmm1, oword([ecx])
        #   vfmaddsub132ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddsub132ps ymm0, ymm1, ymm2
        #   vfmaddsub132ps ymm0, ymm1, ymm2
        #   vfmaddsub132ps ymm0, ymm1, yword([ecx])
        #   vfmaddsub132ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vfmaddsub213pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmaddsub213pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub213pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmaddsub213pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub213pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmaddsub213pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub213pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmaddsub213pd xmm0, xmm1, xmm2
        #   vfmaddsub213pd xmm0, xmm1, xmm2
        #   vfmaddsub213pd xmm0, xmm1, oword([ecx])
        #   vfmaddsub213pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmaddsub213pd ymm0, ymm1, ymm2
        #   vfmaddsub213pd ymm0, ymm1, ymm2
        #   vfmaddsub213pd ymm0, ymm1, yword([ecx])
        #   vfmaddsub213pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmaddsub213ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmaddsub213ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub213ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmaddsub213ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub213ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmaddsub213ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub213ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmaddsub213ph xmm0, xmm1, xmm2
        #   vfmaddsub213ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmaddsub213ph ymm0, ymm1, ymm2
        #   vfmaddsub213ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmaddsub213ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddsub213ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub213ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddsub213ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub213ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmaddsub213ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub213ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddsub213ps xmm0, xmm1, xmm2
        #   vfmaddsub213ps xmm0, xmm1, xmm2
        #   vfmaddsub213ps xmm0, xmm1, oword([ecx])
        #   vfmaddsub213ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddsub213ps ymm0, ymm1, ymm2
        #   vfmaddsub213ps ymm0, ymm1, ymm2
        #   vfmaddsub213ps ymm0, ymm1, yword([ecx])
        #   vfmaddsub213ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vfmaddsub231pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmaddsub231pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub231pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmaddsub231pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub231pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmaddsub231pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub231pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmaddsub231pd xmm0, xmm1, xmm2
        #   vfmaddsub231pd xmm0, xmm1, xmm2
        #   vfmaddsub231pd xmm0, xmm1, oword([ecx])
        #   vfmaddsub231pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmaddsub231pd ymm0, ymm1, ymm2
        #   vfmaddsub231pd ymm0, ymm1, ymm2
        #   vfmaddsub231pd ymm0, ymm1, yword([ecx])
        #   vfmaddsub231pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmaddsub231ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmaddsub231ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub231ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmaddsub231ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub231ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmaddsub231ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub231ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmaddsub231ph xmm0, xmm1, xmm2
        #   vfmaddsub231ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmaddsub231ph ymm0, ymm1, ymm2
        #   vfmaddsub231ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmaddsub231ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddsub231ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmaddsub231ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddsub231ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmaddsub231ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmaddsub231ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmaddsub231ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmaddsub231ps xmm0, xmm1, xmm2
        #   vfmaddsub231ps xmm0, xmm1, xmm2
        #   vfmaddsub231ps xmm0, xmm1, oword([ecx])
        #   vfmaddsub231ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmaddsub231ps ymm0, ymm1, ymm2
        #   vfmaddsub231ps ymm0, ymm1, ymm2
        #   vfmaddsub231ps ymm0, ymm1, yword([ecx])
        #   vfmaddsub231ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmaddsubpd xmm0, xmm1, xmm2, oword([edx])
        #   vfmaddsubpd xmm0, xmm1, oword([ecx]), xmm3
        #   vfmaddsubpd ymm0, ymm1, ymm2, ymm3
        #   vfmaddsubpd ymm0, ymm1, ymm2, yword([edx])
        #   vfmaddsubpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmaddsubps xmm0, xmm1, xmm2, oword([edx])
        #   vfmaddsubps xmm0, xmm1, oword([ecx]), xmm3
        #   vfmaddsubps ymm0, ymm1, ymm2, ymm3
        #   vfmaddsubps ymm0, ymm1, ymm2, yword([edx])
        #   vfmaddsubps ymm0, ymm1, yword([ecx]), ymm3
        ...
        # @example
        #   vfmsub132pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsub132pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub132pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsub132pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub132pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmsub132pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub132pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsub132pd xmm0, xmm1, xmm2
        #   vfmsub132pd xmm0, xmm1, xmm2
        #   vfmsub132pd xmm0, xmm1, oword([ecx])
        #   vfmsub132pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsub132pd ymm0, ymm1, ymm2
        #   vfmsub132pd ymm0, ymm1, ymm2
        #   vfmsub132pd ymm0, ymm1, yword([ecx])
        #   vfmsub132pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmsub132ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsub132ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub132ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsub132ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub132ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmsub132ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub132ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsub132ph xmm0, xmm1, xmm2
        #   vfmsub132ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsub132ph ymm0, ymm1, ymm2
        #   vfmsub132ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmsub132ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsub132ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub132ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsub132ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub132ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmsub132ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub132ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsub132ps xmm0, xmm1, xmm2
        #   vfmsub132ps xmm0, xmm1, xmm2
        #   vfmsub132ps xmm0, xmm1, oword([ecx])
        #   vfmsub132ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsub132ps ymm0, ymm1, ymm2
        #   vfmsub132ps ymm0, ymm1, ymm2
        #   vfmsub132ps ymm0, ymm1, yword([ecx])
        #   vfmsub132ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmsub132sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfmsub132sd xmm0, xmm1, xmm2
        #   vfmsub132sd xmm0, xmm1, xmm2
        #   vfmsub132sd xmm0, xmm1, qword([ecx])
        #   vfmsub132sd xmm0, xmm1, qword([ecx])
        ...
        #   vfmsub132sh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vfmsub132sh xmm0, xmm1, xmm2
        #   vfmsub132sh xmm0, xmm1, word([ecx])
        ...
        #   vfmsub132ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmsub132ss xmm0, xmm1, xmm2
        #   vfmsub132ss xmm0, xmm1, xmm2
        #   vfmsub132ss xmm0, xmm1, dword([ecx])
        #   vfmsub132ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfmsub213pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsub213pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub213pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsub213pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub213pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmsub213pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub213pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsub213pd xmm0, xmm1, xmm2
        #   vfmsub213pd xmm0, xmm1, xmm2
        #   vfmsub213pd xmm0, xmm1, oword([ecx])
        #   vfmsub213pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsub213pd ymm0, ymm1, ymm2
        #   vfmsub213pd ymm0, ymm1, ymm2
        #   vfmsub213pd ymm0, ymm1, yword([ecx])
        #   vfmsub213pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmsub213ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsub213ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub213ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsub213ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub213ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmsub213ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub213ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsub213ph xmm0, xmm1, xmm2
        #   vfmsub213ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsub213ph ymm0, ymm1, ymm2
        #   vfmsub213ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmsub213ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsub213ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub213ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsub213ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub213ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmsub213ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub213ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsub213ps xmm0, xmm1, xmm2
        #   vfmsub213ps xmm0, xmm1, xmm2
        #   vfmsub213ps xmm0, xmm1, oword([ecx])
        #   vfmsub213ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsub213ps ymm0, ymm1, ymm2
        #   vfmsub213ps ymm0, ymm1, ymm2
        #   vfmsub213ps ymm0, ymm1, yword([ecx])
        #   vfmsub213ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmsub213sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfmsub213sd xmm0, xmm1, xmm2
        #   vfmsub213sd xmm0, xmm1, xmm2
        #   vfmsub213sd xmm0, xmm1, qword([ecx])
        #   vfmsub213sd xmm0, xmm1, qword([ecx])
        ...
        #   vfmsub213sh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vfmsub213sh xmm0, xmm1, xmm2
        #   vfmsub213sh xmm0, xmm1, word([ecx])
        ...
        #   vfmsub213ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmsub213ss xmm0, xmm1, xmm2
        #   vfmsub213ss xmm0, xmm1, xmm2
        #   vfmsub213ss xmm0, xmm1, dword([ecx])
        #   vfmsub213ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfmsub231pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsub231pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub231pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsub231pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub231pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmsub231pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub231pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsub231pd xmm0, xmm1, xmm2
        #   vfmsub231pd xmm0, xmm1, xmm2
        #   vfmsub231pd xmm0, xmm1, oword([ecx])
        #   vfmsub231pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsub231pd ymm0, ymm1, ymm2
        #   vfmsub231pd ymm0, ymm1, ymm2
        #   vfmsub231pd ymm0, ymm1, yword([ecx])
        #   vfmsub231pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmsub231ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsub231ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub231ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsub231ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub231ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmsub231ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub231ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsub231ph xmm0, xmm1, xmm2
        #   vfmsub231ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsub231ph ymm0, ymm1, ymm2
        #   vfmsub231ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmsub231ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsub231ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsub231ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsub231ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsub231ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmsub231ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsub231ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsub231ps xmm0, xmm1, xmm2
        #   vfmsub231ps xmm0, xmm1, xmm2
        #   vfmsub231ps xmm0, xmm1, oword([ecx])
        #   vfmsub231ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsub231ps ymm0, ymm1, ymm2
        #   vfmsub231ps ymm0, ymm1, ymm2
        #   vfmsub231ps ymm0, ymm1, yword([ecx])
        #   vfmsub231ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmsub231sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfmsub231sd xmm0, xmm1, xmm2
        #   vfmsub231sd xmm0, xmm1, xmm2
        #   vfmsub231sd xmm0, xmm1, qword([ecx])
        #   vfmsub231sd xmm0, xmm1, qword([ecx])
        ...
        #   vfmsub231sh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vfmsub231sh xmm0, xmm1, xmm2
        #   vfmsub231sh xmm0, xmm1, word([ecx])
        ...
        #   vfmsub231ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmsub231ss xmm0, xmm1, xmm2
        #   vfmsub231ss xmm0, xmm1, xmm2
        #   vfmsub231ss xmm0, xmm1, dword([ecx])
        #   vfmsub231ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfmsubadd132pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsubadd132pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd132pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsubadd132pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd132pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmsubadd132pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd132pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsubadd132pd xmm0, xmm1, xmm2
        #   vfmsubadd132pd xmm0, xmm1, xmm2
        #   vfmsubadd132pd xmm0, xmm1, oword([ecx])
        #   vfmsubadd132pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsubadd132pd ymm0, ymm1, ymm2
        #   vfmsubadd132pd ymm0, ymm1, ymm2
        #   vfmsubadd132pd ymm0, ymm1, yword([ecx])
        #   vfmsubadd132pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmsubadd132ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsubadd132ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd132ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsubadd132ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd132ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmsubadd132ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd132ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsubadd132ph xmm0, xmm1, xmm2
        #   vfmsubadd132ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsubadd132ph ymm0, ymm1, ymm2
        #   vfmsubadd132ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmsubadd132ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsubadd132ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd132ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsubadd132ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd132ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmsubadd132ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd132ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsubadd132ps xmm0, xmm1, xmm2
        #   vfmsubadd132ps xmm0, xmm1, xmm2
        #   vfmsubadd132ps xmm0, xmm1, oword([ecx])
        #   vfmsubadd132ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsubadd132ps ymm0, ymm1, ymm2
        #   vfmsubadd132ps ymm0, ymm1, ymm2
        #   vfmsubadd132ps ymm0, ymm1, yword([ecx])
        #   vfmsubadd132ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vfmsubadd213pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsubadd213pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd213pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsubadd213pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd213pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmsubadd213pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd213pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsubadd213pd xmm0, xmm1, xmm2
        #   vfmsubadd213pd xmm0, xmm1, xmm2
        #   vfmsubadd213pd xmm0, xmm1, oword([ecx])
        #   vfmsubadd213pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsubadd213pd ymm0, ymm1, ymm2
        #   vfmsubadd213pd ymm0, ymm1, ymm2
        #   vfmsubadd213pd ymm0, ymm1, yword([ecx])
        #   vfmsubadd213pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmsubadd213ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsubadd213ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd213ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsubadd213ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd213ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmsubadd213ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd213ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsubadd213ph xmm0, xmm1, xmm2
        #   vfmsubadd213ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsubadd213ph ymm0, ymm1, ymm2
        #   vfmsubadd213ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmsubadd213ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsubadd213ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd213ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsubadd213ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd213ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmsubadd213ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd213ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsubadd213ps xmm0, xmm1, xmm2
        #   vfmsubadd213ps xmm0, xmm1, xmm2
        #   vfmsubadd213ps xmm0, xmm1, oword([ecx])
        #   vfmsubadd213ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsubadd213ps ymm0, ymm1, ymm2
        #   vfmsubadd213ps ymm0, ymm1, ymm2
        #   vfmsubadd213ps ymm0, ymm1, yword([ecx])
        #   vfmsubadd213ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vfmsubadd231pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsubadd231pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd231pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsubadd231pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd231pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfmsubadd231pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd231pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfmsubadd231pd xmm0, xmm1, xmm2
        #   vfmsubadd231pd xmm0, xmm1, xmm2
        #   vfmsubadd231pd xmm0, xmm1, oword([ecx])
        #   vfmsubadd231pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfmsubadd231pd ymm0, ymm1, ymm2
        #   vfmsubadd231pd ymm0, ymm1, ymm2
        #   vfmsubadd231pd ymm0, ymm1, yword([ecx])
        #   vfmsubadd231pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfmsubadd231ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsubadd231ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd231ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsubadd231ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd231ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfmsubadd231ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd231ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfmsubadd231ph xmm0, xmm1, xmm2
        #   vfmsubadd231ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfmsubadd231ph ymm0, ymm1, ymm2
        #   vfmsubadd231ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfmsubadd231ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsubadd231ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmsubadd231ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsubadd231ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmsubadd231ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmsubadd231ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmsubadd231ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmsubadd231ps xmm0, xmm1, xmm2
        #   vfmsubadd231ps xmm0, xmm1, xmm2
        #   vfmsubadd231ps xmm0, xmm1, oword([ecx])
        #   vfmsubadd231ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmsubadd231ps ymm0, ymm1, ymm2
        #   vfmsubadd231ps ymm0, ymm1, ymm2
        #   vfmsubadd231ps ymm0, ymm1, yword([ecx])
        #   vfmsubadd231ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmsubaddpd xmm0, xmm1, xmm2, oword([edx])
        #   vfmsubaddpd xmm0, xmm1, oword([ecx]), xmm3
        #   vfmsubaddpd ymm0, ymm1, ymm2, ymm3
        #   vfmsubaddpd ymm0, ymm1, ymm2, yword([edx])
        #   vfmsubaddpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmsubaddps xmm0, xmm1, xmm2, oword([edx])
        #   vfmsubaddps xmm0, xmm1, oword([ecx]), xmm3
        #   vfmsubaddps ymm0, ymm1, ymm2, ymm3
        #   vfmsubaddps ymm0, ymm1, ymm2, yword([edx])
        #   vfmsubaddps ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmsubpd xmm0, xmm1, xmm2, oword([edx])
        #   vfmsubpd xmm0, xmm1, oword([ecx]), xmm3
        #   vfmsubpd ymm0, ymm1, ymm2, ymm3
        #   vfmsubpd ymm0, ymm1, ymm2, yword([edx])
        #   vfmsubpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmsubps xmm0, xmm1, xmm2, oword([edx])
        #   vfmsubps xmm0, xmm1, oword([ecx]), xmm3
        #   vfmsubps ymm0, ymm1, ymm2, ymm3
        #   vfmsubps ymm0, ymm1, ymm2, yword([edx])
        #   vfmsubps ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfmsubsd xmm0, xmm1, xmm2, qword([edx])
        #   vfmsubsd xmm0, xmm1, qword([ecx]), xmm3
        ...
        #   vfmsubss xmm0, xmm1, xmm2, dword([edx])
        #   vfmsubss xmm0, xmm1, dword([ecx]), xmm3
        ...
        # @example
        #   vfmulcph opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmulcph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfmulcph opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmulcph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfmulcph opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfmulcph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfmulcph xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfmulcph xmm0, xmm1, xmm2
        #   vfmulcph ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfmulcph ymm0, ymm1, ymm2
        #   vfmulcph zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfmulcsh opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfmulcsh xmm0, xmm1, xmm2
        #   vfmulcsh xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfnmadd132pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmadd132pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd132pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmadd132pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd132pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfnmadd132pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd132pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmadd132pd xmm0, xmm1, xmm2
        #   vfnmadd132pd xmm0, xmm1, xmm2
        #   vfnmadd132pd xmm0, xmm1, oword([ecx])
        #   vfnmadd132pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmadd132pd ymm0, ymm1, ymm2
        #   vfnmadd132pd ymm0, ymm1, ymm2
        #   vfnmadd132pd ymm0, ymm1, yword([ecx])
        #   vfnmadd132pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfnmadd132ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmadd132ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd132ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmadd132ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd132ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfnmadd132ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd132ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmadd132ph xmm0, xmm1, xmm2
        #   vfnmadd132ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmadd132ph ymm0, ymm1, ymm2
        #   vfnmadd132ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfnmadd132ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmadd132ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd132ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmadd132ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd132ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfnmadd132ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd132ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmadd132ps xmm0, xmm1, xmm2
        #   vfnmadd132ps xmm0, xmm1, xmm2
        #   vfnmadd132ps xmm0, xmm1, oword([ecx])
        #   vfnmadd132ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmadd132ps ymm0, ymm1, ymm2
        #   vfnmadd132ps ymm0, ymm1, ymm2
        #   vfnmadd132ps ymm0, ymm1, yword([ecx])
        #   vfnmadd132ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfnmadd132sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfnmadd132sd xmm0, xmm1, xmm2
        #   vfnmadd132sd xmm0, xmm1, xmm2
        #   vfnmadd132sd xmm0, xmm1, qword([ecx])
        #   vfnmadd132sd xmm0, xmm1, qword([ecx])
        ...
        #   vfnmadd132ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfnmadd132ss xmm0, xmm1, xmm2
        #   vfnmadd132ss xmm0, xmm1, xmm2
        #   vfnmadd132ss xmm0, xmm1, dword([ecx])
        #   vfnmadd132ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfnmadd213pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmadd213pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd213pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmadd213pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd213pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfnmadd213pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd213pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmadd213pd xmm0, xmm1, xmm2
        #   vfnmadd213pd xmm0, xmm1, xmm2
        #   vfnmadd213pd xmm0, xmm1, oword([ecx])
        #   vfnmadd213pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmadd213pd ymm0, ymm1, ymm2
        #   vfnmadd213pd ymm0, ymm1, ymm2
        #   vfnmadd213pd ymm0, ymm1, yword([ecx])
        #   vfnmadd213pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfnmadd213ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmadd213ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd213ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmadd213ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd213ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfnmadd213ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd213ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmadd213ph xmm0, xmm1, xmm2
        #   vfnmadd213ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmadd213ph ymm0, ymm1, ymm2
        #   vfnmadd213ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfnmadd213ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmadd213ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd213ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmadd213ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd213ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfnmadd213ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd213ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmadd213ps xmm0, xmm1, xmm2
        #   vfnmadd213ps xmm0, xmm1, xmm2
        #   vfnmadd213ps xmm0, xmm1, oword([ecx])
        #   vfnmadd213ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmadd213ps ymm0, ymm1, ymm2
        #   vfnmadd213ps ymm0, ymm1, ymm2
        #   vfnmadd213ps ymm0, ymm1, yword([ecx])
        #   vfnmadd213ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfnmadd213sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfnmadd213sd xmm0, xmm1, xmm2
        #   vfnmadd213sd xmm0, xmm1, xmm2
        #   vfnmadd213sd xmm0, xmm1, qword([ecx])
        #   vfnmadd213sd xmm0, xmm1, qword([ecx])
        ...
        #   vfnmadd213ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfnmadd213ss xmm0, xmm1, xmm2
        #   vfnmadd213ss xmm0, xmm1, xmm2
        #   vfnmadd213ss xmm0, xmm1, dword([ecx])
        #   vfnmadd213ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfnmadd231pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmadd231pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd231pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmadd231pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd231pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfnmadd231pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd231pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmadd231pd xmm0, xmm1, xmm2
        #   vfnmadd231pd xmm0, xmm1, xmm2
        #   vfnmadd231pd xmm0, xmm1, oword([ecx])
        #   vfnmadd231pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmadd231pd ymm0, ymm1, ymm2
        #   vfnmadd231pd ymm0, ymm1, ymm2
        #   vfnmadd231pd ymm0, ymm1, yword([ecx])
        #   vfnmadd231pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfnmadd231ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmadd231ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd231ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmadd231ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd231ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfnmadd231ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd231ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmadd231ph xmm0, xmm1, xmm2
        #   vfnmadd231ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmadd231ph ymm0, ymm1, ymm2
        #   vfnmadd231ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfnmadd231ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmadd231ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmadd231ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmadd231ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmadd231ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfnmadd231ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmadd231ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmadd231ps xmm0, xmm1, xmm2
        #   vfnmadd231ps xmm0, xmm1, xmm2
        #   vfnmadd231ps xmm0, xmm1, oword([ecx])
        #   vfnmadd231ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmadd231ps ymm0, ymm1, ymm2
        #   vfnmadd231ps ymm0, ymm1, ymm2
        #   vfnmadd231ps ymm0, ymm1, yword([ecx])
        #   vfnmadd231ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfnmadd231sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfnmadd231sd xmm0, xmm1, xmm2
        #   vfnmadd231sd xmm0, xmm1, xmm2
        #   vfnmadd231sd xmm0, xmm1, qword([ecx])
        #   vfnmadd231sd xmm0, xmm1, qword([ecx])
        ...
        #   vfnmadd231ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfnmadd231ss xmm0, xmm1, xmm2
        #   vfnmadd231ss xmm0, xmm1, xmm2
        #   vfnmadd231ss xmm0, xmm1, dword([ecx])
        #   vfnmadd231ss xmm0, xmm1, dword([ecx])
        ...
        #   vfnmaddpd xmm0, xmm1, xmm2, oword([edx])
        #   vfnmaddpd xmm0, xmm1, oword([ecx]), xmm3
        #   vfnmaddpd ymm0, ymm1, ymm2, ymm3
        #   vfnmaddpd ymm0, ymm1, ymm2, yword([edx])
        #   vfnmaddpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfnmaddps xmm0, xmm1, xmm2, oword([edx])
        #   vfnmaddps xmm0, xmm1, oword([ecx]), xmm3
        #   vfnmaddps ymm0, ymm1, ymm2, ymm3
        #   vfnmaddps ymm0, ymm1, ymm2, yword([edx])
        #   vfnmaddps ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfnmaddsd xmm0, xmm1, xmm2, qword([edx])
        #   vfnmaddsd xmm0, xmm1, qword([ecx]), xmm3
        ...
        #   vfnmaddss xmm0, xmm1, xmm2, dword([edx])
        #   vfnmaddss xmm0, xmm1, dword([ecx]), xmm3
        ...
        # @example
        #   vfnmsub132pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmsub132pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub132pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmsub132pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub132pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfnmsub132pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub132pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmsub132pd xmm0, xmm1, xmm2
        #   vfnmsub132pd xmm0, xmm1, xmm2
        #   vfnmsub132pd xmm0, xmm1, oword([ecx])
        #   vfnmsub132pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmsub132pd ymm0, ymm1, ymm2
        #   vfnmsub132pd ymm0, ymm1, ymm2
        #   vfnmsub132pd ymm0, ymm1, yword([ecx])
        #   vfnmsub132pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfnmsub132ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmsub132ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub132ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmsub132ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub132ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfnmsub132ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub132ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmsub132ph xmm0, xmm1, xmm2
        #   vfnmsub132ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmsub132ph ymm0, ymm1, ymm2
        #   vfnmsub132ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfnmsub132ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmsub132ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub132ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmsub132ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub132ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfnmsub132ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub132ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmsub132ps xmm0, xmm1, xmm2
        #   vfnmsub132ps xmm0, xmm1, xmm2
        #   vfnmsub132ps xmm0, xmm1, oword([ecx])
        #   vfnmsub132ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmsub132ps ymm0, ymm1, ymm2
        #   vfnmsub132ps ymm0, ymm1, ymm2
        #   vfnmsub132ps ymm0, ymm1, yword([ecx])
        #   vfnmsub132ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfnmsub132sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfnmsub132sd xmm0, xmm1, xmm2
        #   vfnmsub132sd xmm0, xmm1, xmm2
        #   vfnmsub132sd xmm0, xmm1, qword([ecx])
        #   vfnmsub132sd xmm0, xmm1, qword([ecx])
        ...
        #   vfnmsub132sh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vfnmsub132sh xmm0, xmm1, xmm2
        #   vfnmsub132sh xmm0, xmm1, word([ecx])
        ...
        #   vfnmsub132ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfnmsub132ss xmm0, xmm1, xmm2
        #   vfnmsub132ss xmm0, xmm1, xmm2
        #   vfnmsub132ss xmm0, xmm1, dword([ecx])
        #   vfnmsub132ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfnmsub213pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmsub213pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub213pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmsub213pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub213pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfnmsub213pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub213pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmsub213pd xmm0, xmm1, xmm2
        #   vfnmsub213pd xmm0, xmm1, xmm2
        #   vfnmsub213pd xmm0, xmm1, oword([ecx])
        #   vfnmsub213pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmsub213pd ymm0, ymm1, ymm2
        #   vfnmsub213pd ymm0, ymm1, ymm2
        #   vfnmsub213pd ymm0, ymm1, yword([ecx])
        #   vfnmsub213pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfnmsub213ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmsub213ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub213ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmsub213ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub213ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfnmsub213ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub213ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmsub213ph xmm0, xmm1, xmm2
        #   vfnmsub213ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmsub213ph ymm0, ymm1, ymm2
        #   vfnmsub213ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfnmsub213ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmsub213ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub213ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmsub213ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub213ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfnmsub213ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub213ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmsub213ps xmm0, xmm1, xmm2
        #   vfnmsub213ps xmm0, xmm1, xmm2
        #   vfnmsub213ps xmm0, xmm1, oword([ecx])
        #   vfnmsub213ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmsub213ps ymm0, ymm1, ymm2
        #   vfnmsub213ps ymm0, ymm1, ymm2
        #   vfnmsub213ps ymm0, ymm1, yword([ecx])
        #   vfnmsub213ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfnmsub213sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfnmsub213sd xmm0, xmm1, xmm2
        #   vfnmsub213sd xmm0, xmm1, xmm2
        #   vfnmsub213sd xmm0, xmm1, qword([ecx])
        #   vfnmsub213sd xmm0, xmm1, qword([ecx])
        ...
        #   vfnmsub213sh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vfnmsub213sh xmm0, xmm1, xmm2
        #   vfnmsub213sh xmm0, xmm1, word([ecx])
        ...
        #   vfnmsub213ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfnmsub213ss xmm0, xmm1, xmm2
        #   vfnmsub213ss xmm0, xmm1, xmm2
        #   vfnmsub213ss xmm0, xmm1, dword([ecx])
        #   vfnmsub213ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vfnmsub231pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmsub231pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub231pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmsub231pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub231pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vfnmsub231pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub231pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vfnmsub231pd xmm0, xmm1, xmm2
        #   vfnmsub231pd xmm0, xmm1, xmm2
        #   vfnmsub231pd xmm0, xmm1, oword([ecx])
        #   vfnmsub231pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vfnmsub231pd ymm0, ymm1, ymm2
        #   vfnmsub231pd ymm0, ymm1, ymm2
        #   vfnmsub231pd ymm0, ymm1, yword([ecx])
        #   vfnmsub231pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vfnmsub231ph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmsub231ph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub231ph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmsub231ph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub231ph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vfnmsub231ph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub231ph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vfnmsub231ph xmm0, xmm1, xmm2
        #   vfnmsub231ph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vfnmsub231ph ymm0, ymm1, ymm2
        #   vfnmsub231ph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vfnmsub231ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmsub231ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vfnmsub231ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmsub231ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vfnmsub231ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vfnmsub231ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vfnmsub231ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vfnmsub231ps xmm0, xmm1, xmm2
        #   vfnmsub231ps xmm0, xmm1, xmm2
        #   vfnmsub231ps xmm0, xmm1, oword([ecx])
        #   vfnmsub231ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vfnmsub231ps ymm0, ymm1, ymm2
        #   vfnmsub231ps ymm0, ymm1, ymm2
        #   vfnmsub231ps ymm0, ymm1, yword([ecx])
        #   vfnmsub231ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vfnmsub231sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vfnmsub231sd xmm0, xmm1, xmm2
        #   vfnmsub231sd xmm0, xmm1, xmm2
        #   vfnmsub231sd xmm0, xmm1, qword([ecx])
        #   vfnmsub231sd xmm0, xmm1, qword([ecx])
        ...
        #   vfnmsub231sh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vfnmsub231sh xmm0, xmm1, xmm2
        #   vfnmsub231sh xmm0, xmm1, word([ecx])
        ...
        #   vfnmsub231ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vfnmsub231ss xmm0, xmm1, xmm2
        #   vfnmsub231ss xmm0, xmm1, xmm2
        #   vfnmsub231ss xmm0, xmm1, dword([ecx])
        #   vfnmsub231ss xmm0, xmm1, dword([ecx])
        ...
        #   vfnmsubpd xmm0, xmm1, xmm2, oword([edx])
        #   vfnmsubpd xmm0, xmm1, oword([ecx]), xmm3
        #   vfnmsubpd ymm0, ymm1, ymm2, ymm3
        #   vfnmsubpd ymm0, ymm1, ymm2, yword([edx])
        #   vfnmsubpd ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfnmsubps xmm0, xmm1, xmm2, oword([edx])
        #   vfnmsubps xmm0, xmm1, oword([ecx]), xmm3
        #   vfnmsubps ymm0, ymm1, ymm2, ymm3
        #   vfnmsubps ymm0, ymm1, ymm2, yword([edx])
        #   vfnmsubps ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vfnmsubsd xmm0, xmm1, xmm2, qword([edx])
        #   vfnmsubsd xmm0, xmm1, qword([ecx]), xmm3
        ...
        #   vfnmsubss xmm0, xmm1, xmm2, dword([edx])
        #   vfnmsubss xmm0, xmm1, dword([ecx]), xmm3
        ...
        # @example
        #   vfpclasspd opmask(k1, k2), bcst(qword([ebx]), {1=>2}), 0x03
        #   vfpclasspd k1, bcst(qword([ebx]), {1=>2}), 0x03
        #   vfpclasspd opmask(k1, k2), bcst(qword([ebx]), {1=>4}), 0x03
        #   vfpclasspd k1, bcst(qword([ebx]), {1=>4}), 0x03
        #   vfpclasspd opmask(k1, k2), bcst(qword([ebx]), {1=>8}), 0x03
        #   vfpclasspd k1, bcst(qword([ebx]), {1=>8}), 0x03
        ...
        # @example
        #   vfpclassph opmask(k1, k2), bcst(word([ebx]), {1=>8}), 0x03
        #   vfpclassph k1, bcst(word([ebx]), {1=>8}), 0x03
        #   vfpclassph opmask(k1, k2), bcst(word([ebx]), {1=>16}), 0x03
        #   vfpclassph k1, bcst(word([ebx]), {1=>16}), 0x03
        #   vfpclassph opmask(k1, k2), bcst(word([ebx]), {1=>32}), 0x03
        #   vfpclassph k1, bcst(word([ebx]), {1=>32}), 0x03
        ...
        # @example
        #   vfpclassps opmask(k1, k2), bcst(dword([ebx]), {1=>4}), 0x03
        #   vfpclassps k1, bcst(dword([ebx]), {1=>4}), 0x03
        #   vfpclassps opmask(k1, k2), bcst(dword([ebx]), {1=>8}), 0x03
        #   vfpclassps k1, bcst(dword([ebx]), {1=>8}), 0x03
        #   vfpclassps opmask(k1, k2), bcst(dword([ebx]), {1=>16}), 0x03
        #   vfpclassps k1, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vfpclasssd opmask(k1, k2), qword([ebx]), 0x03
        #   vfpclasssd k1, qword([ebx]), 0x03
        ...
        #   vfpclasssh opmask(k1, k2), word([ebx]), 0x03
        #   vfpclasssh k1, word([ebx]), 0x03
        ...
        #   vfpclassss opmask(k1, k2), dword([ebx]), 0x03
        #   vfpclassss k1, dword([ebx]), 0x03
        ...
        # @example
        #   vfrczpd xmm0, xmm1
        #   vfrczpd xmm0, oword([ebx])
        #   vfrczpd ymm0, ymm1
        #   vfrczpd ymm0, yword([ebx])
        ...
        # @example
        #   vfrczps xmm0, xmm1
        #   vfrczps xmm0, oword([ebx])
        #   vfrczps ymm0, ymm1
        #   vfrczps ymm0, yword([ebx])
        ...
        # @example
        #   vgatherdpd opmask(xmm0, k1), dword([ebx+xmm1*4])
        #   vgatherdpd opmask(ymm0, k1), dword([ebx+xmm1*4])
        #   vgatherdpd opmask(zmm0, k1), dword([ebx+ymm1*4])
        #   vgatherdpd xmm0, dword([ebx+xmm1*4]), xmm2
        #   vgatherdpd ymm0, dword([ebx+xmm1*4]), ymm2
        ...
        # @example
        #   vgatherdps opmask(xmm0, k1), dword([ebx+xmm1*4])
        #   vgatherdps opmask(ymm0, k1), dword([ebx+ymm1*4])
        #   vgatherdps opmask(zmm0, k1), dword([ebx+zmm1*4])
        #   vgatherdps xmm0, dword([ebx+xmm1*4]), xmm2
        #   vgatherdps ymm0, dword([ebx+ymm1*4]), ymm2
        ...
        # @example
        #   vgatherpf0dpd opmask(dword([eax+ymm0*4]), k1)
        ...
        # @example
        #   vgatherpf0dps opmask(dword([eax+zmm0*4]), k1)
        ...
        # @example
        #   vgatherpf0qpd opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vgatherpf0qps opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vgatherpf1dpd opmask(dword([eax+ymm0*4]), k1)
        ...
        # @example
        #   vgatherpf1dps opmask(dword([eax+zmm0*4]), k1)
        ...
        # @example
        #   vgatherpf1qpd opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vgatherpf1qps opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vgatherqpd opmask(xmm0, k1), qword([ebx+xmm1*8])
        #   vgatherqpd opmask(ymm0, k1), qword([ebx+ymm1*8])
        #   vgatherqpd opmask(zmm0, k1), qword([ebx+zmm1*8])
        #   vgatherqpd xmm0, qword([ebx+xmm1*8]), xmm2
        #   vgatherqpd ymm0, qword([ebx+ymm1*8]), ymm2
        ...
        # @example
        #   vgatherqps opmask(xmm0, k1), qword([ebx+xmm1*8])
        #   vgatherqps opmask(xmm0, k1), qword([ebx+ymm1*8])
        #   vgatherqps opmask(ymm0, k1), qword([ebx+zmm1*8])
        #   vgatherqps xmm0, qword([ebx+xmm1*8]), xmm2
        #   vgatherqps xmm0, qword([ebx+ymm1*8]), xmm2
        ...
        # @example
        #   vgetexppd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vgetexppd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vgetexppd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vgetexppd opmask(xmm0, k1, zero: true), xmm1
        #   vgetexppd opmask(ymm0, k1, zero: true), ymm1
        #   vgetexppd opmask(zmm0, k1, zero: true), zmm1
        #   vgetexppd xmm0, bcst(qword([ebx]), {1=>2})
        #   vgetexppd xmm0, xmm1
        #   vgetexppd ymm0, bcst(qword([ebx]), {1=>4})
        #   vgetexppd ymm0, ymm1
        #   vgetexppd zmm0, bcst(qword([ebx]), {1=>8})
        #   vgetexppd zmm0, zmm1
        ...
        # @example
        #   vgetexpph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vgetexpph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vgetexpph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vgetexpph opmask(xmm0, k1, zero: true), xmm1
        #   vgetexpph opmask(ymm0, k1, zero: true), ymm1
        #   vgetexpph opmask(zmm0, k1, zero: true), zmm1
        #   vgetexpph xmm0, bcst(word([ebx]), {1=>8})
        #   vgetexpph xmm0, xmm1
        #   vgetexpph ymm0, bcst(word([ebx]), {1=>16})
        #   vgetexpph ymm0, ymm1
        #   vgetexpph zmm0, bcst(word([ebx]), {1=>32})
        #   vgetexpph zmm0, zmm1
        ...
        # @example
        #   vgetexpps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vgetexpps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vgetexpps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vgetexpps opmask(xmm0, k1, zero: true), xmm1
        #   vgetexpps opmask(ymm0, k1, zero: true), ymm1
        #   vgetexpps opmask(zmm0, k1, zero: true), zmm1
        #   vgetexpps xmm0, bcst(dword([ebx]), {1=>4})
        #   vgetexpps xmm0, xmm1
        #   vgetexpps ymm0, bcst(dword([ebx]), {1=>8})
        #   vgetexpps ymm0, ymm1
        #   vgetexpps zmm0, bcst(dword([ebx]), {1=>16})
        #   vgetexpps zmm0, zmm1
        ...
        #   vgetexpsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vgetexpsd xmm0, xmm1, xmm2
        #   vgetexpsd xmm0, xmm1, qword([ecx])
        ...
        #   vgetexpsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vgetexpsh xmm0, xmm1, xmm2
        #   vgetexpsh xmm0, xmm1, word([ecx])
        ...
        #   vgetexpss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vgetexpss xmm0, xmm1, xmm2
        #   vgetexpss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vgetmantpd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vgetmantpd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vgetmantpd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        ...
        #   vgetmantpd xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vgetmantpd xmm0, xmm1, 0x03
        #   vgetmantpd ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vgetmantpd ymm0, ymm1, 0x03
        #   vgetmantpd zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        ...
        # @example
        #   vgetmantph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8}), 0x03
        #   vgetmantph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16}), 0x03
        #   vgetmantph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32}), 0x03
        ...
        #   vgetmantph xmm0, bcst(word([ebx]), {1=>8}), 0x03
        #   vgetmantph xmm0, xmm1, 0x03
        #   vgetmantph ymm0, bcst(word([ebx]), {1=>16}), 0x03
        #   vgetmantph ymm0, ymm1, 0x03
        #   vgetmantph zmm0, bcst(word([ebx]), {1=>32}), 0x03
        ...
        # @example
        #   vgetmantps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vgetmantps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vgetmantps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vgetmantps xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vgetmantps xmm0, xmm1, 0x03
        #   vgetmantps ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vgetmantps ymm0, ymm1, 0x03
        #   vgetmantps zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vgetmantsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx]), 0x04
        #   vgetmantsd xmm0, xmm1, xmm2, 0x04
        #   vgetmantsd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vgetmantsh opmask(xmm0, k1, zero: true), xmm1, word([ecx]), 0x04
        #   vgetmantsh xmm0, xmm1, xmm2, 0x04
        #   vgetmantsh xmm0, xmm1, word([ecx]), 0x04
        ...
        #   vgetmantss opmask(xmm0, k1, zero: true), xmm1, dword([ecx]), 0x04
        #   vgetmantss xmm0, xmm1, xmm2, 0x04
        #   vgetmantss xmm0, xmm1, dword([ecx]), 0x04
        ...
        # @example
        #   vgf2p8affineinvqb opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vgf2p8affineinvqb opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vgf2p8affineinvqb opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vgf2p8affineinvqb opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vgf2p8affineinvqb opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vgf2p8affineinvqb opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vgf2p8affineinvqb xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vgf2p8affineinvqb xmm0, xmm1, xmm2, 0x04
        #   vgf2p8affineinvqb xmm0, xmm1, xmm2, 0x04
        #   vgf2p8affineinvqb xmm0, xmm1, oword([ecx]), 0x04
        #   vgf2p8affineinvqb ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vgf2p8affineinvqb ymm0, ymm1, ymm2, 0x04
        #   vgf2p8affineinvqb ymm0, ymm1, ymm2, 0x04
        #   vgf2p8affineinvqb ymm0, ymm1, yword([ecx]), 0x04
        #   vgf2p8affineinvqb zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vgf2p8affineqb opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vgf2p8affineqb opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vgf2p8affineqb opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vgf2p8affineqb opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vgf2p8affineqb opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vgf2p8affineqb opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vgf2p8affineqb xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vgf2p8affineqb xmm0, xmm1, xmm2, 0x04
        #   vgf2p8affineqb xmm0, xmm1, xmm2, 0x04
        #   vgf2p8affineqb xmm0, xmm1, oword([ecx]), 0x04
        #   vgf2p8affineqb ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vgf2p8affineqb ymm0, ymm1, ymm2, 0x04
        #   vgf2p8affineqb ymm0, ymm1, ymm2, 0x04
        #   vgf2p8affineqb ymm0, ymm1, yword([ecx]), 0x04
        #   vgf2p8affineqb zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        #   vgf2p8mulb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vgf2p8mulb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vgf2p8mulb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vgf2p8mulb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vgf2p8mulb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vgf2p8mulb xmm0, xmm1, xmm2
        #   vgf2p8mulb xmm0, xmm1, xmm2
        #   vgf2p8mulb xmm0, xmm1, oword([ecx])
        #   vgf2p8mulb xmm0, xmm1, oword([ecx])
        #   vgf2p8mulb ymm0, ymm1, ymm2
        #   vgf2p8mulb ymm0, ymm1, ymm2
        #   vgf2p8mulb ymm0, ymm1, yword([ecx])
        #   vgf2p8mulb ymm0, ymm1, yword([ecx])
        #   vgf2p8mulb zmm0, zmm1, zmm2
        #   vgf2p8mulb zmm0, zmm1, zword([ecx])
        ...
        #   vhaddpd xmm0, xmm1, oword([ecx])
        #   vhaddpd ymm0, ymm1, ymm2
        #   vhaddpd ymm0, ymm1, yword([ecx])
        ...
        #   vhaddps xmm0, xmm1, oword([ecx])
        #   vhaddps ymm0, ymm1, ymm2
        #   vhaddps ymm0, ymm1, yword([ecx])
        ...
        #   vhsubpd xmm0, xmm1, oword([ecx])
        #   vhsubpd ymm0, ymm1, ymm2
        #   vhsubpd ymm0, ymm1, yword([ecx])
        ...
        #   vhsubps xmm0, xmm1, oword([ecx])
        #   vhsubps ymm0, ymm1, ymm2
        #   vhsubps ymm0, ymm1, yword([ecx])
        ...
        #   vinsertf128 ymm0, ymm1, oword([ecx]), 0x04
        ...
        #   vinsertf32x4 opmask(ymm0, k1, zero: true), ymm1, oword([ecx]), 0x04
        #   vinsertf32x4 opmask(zmm0, k1, zero: true), zmm1, xmm2, 0x04
        #   vinsertf32x4 opmask(zmm0, k1, zero: true), zmm1, oword([ecx]), 0x04
        #   vinsertf32x4 ymm0, ymm1, xmm2, 0x04
        #   vinsertf32x4 ymm0, ymm1, oword([ecx]), 0x04
        #   vinsertf32x4 zmm0, zmm1, xmm2, 0x04
        #   vinsertf32x4 zmm0, zmm1, oword([ecx]), 0x04
        ...
        #   vinsertf32x8 opmask(zmm0, k1, zero: true), zmm1, yword([ecx]), 0x04
        #   vinsertf32x8 zmm0, zmm1, ymm2, 0x04
        #   vinsertf32x8 zmm0, zmm1, yword([ecx]), 0x04
        ...
        #   vinsertf64x2 opmask(ymm0, k1, zero: true), ymm1, oword([ecx]), 0x04
        #   vinsertf64x2 opmask(zmm0, k1, zero: true), zmm1, xmm2, 0x04
        #   vinsertf64x2 opmask(zmm0, k1, zero: true), zmm1, oword([ecx]), 0x04
        #   vinsertf64x2 ymm0, ymm1, xmm2, 0x04
        #   vinsertf64x2 ymm0, ymm1, oword([ecx]), 0x04
        #   vinsertf64x2 zmm0, zmm1, xmm2, 0x04
        #   vinsertf64x2 zmm0, zmm1, oword([ecx]), 0x04
        ...
        #   vinsertf64x4 opmask(zmm0, k1, zero: true), zmm1, yword([ecx]), 0x04
        #   vinsertf64x4 zmm0, zmm1, ymm2, 0x04
        #   vinsertf64x4 zmm0, zmm1, yword([ecx]), 0x04
        ...
        #   vinserti128 ymm0, ymm1, oword([ecx]), 0x04
        ...
        #   vinserti32x4 opmask(ymm0, k1, zero: true), ymm1, oword([ecx]), 0x04
        #   vinserti32x4 opmask(zmm0, k1, zero: true), zmm1, xmm2, 0x04
        #   vinserti32x4 opmask(zmm0, k1, zero: true), zmm1, oword([ecx]), 0x04
        #   vinserti32x4 ymm0, ymm1, xmm2, 0x04
        #   vinserti32x4 ymm0, ymm1, oword([ecx]), 0x04
        #   vinserti32x4 zmm0, zmm1, xmm2, 0x04
        #   vinserti32x4 zmm0, zmm1, oword([ecx]), 0x04
        ...
        #   vinserti32x8 opmask(zmm0, k1, zero: true), zmm1, yword([ecx]), 0x04
        #   vinserti32x8 zmm0, zmm1, ymm2, 0x04
        #   vinserti32x8 zmm0, zmm1, yword([ecx]), 0x04
        ...
        #   vinserti64x2 opmask(ymm0, k1, zero: true), ymm1, oword([ecx]), 0x04
        #   vinserti64x2 opmask(zmm0, k1, zero: true), zmm1, xmm2, 0x04
        #   vinserti64x2 opmask(zmm0, k1, zero: true), zmm1, oword([ecx]), 0x04
        #   vinserti64x2 ymm0, ymm1, xmm2, 0x04
        #   vinserti64x2 ymm0, ymm1, oword([ecx]), 0x04
        #   vinserti64x2 zmm0, zmm1, xmm2, 0x04
        #   vinserti64x2 zmm0, zmm1, oword([ecx]), 0x04
        ...
        #   vinserti64x4 opmask(zmm0, k1, zero: true), zmm1, yword([ecx]), 0x04
        #   vinserti64x4 zmm0, zmm1, ymm2, 0x04
        #   vinserti64x4 zmm0, zmm1, yword([ecx]), 0x04
        ...
        #   vinsertps xmm0, xmm1, xmm2, 0x04
        #   vinsertps xmm0, xmm1, dword([ecx]), 0x04
        #   vinsertps xmm0, xmm1, dword([ecx]), 0x04
        ...
        # @example
        #   vlddqu xmm0, oword([ebx])
        #   vlddqu ymm0, yword([ebx])
        ...
        # @example
        #   vmaskmovpd xmm0, xmm1, oword([ecx])
        #   vmaskmovpd ymm0, ymm1, yword([ecx])
        #   vmaskmovpd oword([eax]), xmm1, xmm2
        #   vmaskmovpd yword([eax]), ymm1, ymm2
        ...
        # @example
        #   vmaskmovps xmm0, xmm1, oword([ecx])
        #   vmaskmovps ymm0, ymm1, yword([ecx])
        #   vmaskmovps oword([eax]), xmm1, xmm2
        #   vmaskmovps yword([eax]), ymm1, ymm2
        ...
        # @example
        #   vmaxpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vmaxpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vmaxpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vmaxpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vmaxpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vmaxpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vmaxpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vmaxpd xmm0, xmm1, xmm2
        #   vmaxpd xmm0, xmm1, xmm2
        #   vmaxpd xmm0, xmm1, oword([ecx])
        #   vmaxpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vmaxpd ymm0, ymm1, ymm2
        #   vmaxpd ymm0, ymm1, ymm2
        #   vmaxpd ymm0, ymm1, yword([ecx])
        #   vmaxpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vmaxph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vmaxph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vmaxph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vmaxph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vmaxph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vmaxph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vmaxph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vmaxph xmm0, xmm1, xmm2
        #   vmaxph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vmaxph ymm0, ymm1, ymm2
        #   vmaxph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vmaxps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vmaxps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vmaxps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vmaxps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vmaxps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vmaxps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vmaxps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vmaxps xmm0, xmm1, xmm2
        #   vmaxps xmm0, xmm1, xmm2
        #   vmaxps xmm0, xmm1, oword([ecx])
        #   vmaxps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vmaxps ymm0, ymm1, ymm2
        #   vmaxps ymm0, ymm1, ymm2
        #   vmaxps ymm0, ymm1, yword([ecx])
        #   vmaxps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vmaxsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vmaxsd xmm0, xmm1, xmm2
        #   vmaxsd xmm0, xmm1, xmm2
        #   vmaxsd xmm0, xmm1, qword([ecx])
        #   vmaxsd xmm0, xmm1, qword([ecx])
        ...
        #   vmaxsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vmaxsh xmm0, xmm1, xmm2
        #   vmaxsh xmm0, xmm1, word([ecx])
        ...
        #   vmaxss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vmaxss xmm0, xmm1, xmm2
        #   vmaxss xmm0, xmm1, xmm2
        #   vmaxss xmm0, xmm1, dword([ecx])
        #   vmaxss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vminpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vminpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vminpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vminpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vminpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vminpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vminpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vminpd xmm0, xmm1, xmm2
        #   vminpd xmm0, xmm1, xmm2
        #   vminpd xmm0, xmm1, oword([ecx])
        #   vminpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vminpd ymm0, ymm1, ymm2
        #   vminpd ymm0, ymm1, ymm2
        #   vminpd ymm0, ymm1, yword([ecx])
        #   vminpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vminph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vminph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vminph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vminph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vminph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vminph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vminph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vminph xmm0, xmm1, xmm2
        #   vminph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vminph ymm0, ymm1, ymm2
        #   vminph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vminps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vminps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vminps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vminps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vminps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vminps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vminps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vminps xmm0, xmm1, xmm2
        #   vminps xmm0, xmm1, xmm2
        #   vminps xmm0, xmm1, oword([ecx])
        #   vminps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vminps ymm0, ymm1, ymm2
        #   vminps ymm0, ymm1, ymm2
        #   vminps ymm0, ymm1, yword([ecx])
        #   vminps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vminsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vminsd xmm0, xmm1, xmm2
        #   vminsd xmm0, xmm1, xmm2
        #   vminsd xmm0, xmm1, qword([ecx])
        #   vminsd xmm0, xmm1, qword([ecx])
        ...
        #   vminsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vminsh xmm0, xmm1, xmm2
        #   vminsh xmm0, xmm1, word([ecx])
        ...
        #   vminss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vminss xmm0, xmm1, xmm2
        #   vminss xmm0, xmm1, xmm2
        #   vminss xmm0, xmm1, dword([ecx])
        #   vminss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vmovapd opmask(oword([eax]), k1), xmm1
        #   vmovapd opmask(xmm0, k1, zero: true), xmm1
        #   vmovapd opmask(yword([eax]), k1), ymm1
        #   vmovapd opmask(ymm0, k1, zero: true), ymm1
        #   vmovapd opmask(zword([eax]), k1), zmm1
        #   vmovapd opmask(zmm0, k1, zero: true), zmm1
        #   vmovapd opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovapd opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovapd opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovapd xmm0, xmm1
        #   vmovapd xmm0, xmm1
        #   vmovapd xmm0, oword([ebx])
        #   vmovapd xmm0, oword([ebx])
        #   vmovapd ymm0, ymm1
        #   vmovapd ymm0, ymm1
        #   vmovapd ymm0, yword([ebx])
        #   vmovapd ymm0, yword([ebx])
        #   vmovapd zmm0, zmm1
        #   vmovapd zmm0, zword([ebx])
        #   vmovapd oword([eax]), xmm1
        #   vmovapd oword([eax]), xmm1
        #   vmovapd yword([eax]), ymm1
        #   vmovapd yword([eax]), ymm1
        #   vmovapd zword([eax]), zmm1
        ...
        # @example
        #   vmovaps opmask(oword([eax]), k1), xmm1
        #   vmovaps opmask(xmm0, k1, zero: true), xmm1
        #   vmovaps opmask(yword([eax]), k1), ymm1
        #   vmovaps opmask(ymm0, k1, zero: true), ymm1
        #   vmovaps opmask(zword([eax]), k1), zmm1
        #   vmovaps opmask(zmm0, k1, zero: true), zmm1
        #   vmovaps opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovaps opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovaps opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovaps xmm0, xmm1
        #   vmovaps xmm0, xmm1
        #   vmovaps xmm0, oword([ebx])
        #   vmovaps xmm0, oword([ebx])
        #   vmovaps ymm0, ymm1
        #   vmovaps ymm0, ymm1
        #   vmovaps ymm0, yword([ebx])
        #   vmovaps ymm0, yword([ebx])
        #   vmovaps zmm0, zmm1
        #   vmovaps zmm0, zword([ebx])
        #   vmovaps oword([eax]), xmm1
        #   vmovaps oword([eax]), xmm1
        #   vmovaps yword([eax]), ymm1
        #   vmovaps yword([eax]), ymm1
        #   vmovaps zword([eax]), zmm1
        ...
        #   vmovd xmm0, ebx
        #   vmovd xmm0, ebx
        #   vmovd xmm0, dword([ebx])
        #   vmovd xmm0, dword([ebx])
        #   vmovd dword([eax]), xmm1
        #   vmovd dword([eax]), xmm1
        ...
        #   vmovddup opmask(xmm0, k1, zero: true), qword([ebx])
        #   vmovddup opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovddup opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovddup xmm0, xmm1
        #   vmovddup xmm0, xmm1
        #   vmovddup xmm0, qword([ebx])
        #   vmovddup xmm0, qword([ebx])
        #   vmovddup ymm0, ymm1
        #   vmovddup ymm0, ymm1
        #   vmovddup ymm0, yword([ebx])
        #   vmovddup ymm0, yword([ebx])
        #   vmovddup zmm0, zmm1
        #   vmovddup zmm0, zword([ebx])
        ...
        # @example
        #   vmovdqa xmm0, xmm1
        #   vmovdqa xmm0, oword([ebx])
        #   vmovdqa ymm0, ymm1
        #   vmovdqa ymm0, yword([ebx])
        #   vmovdqa oword([eax]), xmm1
        ...
        # @example
        #   vmovdqa32 opmask(oword([eax]), k1), xmm1
        #   vmovdqa32 opmask(xmm0, k1, zero: true), xmm1
        #   vmovdqa32 opmask(yword([eax]), k1), ymm1
        #   vmovdqa32 opmask(ymm0, k1, zero: true), ymm1
        #   vmovdqa32 opmask(zword([eax]), k1), zmm1
        #   vmovdqa32 opmask(zmm0, k1, zero: true), zmm1
        #   vmovdqa32 opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovdqa32 opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovdqa32 opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovdqa32 xmm0, xmm1
        #   vmovdqa32 xmm0, oword([ebx])
        #   vmovdqa32 ymm0, ymm1
        #   vmovdqa32 ymm0, yword([ebx])
        #   vmovdqa32 zmm0, zmm1
        #   vmovdqa32 zmm0, zword([ebx])
        #   vmovdqa32 oword([eax]), xmm1
        #   vmovdqa32 yword([eax]), ymm1
        #   vmovdqa32 zword([eax]), zmm1
        ...
        # @example
        #   vmovdqa64 opmask(oword([eax]), k1), xmm1
        #   vmovdqa64 opmask(xmm0, k1, zero: true), xmm1
        #   vmovdqa64 opmask(yword([eax]), k1), ymm1
        #   vmovdqa64 opmask(ymm0, k1, zero: true), ymm1
        #   vmovdqa64 opmask(zword([eax]), k1), zmm1
        #   vmovdqa64 opmask(zmm0, k1, zero: true), zmm1
        #   vmovdqa64 opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovdqa64 opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovdqa64 opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovdqa64 xmm0, xmm1
        #   vmovdqa64 xmm0, oword([ebx])
        #   vmovdqa64 ymm0, ymm1
        #   vmovdqa64 ymm0, yword([ebx])
        #   vmovdqa64 zmm0, zmm1
        #   vmovdqa64 zmm0, zword([ebx])
        #   vmovdqa64 oword([eax]), xmm1
        #   vmovdqa64 yword([eax]), ymm1
        #   vmovdqa64 zword([eax]), zmm1
        ...
        # @example
        #   vmovdqu xmm0, xmm1
        #   vmovdqu xmm0, oword([ebx])
        #   vmovdqu ymm0, ymm1
        #   vmovdqu ymm0, yword([ebx])
        #   vmovdqu oword([eax]), xmm1
        #   vmovdqu yword([eax]), ymm1
        ...
        # @example
        #   vmovdqu16 opmask(oword([eax]), k1), xmm1
        #   vmovdqu16 opmask(xmm0, k1, zero: true), xmm1
        #   vmovdqu16 opmask(yword([eax]), k1), ymm1
        #   vmovdqu16 opmask(ymm0, k1, zero: true), ymm1
        #   vmovdqu16 opmask(zword([eax]), k1), zmm1
        #   vmovdqu16 opmask(zmm0, k1, zero: true), zmm1
        #   vmovdqu16 opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovdqu16 opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovdqu16 opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovdqu16 xmm0, xmm1
        #   vmovdqu16 xmm0, oword([ebx])
        #   vmovdqu16 ymm0, ymm1
        #   vmovdqu16 ymm0, yword([ebx])
        #   vmovdqu16 zmm0, zmm1
        #   vmovdqu16 zmm0, zword([ebx])
        #   vmovdqu16 oword([eax]), xmm1
        #   vmovdqu16 yword([eax]), ymm1
        #   vmovdqu16 zword([eax]), zmm1
        ...
        # @example
        #   vmovdqu32 opmask(oword([eax]), k1), xmm1
        #   vmovdqu32 opmask(xmm0, k1, zero: true), xmm1
        #   vmovdqu32 opmask(yword([eax]), k1), ymm1
        #   vmovdqu32 opmask(ymm0, k1, zero: true), ymm1
        #   vmovdqu32 opmask(zword([eax]), k1), zmm1
        #   vmovdqu32 opmask(zmm0, k1, zero: true), zmm1
        #   vmovdqu32 opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovdqu32 opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovdqu32 opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovdqu32 xmm0, xmm1
        #   vmovdqu32 xmm0, oword([ebx])
        #   vmovdqu32 ymm0, ymm1
        #   vmovdqu32 ymm0, yword([ebx])
        #   vmovdqu32 zmm0, zmm1
        #   vmovdqu32 zmm0, zword([ebx])
        #   vmovdqu32 oword([eax]), xmm1
        #   vmovdqu32 yword([eax]), ymm1
        #   vmovdqu32 zword([eax]), zmm1
        ...
        # @example
        #   vmovdqu64 opmask(oword([eax]), k1), xmm1
        #   vmovdqu64 opmask(xmm0, k1, zero: true), xmm1
        #   vmovdqu64 opmask(yword([eax]), k1), ymm1
        #   vmovdqu64 opmask(ymm0, k1, zero: true), ymm1
        #   vmovdqu64 opmask(zword([eax]), k1), zmm1
        #   vmovdqu64 opmask(zmm0, k1, zero: true), zmm1
        #   vmovdqu64 opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovdqu64 opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovdqu64 opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovdqu64 xmm0, xmm1
        #   vmovdqu64 xmm0, oword([ebx])
        #   vmovdqu64 ymm0, ymm1
        #   vmovdqu64 ymm0, yword([ebx])
        #   vmovdqu64 zmm0, zmm1
        #   vmovdqu64 zmm0, zword([ebx])
        #   vmovdqu64 oword([eax]), xmm1
        #   vmovdqu64 yword([eax]), ymm1
        #   vmovdqu64 zword([eax]), zmm1
        ...
        # @example
        #   vmovdqu8 opmask(oword([eax]), k1), xmm1
        #   vmovdqu8 opmask(xmm0, k1, zero: true), xmm1
        #   vmovdqu8 opmask(yword([eax]), k1), ymm1
        #   vmovdqu8 opmask(ymm0, k1, zero: true), ymm1
        #   vmovdqu8 opmask(zword([eax]), k1), zmm1
        #   vmovdqu8 opmask(zmm0, k1, zero: true), zmm1
        #   vmovdqu8 opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovdqu8 opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovdqu8 opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovdqu8 xmm0, xmm1
        #   vmovdqu8 xmm0, oword([ebx])
        #   vmovdqu8 ymm0, ymm1
        #   vmovdqu8 ymm0, yword([ebx])
        #   vmovdqu8 zmm0, zmm1
        #   vmovdqu8 zmm0, zword([ebx])
        #   vmovdqu8 oword([eax]), xmm1
        #   vmovdqu8 yword([eax]), ymm1
        #   vmovdqu8 zword([eax]), zmm1
        ...
        # @example
        #   vmovntdqa xmm0, oword([ebx])
        #   vmovntdqa xmm0, oword([ebx])
        #   vmovntdqa ymm0, yword([ebx])
        #   vmovntdqa ymm0, yword([ebx])
        #   vmovntdqa zmm0, zword([ebx])
        ...
        # @example
        #   vmovsd opmask(qword([eax]), k1), xmm1
        #   vmovsd opmask(xmm0, k1, zero: true), qword([ebx])
        #   vmovsd xmm0, qword([ebx])
        #   vmovsd xmm0, qword([ebx])
        ...
        # @example
        #   vmovsh opmask(word([eax]), k1), xmm1
        #   vmovsh opmask(xmm0, k1, zero: true), word([ebx])
        #   vmovsh xmm0, word([ebx])
        #   vmovsh word([eax]), xmm1
        ...
        #   vmovshdup opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovshdup opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovshdup opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovshdup xmm0, xmm1
        #   vmovshdup xmm0, xmm1
        #   vmovshdup xmm0, oword([ebx])
        #   vmovshdup xmm0, oword([ebx])
        #   vmovshdup ymm0, ymm1
        #   vmovshdup ymm0, ymm1
        #   vmovshdup ymm0, yword([ebx])
        #   vmovshdup ymm0, yword([ebx])
        #   vmovshdup zmm0, zmm1
        #   vmovshdup zmm0, zword([ebx])
        ...
        #   vmovsldup opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovsldup opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovsldup opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovsldup xmm0, xmm1
        #   vmovsldup xmm0, xmm1
        #   vmovsldup xmm0, oword([ebx])
        #   vmovsldup xmm0, oword([ebx])
        #   vmovsldup ymm0, ymm1
        #   vmovsldup ymm0, ymm1
        #   vmovsldup ymm0, yword([ebx])
        #   vmovsldup ymm0, yword([ebx])
        #   vmovsldup zmm0, zmm1
        #   vmovsldup zmm0, zword([ebx])
        ...
        # @example
        #   vmovss opmask(dword([eax]), k1), xmm1
        #   vmovss opmask(xmm0, k1, zero: true), dword([ebx])
        #   vmovss xmm0, dword([ebx])
        #   vmovss xmm0, dword([ebx])
        #   vmovss dword([eax]), xmm1
        #   vmovss dword([eax]), xmm1
        ...
        # @example
        #   vmovupd opmask(oword([eax]), k1), xmm1
        #   vmovupd opmask(xmm0, k1, zero: true), xmm1
        #   vmovupd opmask(yword([eax]), k1), ymm1
        #   vmovupd opmask(ymm0, k1, zero: true), ymm1
        #   vmovupd opmask(zword([eax]), k1), zmm1
        #   vmovupd opmask(zmm0, k1, zero: true), zmm1
        #   vmovupd opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovupd opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovupd opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovupd xmm0, xmm1
        #   vmovupd xmm0, xmm1
        #   vmovupd xmm0, oword([ebx])
        #   vmovupd xmm0, oword([ebx])
        #   vmovupd ymm0, ymm1
        #   vmovupd ymm0, ymm1
        #   vmovupd ymm0, yword([ebx])
        #   vmovupd ymm0, yword([ebx])
        #   vmovupd zmm0, zmm1
        #   vmovupd zmm0, zword([ebx])
        #   vmovupd oword([eax]), xmm1
        #   vmovupd oword([eax]), xmm1
        #   vmovupd yword([eax]), ymm1
        #   vmovupd yword([eax]), ymm1
        #   vmovupd zword([eax]), zmm1
        ...
        # @example
        #   vmovups opmask(oword([eax]), k1), xmm1
        #   vmovups opmask(xmm0, k1, zero: true), xmm1
        #   vmovups opmask(yword([eax]), k1), ymm1
        #   vmovups opmask(ymm0, k1, zero: true), ymm1
        #   vmovups opmask(zword([eax]), k1), zmm1
        #   vmovups opmask(zmm0, k1, zero: true), zmm1
        #   vmovups opmask(xmm0, k1, zero: true), oword([ebx])
        #   vmovups opmask(ymm0, k1, zero: true), yword([ebx])
        #   vmovups opmask(zmm0, k1, zero: true), zword([ebx])
        #   vmovups xmm0, xmm1
        #   vmovups xmm0, xmm1
        #   vmovups xmm0, oword([ebx])
        #   vmovups xmm0, oword([ebx])
        #   vmovups ymm0, ymm1
        #   vmovups ymm0, ymm1
        #   vmovups ymm0, yword([ebx])
        #   vmovups ymm0, yword([ebx])
        #   vmovups zmm0, zmm1
        #   vmovups zmm0, zword([ebx])
        #   vmovups oword([eax]), xmm1
        #   vmovups oword([eax]), xmm1
        #   vmovups yword([eax]), ymm1
        #   vmovups yword([eax]), ymm1
        #   vmovups zword([eax]), zmm1
        ...
        #   vmpsadbw xmm0, xmm1, oword([ecx]), 0x04
        #   vmpsadbw ymm0, ymm1, ymm2, 0x04
        #   vmpsadbw ymm0, ymm1, yword([ecx]), 0x04
        ...
        # @example
        #   vmulpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vmulpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vmulpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vmulpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vmulpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vmulpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vmulpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vmulpd xmm0, xmm1, xmm2
        #   vmulpd xmm0, xmm1, xmm2
        #   vmulpd xmm0, xmm1, oword([ecx])
        #   vmulpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vmulpd ymm0, ymm1, ymm2
        #   vmulpd ymm0, ymm1, ymm2
        #   vmulpd ymm0, ymm1, yword([ecx])
        #   vmulpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vmulph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vmulph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vmulph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vmulph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vmulph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vmulph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vmulph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vmulph xmm0, xmm1, xmm2
        #   vmulph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vmulph ymm0, ymm1, ymm2
        #   vmulph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vmulps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vmulps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vmulps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vmulps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vmulps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vmulps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vmulps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vmulps xmm0, xmm1, xmm2
        #   vmulps xmm0, xmm1, xmm2
        #   vmulps xmm0, xmm1, oword([ecx])
        #   vmulps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vmulps ymm0, ymm1, ymm2
        #   vmulps ymm0, ymm1, ymm2
        #   vmulps ymm0, ymm1, yword([ecx])
        #   vmulps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vmulsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vmulsd xmm0, xmm1, xmm2
        #   vmulsd xmm0, xmm1, xmm2
        #   vmulsd xmm0, xmm1, qword([ecx])
        #   vmulsd xmm0, xmm1, qword([ecx])
        ...
        #   vmulsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vmulsh xmm0, xmm1, xmm2
        #   vmulsh xmm0, xmm1, word([ecx])
        ...
        #   vmulss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vmulss xmm0, xmm1, xmm2
        #   vmulss xmm0, xmm1, xmm2
        #   vmulss xmm0, xmm1, dword([ecx])
        #   vmulss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vorpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vorpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vorpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vorpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vorpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vorpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vorpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vorpd xmm0, xmm1, xmm2
        #   vorpd xmm0, xmm1, xmm2
        #   vorpd xmm0, xmm1, oword([ecx])
        #   vorpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vorpd ymm0, ymm1, ymm2
        #   vorpd ymm0, ymm1, ymm2
        #   vorpd ymm0, ymm1, yword([ecx])
        #   vorpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vorps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vorps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vorps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vorps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vorps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vorps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vorps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vorps xmm0, xmm1, xmm2
        #   vorps xmm0, xmm1, xmm2
        #   vorps xmm0, xmm1, oword([ecx])
        #   vorps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vorps ymm0, ymm1, ymm2
        #   vorps ymm0, ymm1, ymm2
        #   vorps ymm0, ymm1, yword([ecx])
        #   vorps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpabsb opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpabsb opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpabsb opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpabsb xmm0, xmm1
        #   vpabsb xmm0, xmm1
        #   vpabsb xmm0, oword([ebx])
        #   vpabsb xmm0, oword([ebx])
        #   vpabsb ymm0, ymm1
        #   vpabsb ymm0, ymm1
        #   vpabsb ymm0, yword([ebx])
        #   vpabsb ymm0, yword([ebx])
        #   vpabsb zmm0, zmm1
        #   vpabsb zmm0, zword([ebx])
        def vpabsb(*operands,**kwargs) = add_instruction(Instructions::VPABSB,*operands,**kwargs)
        # Packed Absolute Value of Doubleword Integers
        # @return [Ronin::ASM::X86::Instructions::VPABSD]
        # @example
        #   vpabsd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vpabsd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vpabsd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vpabsd opmask(xmm0, k1, zero: true), xmm1
        #   vpabsd opmask(ymm0, k1, zero: true), ymm1
        #   vpabsd opmask(zmm0, k1, zero: true), zmm1
        #   vpabsd xmm0, bcst(dword([ebx]), {1=>4})
        #   vpabsd xmm0, xmm1
        #   vpabsd xmm0, xmm1
        #   vpabsd xmm0, oword([ebx])
        #   vpabsd ymm0, bcst(dword([ebx]), {1=>8})
        #   vpabsd ymm0, ymm1
        #   vpabsd ymm0, ymm1
        #   vpabsd ymm0, yword([ebx])
        #   vpabsd zmm0, bcst(dword([ebx]), {1=>16})
        #   vpabsd zmm0, zmm1
        ...
        # @example
        #   vpabsq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vpabsq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vpabsq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vpabsq opmask(xmm0, k1, zero: true), xmm1
        #   vpabsq opmask(ymm0, k1, zero: true), ymm1
        #   vpabsq opmask(zmm0, k1, zero: true), zmm1
        #   vpabsq xmm0, bcst(qword([ebx]), {1=>2})
        #   vpabsq xmm0, xmm1
        #   vpabsq ymm0, bcst(qword([ebx]), {1=>4})
        #   vpabsq ymm0, ymm1
        #   vpabsq zmm0, bcst(qword([ebx]), {1=>8})
        #   vpabsq zmm0, zmm1
        ...
        #   vpabsw opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpabsw opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpabsw opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpabsw xmm0, xmm1
        #   vpabsw xmm0, xmm1
        #   vpabsw xmm0, oword([ebx])
        #   vpabsw xmm0, oword([ebx])
        #   vpabsw ymm0, ymm1
        #   vpabsw ymm0, ymm1
        #   vpabsw ymm0, yword([ebx])
        #   vpabsw ymm0, yword([ebx])
        #   vpabsw zmm0, zmm1
        #   vpabsw zmm0, zword([ebx])
        ...
        # @example
        #   vpackssdw opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpackssdw opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpackssdw opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpackssdw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpackssdw opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpackssdw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpackssdw xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpackssdw xmm0, xmm1, xmm2
        #   vpackssdw xmm0, xmm1, xmm2
        #   vpackssdw xmm0, xmm1, oword([ecx])
        #   vpackssdw ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpackssdw ymm0, ymm1, ymm2
        #   vpackssdw ymm0, ymm1, ymm2
        #   vpackssdw ymm0, ymm1, yword([ecx])
        #   vpackssdw zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpacksswb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpacksswb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpacksswb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpacksswb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpacksswb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpacksswb xmm0, xmm1, xmm2
        #   vpacksswb xmm0, xmm1, xmm2
        #   vpacksswb xmm0, xmm1, oword([ecx])
        #   vpacksswb xmm0, xmm1, oword([ecx])
        #   vpacksswb ymm0, ymm1, ymm2
        #   vpacksswb ymm0, ymm1, ymm2
        #   vpacksswb ymm0, ymm1, yword([ecx])
        #   vpacksswb ymm0, ymm1, yword([ecx])
        #   vpacksswb zmm0, zmm1, zmm2
        #   vpacksswb zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpackusdw opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpackusdw opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpackusdw opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpackusdw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpackusdw opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpackusdw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpackusdw xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpackusdw xmm0, xmm1, xmm2
        #   vpackusdw xmm0, xmm1, xmm2
        #   vpackusdw xmm0, xmm1, oword([ecx])
        #   vpackusdw ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpackusdw ymm0, ymm1, ymm2
        #   vpackusdw ymm0, ymm1, ymm2
        #   vpackusdw ymm0, ymm1, yword([ecx])
        #   vpackusdw zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpackuswb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpackuswb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpackuswb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpackuswb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpackuswb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpackuswb xmm0, xmm1, xmm2
        #   vpackuswb xmm0, xmm1, xmm2
        #   vpackuswb xmm0, xmm1, oword([ecx])
        #   vpackuswb xmm0, xmm1, oword([ecx])
        #   vpackuswb ymm0, ymm1, ymm2
        #   vpackuswb ymm0, ymm1, ymm2
        #   vpackuswb ymm0, ymm1, yword([ecx])
        #   vpackuswb ymm0, ymm1, yword([ecx])
        #   vpackuswb zmm0, zmm1, zmm2
        #   vpackuswb zmm0, zmm1, zword([ecx])
        ...
        #   vpaddb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpaddb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpaddb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpaddb xmm0, xmm1, xmm2
        #   vpaddb xmm0, xmm1, xmm2
        #   vpaddb xmm0, xmm1, oword([ecx])
        #   vpaddb xmm0, xmm1, oword([ecx])
        #   vpaddb ymm0, ymm1, ymm2
        #   vpaddb ymm0, ymm1, ymm2
        #   vpaddb ymm0, ymm1, yword([ecx])
        #   vpaddb ymm0, ymm1, yword([ecx])
        #   vpaddb zmm0, zmm1, zmm2
        #   vpaddb zmm0, zmm1, zword([ecx])
        def vpaddb(*operands,**kwargs) = add_instruction(Instructions::VPADDB,*operands,**kwargs)
        # Add Packed Doubleword Integers
        # @return [Ronin::ASM::X86::Instructions::VPADDD]
        # @example
        #   vpaddd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpaddd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpaddd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpaddd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpaddd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpaddd xmm0, xmm1, xmm2
        #   vpaddd xmm0, xmm1, xmm2
        #   vpaddd xmm0, xmm1, oword([ecx])
        #   vpaddd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpaddd ymm0, ymm1, ymm2
        #   vpaddd ymm0, ymm1, ymm2
        #   vpaddd ymm0, ymm1, yword([ecx])
        #   vpaddd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpaddq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpaddq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpaddq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpaddq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpaddq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpaddq xmm0, xmm1, xmm2
        #   vpaddq xmm0, xmm1, xmm2
        #   vpaddq xmm0, xmm1, oword([ecx])
        #   vpaddq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpaddq ymm0, ymm1, ymm2
        #   vpaddq ymm0, ymm1, ymm2
        #   vpaddq ymm0, ymm1, yword([ecx])
        #   vpaddq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpaddsb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpaddsb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddsb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpaddsb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddsb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpaddsb xmm0, xmm1, xmm2
        #   vpaddsb xmm0, xmm1, xmm2
        #   vpaddsb xmm0, xmm1, oword([ecx])
        #   vpaddsb xmm0, xmm1, oword([ecx])
        #   vpaddsb ymm0, ymm1, ymm2
        #   vpaddsb ymm0, ymm1, ymm2
        #   vpaddsb ymm0, ymm1, yword([ecx])
        #   vpaddsb ymm0, ymm1, yword([ecx])
        #   vpaddsb zmm0, zmm1, zmm2
        #   vpaddsb zmm0, zmm1, zword([ecx])
        ...
        #   vpaddsw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpaddsw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddsw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpaddsw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddsw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpaddsw xmm0, xmm1, xmm2
        #   vpaddsw xmm0, xmm1, xmm2
        #   vpaddsw xmm0, xmm1, oword([ecx])
        #   vpaddsw xmm0, xmm1, oword([ecx])
        #   vpaddsw ymm0, ymm1, ymm2
        #   vpaddsw ymm0, ymm1, ymm2
        #   vpaddsw ymm0, ymm1, yword([ecx])
        #   vpaddsw ymm0, ymm1, yword([ecx])
        #   vpaddsw zmm0, zmm1, zmm2
        #   vpaddsw zmm0, zmm1, zword([ecx])
        ...
        #   vpaddusb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpaddusb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddusb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpaddusb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddusb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpaddusb xmm0, xmm1, xmm2
        #   vpaddusb xmm0, xmm1, xmm2
        #   vpaddusb xmm0, xmm1, oword([ecx])
        #   vpaddusb xmm0, xmm1, oword([ecx])
        #   vpaddusb ymm0, ymm1, ymm2
        #   vpaddusb ymm0, ymm1, ymm2
        #   vpaddusb ymm0, ymm1, yword([ecx])
        #   vpaddusb ymm0, ymm1, yword([ecx])
        #   vpaddusb zmm0, zmm1, zmm2
        #   vpaddusb zmm0, zmm1, zword([ecx])
        ...
        #   vpaddusw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpaddusw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddusw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpaddusw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddusw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpaddusw xmm0, xmm1, xmm2
        #   vpaddusw xmm0, xmm1, xmm2
        #   vpaddusw xmm0, xmm1, oword([ecx])
        #   vpaddusw xmm0, xmm1, oword([ecx])
        #   vpaddusw ymm0, ymm1, ymm2
        #   vpaddusw ymm0, ymm1, ymm2
        #   vpaddusw ymm0, ymm1, yword([ecx])
        #   vpaddusw ymm0, ymm1, yword([ecx])
        #   vpaddusw zmm0, zmm1, zmm2
        #   vpaddusw zmm0, zmm1, zword([ecx])
        ...
        #   vpaddw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpaddw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpaddw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpaddw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpaddw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpaddw xmm0, xmm1, xmm2
        #   vpaddw xmm0, xmm1, xmm2
        #   vpaddw xmm0, xmm1, oword([ecx])
        #   vpaddw xmm0, xmm1, oword([ecx])
        #   vpaddw ymm0, ymm1, ymm2
        #   vpaddw ymm0, ymm1, ymm2
        #   vpaddw ymm0, ymm1, yword([ecx])
        #   vpaddw ymm0, ymm1, yword([ecx])
        #   vpaddw zmm0, zmm1, zmm2
        #   vpaddw zmm0, zmm1, zword([ecx])
        ...
        #   vpalignr opmask(xmm0, k1, zero: true), xmm1, oword([ecx]), 0x04
        #   vpalignr opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpalignr opmask(ymm0, k1, zero: true), ymm1, yword([ecx]), 0x04
        #   vpalignr opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpalignr opmask(zmm0, k1, zero: true), zmm1, zword([ecx]), 0x04
        #   vpalignr xmm0, xmm1, xmm2, 0x04
        #   vpalignr xmm0, xmm1, xmm2, 0x04
        #   vpalignr xmm0, xmm1, oword([ecx]), 0x04
        #   vpalignr xmm0, xmm1, oword([ecx]), 0x04
        #   vpalignr ymm0, ymm1, ymm2, 0x04
        #   vpalignr ymm0, ymm1, ymm2, 0x04
        #   vpalignr ymm0, ymm1, yword([ecx]), 0x04
        #   vpalignr ymm0, ymm1, yword([ecx]), 0x04
        #   vpalignr zmm0, zmm1, zmm2, 0x04
        #   vpalignr zmm0, zmm1, zword([ecx]), 0x04
        ...
        #   vpand xmm0, xmm1, oword([ecx])
        #   vpand ymm0, ymm1, ymm2
        #   vpand ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpandd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpandd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpandd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpandd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpandd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpandd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpandd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpandd xmm0, xmm1, xmm2
        #   vpandd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpandd ymm0, ymm1, ymm2
        #   vpandd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpandn xmm0, xmm1, oword([ecx])
        #   vpandn ymm0, ymm1, ymm2
        #   vpandn ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpandnd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpandnd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpandnd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpandnd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpandnd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpandnd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpandnd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpandnd xmm0, xmm1, xmm2
        #   vpandnd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpandnd ymm0, ymm1, ymm2
        #   vpandnd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpandnq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpandnq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpandnq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpandnq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpandnq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpandnq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpandnq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpandnq xmm0, xmm1, xmm2
        #   vpandnq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpandnq ymm0, ymm1, ymm2
        #   vpandnq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpandq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpandq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpandq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpandq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpandq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpandq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpandq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpandq xmm0, xmm1, xmm2
        #   vpandq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpandq ymm0, ymm1, ymm2
        #   vpandq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpavgb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpavgb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpavgb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpavgb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpavgb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpavgb xmm0, xmm1, xmm2
        #   vpavgb xmm0, xmm1, xmm2
        #   vpavgb xmm0, xmm1, oword([ecx])
        #   vpavgb xmm0, xmm1, oword([ecx])
        #   vpavgb ymm0, ymm1, ymm2
        #   vpavgb ymm0, ymm1, ymm2
        #   vpavgb ymm0, ymm1, yword([ecx])
        #   vpavgb ymm0, ymm1, yword([ecx])
        #   vpavgb zmm0, zmm1, zmm2
        #   vpavgb zmm0, zmm1, zword([ecx])
        ...
        #   vpavgw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpavgw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpavgw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpavgw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpavgw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpavgw xmm0, xmm1, xmm2
        #   vpavgw xmm0, xmm1, xmm2
        #   vpavgw xmm0, xmm1, oword([ecx])
        #   vpavgw xmm0, xmm1, oword([ecx])
        #   vpavgw ymm0, ymm1, ymm2
        #   vpavgw ymm0, ymm1, ymm2
        #   vpavgw ymm0, ymm1, yword([ecx])
        #   vpavgw ymm0, ymm1, yword([ecx])
        #   vpavgw zmm0, zmm1, zmm2
        #   vpavgw zmm0, zmm1, zword([ecx])
        ...
        #   vpblendd xmm0, xmm1, oword([ecx]), 0x04
        #   vpblendd ymm0, ymm1, ymm2, 0x04
        #   vpblendd ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vpblendmb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpblendmb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpblendmb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpblendmb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpblendmb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpblendmb xmm0, xmm1, xmm2
        #   vpblendmb xmm0, xmm1, oword([ecx])
        #   vpblendmb ymm0, ymm1, ymm2
        #   vpblendmb ymm0, ymm1, yword([ecx])
        #   vpblendmb zmm0, zmm1, zmm2
        #   vpblendmb zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpblendmd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpblendmd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpblendmd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpblendmd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpblendmd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpblendmd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpblendmd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpblendmd xmm0, xmm1, xmm2
        #   vpblendmd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpblendmd ymm0, ymm1, ymm2
        #   vpblendmd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpblendmq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpblendmq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpblendmq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpblendmq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpblendmq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpblendmq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpblendmq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpblendmq xmm0, xmm1, xmm2
        #   vpblendmq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpblendmq ymm0, ymm1, ymm2
        #   vpblendmq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpblendmw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpblendmw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpblendmw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpblendmw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpblendmw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpblendmw xmm0, xmm1, xmm2
        #   vpblendmw xmm0, xmm1, oword([ecx])
        #   vpblendmw ymm0, ymm1, ymm2
        #   vpblendmw ymm0, ymm1, yword([ecx])
        #   vpblendmw zmm0, zmm1, zmm2
        #   vpblendmw zmm0, zmm1, zword([ecx])
        ...
        #   vpblendvb xmm0, xmm1, oword([ecx]), xmm3
        #   vpblendvb ymm0, ymm1, ymm2, ymm3
        #   vpblendvb ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vpblendw xmm0, xmm1, oword([ecx]), 0x04
        #   vpblendw ymm0, ymm1, ymm2, 0x04
        #   vpblendw ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vpbroadcastb opmask(xmm0, k1, zero: true), byte([ebx])
        #   vpbroadcastb opmask(ymm0, k1, zero: true), byte([ebx])
        #   vpbroadcastb opmask(zmm0, k1, zero: true), byte([ebx])
        #   vpbroadcastb xmm0, ebx
        #   vpbroadcastb xmm0, xmm1
        #   vpbroadcastb xmm0, xmm1
        #   vpbroadcastb xmm0, byte([ebx])
        #   vpbroadcastb xmm0, byte([ebx])
        #   vpbroadcastb ymm0, ebx
        #   vpbroadcastb ymm0, xmm1
        #   vpbroadcastb ymm0, xmm1
        #   vpbroadcastb ymm0, byte([ebx])
        #   vpbroadcastb ymm0, byte([ebx])
        #   vpbroadcastb zmm0, ebx
        #   vpbroadcastb zmm0, xmm1
        #   vpbroadcastb zmm0, byte([ebx])
        ...
        #   vpbroadcastd opmask(xmm0, k1, zero: true), dword([ebx])
        #   vpbroadcastd opmask(ymm0, k1, zero: true), dword([ebx])
        #   vpbroadcastd opmask(zmm0, k1, zero: true), dword([ebx])
        #   vpbroadcastd xmm0, ebx
        #   vpbroadcastd xmm0, xmm1
        #   vpbroadcastd xmm0, xmm1
        #   vpbroadcastd xmm0, dword([ebx])
        #   vpbroadcastd xmm0, dword([ebx])
        #   vpbroadcastd ymm0, ebx
        #   vpbroadcastd ymm0, xmm1
        #   vpbroadcastd ymm0, xmm1
        #   vpbroadcastd ymm0, dword([ebx])
        #   vpbroadcastd ymm0, dword([ebx])
        #   vpbroadcastd zmm0, ebx
        #   vpbroadcastd zmm0, xmm1
        #   vpbroadcastd zmm0, dword([ebx])
        ...
        #   vpbroadcastq opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpbroadcastq opmask(ymm0, k1, zero: true), qword([ebx])
        #   vpbroadcastq opmask(zmm0, k1, zero: true), qword([ebx])
        #   vpbroadcastq xmm0, xmm1
        #   vpbroadcastq xmm0, xmm1
        #   vpbroadcastq xmm0, qword([ebx])
        #   vpbroadcastq xmm0, qword([ebx])
        #   vpbroadcastq ymm0, xmm1
        #   vpbroadcastq ymm0, xmm1
        #   vpbroadcastq ymm0, qword([ebx])
        #   vpbroadcastq ymm0, qword([ebx])
        #   vpbroadcastq zmm0, xmm1
        #   vpbroadcastq zmm0, qword([ebx])
        ...
        #   vpbroadcastw opmask(xmm0, k1, zero: true), word([ebx])
        #   vpbroadcastw opmask(ymm0, k1, zero: true), word([ebx])
        #   vpbroadcastw opmask(zmm0, k1, zero: true), word([ebx])
        #   vpbroadcastw xmm0, ebx
        #   vpbroadcastw xmm0, xmm1
        #   vpbroadcastw xmm0, xmm1
        #   vpbroadcastw xmm0, word([ebx])
        #   vpbroadcastw xmm0, word([ebx])
        #   vpbroadcastw ymm0, ebx
        #   vpbroadcastw ymm0, xmm1
        #   vpbroadcastw ymm0, xmm1
        #   vpbroadcastw ymm0, word([ebx])
        #   vpbroadcastw ymm0, word([ebx])
        #   vpbroadcastw zmm0, ebx
        #   vpbroadcastw zmm0, xmm1
        #   vpbroadcastw zmm0, word([ebx])
        ...
        #   vpclmulqdq xmm0, xmm1, xmm2, 0x04
        #   vpclmulqdq xmm0, xmm1, oword([ecx]), 0x04
        #   vpclmulqdq xmm0, xmm1, oword([ecx]), 0x04
        #   vpclmulqdq ymm0, ymm1, ymm2, 0x04
        #   vpclmulqdq ymm0, ymm1, ymm2, 0x04
        #   vpclmulqdq ymm0, ymm1, yword([ecx]), 0x04
        #   vpclmulqdq ymm0, ymm1, yword([ecx]), 0x04
        #   vpclmulqdq zmm0, zmm1, zmm2, 0x04
        #   vpclmulqdq zmm0, zmm1, zword([ecx]), 0x04
        ...
        #   vpcmov xmm0, xmm1, xmm2, oword([edx])
        #   vpcmov xmm0, xmm1, oword([ecx]), xmm3
        #   vpcmov ymm0, ymm1, ymm2, ymm3
        #   vpcmov ymm0, ymm1, ymm2, yword([edx])
        #   vpcmov ymm0, ymm1, yword([ecx]), ymm3
        ...
        #   vpcmpb opmask(k1, k2), xmm1, oword([ecx]), 0x04
        #   vpcmpb k1, xmm1, oword([ecx]), 0x04
        #   vpcmpb opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpb k1, ymm1, ymm2, 0x04
        #   vpcmpb opmask(k1, k2), ymm1, yword([ecx]), 0x04
        #   vpcmpb k1, ymm1, yword([ecx]), 0x04
        #   vpcmpb opmask(k1, k2), zmm1, zmm2, 0x04
        #   vpcmpb k1, zmm1, zmm2, 0x04
        #   vpcmpb opmask(k1, k2), zmm1, zword([ecx]), 0x04
        #   vpcmpb k1, zmm1, zword([ecx]), 0x04
        ...
        # @example
        #   vpcmpd opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpcmpd k1, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpcmpd opmask(k1, k2), xmm1, xmm2, 0x04
        #   vpcmpd k1, xmm1, xmm2, 0x04
        #   vpcmpd opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpcmpd k1, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpcmpd opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpd k1, ymm1, ymm2, 0x04
        #   vpcmpd opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vpcmpd k1, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        #   vpcmpeqb opmask(k1, k2), xmm1, oword([ecx])
        #   vpcmpeqb k1, xmm1, oword([ecx])
        #   vpcmpeqb opmask(k1, k2), ymm1, ymm2
        #   vpcmpeqb k1, ymm1, ymm2
        #   vpcmpeqb opmask(k1, k2), ymm1, yword([ecx])
        #   vpcmpeqb k1, ymm1, yword([ecx])
        #   vpcmpeqb opmask(k1, k2), zmm1, zmm2
        #   vpcmpeqb k1, zmm1, zmm2
        #   vpcmpeqb opmask(k1, k2), zmm1, zword([ecx])
        #   vpcmpeqb k1, zmm1, zword([ecx])
        #   vpcmpeqb xmm0, xmm1, xmm2
        #   vpcmpeqb xmm0, xmm1, oword([ecx])
        #   vpcmpeqb ymm0, ymm1, ymm2
        #   vpcmpeqb ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpcmpeqd opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpcmpeqd k1, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpcmpeqd opmask(k1, k2), xmm1, xmm2
        #   vpcmpeqd k1, xmm1, xmm2
        #   vpcmpeqd opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpcmpeqd k1, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpcmpeqd opmask(k1, k2), ymm1, ymm2
        #   vpcmpeqd k1, ymm1, ymm2
        #   vpcmpeqd opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpcmpeqd k1, zmm1, bcst(dword([ecx]), {1=>16})
        #   vpcmpeqd opmask(k1, k2), zmm1, zmm2
        #   vpcmpeqd k1, zmm1, zmm2
        #   vpcmpeqd xmm0, xmm1, xmm2
        #   vpcmpeqd xmm0, xmm1, oword([ecx])
        #   vpcmpeqd ymm0, ymm1, ymm2
        #   vpcmpeqd ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpcmpeqq opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpcmpeqq k1, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpcmpeqq opmask(k1, k2), xmm1, xmm2
        #   vpcmpeqq k1, xmm1, xmm2
        #   vpcmpeqq opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpcmpeqq k1, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpcmpeqq opmask(k1, k2), ymm1, ymm2
        #   vpcmpeqq k1, ymm1, ymm2
        #   vpcmpeqq opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpcmpeqq k1, zmm1, bcst(qword([ecx]), {1=>8})
        #   vpcmpeqq opmask(k1, k2), zmm1, zmm2
        #   vpcmpeqq k1, zmm1, zmm2
        #   vpcmpeqq xmm0, xmm1, xmm2
        #   vpcmpeqq xmm0, xmm1, oword([ecx])
        #   vpcmpeqq ymm0, ymm1, ymm2
        #   vpcmpeqq ymm0, ymm1, yword([ecx])
        ...
        #   vpcmpeqw opmask(k1, k2), xmm1, oword([ecx])
        #   vpcmpeqw k1, xmm1, oword([ecx])
        #   vpcmpeqw opmask(k1, k2), ymm1, ymm2
        #   vpcmpeqw k1, ymm1, ymm2
        #   vpcmpeqw opmask(k1, k2), ymm1, yword([ecx])
        #   vpcmpeqw k1, ymm1, yword([ecx])
        #   vpcmpeqw opmask(k1, k2), zmm1, zmm2
        #   vpcmpeqw k1, zmm1, zmm2
        #   vpcmpeqw opmask(k1, k2), zmm1, zword([ecx])
        #   vpcmpeqw k1, zmm1, zword([ecx])
        #   vpcmpeqw xmm0, xmm1, xmm2
        #   vpcmpeqw xmm0, xmm1, oword([ecx])
        #   vpcmpeqw ymm0, ymm1, ymm2
        #   vpcmpeqw ymm0, ymm1, yword([ecx])
        ...
        #   vpcmpestri xmm0, oword([ebx]), 0x03
        ...
        #   vpcmpestrm xmm0, oword([ebx]), 0x03
        ...
        #   vpcmpgtb opmask(k1, k2), xmm1, oword([ecx])
        #   vpcmpgtb k1, xmm1, oword([ecx])
        #   vpcmpgtb opmask(k1, k2), ymm1, ymm2
        #   vpcmpgtb k1, ymm1, ymm2
        #   vpcmpgtb opmask(k1, k2), ymm1, yword([ecx])
        #   vpcmpgtb k1, ymm1, yword([ecx])
        #   vpcmpgtb opmask(k1, k2), zmm1, zmm2
        #   vpcmpgtb k1, zmm1, zmm2
        #   vpcmpgtb opmask(k1, k2), zmm1, zword([ecx])
        #   vpcmpgtb k1, zmm1, zword([ecx])
        #   vpcmpgtb xmm0, xmm1, xmm2
        #   vpcmpgtb xmm0, xmm1, oword([ecx])
        #   vpcmpgtb ymm0, ymm1, ymm2
        #   vpcmpgtb ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpcmpgtd opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpcmpgtd k1, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpcmpgtd opmask(k1, k2), xmm1, xmm2
        #   vpcmpgtd k1, xmm1, xmm2
        #   vpcmpgtd opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpcmpgtd k1, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpcmpgtd opmask(k1, k2), ymm1, ymm2
        #   vpcmpgtd k1, ymm1, ymm2
        #   vpcmpgtd opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpcmpgtd k1, zmm1, bcst(dword([ecx]), {1=>16})
        #   vpcmpgtd opmask(k1, k2), zmm1, zmm2
        #   vpcmpgtd k1, zmm1, zmm2
        #   vpcmpgtd xmm0, xmm1, xmm2
        #   vpcmpgtd xmm0, xmm1, oword([ecx])
        #   vpcmpgtd ymm0, ymm1, ymm2
        #   vpcmpgtd ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpcmpgtq opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpcmpgtq k1, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpcmpgtq opmask(k1, k2), xmm1, xmm2
        #   vpcmpgtq k1, xmm1, xmm2
        #   vpcmpgtq opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpcmpgtq k1, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpcmpgtq opmask(k1, k2), ymm1, ymm2
        #   vpcmpgtq k1, ymm1, ymm2
        #   vpcmpgtq opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpcmpgtq k1, zmm1, bcst(qword([ecx]), {1=>8})
        #   vpcmpgtq opmask(k1, k2), zmm1, zmm2
        #   vpcmpgtq k1, zmm1, zmm2
        #   vpcmpgtq xmm0, xmm1, xmm2
        #   vpcmpgtq xmm0, xmm1, oword([ecx])
        #   vpcmpgtq ymm0, ymm1, ymm2
        #   vpcmpgtq ymm0, ymm1, yword([ecx])
        ...
        #   vpcmpgtw opmask(k1, k2), xmm1, oword([ecx])
        #   vpcmpgtw k1, xmm1, oword([ecx])
        #   vpcmpgtw opmask(k1, k2), ymm1, ymm2
        #   vpcmpgtw k1, ymm1, ymm2
        #   vpcmpgtw opmask(k1, k2), ymm1, yword([ecx])
        #   vpcmpgtw k1, ymm1, yword([ecx])
        #   vpcmpgtw opmask(k1, k2), zmm1, zmm2
        #   vpcmpgtw k1, zmm1, zmm2
        #   vpcmpgtw opmask(k1, k2), zmm1, zword([ecx])
        #   vpcmpgtw k1, zmm1, zword([ecx])
        #   vpcmpgtw xmm0, xmm1, xmm2
        #   vpcmpgtw xmm0, xmm1, oword([ecx])
        #   vpcmpgtw ymm0, ymm1, ymm2
        #   vpcmpgtw ymm0, ymm1, yword([ecx])
        ...
        #   vpcmpistri xmm0, oword([ebx]), 0x03
        ...
        #   vpcmpistrm xmm0, oword([ebx]), 0x03
        ...
        # @example
        #   vpcmpq opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpcmpq k1, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpcmpq opmask(k1, k2), xmm1, xmm2, 0x04
        #   vpcmpq k1, xmm1, xmm2, 0x04
        #   vpcmpq opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpcmpq k1, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpcmpq opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpq k1, ymm1, ymm2, 0x04
        #   vpcmpq opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vpcmpq k1, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        #   vpcmpub opmask(k1, k2), xmm1, oword([ecx]), 0x04
        #   vpcmpub k1, xmm1, oword([ecx]), 0x04
        #   vpcmpub opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpub k1, ymm1, ymm2, 0x04
        #   vpcmpub opmask(k1, k2), ymm1, yword([ecx]), 0x04
        #   vpcmpub k1, ymm1, yword([ecx]), 0x04
        #   vpcmpub opmask(k1, k2), zmm1, zmm2, 0x04
        #   vpcmpub k1, zmm1, zmm2, 0x04
        #   vpcmpub opmask(k1, k2), zmm1, zword([ecx]), 0x04
        #   vpcmpub k1, zmm1, zword([ecx]), 0x04
        ...
        # @example
        #   vpcmpud opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpcmpud k1, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpcmpud opmask(k1, k2), xmm1, xmm2, 0x04
        #   vpcmpud k1, xmm1, xmm2, 0x04
        #   vpcmpud opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpcmpud k1, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpcmpud opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpud k1, ymm1, ymm2, 0x04
        #   vpcmpud opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vpcmpud k1, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   vpcmpuq opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpcmpuq k1, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpcmpuq opmask(k1, k2), xmm1, xmm2, 0x04
        #   vpcmpuq k1, xmm1, xmm2, 0x04
        #   vpcmpuq opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpcmpuq k1, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpcmpuq opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpuq k1, ymm1, ymm2, 0x04
        #   vpcmpuq opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vpcmpuq k1, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        #   vpcmpuw opmask(k1, k2), xmm1, oword([ecx]), 0x04
        #   vpcmpuw k1, xmm1, oword([ecx]), 0x04
        #   vpcmpuw opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpuw k1, ymm1, ymm2, 0x04
        #   vpcmpuw opmask(k1, k2), ymm1, yword([ecx]), 0x04
        #   vpcmpuw k1, ymm1, yword([ecx]), 0x04
        #   vpcmpuw opmask(k1, k2), zmm1, zmm2, 0x04
        #   vpcmpuw k1, zmm1, zmm2, 0x04
        #   vpcmpuw opmask(k1, k2), zmm1, zword([ecx]), 0x04
        #   vpcmpuw k1, zmm1, zword([ecx]), 0x04
        ...
        #   vpcmpw opmask(k1, k2), xmm1, oword([ecx]), 0x04
        #   vpcmpw k1, xmm1, oword([ecx]), 0x04
        #   vpcmpw opmask(k1, k2), ymm1, ymm2, 0x04
        #   vpcmpw k1, ymm1, ymm2, 0x04
        #   vpcmpw opmask(k1, k2), ymm1, yword([ecx]), 0x04
        #   vpcmpw k1, ymm1, yword([ecx]), 0x04
        #   vpcmpw opmask(k1, k2), zmm1, zmm2, 0x04
        #   vpcmpw k1, zmm1, zmm2, 0x04
        #   vpcmpw opmask(k1, k2), zmm1, zword([ecx]), 0x04
        #   vpcmpw k1, zmm1, zword([ecx]), 0x04
        ...
        #   vpcomb xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vpcomd xmm0, xmm1, oword([ecx]), 0x04
        ...
        # @example
        #   vpcompressb opmask(oword([eax]), k1), xmm1
        #   vpcompressb opmask(xmm0, k1, zero: true), xmm1
        #   vpcompressb opmask(yword([eax]), k1), ymm1
        #   vpcompressb opmask(ymm0, k1, zero: true), ymm1
        #   vpcompressb opmask(zword([eax]), k1), zmm1
        #   vpcompressb opmask(zmm0, k1, zero: true), zmm1
        #   vpcompressb xmm0, xmm1
        #   vpcompressb ymm0, ymm1
        #   vpcompressb zmm0, zmm1
        #   vpcompressb oword([eax]), xmm1
        #   vpcompressb yword([eax]), ymm1
        #   vpcompressb zword([eax]), zmm1
        ...
        #   vpcompressd opmask(oword([eax]), k1), xmm1
        #   vpcompressd opmask(ymm0, k1, zero: true), ymm1
        #   vpcompressd opmask(yword([eax]), k1), ymm1
        #   vpcompressd opmask(zmm0, k1, zero: true), zmm1
        #   vpcompressd opmask(zword([eax]), k1), zmm1
        #   vpcompressd xmm0, xmm1
        #   vpcompressd ymm0, ymm1
        #   vpcompressd zmm0, zmm1
        #   vpcompressd oword([eax]), xmm1
        #   vpcompressd yword([eax]), ymm1
        #   vpcompressd zword([eax]), zmm1
        ...
        #   vpcompressq opmask(oword([eax]), k1), xmm1
        #   vpcompressq opmask(ymm0, k1, zero: true), ymm1
        #   vpcompressq opmask(yword([eax]), k1), ymm1
        #   vpcompressq opmask(zmm0, k1, zero: true), zmm1
        #   vpcompressq opmask(zword([eax]), k1), zmm1
        #   vpcompressq xmm0, xmm1
        #   vpcompressq ymm0, ymm1
        #   vpcompressq zmm0, zmm1
        #   vpcompressq oword([eax]), xmm1
        #   vpcompressq yword([eax]), ymm1
        #   vpcompressq zword([eax]), zmm1
        ...
        # @example
        #   vpcompressw opmask(oword([eax]), k1), xmm1
        #   vpcompressw opmask(xmm0, k1, zero: true), xmm1
        #   vpcompressw opmask(yword([eax]), k1), ymm1
        #   vpcompressw opmask(ymm0, k1, zero: true), ymm1
        #   vpcompressw opmask(zword([eax]), k1), zmm1
        #   vpcompressw opmask(zmm0, k1, zero: true), zmm1
        #   vpcompressw xmm0, xmm1
        #   vpcompressw ymm0, ymm1
        #   vpcompressw zmm0, zmm1
        #   vpcompressw oword([eax]), xmm1
        #   vpcompressw yword([eax]), ymm1
        #   vpcompressw zword([eax]), zmm1
        ...
        #   vpcomq xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vpcomub xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vpcomud xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vpcomuq xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vpcomuw xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vpcomw xmm0, xmm1, oword([ecx]), 0x04
        ...
        # @example
        #   vpconflictd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vpconflictd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vpconflictd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        ...
        #   vpconflictd xmm0, bcst(dword([ebx]), {1=>4})
        #   vpconflictd xmm0, xmm1
        #   vpconflictd ymm0, bcst(dword([ebx]), {1=>8})
        #   vpconflictd ymm0, ymm1
        #   vpconflictd zmm0, bcst(dword([ebx]), {1=>16})
        ...
        # @example
        #   vpconflictq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vpconflictq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vpconflictq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        ...
        #   vpconflictq xmm0, bcst(qword([ebx]), {1=>2})
        #   vpconflictq xmm0, xmm1
        #   vpconflictq ymm0, bcst(qword([ebx]), {1=>4})
        #   vpconflictq ymm0, ymm1
        #   vpconflictq zmm0, bcst(qword([ebx]), {1=>8})
        ...
        #   vpdpbssd xmm0, xmm1, oword([ecx])
        #   vpdpbssd ymm0, ymm1, ymm2
        #   vpdpbssd ymm0, ymm1, yword([ecx])
        ...
        #   vpdpbssds xmm0, xmm1, oword([ecx])
        #   vpdpbssds ymm0, ymm1, ymm2
        #   vpdpbssds ymm0, ymm1, yword([ecx])
        ...
        #   vpdpbsud xmm0, xmm1, oword([ecx])
        #   vpdpbsud ymm0, ymm1, ymm2
        #   vpdpbsud ymm0, ymm1, yword([ecx])
        ...
        #   vpdpbsuds xmm0, xmm1, oword([ecx])
        #   vpdpbsuds ymm0, ymm1, ymm2
        #   vpdpbsuds ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpdpbusd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpbusd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpdpbusd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpbusd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpdpbusd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpdpbusd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpdpbusd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpbusd xmm0, xmm1, xmm2
        #   vpdpbusd xmm0, xmm1, xmm2
        #   vpdpbusd xmm0, xmm1, oword([ecx])
        #   vpdpbusd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpbusd ymm0, ymm1, ymm2
        #   vpdpbusd ymm0, ymm1, ymm2
        #   vpdpbusd ymm0, ymm1, yword([ecx])
        #   vpdpbusd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpdpbusds opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpbusds opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpdpbusds opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpbusds opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpdpbusds opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpdpbusds opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpdpbusds xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpbusds xmm0, xmm1, xmm2
        #   vpdpbusds xmm0, xmm1, xmm2
        #   vpdpbusds xmm0, xmm1, oword([ecx])
        #   vpdpbusds ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpbusds ymm0, ymm1, ymm2
        #   vpdpbusds ymm0, ymm1, ymm2
        #   vpdpbusds ymm0, ymm1, yword([ecx])
        #   vpdpbusds zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpdpbuud xmm0, xmm1, oword([ecx])
        #   vpdpbuud ymm0, ymm1, ymm2
        #   vpdpbuud ymm0, ymm1, yword([ecx])
        ...
        #   vpdpbuuds xmm0, xmm1, oword([ecx])
        #   vpdpbuuds ymm0, ymm1, ymm2
        #   vpdpbuuds ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpdpwssd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpwssd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpdpwssd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpwssd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpdpwssd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpdpwssd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpdpwssd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpwssd xmm0, xmm1, xmm2
        #   vpdpwssd xmm0, xmm1, xmm2
        #   vpdpwssd xmm0, xmm1, oword([ecx])
        #   vpdpwssd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpwssd ymm0, ymm1, ymm2
        #   vpdpwssd ymm0, ymm1, ymm2
        #   vpdpwssd ymm0, ymm1, yword([ecx])
        #   vpdpwssd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpdpwssds opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpwssds opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpdpwssds opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpwssds opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpdpwssds opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpdpwssds opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpdpwssds xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpdpwssds xmm0, xmm1, xmm2
        #   vpdpwssds xmm0, xmm1, xmm2
        #   vpdpwssds xmm0, xmm1, oword([ecx])
        #   vpdpwssds ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpdpwssds ymm0, ymm1, ymm2
        #   vpdpwssds ymm0, ymm1, ymm2
        #   vpdpwssds ymm0, ymm1, yword([ecx])
        #   vpdpwssds zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpdpwsud xmm0, xmm1, oword([ecx])
        #   vpdpwsud ymm0, ymm1, ymm2
        #   vpdpwsud ymm0, ymm1, yword([ecx])
        ...
        #   vpdpwsuds xmm0, xmm1, oword([ecx])
        #   vpdpwsuds ymm0, ymm1, ymm2
        #   vpdpwsuds ymm0, ymm1, yword([ecx])
        ...
        #   vpdpwusd xmm0, xmm1, oword([ecx])
        #   vpdpwusd ymm0, ymm1, ymm2
        #   vpdpwusd ymm0, ymm1, yword([ecx])
        ...
        #   vpdpwusds xmm0, xmm1, oword([ecx])
        #   vpdpwusds ymm0, ymm1, ymm2
        #   vpdpwusds ymm0, ymm1, yword([ecx])
        ...
        #   vpdpwuud xmm0, xmm1, oword([ecx])
        #   vpdpwuud ymm0, ymm1, ymm2
        #   vpdpwuud ymm0, ymm1, yword([ecx])
        ...
        #   vpdpwuuds xmm0, xmm1, oword([ecx])
        #   vpdpwuuds ymm0, ymm1, ymm2
        #   vpdpwuuds ymm0, ymm1, yword([ecx])
        ...
        #   vperm2f128 ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vperm2i128 ymm0, ymm1, yword([ecx]), 0x04
        ...
        #   vpermb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpermb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpermb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpermb xmm0, xmm1, xmm2
        #   vpermb xmm0, xmm1, oword([ecx])
        #   vpermb ymm0, ymm1, ymm2
        #   vpermb ymm0, ymm1, yword([ecx])
        #   vpermb zmm0, zmm1, zmm2
        #   vpermb zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpermd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermd ymm0, ymm1, ymm2
        #   vpermd ymm0, ymm1, ymm2
        #   vpermd ymm0, ymm1, yword([ecx])
        #   vpermd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vpermi2b opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpermi2b opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermi2b opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpermi2b opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermi2b opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpermi2b xmm0, xmm1, xmm2
        #   vpermi2b xmm0, xmm1, oword([ecx])
        #   vpermi2b ymm0, ymm1, ymm2
        #   vpermi2b ymm0, ymm1, yword([ecx])
        #   vpermi2b zmm0, zmm1, zmm2
        #   vpermi2b zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpermi2d opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermi2d opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermi2d opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermi2d opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermi2d opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermi2d opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermi2d xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermi2d xmm0, xmm1, xmm2
        #   vpermi2d ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermi2d ymm0, ymm1, ymm2
        #   vpermi2d zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpermi2pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermi2pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermi2pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermi2pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermi2pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermi2pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermi2pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermi2pd xmm0, xmm1, xmm2
        #   vpermi2pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermi2pd ymm0, ymm1, ymm2
        #   vpermi2pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpermi2ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermi2ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermi2ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermi2ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermi2ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermi2ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermi2ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermi2ps xmm0, xmm1, xmm2
        #   vpermi2ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermi2ps ymm0, ymm1, ymm2
        #   vpermi2ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpermi2q opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermi2q opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermi2q opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermi2q opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermi2q opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermi2q opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermi2q xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermi2q xmm0, xmm1, xmm2
        #   vpermi2q ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermi2q ymm0, ymm1, ymm2
        #   vpermi2q zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpermi2w opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpermi2w opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermi2w opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpermi2w opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermi2w opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpermi2w xmm0, xmm1, xmm2
        #   vpermi2w xmm0, xmm1, oword([ecx])
        #   vpermi2w ymm0, ymm1, ymm2
        #   vpermi2w ymm0, ymm1, yword([ecx])
        #   vpermi2w zmm0, zmm1, zmm2
        #   vpermi2w zmm0, zmm1, zword([ecx])
        ...
        #   vpermil2pd xmm0, xmm1, xmm2, oword([edx]), 0b1111
        #   vpermil2pd xmm0, xmm1, oword([ecx]), xmm3, 0b1111
        #   vpermil2pd ymm0, ymm1, ymm2, ymm3, 0b1111
        #   vpermil2pd ymm0, ymm1, ymm2, yword([edx]), 0b1111
        #   vpermil2pd ymm0, ymm1, yword([ecx]), ymm3, 0b1111
        ...
        #   vpermil2ps xmm0, xmm1, xmm2, oword([edx]), 0b1111
        #   vpermil2ps xmm0, xmm1, oword([ecx]), xmm3, 0b1111
        #   vpermil2ps ymm0, ymm1, ymm2, ymm3, 0b1111
        #   vpermil2ps ymm0, ymm1, ymm2, yword([edx]), 0b1111
        #   vpermil2ps ymm0, ymm1, yword([ecx]), ymm3, 0b1111
        ...
        # @example
        #   vpermilpd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vpermilpd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vpermilpd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        #   vpermilpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermilpd opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpermilpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermilpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermilpd opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpermilpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermilpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermilpd opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpermilpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermilpd xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vpermilpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermilpd xmm0, xmm1, 0x03
        #   vpermilpd xmm0, xmm1, 0x03
        #   vpermilpd xmm0, xmm1, xmm2
        #   vpermilpd xmm0, xmm1, xmm2
        #   vpermilpd xmm0, xmm1, oword([ecx])
        #   vpermilpd xmm0, oword([ebx]), 0x03
        #   vpermilpd ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vpermilpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermilpd ymm0, ymm1, 0x03
        #   vpermilpd ymm0, ymm1, 0x03
        #   vpermilpd ymm0, ymm1, ymm2
        #   vpermilpd ymm0, ymm1, ymm2
        #   vpermilpd ymm0, ymm1, yword([ecx])
        #   vpermilpd ymm0, yword([ebx]), 0x03
        #   vpermilpd zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        #   vpermilpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpermilps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vpermilps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vpermilps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        #   vpermilps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermilps opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpermilps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermilps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermilps opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpermilps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermilps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermilps opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpermilps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermilps xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vpermilps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermilps xmm0, xmm1, 0x03
        #   vpermilps xmm0, xmm1, 0x03
        #   vpermilps xmm0, xmm1, xmm2
        #   vpermilps xmm0, xmm1, xmm2
        #   vpermilps xmm0, xmm1, oword([ecx])
        #   vpermilps xmm0, oword([ebx]), 0x03
        #   vpermilps ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vpermilps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermilps ymm0, ymm1, 0x03
        #   vpermilps ymm0, ymm1, 0x03
        #   vpermilps ymm0, ymm1, ymm2
        #   vpermilps ymm0, ymm1, ymm2
        #   vpermilps ymm0, ymm1, yword([ecx])
        #   vpermilps ymm0, yword([ebx]), 0x03
        #   vpermilps zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        #   vpermilps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpermpd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vpermpd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        #   vpermpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermpd opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpermpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermpd opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpermpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermpd ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vpermpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermpd ymm0, ymm1, 0x03
        #   vpermpd ymm0, ymm1, 0x03
        #   vpermpd ymm0, ymm1, ymm2
        #   vpermpd ymm0, yword([ebx]), 0x03
        #   vpermpd zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        #   vpermpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpermps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermps ymm0, ymm1, ymm2
        #   vpermps ymm0, ymm1, ymm2
        #   vpermps ymm0, ymm1, yword([ecx])
        #   vpermps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpermq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vpermq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        #   vpermq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermq opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpermq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermq opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpermq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermq ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vpermq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermq ymm0, ymm1, 0x03
        #   vpermq ymm0, ymm1, 0x03
        #   vpermq ymm0, ymm1, ymm2
        #   vpermq ymm0, yword([ebx]), 0x03
        #   vpermq zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        #   vpermq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpermt2b opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpermt2b opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermt2b opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpermt2b opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermt2b opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpermt2b xmm0, xmm1, xmm2
        #   vpermt2b xmm0, xmm1, oword([ecx])
        #   vpermt2b ymm0, ymm1, ymm2
        #   vpermt2b ymm0, ymm1, yword([ecx])
        #   vpermt2b zmm0, zmm1, zmm2
        #   vpermt2b zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpermt2d opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermt2d opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermt2d opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermt2d opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermt2d opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermt2d opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermt2d xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermt2d xmm0, xmm1, xmm2
        #   vpermt2d ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermt2d ymm0, ymm1, ymm2
        #   vpermt2d zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpermt2pd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermt2pd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermt2pd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermt2pd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermt2pd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermt2pd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermt2pd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermt2pd xmm0, xmm1, xmm2
        #   vpermt2pd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermt2pd ymm0, ymm1, ymm2
        #   vpermt2pd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpermt2ps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermt2ps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermt2ps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermt2ps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermt2ps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpermt2ps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermt2ps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpermt2ps xmm0, xmm1, xmm2
        #   vpermt2ps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpermt2ps ymm0, ymm1, ymm2
        #   vpermt2ps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpermt2q opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermt2q opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpermt2q opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermt2q opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermt2q opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpermt2q opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermt2q xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpermt2q xmm0, xmm1, xmm2
        #   vpermt2q ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpermt2q ymm0, ymm1, ymm2
        #   vpermt2q zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpermt2w opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpermt2w opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermt2w opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpermt2w opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermt2w opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpermt2w xmm0, xmm1, xmm2
        #   vpermt2w xmm0, xmm1, oword([ecx])
        #   vpermt2w ymm0, ymm1, ymm2
        #   vpermt2w ymm0, ymm1, yword([ecx])
        #   vpermt2w zmm0, zmm1, zmm2
        #   vpermt2w zmm0, zmm1, zword([ecx])
        ...
        #   vpermw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpermw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpermw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpermw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpermw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpermw xmm0, xmm1, xmm2
        #   vpermw xmm0, xmm1, oword([ecx])
        #   vpermw ymm0, ymm1, ymm2
        #   vpermw ymm0, ymm1, yword([ecx])
        #   vpermw zmm0, zmm1, zmm2
        #   vpermw zmm0, zmm1, zword([ecx])
        ...
        #   vpexpandb opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpexpandb opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpexpandb opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpexpandb xmm0, xmm1
        #   vpexpandb xmm0, oword([ebx])
        #   vpexpandb ymm0, ymm1
        #   vpexpandb ymm0, yword([ebx])
        #   vpexpandb zmm0, zmm1
        #   vpexpandb zmm0, zword([ebx])
        ...
        #   vpexpandd opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpexpandd opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpexpandd opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpexpandd xmm0, xmm1
        #   vpexpandd xmm0, oword([ebx])
        #   vpexpandd ymm0, ymm1
        #   vpexpandd ymm0, yword([ebx])
        #   vpexpandd zmm0, zmm1
        #   vpexpandd zmm0, zword([ebx])
        ...
        #   vpexpandq opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpexpandq opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpexpandq opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpexpandq xmm0, xmm1
        #   vpexpandq xmm0, oword([ebx])
        #   vpexpandq ymm0, ymm1
        #   vpexpandq ymm0, yword([ebx])
        #   vpexpandq zmm0, zmm1
        #   vpexpandq zmm0, zword([ebx])
        ...
        #   vpexpandw opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpexpandw opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpexpandw opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpexpandw xmm0, xmm1
        #   vpexpandw xmm0, oword([ebx])
        #   vpexpandw ymm0, ymm1
        #   vpexpandw ymm0, yword([ebx])
        #   vpexpandw zmm0, zmm1
        #   vpexpandw zmm0, zword([ebx])
        ...
        # @example
        #   vpgatherdd opmask(xmm0, k1), dword([ebx+xmm1*4])
        #   vpgatherdd opmask(ymm0, k1), dword([ebx+ymm1*4])
        #   vpgatherdd opmask(zmm0, k1), dword([ebx+zmm1*4])
        #   vpgatherdd xmm0, dword([ebx+xmm1*4]), xmm2
        #   vpgatherdd ymm0, dword([ebx+ymm1*4]), ymm2
        ...
        # @example
        #   vpgatherdq opmask(xmm0, k1), dword([ebx+xmm1*4])
        #   vpgatherdq opmask(ymm0, k1), dword([ebx+xmm1*4])
        #   vpgatherdq opmask(zmm0, k1), dword([ebx+ymm1*4])
        #   vpgatherdq xmm0, dword([ebx+xmm1*4]), xmm2
        #   vpgatherdq ymm0, dword([ebx+xmm1*4]), ymm2
        ...
        # @example
        #   vpgatherqd opmask(xmm0, k1), qword([ebx+xmm1*8])
        #   vpgatherqd opmask(xmm0, k1), qword([ebx+ymm1*8])
        #   vpgatherqd opmask(ymm0, k1), qword([ebx+zmm1*8])
        #   vpgatherqd xmm0, qword([ebx+xmm1*8]), xmm2
        #   vpgatherqd xmm0, qword([ebx+ymm1*8]), xmm2
        ...
        # @example
        #   vpgatherqq opmask(xmm0, k1), qword([ebx+xmm1*8])
        #   vpgatherqq opmask(ymm0, k1), qword([ebx+ymm1*8])
        #   vpgatherqq opmask(zmm0, k1), qword([ebx+zmm1*8])
        #   vpgatherqq xmm0, qword([ebx+xmm1*8]), xmm2
        #   vpgatherqq ymm0, qword([ebx+ymm1*8]), ymm2
        ...
        #   vphaddd xmm0, xmm1, oword([ecx])
        #   vphaddd ymm0, ymm1, ymm2
        #   vphaddd ymm0, ymm1, yword([ecx])
        ...
        #   vphaddsw xmm0, xmm1, oword([ecx])
        #   vphaddsw ymm0, ymm1, ymm2
        #   vphaddsw ymm0, ymm1, yword([ecx])
        ...
        #   vphaddw xmm0, xmm1, oword([ecx])
        #   vphaddw ymm0, ymm1, ymm2
        #   vphaddw ymm0, ymm1, yword([ecx])
        ...
        #   vphsubd xmm0, xmm1, oword([ecx])
        #   vphsubd ymm0, ymm1, ymm2
        #   vphsubd ymm0, ymm1, yword([ecx])
        ...
        #   vphsubsw xmm0, xmm1, oword([ecx])
        #   vphsubsw ymm0, ymm1, ymm2
        #   vphsubsw ymm0, ymm1, yword([ecx])
        ...
        #   vphsubw xmm0, xmm1, oword([ecx])
        #   vphsubw ymm0, ymm1, ymm2
        #   vphsubw ymm0, ymm1, yword([ecx])
        ...
        #   vpinsrb xmm0, xmm1, ecx, 0x04
        #   vpinsrb xmm0, xmm1, byte([ecx]), 0x04
        #   vpinsrb xmm0, xmm1, byte([ecx]), 0x04
        ...
        #   vpinsrd xmm0, xmm1, ecx, 0x04
        #   vpinsrd xmm0, xmm1, dword([ecx]), 0x04
        #   vpinsrd xmm0, xmm1, dword([ecx]), 0x04
        ...
        #   vpinsrw xmm0, xmm1, ecx, 0x04
        #   vpinsrw xmm0, xmm1, word([ecx]), 0x04
        #   vpinsrw xmm0, xmm1, word([ecx]), 0x04
        ...
        # @example
        #   vplzcntd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vplzcntd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vplzcntd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vplzcntd opmask(xmm0, k1, zero: true), xmm1
        #   vplzcntd opmask(ymm0, k1, zero: true), ymm1
        #   vplzcntd opmask(zmm0, k1, zero: true), zmm1
        #   vplzcntd xmm0, bcst(dword([ebx]), {1=>4})
        #   vplzcntd xmm0, xmm1
        #   vplzcntd ymm0, bcst(dword([ebx]), {1=>8})
        #   vplzcntd ymm0, ymm1
        #   vplzcntd zmm0, bcst(dword([ebx]), {1=>16})
        #   vplzcntd zmm0, zmm1
        ...
        # @example
        #   vplzcntq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vplzcntq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vplzcntq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vplzcntq opmask(xmm0, k1, zero: true), xmm1
        #   vplzcntq opmask(ymm0, k1, zero: true), ymm1
        #   vplzcntq opmask(zmm0, k1, zero: true), zmm1
        #   vplzcntq xmm0, bcst(qword([ebx]), {1=>2})
        #   vplzcntq xmm0, xmm1
        #   vplzcntq ymm0, bcst(qword([ebx]), {1=>4})
        #   vplzcntq ymm0, ymm1
        #   vplzcntq zmm0, bcst(qword([ebx]), {1=>8})
        #   vplzcntq zmm0, zmm1
        ...
        #   vpmacsdd xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacsdqh xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacsdql xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacssdd xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacssdqh xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacssdql xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacsswd xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacssww xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacswd xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmacsww xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmadcsswd xmm0, xmm1, oword([ecx]), xmm3
        ...
        #   vpmadcswd xmm0, xmm1, oword([ecx]), xmm3
        ...
        # @example
        #   vpmadd52huq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmadd52huq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmadd52huq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmadd52huq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmadd52huq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmadd52huq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmadd52huq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmadd52huq xmm0, xmm1, xmm2
        #   vpmadd52huq xmm0, xmm1, xmm2
        #   vpmadd52huq xmm0, xmm1, oword([ecx])
        #   vpmadd52huq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmadd52huq ymm0, ymm1, ymm2
        #   vpmadd52huq ymm0, ymm1, ymm2
        #   vpmadd52huq ymm0, ymm1, yword([ecx])
        #   vpmadd52huq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpmadd52luq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmadd52luq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmadd52luq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmadd52luq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmadd52luq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmadd52luq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmadd52luq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmadd52luq xmm0, xmm1, xmm2
        #   vpmadd52luq xmm0, xmm1, xmm2
        #   vpmadd52luq xmm0, xmm1, oword([ecx])
        #   vpmadd52luq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmadd52luq ymm0, ymm1, ymm2
        #   vpmadd52luq ymm0, ymm1, ymm2
        #   vpmadd52luq ymm0, ymm1, yword([ecx])
        #   vpmadd52luq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpmaddubsw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmaddubsw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaddubsw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmaddubsw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaddubsw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmaddubsw xmm0, xmm1, xmm2
        #   vpmaddubsw xmm0, xmm1, xmm2
        #   vpmaddubsw xmm0, xmm1, oword([ecx])
        #   vpmaddubsw xmm0, xmm1, oword([ecx])
        #   vpmaddubsw ymm0, ymm1, ymm2
        #   vpmaddubsw ymm0, ymm1, ymm2
        #   vpmaddubsw ymm0, ymm1, yword([ecx])
        #   vpmaddubsw ymm0, ymm1, yword([ecx])
        #   vpmaddubsw zmm0, zmm1, zmm2
        #   vpmaddubsw zmm0, zmm1, zword([ecx])
        ...
        #   vpmaddwd opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmaddwd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaddwd opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmaddwd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaddwd opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmaddwd xmm0, xmm1, xmm2
        #   vpmaddwd xmm0, xmm1, xmm2
        #   vpmaddwd xmm0, xmm1, oword([ecx])
        #   vpmaddwd xmm0, xmm1, oword([ecx])
        #   vpmaddwd ymm0, ymm1, ymm2
        #   vpmaddwd ymm0, ymm1, ymm2
        #   vpmaddwd ymm0, ymm1, yword([ecx])
        #   vpmaddwd ymm0, ymm1, yword([ecx])
        #   vpmaddwd zmm0, zmm1, zmm2
        #   vpmaddwd zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpmaskmovd xmm0, xmm1, oword([ecx])
        #   vpmaskmovd ymm0, ymm1, yword([ecx])
        #   vpmaskmovd oword([eax]), xmm1, xmm2
        #   vpmaskmovd yword([eax]), ymm1, ymm2
        ...
        # @example
        #   vpmaskmovq xmm0, xmm1, oword([ecx])
        #   vpmaskmovq ymm0, ymm1, yword([ecx])
        #   vpmaskmovq oword([eax]), xmm1, xmm2
        #   vpmaskmovq yword([eax]), ymm1, ymm2
        ...
        #   vpmaxsb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmaxsb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxsb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmaxsb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxsb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmaxsb xmm0, xmm1, xmm2
        #   vpmaxsb xmm0, xmm1, xmm2
        #   vpmaxsb xmm0, xmm1, oword([ecx])
        #   vpmaxsb xmm0, xmm1, oword([ecx])
        #   vpmaxsb ymm0, ymm1, ymm2
        #   vpmaxsb ymm0, ymm1, ymm2
        #   vpmaxsb ymm0, ymm1, yword([ecx])
        #   vpmaxsb ymm0, ymm1, yword([ecx])
        #   vpmaxsb zmm0, zmm1, zmm2
        #   vpmaxsb zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpmaxsd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpmaxsd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmaxsd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpmaxsd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxsd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpmaxsd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxsd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpmaxsd xmm0, xmm1, xmm2
        #   vpmaxsd xmm0, xmm1, xmm2
        #   vpmaxsd xmm0, xmm1, oword([ecx])
        #   vpmaxsd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpmaxsd ymm0, ymm1, ymm2
        #   vpmaxsd ymm0, ymm1, ymm2
        #   vpmaxsd ymm0, ymm1, yword([ecx])
        #   vpmaxsd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpmaxsq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmaxsq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmaxsq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmaxsq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxsq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmaxsq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxsq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmaxsq xmm0, xmm1, xmm2
        #   vpmaxsq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmaxsq ymm0, ymm1, ymm2
        #   vpmaxsq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpmaxsw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmaxsw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxsw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmaxsw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxsw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmaxsw xmm0, xmm1, xmm2
        #   vpmaxsw xmm0, xmm1, xmm2
        #   vpmaxsw xmm0, xmm1, oword([ecx])
        #   vpmaxsw xmm0, xmm1, oword([ecx])
        #   vpmaxsw ymm0, ymm1, ymm2
        #   vpmaxsw ymm0, ymm1, ymm2
        #   vpmaxsw ymm0, ymm1, yword([ecx])
        #   vpmaxsw ymm0, ymm1, yword([ecx])
        #   vpmaxsw zmm0, zmm1, zmm2
        #   vpmaxsw zmm0, zmm1, zword([ecx])
        ...
        #   vpmaxub opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmaxub opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxub opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmaxub opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxub opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmaxub xmm0, xmm1, xmm2
        #   vpmaxub xmm0, xmm1, xmm2
        #   vpmaxub xmm0, xmm1, oword([ecx])
        #   vpmaxub xmm0, xmm1, oword([ecx])
        #   vpmaxub ymm0, ymm1, ymm2
        #   vpmaxub ymm0, ymm1, ymm2
        #   vpmaxub ymm0, ymm1, yword([ecx])
        #   vpmaxub ymm0, ymm1, yword([ecx])
        #   vpmaxub zmm0, zmm1, zmm2
        #   vpmaxub zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpmaxud opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpmaxud opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmaxud opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpmaxud opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxud opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpmaxud opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxud xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpmaxud xmm0, xmm1, xmm2
        #   vpmaxud xmm0, xmm1, xmm2
        #   vpmaxud xmm0, xmm1, oword([ecx])
        #   vpmaxud ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpmaxud ymm0, ymm1, ymm2
        #   vpmaxud ymm0, ymm1, ymm2
        #   vpmaxud ymm0, ymm1, yword([ecx])
        #   vpmaxud zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpmaxuq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmaxuq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmaxuq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmaxuq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxuq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmaxuq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxuq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmaxuq xmm0, xmm1, xmm2
        #   vpmaxuq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmaxuq ymm0, ymm1, ymm2
        #   vpmaxuq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpmaxuw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmaxuw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmaxuw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmaxuw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmaxuw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmaxuw xmm0, xmm1, xmm2
        #   vpmaxuw xmm0, xmm1, xmm2
        #   vpmaxuw xmm0, xmm1, oword([ecx])
        #   vpmaxuw xmm0, xmm1, oword([ecx])
        #   vpmaxuw ymm0, ymm1, ymm2
        #   vpmaxuw ymm0, ymm1, ymm2
        #   vpmaxuw ymm0, ymm1, yword([ecx])
        #   vpmaxuw ymm0, ymm1, yword([ecx])
        #   vpmaxuw zmm0, zmm1, zmm2
        #   vpmaxuw zmm0, zmm1, zword([ecx])
        ...
        #   vpminsb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpminsb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminsb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpminsb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminsb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpminsb xmm0, xmm1, xmm2
        #   vpminsb xmm0, xmm1, xmm2
        #   vpminsb xmm0, xmm1, oword([ecx])
        #   vpminsb xmm0, xmm1, oword([ecx])
        #   vpminsb ymm0, ymm1, ymm2
        #   vpminsb ymm0, ymm1, ymm2
        #   vpminsb ymm0, ymm1, yword([ecx])
        #   vpminsb ymm0, ymm1, yword([ecx])
        #   vpminsb zmm0, zmm1, zmm2
        #   vpminsb zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpminsd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpminsd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpminsd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpminsd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminsd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpminsd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminsd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpminsd xmm0, xmm1, xmm2
        #   vpminsd xmm0, xmm1, xmm2
        #   vpminsd xmm0, xmm1, oword([ecx])
        #   vpminsd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpminsd ymm0, ymm1, ymm2
        #   vpminsd ymm0, ymm1, ymm2
        #   vpminsd ymm0, ymm1, yword([ecx])
        #   vpminsd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpminsq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpminsq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpminsq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpminsq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminsq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpminsq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminsq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpminsq xmm0, xmm1, xmm2
        #   vpminsq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpminsq ymm0, ymm1, ymm2
        #   vpminsq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpminsw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpminsw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminsw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpminsw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminsw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpminsw xmm0, xmm1, xmm2
        #   vpminsw xmm0, xmm1, xmm2
        #   vpminsw xmm0, xmm1, oword([ecx])
        #   vpminsw xmm0, xmm1, oword([ecx])
        #   vpminsw ymm0, ymm1, ymm2
        #   vpminsw ymm0, ymm1, ymm2
        #   vpminsw ymm0, ymm1, yword([ecx])
        #   vpminsw ymm0, ymm1, yword([ecx])
        #   vpminsw zmm0, zmm1, zmm2
        #   vpminsw zmm0, zmm1, zword([ecx])
        ...
        #   vpminub opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpminub opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminub opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpminub opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminub opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpminub xmm0, xmm1, xmm2
        #   vpminub xmm0, xmm1, xmm2
        #   vpminub xmm0, xmm1, oword([ecx])
        #   vpminub xmm0, xmm1, oword([ecx])
        #   vpminub ymm0, ymm1, ymm2
        #   vpminub ymm0, ymm1, ymm2
        #   vpminub ymm0, ymm1, yword([ecx])
        #   vpminub ymm0, ymm1, yword([ecx])
        #   vpminub zmm0, zmm1, zmm2
        #   vpminub zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpminud opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpminud opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpminud opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpminud opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminud opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpminud opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminud xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpminud xmm0, xmm1, xmm2
        #   vpminud xmm0, xmm1, xmm2
        #   vpminud xmm0, xmm1, oword([ecx])
        #   vpminud ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpminud ymm0, ymm1, ymm2
        #   vpminud ymm0, ymm1, ymm2
        #   vpminud ymm0, ymm1, yword([ecx])
        #   vpminud zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpminuq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpminuq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpminuq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpminuq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminuq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpminuq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminuq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpminuq xmm0, xmm1, xmm2
        #   vpminuq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpminuq ymm0, ymm1, ymm2
        #   vpminuq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpminuw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpminuw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpminuw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpminuw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpminuw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpminuw xmm0, xmm1, xmm2
        #   vpminuw xmm0, xmm1, xmm2
        #   vpminuw xmm0, xmm1, oword([ecx])
        #   vpminuw xmm0, xmm1, oword([ecx])
        #   vpminuw ymm0, ymm1, ymm2
        #   vpminuw ymm0, ymm1, ymm2
        #   vpminuw ymm0, ymm1, yword([ecx])
        #   vpminuw ymm0, ymm1, yword([ecx])
        #   vpminuw zmm0, zmm1, zmm2
        #   vpminuw zmm0, zmm1, zword([ecx])
        ...
        #   vpmovdb opmask(dword([eax]), k1), xmm1
        #   vpmovdb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovdb opmask(qword([eax]), k1), ymm1
        #   vpmovdb opmask(xmm0, k1, zero: true), zmm1
        #   vpmovdb opmask(oword([eax]), k1), zmm1
        #   vpmovdb xmm0, xmm1
        #   vpmovdb xmm0, ymm1
        #   vpmovdb xmm0, zmm1
        #   vpmovdb dword([eax]), xmm1
        #   vpmovdb qword([eax]), ymm1
        #   vpmovdb oword([eax]), zmm1
        ...
        #   vpmovdw opmask(qword([eax]), k1), xmm1
        #   vpmovdw opmask(xmm0, k1, zero: true), ymm1
        #   vpmovdw opmask(oword([eax]), k1), ymm1
        #   vpmovdw opmask(ymm0, k1, zero: true), zmm1
        #   vpmovdw opmask(yword([eax]), k1), zmm1
        #   vpmovdw xmm0, xmm1
        #   vpmovdw xmm0, ymm1
        #   vpmovdw ymm0, zmm1
        #   vpmovdw qword([eax]), xmm1
        #   vpmovdw oword([eax]), ymm1
        #   vpmovdw yword([eax]), zmm1
        ...
        #   vpmovqb opmask(word([eax]), k1), xmm1
        #   vpmovqb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovqb opmask(dword([eax]), k1), ymm1
        #   vpmovqb opmask(xmm0, k1, zero: true), zmm1
        #   vpmovqb opmask(qword([eax]), k1), zmm1
        #   vpmovqb xmm0, xmm1
        #   vpmovqb xmm0, ymm1
        #   vpmovqb xmm0, zmm1
        #   vpmovqb word([eax]), xmm1
        #   vpmovqb dword([eax]), ymm1
        #   vpmovqb qword([eax]), zmm1
        ...
        #   vpmovqd opmask(qword([eax]), k1), xmm1
        #   vpmovqd opmask(xmm0, k1, zero: true), ymm1
        #   vpmovqd opmask(oword([eax]), k1), ymm1
        #   vpmovqd opmask(ymm0, k1, zero: true), zmm1
        #   vpmovqd opmask(yword([eax]), k1), zmm1
        #   vpmovqd xmm0, xmm1
        #   vpmovqd xmm0, ymm1
        #   vpmovqd ymm0, zmm1
        #   vpmovqd qword([eax]), xmm1
        #   vpmovqd oword([eax]), ymm1
        #   vpmovqd yword([eax]), zmm1
        ...
        #   vpmovqw opmask(dword([eax]), k1), xmm1
        #   vpmovqw opmask(xmm0, k1, zero: true), ymm1
        #   vpmovqw opmask(qword([eax]), k1), ymm1
        #   vpmovqw opmask(xmm0, k1, zero: true), zmm1
        #   vpmovqw opmask(oword([eax]), k1), zmm1
        #   vpmovqw xmm0, xmm1
        #   vpmovqw xmm0, ymm1
        #   vpmovqw xmm0, zmm1
        #   vpmovqw dword([eax]), xmm1
        #   vpmovqw qword([eax]), ymm1
        #   vpmovqw oword([eax]), zmm1
        ...
        #   vpmovsdb opmask(dword([eax]), k1), xmm1
        #   vpmovsdb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovsdb opmask(qword([eax]), k1), ymm1
        #   vpmovsdb opmask(xmm0, k1, zero: true), zmm1
        #   vpmovsdb opmask(oword([eax]), k1), zmm1
        #   vpmovsdb xmm0, xmm1
        #   vpmovsdb xmm0, ymm1
        #   vpmovsdb xmm0, zmm1
        #   vpmovsdb dword([eax]), xmm1
        #   vpmovsdb qword([eax]), ymm1
        #   vpmovsdb oword([eax]), zmm1
        ...
        #   vpmovsdw opmask(qword([eax]), k1), xmm1
        #   vpmovsdw opmask(xmm0, k1, zero: true), ymm1
        #   vpmovsdw opmask(oword([eax]), k1), ymm1
        #   vpmovsdw opmask(ymm0, k1, zero: true), zmm1
        #   vpmovsdw opmask(yword([eax]), k1), zmm1
        #   vpmovsdw xmm0, xmm1
        #   vpmovsdw xmm0, ymm1
        #   vpmovsdw ymm0, zmm1
        #   vpmovsdw qword([eax]), xmm1
        #   vpmovsdw oword([eax]), ymm1
        #   vpmovsdw yword([eax]), zmm1
        ...
        #   vpmovsqb opmask(word([eax]), k1), xmm1
        #   vpmovsqb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovsqb opmask(dword([eax]), k1), ymm1
        #   vpmovsqb opmask(xmm0, k1, zero: true), zmm1
        #   vpmovsqb opmask(qword([eax]), k1), zmm1
        #   vpmovsqb xmm0, xmm1
        #   vpmovsqb xmm0, ymm1
        #   vpmovsqb xmm0, zmm1
        #   vpmovsqb word([eax]), xmm1
        #   vpmovsqb dword([eax]), ymm1
        #   vpmovsqb qword([eax]), zmm1
        ...
        #   vpmovsqd opmask(qword([eax]), k1), xmm1
        #   vpmovsqd opmask(xmm0, k1, zero: true), ymm1
        #   vpmovsqd opmask(oword([eax]), k1), ymm1
        #   vpmovsqd opmask(ymm0, k1, zero: true), zmm1
        #   vpmovsqd opmask(yword([eax]), k1), zmm1
        #   vpmovsqd xmm0, xmm1
        #   vpmovsqd xmm0, ymm1
        #   vpmovsqd ymm0, zmm1
        #   vpmovsqd qword([eax]), xmm1
        #   vpmovsqd oword([eax]), ymm1
        #   vpmovsqd yword([eax]), zmm1
        ...
        #   vpmovsqw opmask(dword([eax]), k1), xmm1
        #   vpmovsqw opmask(xmm0, k1, zero: true), ymm1
        #   vpmovsqw opmask(qword([eax]), k1), ymm1
        #   vpmovsqw opmask(xmm0, k1, zero: true), zmm1
        #   vpmovsqw opmask(oword([eax]), k1), zmm1
        #   vpmovsqw xmm0, xmm1
        #   vpmovsqw xmm0, ymm1
        #   vpmovsqw xmm0, zmm1
        #   vpmovsqw dword([eax]), xmm1
        #   vpmovsqw qword([eax]), ymm1
        #   vpmovsqw oword([eax]), zmm1
        ...
        #   vpmovswb opmask(qword([eax]), k1), xmm1
        #   vpmovswb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovswb opmask(oword([eax]), k1), ymm1
        #   vpmovswb opmask(ymm0, k1, zero: true), zmm1
        #   vpmovswb opmask(yword([eax]), k1), zmm1
        #   vpmovswb xmm0, xmm1
        #   vpmovswb xmm0, ymm1
        #   vpmovswb ymm0, zmm1
        #   vpmovswb qword([eax]), xmm1
        #   vpmovswb oword([eax]), ymm1
        #   vpmovswb yword([eax]), zmm1
        ...
        #   vpmovsxbd opmask(xmm0, k1, zero: true), dword([ebx])
        #   vpmovsxbd opmask(ymm0, k1, zero: true), qword([ebx])
        #   vpmovsxbd opmask(zmm0, k1, zero: true), oword([ebx])
        #   vpmovsxbd xmm0, xmm1
        #   vpmovsxbd xmm0, xmm1
        #   vpmovsxbd xmm0, dword([ebx])
        #   vpmovsxbd xmm0, dword([ebx])
        #   vpmovsxbd ymm0, xmm1
        #   vpmovsxbd ymm0, xmm1
        #   vpmovsxbd ymm0, qword([ebx])
        #   vpmovsxbd ymm0, qword([ebx])
        #   vpmovsxbd zmm0, xmm1
        #   vpmovsxbd zmm0, oword([ebx])
        ...
        #   vpmovsxbq opmask(xmm0, k1, zero: true), word([ebx])
        #   vpmovsxbq opmask(ymm0, k1, zero: true), dword([ebx])
        #   vpmovsxbq opmask(zmm0, k1, zero: true), qword([ebx])
        #   vpmovsxbq xmm0, xmm1
        #   vpmovsxbq xmm0, xmm1
        #   vpmovsxbq xmm0, word([ebx])
        #   vpmovsxbq xmm0, word([ebx])
        #   vpmovsxbq ymm0, xmm1
        #   vpmovsxbq ymm0, xmm1
        #   vpmovsxbq ymm0, dword([ebx])
        #   vpmovsxbq ymm0, dword([ebx])
        #   vpmovsxbq zmm0, xmm1
        #   vpmovsxbq zmm0, qword([ebx])
        ...
        #   vpmovsxbw opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpmovsxbw opmask(ymm0, k1, zero: true), oword([ebx])
        #   vpmovsxbw opmask(zmm0, k1, zero: true), yword([ebx])
        #   vpmovsxbw xmm0, xmm1
        #   vpmovsxbw xmm0, xmm1
        #   vpmovsxbw xmm0, qword([ebx])
        #   vpmovsxbw xmm0, qword([ebx])
        #   vpmovsxbw ymm0, xmm1
        #   vpmovsxbw ymm0, xmm1
        #   vpmovsxbw ymm0, oword([ebx])
        #   vpmovsxbw ymm0, oword([ebx])
        #   vpmovsxbw zmm0, ymm1
        #   vpmovsxbw zmm0, yword([ebx])
        ...
        #   vpmovsxdq opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpmovsxdq opmask(ymm0, k1, zero: true), oword([ebx])
        #   vpmovsxdq opmask(zmm0, k1, zero: true), yword([ebx])
        #   vpmovsxdq xmm0, xmm1
        #   vpmovsxdq xmm0, xmm1
        #   vpmovsxdq xmm0, qword([ebx])
        #   vpmovsxdq xmm0, qword([ebx])
        #   vpmovsxdq ymm0, xmm1
        #   vpmovsxdq ymm0, xmm1
        #   vpmovsxdq ymm0, oword([ebx])
        #   vpmovsxdq ymm0, oword([ebx])
        #   vpmovsxdq zmm0, ymm1
        #   vpmovsxdq zmm0, yword([ebx])
        ...
        #   vpmovsxwd opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpmovsxwd opmask(ymm0, k1, zero: true), oword([ebx])
        #   vpmovsxwd opmask(zmm0, k1, zero: true), yword([ebx])
        #   vpmovsxwd xmm0, xmm1
        #   vpmovsxwd xmm0, xmm1
        #   vpmovsxwd xmm0, qword([ebx])
        #   vpmovsxwd xmm0, qword([ebx])
        #   vpmovsxwd ymm0, xmm1
        #   vpmovsxwd ymm0, xmm1
        #   vpmovsxwd ymm0, oword([ebx])
        #   vpmovsxwd ymm0, oword([ebx])
        #   vpmovsxwd zmm0, ymm1
        #   vpmovsxwd zmm0, yword([ebx])
        ...
        #   vpmovsxwq opmask(xmm0, k1, zero: true), dword([ebx])
        #   vpmovsxwq opmask(ymm0, k1, zero: true), qword([ebx])
        #   vpmovsxwq opmask(zmm0, k1, zero: true), oword([ebx])
        #   vpmovsxwq xmm0, xmm1
        #   vpmovsxwq xmm0, xmm1
        #   vpmovsxwq xmm0, dword([ebx])
        #   vpmovsxwq xmm0, dword([ebx])
        #   vpmovsxwq ymm0, xmm1
        #   vpmovsxwq ymm0, xmm1
        #   vpmovsxwq ymm0, qword([ebx])
        #   vpmovsxwq ymm0, qword([ebx])
        #   vpmovsxwq zmm0, xmm1
        #   vpmovsxwq zmm0, oword([ebx])
        ...
        #   vpmovusdb opmask(dword([eax]), k1), xmm1
        #   vpmovusdb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovusdb opmask(qword([eax]), k1), ymm1
        #   vpmovusdb opmask(xmm0, k1, zero: true), zmm1
        #   vpmovusdb opmask(oword([eax]), k1), zmm1
        #   vpmovusdb xmm0, xmm1
        #   vpmovusdb xmm0, ymm1
        #   vpmovusdb xmm0, zmm1
        #   vpmovusdb dword([eax]), xmm1
        #   vpmovusdb qword([eax]), ymm1
        #   vpmovusdb oword([eax]), zmm1
        ...
        #   vpmovusdw opmask(qword([eax]), k1), xmm1
        #   vpmovusdw opmask(xmm0, k1, zero: true), ymm1
        #   vpmovusdw opmask(oword([eax]), k1), ymm1
        #   vpmovusdw opmask(ymm0, k1, zero: true), zmm1
        #   vpmovusdw opmask(yword([eax]), k1), zmm1
        #   vpmovusdw xmm0, xmm1
        #   vpmovusdw xmm0, ymm1
        #   vpmovusdw ymm0, zmm1
        #   vpmovusdw qword([eax]), xmm1
        #   vpmovusdw oword([eax]), ymm1
        #   vpmovusdw yword([eax]), zmm1
        ...
        #   vpmovusqb opmask(word([eax]), k1), xmm1
        #   vpmovusqb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovusqb opmask(dword([eax]), k1), ymm1
        #   vpmovusqb opmask(xmm0, k1, zero: true), zmm1
        #   vpmovusqb opmask(qword([eax]), k1), zmm1
        #   vpmovusqb xmm0, xmm1
        #   vpmovusqb xmm0, ymm1
        #   vpmovusqb xmm0, zmm1
        #   vpmovusqb word([eax]), xmm1
        #   vpmovusqb dword([eax]), ymm1
        #   vpmovusqb qword([eax]), zmm1
        ...
        #   vpmovusqd opmask(qword([eax]), k1), xmm1
        #   vpmovusqd opmask(xmm0, k1, zero: true), ymm1
        #   vpmovusqd opmask(oword([eax]), k1), ymm1
        #   vpmovusqd opmask(ymm0, k1, zero: true), zmm1
        #   vpmovusqd opmask(yword([eax]), k1), zmm1
        #   vpmovusqd xmm0, xmm1
        #   vpmovusqd xmm0, ymm1
        #   vpmovusqd ymm0, zmm1
        #   vpmovusqd qword([eax]), xmm1
        #   vpmovusqd oword([eax]), ymm1
        #   vpmovusqd yword([eax]), zmm1
        ...
        #   vpmovusqw opmask(dword([eax]), k1), xmm1
        #   vpmovusqw opmask(xmm0, k1, zero: true), ymm1
        #   vpmovusqw opmask(qword([eax]), k1), ymm1
        #   vpmovusqw opmask(xmm0, k1, zero: true), zmm1
        #   vpmovusqw opmask(oword([eax]), k1), zmm1
        #   vpmovusqw xmm0, xmm1
        #   vpmovusqw xmm0, ymm1
        #   vpmovusqw xmm0, zmm1
        #   vpmovusqw dword([eax]), xmm1
        #   vpmovusqw qword([eax]), ymm1
        #   vpmovusqw oword([eax]), zmm1
        ...
        #   vpmovuswb opmask(qword([eax]), k1), xmm1
        #   vpmovuswb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovuswb opmask(oword([eax]), k1), ymm1
        #   vpmovuswb opmask(ymm0, k1, zero: true), zmm1
        #   vpmovuswb opmask(yword([eax]), k1), zmm1
        #   vpmovuswb xmm0, xmm1
        #   vpmovuswb xmm0, ymm1
        #   vpmovuswb ymm0, zmm1
        #   vpmovuswb qword([eax]), xmm1
        #   vpmovuswb oword([eax]), ymm1
        #   vpmovuswb yword([eax]), zmm1
        ...
        #   vpmovwb opmask(qword([eax]), k1), xmm1
        #   vpmovwb opmask(xmm0, k1, zero: true), ymm1
        #   vpmovwb opmask(oword([eax]), k1), ymm1
        #   vpmovwb opmask(ymm0, k1, zero: true), zmm1
        #   vpmovwb opmask(yword([eax]), k1), zmm1
        #   vpmovwb xmm0, xmm1
        #   vpmovwb xmm0, ymm1
        #   vpmovwb ymm0, zmm1
        #   vpmovwb qword([eax]), xmm1
        #   vpmovwb oword([eax]), ymm1
        #   vpmovwb yword([eax]), zmm1
        ...
        #   vpmovzxbd opmask(xmm0, k1, zero: true), dword([ebx])
        #   vpmovzxbd opmask(ymm0, k1, zero: true), qword([ebx])
        #   vpmovzxbd opmask(zmm0, k1, zero: true), oword([ebx])
        #   vpmovzxbd xmm0, xmm1
        #   vpmovzxbd xmm0, xmm1
        #   vpmovzxbd xmm0, dword([ebx])
        #   vpmovzxbd xmm0, dword([ebx])
        #   vpmovzxbd ymm0, xmm1
        #   vpmovzxbd ymm0, xmm1
        #   vpmovzxbd ymm0, qword([ebx])
        #   vpmovzxbd ymm0, qword([ebx])
        #   vpmovzxbd zmm0, xmm1
        #   vpmovzxbd zmm0, oword([ebx])
        ...
        #   vpmovzxbq opmask(xmm0, k1, zero: true), word([ebx])
        #   vpmovzxbq opmask(ymm0, k1, zero: true), dword([ebx])
        #   vpmovzxbq opmask(zmm0, k1, zero: true), qword([ebx])
        #   vpmovzxbq xmm0, xmm1
        #   vpmovzxbq xmm0, xmm1
        #   vpmovzxbq xmm0, word([ebx])
        #   vpmovzxbq xmm0, word([ebx])
        #   vpmovzxbq ymm0, xmm1
        #   vpmovzxbq ymm0, xmm1
        #   vpmovzxbq ymm0, dword([ebx])
        #   vpmovzxbq ymm0, dword([ebx])
        #   vpmovzxbq zmm0, xmm1
        #   vpmovzxbq zmm0, qword([ebx])
        ...
        #   vpmovzxbw opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpmovzxbw opmask(ymm0, k1, zero: true), oword([ebx])
        #   vpmovzxbw opmask(zmm0, k1, zero: true), yword([ebx])
        #   vpmovzxbw xmm0, xmm1
        #   vpmovzxbw xmm0, xmm1
        #   vpmovzxbw xmm0, qword([ebx])
        #   vpmovzxbw xmm0, qword([ebx])
        #   vpmovzxbw ymm0, xmm1
        #   vpmovzxbw ymm0, xmm1
        #   vpmovzxbw ymm0, oword([ebx])
        #   vpmovzxbw ymm0, oword([ebx])
        #   vpmovzxbw zmm0, ymm1
        #   vpmovzxbw zmm0, yword([ebx])
        ...
        #   vpmovzxdq opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpmovzxdq opmask(ymm0, k1, zero: true), oword([ebx])
        #   vpmovzxdq opmask(zmm0, k1, zero: true), yword([ebx])
        #   vpmovzxdq xmm0, xmm1
        #   vpmovzxdq xmm0, xmm1
        #   vpmovzxdq xmm0, qword([ebx])
        #   vpmovzxdq xmm0, qword([ebx])
        #   vpmovzxdq ymm0, xmm1
        #   vpmovzxdq ymm0, xmm1
        #   vpmovzxdq ymm0, oword([ebx])
        #   vpmovzxdq ymm0, oword([ebx])
        #   vpmovzxdq zmm0, ymm1
        #   vpmovzxdq zmm0, yword([ebx])
        ...
        #   vpmovzxwd opmask(xmm0, k1, zero: true), qword([ebx])
        #   vpmovzxwd opmask(ymm0, k1, zero: true), oword([ebx])
        #   vpmovzxwd opmask(zmm0, k1, zero: true), yword([ebx])
        #   vpmovzxwd xmm0, xmm1
        #   vpmovzxwd xmm0, xmm1
        #   vpmovzxwd xmm0, qword([ebx])
        #   vpmovzxwd xmm0, qword([ebx])
        #   vpmovzxwd ymm0, xmm1
        #   vpmovzxwd ymm0, xmm1
        #   vpmovzxwd ymm0, oword([ebx])
        #   vpmovzxwd ymm0, oword([ebx])
        #   vpmovzxwd zmm0, ymm1
        #   vpmovzxwd zmm0, yword([ebx])
        ...
        #   vpmovzxwq opmask(xmm0, k1, zero: true), dword([ebx])
        #   vpmovzxwq opmask(ymm0, k1, zero: true), qword([ebx])
        #   vpmovzxwq opmask(zmm0, k1, zero: true), oword([ebx])
        #   vpmovzxwq xmm0, xmm1
        #   vpmovzxwq xmm0, xmm1
        #   vpmovzxwq xmm0, dword([ebx])
        #   vpmovzxwq xmm0, dword([ebx])
        #   vpmovzxwq ymm0, xmm1
        #   vpmovzxwq ymm0, xmm1
        #   vpmovzxwq ymm0, qword([ebx])
        #   vpmovzxwq ymm0, qword([ebx])
        #   vpmovzxwq zmm0, xmm1
        #   vpmovzxwq zmm0, oword([ebx])
        ...
        # @example
        #   vpmuldq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmuldq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmuldq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmuldq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmuldq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmuldq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmuldq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmuldq xmm0, xmm1, xmm2
        #   vpmuldq xmm0, xmm1, xmm2
        #   vpmuldq xmm0, xmm1, oword([ecx])
        #   vpmuldq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmuldq ymm0, ymm1, ymm2
        #   vpmuldq ymm0, ymm1, ymm2
        #   vpmuldq ymm0, ymm1, yword([ecx])
        #   vpmuldq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpmulhrsw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmulhrsw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmulhrsw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmulhrsw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmulhrsw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmulhrsw xmm0, xmm1, xmm2
        #   vpmulhrsw xmm0, xmm1, xmm2
        #   vpmulhrsw xmm0, xmm1, oword([ecx])
        #   vpmulhrsw xmm0, xmm1, oword([ecx])
        #   vpmulhrsw ymm0, ymm1, ymm2
        #   vpmulhrsw ymm0, ymm1, ymm2
        #   vpmulhrsw ymm0, ymm1, yword([ecx])
        #   vpmulhrsw ymm0, ymm1, yword([ecx])
        #   vpmulhrsw zmm0, zmm1, zmm2
        #   vpmulhrsw zmm0, zmm1, zword([ecx])
        ...
        #   vpmulhuw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmulhuw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmulhuw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmulhuw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmulhuw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmulhuw xmm0, xmm1, xmm2
        #   vpmulhuw xmm0, xmm1, xmm2
        #   vpmulhuw xmm0, xmm1, oword([ecx])
        #   vpmulhuw xmm0, xmm1, oword([ecx])
        #   vpmulhuw ymm0, ymm1, ymm2
        #   vpmulhuw ymm0, ymm1, ymm2
        #   vpmulhuw ymm0, ymm1, yword([ecx])
        #   vpmulhuw ymm0, ymm1, yword([ecx])
        #   vpmulhuw zmm0, zmm1, zmm2
        #   vpmulhuw zmm0, zmm1, zword([ecx])
        ...
        #   vpmulhw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmulhw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmulhw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmulhw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmulhw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmulhw xmm0, xmm1, xmm2
        #   vpmulhw xmm0, xmm1, xmm2
        #   vpmulhw xmm0, xmm1, oword([ecx])
        #   vpmulhw xmm0, xmm1, oword([ecx])
        #   vpmulhw ymm0, ymm1, ymm2
        #   vpmulhw ymm0, ymm1, ymm2
        #   vpmulhw ymm0, ymm1, yword([ecx])
        #   vpmulhw ymm0, ymm1, yword([ecx])
        #   vpmulhw zmm0, zmm1, zmm2
        #   vpmulhw zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpmulld opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpmulld opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmulld opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpmulld opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmulld opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpmulld opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmulld xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpmulld xmm0, xmm1, xmm2
        #   vpmulld xmm0, xmm1, xmm2
        #   vpmulld xmm0, xmm1, oword([ecx])
        #   vpmulld ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpmulld ymm0, ymm1, ymm2
        #   vpmulld ymm0, ymm1, ymm2
        #   vpmulld ymm0, ymm1, yword([ecx])
        #   vpmulld zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpmullq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmullq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmullq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmullq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmullq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmullq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmullq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmullq xmm0, xmm1, xmm2
        #   vpmullq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmullq ymm0, ymm1, ymm2
        #   vpmullq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpmullw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpmullw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmullw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpmullw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmullw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpmullw xmm0, xmm1, xmm2
        #   vpmullw xmm0, xmm1, xmm2
        #   vpmullw xmm0, xmm1, oword([ecx])
        #   vpmullw xmm0, xmm1, oword([ecx])
        #   vpmullw ymm0, ymm1, ymm2
        #   vpmullw ymm0, ymm1, ymm2
        #   vpmullw ymm0, ymm1, yword([ecx])
        #   vpmullw ymm0, ymm1, yword([ecx])
        #   vpmullw zmm0, zmm1, zmm2
        #   vpmullw zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpmultishiftqb opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmultishiftqb opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmultishiftqb opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmultishiftqb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmultishiftqb opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmultishiftqb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmultishiftqb xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmultishiftqb xmm0, xmm1, xmm2
        #   vpmultishiftqb ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmultishiftqb ymm0, ymm1, ymm2
        #   vpmultishiftqb zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vpmuludq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmuludq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpmuludq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmuludq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpmuludq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpmuludq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpmuludq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpmuludq xmm0, xmm1, xmm2
        #   vpmuludq xmm0, xmm1, xmm2
        #   vpmuludq xmm0, xmm1, oword([ecx])
        #   vpmuludq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpmuludq ymm0, ymm1, ymm2
        #   vpmuludq ymm0, ymm1, ymm2
        #   vpmuludq ymm0, ymm1, yword([ecx])
        #   vpmuludq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpopcntb opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpopcntb opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpopcntb opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpopcntb xmm0, xmm1
        #   vpopcntb xmm0, oword([ebx])
        #   vpopcntb ymm0, ymm1
        #   vpopcntb ymm0, yword([ebx])
        #   vpopcntb zmm0, zmm1
        #   vpopcntb zmm0, zword([ebx])
        ...
        # @example
        #   vpopcntd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vpopcntd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vpopcntd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vpopcntd opmask(xmm0, k1, zero: true), xmm1
        #   vpopcntd opmask(ymm0, k1, zero: true), ymm1
        #   vpopcntd opmask(zmm0, k1, zero: true), zmm1
        #   vpopcntd xmm0, bcst(dword([ebx]), {1=>4})
        #   vpopcntd xmm0, xmm1
        #   vpopcntd ymm0, bcst(dword([ebx]), {1=>8})
        #   vpopcntd ymm0, ymm1
        #   vpopcntd zmm0, bcst(dword([ebx]), {1=>16})
        #   vpopcntd zmm0, zmm1
        ...
        # @example
        #   vpopcntq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vpopcntq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vpopcntq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vpopcntq opmask(xmm0, k1, zero: true), xmm1
        #   vpopcntq opmask(ymm0, k1, zero: true), ymm1
        #   vpopcntq opmask(zmm0, k1, zero: true), zmm1
        #   vpopcntq xmm0, bcst(qword([ebx]), {1=>2})
        #   vpopcntq xmm0, xmm1
        #   vpopcntq ymm0, bcst(qword([ebx]), {1=>4})
        #   vpopcntq ymm0, ymm1
        #   vpopcntq zmm0, bcst(qword([ebx]), {1=>8})
        #   vpopcntq zmm0, zmm1
        ...
        #   vpopcntw opmask(xmm0, k1, zero: true), oword([ebx])
        #   vpopcntw opmask(ymm0, k1, zero: true), yword([ebx])
        #   vpopcntw opmask(zmm0, k1, zero: true), zword([ebx])
        #   vpopcntw xmm0, xmm1
        #   vpopcntw xmm0, oword([ebx])
        #   vpopcntw ymm0, ymm1
        #   vpopcntw ymm0, yword([ebx])
        #   vpopcntw zmm0, zmm1
        #   vpopcntw zmm0, zword([ebx])
        def vpopcntw(*operands,**kwargs) = add_instruction(Instructions::VPOPCNTW,*operands,**kwargs)
        # Packed Bitwise Logical OR
        # @return [Ronin::ASM::X86::Instructions::VPOR]
        # @example
        #   vpor xmm0, xmm1, xmm2
        #   vpor xmm0, xmm1, oword([ecx])
        #   vpor ymm0, ymm1, ymm2
        #   vpor ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpord opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpord opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpord opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpord opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpord opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpord opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpord xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpord xmm0, xmm1, xmm2
        #   vpord ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpord ymm0, ymm1, ymm2
        #   vpord zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vporq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vporq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vporq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vporq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vporq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vporq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vporq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vporq xmm0, xmm1, xmm2
        #   vporq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vporq ymm0, ymm1, ymm2
        #   vporq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpperm xmm0, xmm1, xmm2, oword([edx])
        #   vpperm xmm0, xmm1, oword([ecx]), xmm3
        ...
        # @example
        #   vprold opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vprold opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vprold opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vprold xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vprold xmm0, xmm1, 0x03
        #   vprold ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vprold ymm0, ymm1, 0x03
        #   vprold zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        # @example
        #   vprolq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vprolq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vprolq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        ...
        #   vprolq xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vprolq xmm0, xmm1, 0x03
        #   vprolq ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vprolq ymm0, ymm1, 0x03
        #   vprolq zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        ...
        # @example
        #   vprolvd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vprolvd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vprolvd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vprolvd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vprolvd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vprolvd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vprolvd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vprolvd xmm0, xmm1, xmm2
        #   vprolvd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vprolvd ymm0, ymm1, ymm2
        #   vprolvd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vprolvq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vprolvq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vprolvq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vprolvq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vprolvq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vprolvq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vprolvq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vprolvq xmm0, xmm1, xmm2
        #   vprolvq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vprolvq ymm0, ymm1, ymm2
        #   vprolvq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vprord opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vprord opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vprord opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vprord xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vprord xmm0, xmm1, 0x03
        #   vprord ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vprord ymm0, ymm1, 0x03
        #   vprord zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        # @example
        #   vprorq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vprorq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vprorq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        ...
        #   vprorq xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vprorq xmm0, xmm1, 0x03
        #   vprorq ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vprorq ymm0, ymm1, 0x03
        #   vprorq zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        ...
        # @example
        #   vprorvd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vprorvd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vprorvd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vprorvd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vprorvd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vprorvd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vprorvd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vprorvd xmm0, xmm1, xmm2
        #   vprorvd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vprorvd ymm0, ymm1, ymm2
        #   vprorvd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vprorvq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vprorvq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vprorvq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vprorvq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vprorvq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vprorvq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vprorvq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vprorvq xmm0, xmm1, xmm2
        #   vprorvq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vprorvq ymm0, ymm1, ymm2
        #   vprorvq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vprotb xmm0, xmm1, oword([ecx])
        #   vprotb xmm0, oword([ebx]), 0x03
        #   vprotb xmm0, oword([ebx]), xmm2
        ...
        #   vprotd xmm0, xmm1, oword([ecx])
        #   vprotd xmm0, oword([ebx]), 0x03
        #   vprotd xmm0, oword([ebx]), xmm2
        ...
        #   vprotq xmm0, xmm1, oword([ecx])
        #   vprotq xmm0, oword([ebx]), 0x03
        #   vprotq xmm0, oword([ebx]), xmm2
        ...
        #   vprotw xmm0, xmm1, oword([ecx])
        #   vprotw xmm0, oword([ebx]), 0x03
        #   vprotw xmm0, oword([ebx]), xmm2
        ...
        #   vpsadbw xmm0, xmm1, xmm2
        #   vpsadbw xmm0, xmm1, oword([ecx])
        #   vpsadbw xmm0, xmm1, oword([ecx])
        #   vpsadbw ymm0, ymm1, ymm2
        #   vpsadbw ymm0, ymm1, ymm2
        #   vpsadbw ymm0, ymm1, yword([ecx])
        #   vpsadbw ymm0, ymm1, yword([ecx])
        #   vpsadbw zmm0, zmm1, zmm2
        #   vpsadbw zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpscatterdd opmask(dword([eax+xmm0*4]), k1), xmm1
        #   vpscatterdd opmask(dword([eax+ymm0*4]), k1), ymm1
        #   vpscatterdd opmask(dword([eax+zmm0*4]), k1), zmm1
        ...
        # @example
        #   vpscatterdq opmask(dword([eax+xmm0*4]), k1), xmm1
        #   vpscatterdq opmask(dword([eax+xmm0*4]), k1), ymm1
        #   vpscatterdq opmask(dword([eax+ymm0*4]), k1), zmm1
        ...
        # @example
        #   vpscatterqd opmask(qword([eax+xmm0*8]), k1), xmm1
        #   vpscatterqd opmask(qword([eax+ymm0*8]), k1), xmm1
        #   vpscatterqd opmask(qword([eax+zmm0*8]), k1), ymm1
        ...
        # @example
        #   vpscatterqq opmask(qword([eax+xmm0*8]), k1), xmm1
        #   vpscatterqq opmask(qword([eax+ymm0*8]), k1), ymm1
        #   vpscatterqq opmask(qword([eax+zmm0*8]), k1), zmm1
        ...
        #   vpshab xmm0, xmm1, oword([ecx])
        #   vpshab xmm0, oword([ebx]), xmm2
        ...
        #   vpshad xmm0, xmm1, oword([ecx])
        #   vpshad xmm0, oword([ebx]), xmm2
        ...
        #   vpshaq xmm0, xmm1, oword([ecx])
        #   vpshaq xmm0, oword([ebx]), xmm2
        ...
        #   vpshaw xmm0, xmm1, oword([ecx])
        #   vpshaw xmm0, oword([ebx]), xmm2
        ...
        #   vpshlb xmm0, xmm1, oword([ecx])
        #   vpshlb xmm0, oword([ebx]), xmm2
        ...
        #   vpshld xmm0, xmm1, oword([ecx])
        #   vpshld xmm0, oword([ebx]), xmm2
        ...
        # @example
        #   vpshldd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpshldd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vpshldd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpshldd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpshldd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vpshldd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpshldd xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpshldd xmm0, xmm1, xmm2, 0x04
        #   vpshldd ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpshldd ymm0, ymm1, ymm2, 0x04
        #   vpshldd zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   vpshldq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpshldq opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vpshldq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpshldq opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpshldq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vpshldq opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpshldq xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpshldq xmm0, xmm1, xmm2, 0x04
        #   vpshldq ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpshldq ymm0, ymm1, ymm2, 0x04
        #   vpshldq zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vpshldvd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpshldvd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpshldvd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpshldvd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshldvd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpshldvd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshldvd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpshldvd xmm0, xmm1, xmm2
        #   vpshldvd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpshldvd ymm0, ymm1, ymm2
        #   vpshldvd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpshldvq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpshldvq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpshldvq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpshldvq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshldvq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpshldvq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshldvq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpshldvq xmm0, xmm1, xmm2
        #   vpshldvq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpshldvq ymm0, ymm1, ymm2
        #   vpshldvq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpshldvw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpshldvw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshldvw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpshldvw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshldvw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpshldvw xmm0, xmm1, xmm2
        #   vpshldvw xmm0, xmm1, oword([ecx])
        #   vpshldvw ymm0, ymm1, ymm2
        #   vpshldvw ymm0, ymm1, yword([ecx])
        #   vpshldvw zmm0, zmm1, zmm2
        #   vpshldvw zmm0, zmm1, zword([ecx])
        ...
        #   vpshldw opmask(xmm0, k1, zero: true), xmm1, oword([ecx]), 0x04
        #   vpshldw opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpshldw opmask(ymm0, k1, zero: true), ymm1, yword([ecx]), 0x04
        #   vpshldw opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpshldw opmask(zmm0, k1, zero: true), zmm1, zword([ecx]), 0x04
        #   vpshldw xmm0, xmm1, xmm2, 0x04
        #   vpshldw xmm0, xmm1, oword([ecx]), 0x04
        #   vpshldw ymm0, ymm1, ymm2, 0x04
        #   vpshldw ymm0, ymm1, yword([ecx]), 0x04
        #   vpshldw zmm0, zmm1, zmm2, 0x04
        #   vpshldw zmm0, zmm1, zword([ecx]), 0x04
        ...
        #   vpshlq xmm0, xmm1, oword([ecx])
        #   vpshlq xmm0, oword([ebx]), xmm2
        ...
        #   vpshlw xmm0, xmm1, oword([ecx])
        #   vpshlw xmm0, oword([ebx]), xmm2
        ...
        # @example
        #   vpshrdd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpshrdd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vpshrdd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpshrdd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpshrdd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vpshrdd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpshrdd xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpshrdd xmm0, xmm1, xmm2, 0x04
        #   vpshrdd ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpshrdd ymm0, ymm1, ymm2, 0x04
        #   vpshrdd zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   vpshrdq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpshrdq opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vpshrdq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpshrdq opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpshrdq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vpshrdq opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpshrdq xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpshrdq xmm0, xmm1, xmm2, 0x04
        #   vpshrdq ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpshrdq ymm0, ymm1, ymm2, 0x04
        #   vpshrdq zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vpshrdvd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpshrdvd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpshrdvd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpshrdvd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshrdvd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpshrdvd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshrdvd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpshrdvd xmm0, xmm1, xmm2
        #   vpshrdvd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpshrdvd ymm0, ymm1, ymm2
        #   vpshrdvd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpshrdvq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpshrdvq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpshrdvq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpshrdvq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshrdvq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpshrdvq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshrdvq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpshrdvq xmm0, xmm1, xmm2
        #   vpshrdvq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpshrdvq ymm0, ymm1, ymm2
        #   vpshrdvq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpshrdvw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpshrdvw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshrdvw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpshrdvw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshrdvw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpshrdvw xmm0, xmm1, xmm2
        #   vpshrdvw xmm0, xmm1, oword([ecx])
        #   vpshrdvw ymm0, ymm1, ymm2
        #   vpshrdvw ymm0, ymm1, yword([ecx])
        #   vpshrdvw zmm0, zmm1, zmm2
        #   vpshrdvw zmm0, zmm1, zword([ecx])
        ...
        #   vpshrdw opmask(xmm0, k1, zero: true), xmm1, oword([ecx]), 0x04
        #   vpshrdw opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpshrdw opmask(ymm0, k1, zero: true), ymm1, yword([ecx]), 0x04
        #   vpshrdw opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpshrdw opmask(zmm0, k1, zero: true), zmm1, zword([ecx]), 0x04
        #   vpshrdw xmm0, xmm1, xmm2, 0x04
        #   vpshrdw xmm0, xmm1, oword([ecx]), 0x04
        #   vpshrdw ymm0, ymm1, ymm2, 0x04
        #   vpshrdw ymm0, ymm1, yword([ecx]), 0x04
        #   vpshrdw zmm0, zmm1, zmm2, 0x04
        #   vpshrdw zmm0, zmm1, zword([ecx]), 0x04
        ...
        #   vpshufb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpshufb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpshufb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpshufb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpshufb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpshufb xmm0, xmm1, xmm2
        #   vpshufb xmm0, xmm1, xmm2
        #   vpshufb xmm0, xmm1, oword([ecx])
        #   vpshufb xmm0, xmm1, oword([ecx])
        #   vpshufb ymm0, ymm1, ymm2
        #   vpshufb ymm0, ymm1, ymm2
        #   vpshufb ymm0, ymm1, yword([ecx])
        #   vpshufb ymm0, ymm1, yword([ecx])
        #   vpshufb zmm0, zmm1, zmm2
        #   vpshufb zmm0, zmm1, zword([ecx])
        ...
        #   vpshufbitqmb opmask(k1, k2), xmm1, oword([ecx])
        #   vpshufbitqmb k1, xmm1, oword([ecx])
        #   vpshufbitqmb opmask(k1, k2), ymm1, ymm2
        #   vpshufbitqmb k1, ymm1, ymm2
        #   vpshufbitqmb opmask(k1, k2), ymm1, yword([ecx])
        #   vpshufbitqmb k1, ymm1, yword([ecx])
        #   vpshufbitqmb opmask(k1, k2), zmm1, zmm2
        #   vpshufbitqmb k1, zmm1, zmm2
        #   vpshufbitqmb opmask(k1, k2), zmm1, zword([ecx])
        #   vpshufbitqmb k1, zmm1, zword([ecx])
        ...
        # @example
        #   vpshufd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vpshufd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vpshufd opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vpshufd xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vpshufd xmm0, xmm1, 0x03
        #   vpshufd xmm0, xmm1, 0x03
        #   vpshufd xmm0, oword([ebx]), 0x03
        #   vpshufd ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vpshufd ymm0, ymm1, 0x03
        #   vpshufd ymm0, ymm1, 0x03
        #   vpshufd ymm0, yword([ebx]), 0x03
        #   vpshufd zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vpshufhw opmask(xmm0, k1, zero: true), oword([ebx]), 0x03
        #   vpshufhw opmask(ymm0, k1, zero: true), yword([ebx]), 0x03
        #   vpshufhw opmask(zmm0, k1, zero: true), zword([ebx]), 0x03
        #   vpshufhw xmm0, xmm1, 0x03
        #   vpshufhw xmm0, xmm1, 0x03
        #   vpshufhw xmm0, oword([ebx]), 0x03
        #   vpshufhw xmm0, oword([ebx]), 0x03
        #   vpshufhw ymm0, ymm1, 0x03
        #   vpshufhw ymm0, ymm1, 0x03
        #   vpshufhw ymm0, yword([ebx]), 0x03
        #   vpshufhw ymm0, yword([ebx]), 0x03
        #   vpshufhw zmm0, zmm1, 0x03
        #   vpshufhw zmm0, zword([ebx]), 0x03
        ...
        #   vpshuflw opmask(xmm0, k1, zero: true), oword([ebx]), 0x03
        #   vpshuflw opmask(ymm0, k1, zero: true), yword([ebx]), 0x03
        #   vpshuflw opmask(zmm0, k1, zero: true), zword([ebx]), 0x03
        #   vpshuflw xmm0, xmm1, 0x03
        #   vpshuflw xmm0, xmm1, 0x03
        #   vpshuflw xmm0, oword([ebx]), 0x03
        #   vpshuflw xmm0, oword([ebx]), 0x03
        #   vpshuflw ymm0, ymm1, 0x03
        #   vpshuflw ymm0, ymm1, 0x03
        #   vpshuflw ymm0, yword([ebx]), 0x03
        #   vpshuflw ymm0, yword([ebx]), 0x03
        #   vpshuflw zmm0, zmm1, 0x03
        #   vpshuflw zmm0, zword([ebx]), 0x03
        ...
        #   vpsignb xmm0, xmm1, oword([ecx])
        #   vpsignb ymm0, ymm1, ymm2
        #   vpsignb ymm0, ymm1, yword([ecx])
        ...
        #   vpsignd xmm0, xmm1, oword([ecx])
        #   vpsignd ymm0, ymm1, ymm2
        #   vpsignd ymm0, ymm1, yword([ecx])
        ...
        #   vpsignw xmm0, xmm1, oword([ecx])
        #   vpsignw ymm0, ymm1, ymm2
        #   vpsignw ymm0, ymm1, yword([ecx])
        def vpsignw(*operands,**kwargs) = add_instruction(Instructions::VPSIGNW,*operands,**kwargs)
        # Shift Packed Doubleword Data Left Logical
        # @return [Ronin::ASM::X86::Instructions::VPSLLD]
        # @example
        #   vpslld opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vpslld opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vpslld opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        #   vpslld opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpslld opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpslld opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpslld opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpslld opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpslld opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpslld opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpslld opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpslld opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpslld xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vpslld xmm0, xmm1, 0x03
        #   vpslld xmm0, xmm1, 0x03
        #   vpslld xmm0, xmm1, xmm2
        #   vpslld xmm0, xmm1, xmm2
        #   vpslld xmm0, xmm1, oword([ecx])
        #   vpslld xmm0, xmm1, oword([ecx])
        #   vpslld ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vpslld ymm0, ymm1, 0x03
        #   vpslld ymm0, ymm1, 0x03
        #   vpslld ymm0, ymm1, xmm2
        #   vpslld ymm0, ymm1, xmm2
        #   vpslld ymm0, ymm1, oword([ecx])
        #   vpslld ymm0, ymm1, oword([ecx])
        #   vpslld zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        #   vpslld zmm0, zmm1, 0x03
        #   vpslld zmm0, zmm1, xmm2
        #   vpslld zmm0, zmm1, oword([ecx])
        ...
        #   vpslldq xmm0, xmm1, 0x03
        #   vpslldq xmm0, oword([ebx]), 0x03
        #   vpslldq ymm0, ymm1, 0x03
        #   vpslldq ymm0, ymm1, 0x03
        #   vpslldq ymm0, yword([ebx]), 0x03
        #   vpslldq zmm0, zmm1, 0x03
        #   vpslldq zmm0, zword([ebx]), 0x03
        def vpslldq(*operands,**kwargs) = add_instruction(Instructions::VPSLLDQ,*operands,**kwargs)
        # Shift Packed Quadword Data Left Logical
        # @return [Ronin::ASM::X86::Instructions::VPSLLQ]
        # @example
        #   vpsllq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vpsllq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vpsllq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        #   vpsllq opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpsllq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsllq opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsllq opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsllq opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsllq opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsllq opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsllq opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsllq opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsllq xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vpsllq xmm0, xmm1, 0x03
        #   vpsllq xmm0, xmm1, 0x03
        #   vpsllq xmm0, xmm1, xmm2
        #   vpsllq xmm0, xmm1, xmm2
        #   vpsllq xmm0, xmm1, oword([ecx])
        #   vpsllq xmm0, xmm1, oword([ecx])
        #   vpsllq ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vpsllq ymm0, ymm1, 0x03
        #   vpsllq ymm0, ymm1, 0x03
        #   vpsllq ymm0, ymm1, xmm2
        #   vpsllq ymm0, ymm1, xmm2
        #   vpsllq ymm0, ymm1, oword([ecx])
        #   vpsllq ymm0, ymm1, oword([ecx])
        #   vpsllq zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        #   vpsllq zmm0, zmm1, 0x03
        #   vpsllq zmm0, zmm1, xmm2
        #   vpsllq zmm0, zmm1, oword([ecx])
        ...
        # @example
        #   vpsllvd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsllvd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsllvd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsllvd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsllvd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpsllvd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsllvd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsllvd xmm0, xmm1, xmm2
        #   vpsllvd xmm0, xmm1, xmm2
        #   vpsllvd xmm0, xmm1, oword([ecx])
        #   vpsllvd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsllvd ymm0, ymm1, ymm2
        #   vpsllvd ymm0, ymm1, ymm2
        #   vpsllvd ymm0, ymm1, yword([ecx])
        #   vpsllvd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpsllvq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsllvq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsllvq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsllvq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsllvq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpsllvq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsllvq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsllvq xmm0, xmm1, xmm2
        #   vpsllvq xmm0, xmm1, xmm2
        #   vpsllvq xmm0, xmm1, oword([ecx])
        #   vpsllvq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsllvq ymm0, ymm1, ymm2
        #   vpsllvq ymm0, ymm1, ymm2
        #   vpsllvq ymm0, ymm1, yword([ecx])
        #   vpsllvq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpsllvw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsllvw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsllvw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsllvw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsllvw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsllvw xmm0, xmm1, xmm2
        #   vpsllvw xmm0, xmm1, oword([ecx])
        #   vpsllvw ymm0, ymm1, ymm2
        #   vpsllvw ymm0, ymm1, yword([ecx])
        #   vpsllvw zmm0, zmm1, zmm2
        #   vpsllvw zmm0, zmm1, zword([ecx])
        ...
        #   vpsllw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsllw opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsllw opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsllw opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsllw opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsllw opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsllw opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsllw opmask(xmm0, k1, zero: true), oword([ebx]), 0x03
        #   vpsllw opmask(ymm0, k1, zero: true), yword([ebx]), 0x03
        #   vpsllw opmask(zmm0, k1, zero: true), zword([ebx]), 0x03
        #   vpsllw xmm0, xmm1, 0x03
        #   vpsllw xmm0, xmm1, 0x03
        #   vpsllw xmm0, xmm1, xmm2
        #   vpsllw xmm0, xmm1, xmm2
        #   vpsllw xmm0, xmm1, oword([ecx])
        #   vpsllw xmm0, xmm1, oword([ecx])
        #   vpsllw xmm0, oword([ebx]), 0x03
        #   vpsllw ymm0, ymm1, 0x03
        #   vpsllw ymm0, ymm1, 0x03
        #   vpsllw ymm0, ymm1, xmm2
        #   vpsllw ymm0, ymm1, xmm2
        #   vpsllw ymm0, ymm1, oword([ecx])
        #   vpsllw ymm0, ymm1, oword([ecx])
        #   vpsllw ymm0, yword([ebx]), 0x03
        #   vpsllw zmm0, zmm1, 0x03
        #   vpsllw zmm0, zmm1, xmm2
        #   vpsllw zmm0, zmm1, oword([ecx])
        #   vpsllw zmm0, zword([ebx]), 0x03
        def vpsllw(*operands,**kwargs) = add_instruction(Instructions::VPSLLW,*operands,**kwargs)
        # Shift Packed Doubleword Data Right Arithmetic
        # @return [Ronin::ASM::X86::Instructions::VPSRAD]
        # @example
        #   vpsrad opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vpsrad opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vpsrad opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        #   vpsrad opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpsrad opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsrad opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsrad opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsrad opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsrad opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsrad opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsrad opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsrad opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsrad xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vpsrad xmm0, xmm1, 0x03
        #   vpsrad xmm0, xmm1, 0x03
        #   vpsrad xmm0, xmm1, xmm2
        #   vpsrad xmm0, xmm1, xmm2
        #   vpsrad xmm0, xmm1, oword([ecx])
        #   vpsrad xmm0, xmm1, oword([ecx])
        #   vpsrad ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vpsrad ymm0, ymm1, 0x03
        #   vpsrad ymm0, ymm1, 0x03
        #   vpsrad ymm0, ymm1, xmm2
        #   vpsrad ymm0, ymm1, xmm2
        #   vpsrad ymm0, ymm1, oword([ecx])
        #   vpsrad ymm0, ymm1, oword([ecx])
        #   vpsrad zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        #   vpsrad zmm0, zmm1, 0x03
        #   vpsrad zmm0, zmm1, xmm2
        #   vpsrad zmm0, zmm1, oword([ecx])
        ...
        # @example
        #   vpsraq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vpsraq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vpsraq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        #   vpsraq opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpsraq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsraq opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsraq opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsraq opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsraq opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsraq opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsraq opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsraq opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsraq xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vpsraq xmm0, xmm1, 0x03
        #   vpsraq xmm0, xmm1, xmm2
        #   vpsraq xmm0, xmm1, oword([ecx])
        #   vpsraq ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vpsraq ymm0, ymm1, 0x03
        #   vpsraq ymm0, ymm1, xmm2
        #   vpsraq ymm0, ymm1, oword([ecx])
        #   vpsraq zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        #   vpsraq zmm0, zmm1, 0x03
        #   vpsraq zmm0, zmm1, xmm2
        #   vpsraq zmm0, zmm1, oword([ecx])
        ...
        # @example
        #   vpsravd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsravd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsravd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsravd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsravd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpsravd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsravd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsravd xmm0, xmm1, xmm2
        #   vpsravd xmm0, xmm1, xmm2
        #   vpsravd xmm0, xmm1, oword([ecx])
        #   vpsravd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsravd ymm0, ymm1, ymm2
        #   vpsravd ymm0, ymm1, ymm2
        #   vpsravd ymm0, ymm1, yword([ecx])
        #   vpsravd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpsravq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsravq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsravq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsravq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsravq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpsravq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsravq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsravq xmm0, xmm1, xmm2
        #   vpsravq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsravq ymm0, ymm1, ymm2
        #   vpsravq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpsravw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsravw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsravw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsravw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsravw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsravw xmm0, xmm1, xmm2
        #   vpsravw xmm0, xmm1, oword([ecx])
        #   vpsravw ymm0, ymm1, ymm2
        #   vpsravw ymm0, ymm1, yword([ecx])
        #   vpsravw zmm0, zmm1, zmm2
        #   vpsravw zmm0, zmm1, zword([ecx])
        ...
        #   vpsraw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsraw opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsraw opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsraw opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsraw opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsraw opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsraw opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsraw opmask(xmm0, k1, zero: true), oword([ebx]), 0x03
        #   vpsraw opmask(ymm0, k1, zero: true), yword([ebx]), 0x03
        #   vpsraw opmask(zmm0, k1, zero: true), zword([ebx]), 0x03
        #   vpsraw xmm0, xmm1, 0x03
        #   vpsraw xmm0, xmm1, 0x03
        #   vpsraw xmm0, xmm1, xmm2
        #   vpsraw xmm0, xmm1, xmm2
        #   vpsraw xmm0, xmm1, oword([ecx])
        #   vpsraw xmm0, xmm1, oword([ecx])
        #   vpsraw xmm0, oword([ebx]), 0x03
        #   vpsraw ymm0, ymm1, 0x03
        #   vpsraw ymm0, ymm1, 0x03
        #   vpsraw ymm0, ymm1, xmm2
        #   vpsraw ymm0, ymm1, xmm2
        #   vpsraw ymm0, ymm1, oword([ecx])
        #   vpsraw ymm0, ymm1, oword([ecx])
        #   vpsraw ymm0, yword([ebx]), 0x03
        #   vpsraw zmm0, zmm1, 0x03
        #   vpsraw zmm0, zmm1, xmm2
        #   vpsraw zmm0, zmm1, oword([ecx])
        #   vpsraw zmm0, zword([ebx]), 0x03
        def vpsraw(*operands,**kwargs) = add_instruction(Instructions::VPSRAW,*operands,**kwargs)
        # Shift Packed Doubleword Data Right Logical
        # @return [Ronin::ASM::X86::Instructions::VPSRLD]
        # @example
        #   vpsrld opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vpsrld opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vpsrld opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        #   vpsrld opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpsrld opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsrld opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsrld opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsrld opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsrld opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsrld opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsrld opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsrld opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsrld xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vpsrld xmm0, xmm1, 0x03
        #   vpsrld xmm0, xmm1, 0x03
        #   vpsrld xmm0, xmm1, xmm2
        #   vpsrld xmm0, xmm1, xmm2
        #   vpsrld xmm0, xmm1, oword([ecx])
        #   vpsrld xmm0, xmm1, oword([ecx])
        #   vpsrld ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vpsrld ymm0, ymm1, 0x03
        #   vpsrld ymm0, ymm1, 0x03
        #   vpsrld ymm0, ymm1, xmm2
        #   vpsrld ymm0, ymm1, xmm2
        #   vpsrld ymm0, ymm1, oword([ecx])
        #   vpsrld ymm0, ymm1, oword([ecx])
        #   vpsrld zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        #   vpsrld zmm0, zmm1, 0x03
        #   vpsrld zmm0, zmm1, xmm2
        #   vpsrld zmm0, zmm1, oword([ecx])
        ...
        #   vpsrldq xmm0, xmm1, 0x03
        #   vpsrldq xmm0, oword([ebx]), 0x03
        #   vpsrldq ymm0, ymm1, 0x03
        #   vpsrldq ymm0, ymm1, 0x03
        #   vpsrldq ymm0, yword([ebx]), 0x03
        #   vpsrldq zmm0, zmm1, 0x03
        #   vpsrldq zmm0, zword([ebx]), 0x03
        def vpsrldq(*operands,**kwargs) = add_instruction(Instructions::VPSRLDQ,*operands,**kwargs)
        # Shift Packed Quadword Data Right Logical
        # @return [Ronin::ASM::X86::Instructions::VPSRLQ]
        # @example
        #   vpsrlq opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vpsrlq opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vpsrlq opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        #   vpsrlq opmask(xmm0, k1, zero: true), xmm1, 0x03
        #   vpsrlq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsrlq opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsrlq opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsrlq opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsrlq opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsrlq opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsrlq opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsrlq opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsrlq xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vpsrlq xmm0, xmm1, 0x03
        #   vpsrlq xmm0, xmm1, 0x03
        #   vpsrlq xmm0, xmm1, xmm2
        #   vpsrlq xmm0, xmm1, xmm2
        #   vpsrlq xmm0, xmm1, oword([ecx])
        #   vpsrlq xmm0, xmm1, oword([ecx])
        #   vpsrlq ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vpsrlq ymm0, ymm1, 0x03
        #   vpsrlq ymm0, ymm1, 0x03
        #   vpsrlq ymm0, ymm1, xmm2
        #   vpsrlq ymm0, ymm1, xmm2
        #   vpsrlq ymm0, ymm1, oword([ecx])
        #   vpsrlq ymm0, ymm1, oword([ecx])
        #   vpsrlq zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        #   vpsrlq zmm0, zmm1, 0x03
        #   vpsrlq zmm0, zmm1, xmm2
        #   vpsrlq zmm0, zmm1, oword([ecx])
        ...
        # @example
        #   vpsrlvd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsrlvd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsrlvd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsrlvd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsrlvd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpsrlvd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsrlvd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsrlvd xmm0, xmm1, xmm2
        #   vpsrlvd xmm0, xmm1, xmm2
        #   vpsrlvd xmm0, xmm1, oword([ecx])
        #   vpsrlvd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsrlvd ymm0, ymm1, ymm2
        #   vpsrlvd ymm0, ymm1, ymm2
        #   vpsrlvd ymm0, ymm1, yword([ecx])
        #   vpsrlvd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpsrlvq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsrlvq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsrlvq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsrlvq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsrlvq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpsrlvq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsrlvq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsrlvq xmm0, xmm1, xmm2
        #   vpsrlvq xmm0, xmm1, xmm2
        #   vpsrlvq xmm0, xmm1, oword([ecx])
        #   vpsrlvq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsrlvq ymm0, ymm1, ymm2
        #   vpsrlvq ymm0, ymm1, ymm2
        #   vpsrlvq ymm0, ymm1, yword([ecx])
        #   vpsrlvq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpsrlvw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsrlvw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsrlvw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsrlvw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsrlvw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsrlvw xmm0, xmm1, xmm2
        #   vpsrlvw xmm0, xmm1, oword([ecx])
        #   vpsrlvw ymm0, ymm1, ymm2
        #   vpsrlvw ymm0, ymm1, yword([ecx])
        #   vpsrlvw zmm0, zmm1, zmm2
        #   vpsrlvw zmm0, zmm1, zword([ecx])
        ...
        #   vpsrlw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsrlw opmask(ymm0, k1, zero: true), ymm1, 0x03
        #   vpsrlw opmask(ymm0, k1, zero: true), ymm1, xmm2
        #   vpsrlw opmask(ymm0, k1, zero: true), ymm1, oword([ecx])
        #   vpsrlw opmask(zmm0, k1, zero: true), zmm1, 0x03
        #   vpsrlw opmask(zmm0, k1, zero: true), zmm1, xmm2
        #   vpsrlw opmask(zmm0, k1, zero: true), zmm1, oword([ecx])
        #   vpsrlw opmask(xmm0, k1, zero: true), oword([ebx]), 0x03
        #   vpsrlw opmask(ymm0, k1, zero: true), yword([ebx]), 0x03
        #   vpsrlw opmask(zmm0, k1, zero: true), zword([ebx]), 0x03
        #   vpsrlw xmm0, xmm1, 0x03
        #   vpsrlw xmm0, xmm1, 0x03
        #   vpsrlw xmm0, xmm1, xmm2
        #   vpsrlw xmm0, xmm1, xmm2
        #   vpsrlw xmm0, xmm1, oword([ecx])
        #   vpsrlw xmm0, xmm1, oword([ecx])
        #   vpsrlw xmm0, oword([ebx]), 0x03
        #   vpsrlw ymm0, ymm1, 0x03
        #   vpsrlw ymm0, ymm1, 0x03
        #   vpsrlw ymm0, ymm1, xmm2
        #   vpsrlw ymm0, ymm1, xmm2
        #   vpsrlw ymm0, ymm1, oword([ecx])
        #   vpsrlw ymm0, ymm1, oword([ecx])
        #   vpsrlw ymm0, yword([ebx]), 0x03
        #   vpsrlw zmm0, zmm1, 0x03
        #   vpsrlw zmm0, zmm1, xmm2
        #   vpsrlw zmm0, zmm1, oword([ecx])
        #   vpsrlw zmm0, zword([ebx]), 0x03
        ...
        #   vpsubb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsubb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsubb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsubb xmm0, xmm1, xmm2
        #   vpsubb xmm0, xmm1, xmm2
        #   vpsubb xmm0, xmm1, oword([ecx])
        #   vpsubb xmm0, xmm1, oword([ecx])
        #   vpsubb ymm0, ymm1, ymm2
        #   vpsubb ymm0, ymm1, ymm2
        #   vpsubb ymm0, ymm1, yword([ecx])
        #   vpsubb ymm0, ymm1, yword([ecx])
        #   vpsubb zmm0, zmm1, zmm2
        #   vpsubb zmm0, zmm1, zword([ecx])
        def vpsubb(*operands,**kwargs) = add_instruction(Instructions::VPSUBB,*operands,**kwargs)
        # Subtract Packed Doubleword Integers
        # @return [Ronin::ASM::X86::Instructions::VPSUBD]
        # @example
        #   vpsubd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsubd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsubd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsubd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpsubd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubd xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpsubd xmm0, xmm1, xmm2
        #   vpsubd xmm0, xmm1, xmm2
        #   vpsubd xmm0, xmm1, oword([ecx])
        #   vpsubd ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpsubd ymm0, ymm1, ymm2
        #   vpsubd ymm0, ymm1, ymm2
        #   vpsubd ymm0, ymm1, yword([ecx])
        #   vpsubd zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpsubq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsubq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpsubq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsubq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpsubq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpsubq xmm0, xmm1, xmm2
        #   vpsubq xmm0, xmm1, xmm2
        #   vpsubq xmm0, xmm1, oword([ecx])
        #   vpsubq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpsubq ymm0, ymm1, ymm2
        #   vpsubq ymm0, ymm1, ymm2
        #   vpsubq ymm0, ymm1, yword([ecx])
        #   vpsubq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpsubsb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsubsb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubsb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsubsb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubsb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsubsb xmm0, xmm1, xmm2
        #   vpsubsb xmm0, xmm1, xmm2
        #   vpsubsb xmm0, xmm1, oword([ecx])
        #   vpsubsb xmm0, xmm1, oword([ecx])
        #   vpsubsb ymm0, ymm1, ymm2
        #   vpsubsb ymm0, ymm1, ymm2
        #   vpsubsb ymm0, ymm1, yword([ecx])
        #   vpsubsb ymm0, ymm1, yword([ecx])
        #   vpsubsb zmm0, zmm1, zmm2
        #   vpsubsb zmm0, zmm1, zword([ecx])
        ...
        #   vpsubsw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsubsw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubsw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsubsw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubsw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsubsw xmm0, xmm1, xmm2
        #   vpsubsw xmm0, xmm1, xmm2
        #   vpsubsw xmm0, xmm1, oword([ecx])
        #   vpsubsw xmm0, xmm1, oword([ecx])
        #   vpsubsw ymm0, ymm1, ymm2
        #   vpsubsw ymm0, ymm1, ymm2
        #   vpsubsw ymm0, ymm1, yword([ecx])
        #   vpsubsw ymm0, ymm1, yword([ecx])
        #   vpsubsw zmm0, zmm1, zmm2
        #   vpsubsw zmm0, zmm1, zword([ecx])
        ...
        #   vpsubusb opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsubusb opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubusb opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsubusb opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubusb opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsubusb xmm0, xmm1, xmm2
        #   vpsubusb xmm0, xmm1, xmm2
        #   vpsubusb xmm0, xmm1, oword([ecx])
        #   vpsubusb xmm0, xmm1, oword([ecx])
        #   vpsubusb ymm0, ymm1, ymm2
        #   vpsubusb ymm0, ymm1, ymm2
        #   vpsubusb ymm0, ymm1, yword([ecx])
        #   vpsubusb ymm0, ymm1, yword([ecx])
        #   vpsubusb zmm0, zmm1, zmm2
        #   vpsubusb zmm0, zmm1, zword([ecx])
        ...
        #   vpsubusw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsubusw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubusw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsubusw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubusw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsubusw xmm0, xmm1, xmm2
        #   vpsubusw xmm0, xmm1, xmm2
        #   vpsubusw xmm0, xmm1, oword([ecx])
        #   vpsubusw xmm0, xmm1, oword([ecx])
        #   vpsubusw ymm0, ymm1, ymm2
        #   vpsubusw ymm0, ymm1, ymm2
        #   vpsubusw ymm0, ymm1, yword([ecx])
        #   vpsubusw ymm0, ymm1, yword([ecx])
        #   vpsubusw zmm0, zmm1, zmm2
        #   vpsubusw zmm0, zmm1, zword([ecx])
        ...
        #   vpsubw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpsubw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpsubw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpsubw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpsubw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpsubw xmm0, xmm1, xmm2
        #   vpsubw xmm0, xmm1, xmm2
        #   vpsubw xmm0, xmm1, oword([ecx])
        #   vpsubw xmm0, xmm1, oword([ecx])
        #   vpsubw ymm0, ymm1, ymm2
        #   vpsubw ymm0, ymm1, ymm2
        #   vpsubw ymm0, ymm1, yword([ecx])
        #   vpsubw ymm0, ymm1, yword([ecx])
        #   vpsubw zmm0, zmm1, zmm2
        #   vpsubw zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpternlogd opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpternlogd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vpternlogd opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpternlogd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpternlogd opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vpternlogd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpternlogd xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vpternlogd xmm0, xmm1, xmm2, 0x04
        #   vpternlogd ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vpternlogd ymm0, ymm1, ymm2, 0x04
        #   vpternlogd zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   vpternlogq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpternlogq opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vpternlogq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpternlogq opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vpternlogq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vpternlogq opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vpternlogq xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vpternlogq xmm0, xmm1, xmm2, 0x04
        #   vpternlogq ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vpternlogq ymm0, ymm1, ymm2, 0x04
        #   vpternlogq zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vptest xmm0, xmm1
        #   vptest xmm0, oword([ebx])
        #   vptest ymm0, ymm1
        #   vptest ymm0, yword([ebx])
        ...
        #   vptestmb opmask(k1, k2), xmm1, oword([ecx])
        #   vptestmb k1, xmm1, oword([ecx])
        #   vptestmb opmask(k1, k2), ymm1, ymm2
        #   vptestmb k1, ymm1, ymm2
        #   vptestmb opmask(k1, k2), ymm1, yword([ecx])
        #   vptestmb k1, ymm1, yword([ecx])
        #   vptestmb opmask(k1, k2), zmm1, zmm2
        #   vptestmb k1, zmm1, zmm2
        #   vptestmb opmask(k1, k2), zmm1, zword([ecx])
        #   vptestmb k1, zmm1, zword([ecx])
        ...
        # @example
        #   vptestmd opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4})
        #   vptestmd k1, xmm1, bcst(dword([ecx]), {1=>4})
        #   vptestmd opmask(k1, k2), xmm1, xmm2
        #   vptestmd k1, xmm1, xmm2
        #   vptestmd opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8})
        #   vptestmd k1, ymm1, bcst(dword([ecx]), {1=>8})
        #   vptestmd opmask(k1, k2), ymm1, ymm2
        #   vptestmd k1, ymm1, ymm2
        #   vptestmd opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16})
        #   vptestmd k1, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vptestmq opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2})
        #   vptestmq k1, xmm1, bcst(qword([ecx]), {1=>2})
        #   vptestmq opmask(k1, k2), xmm1, xmm2
        #   vptestmq k1, xmm1, xmm2
        #   vptestmq opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4})
        #   vptestmq k1, ymm1, bcst(qword([ecx]), {1=>4})
        #   vptestmq opmask(k1, k2), ymm1, ymm2
        #   vptestmq k1, ymm1, ymm2
        #   vptestmq opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8})
        #   vptestmq k1, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vptestmw opmask(k1, k2), xmm1, oword([ecx])
        #   vptestmw k1, xmm1, oword([ecx])
        #   vptestmw opmask(k1, k2), ymm1, ymm2
        #   vptestmw k1, ymm1, ymm2
        #   vptestmw opmask(k1, k2), ymm1, yword([ecx])
        #   vptestmw k1, ymm1, yword([ecx])
        #   vptestmw opmask(k1, k2), zmm1, zmm2
        #   vptestmw k1, zmm1, zmm2
        #   vptestmw opmask(k1, k2), zmm1, zword([ecx])
        #   vptestmw k1, zmm1, zword([ecx])
        ...
        #   vptestnmb opmask(k1, k2), xmm1, oword([ecx])
        #   vptestnmb k1, xmm1, oword([ecx])
        #   vptestnmb opmask(k1, k2), ymm1, ymm2
        #   vptestnmb k1, ymm1, ymm2
        #   vptestnmb opmask(k1, k2), ymm1, yword([ecx])
        #   vptestnmb k1, ymm1, yword([ecx])
        #   vptestnmb opmask(k1, k2), zmm1, zmm2
        #   vptestnmb k1, zmm1, zmm2
        #   vptestnmb opmask(k1, k2), zmm1, zword([ecx])
        #   vptestnmb k1, zmm1, zword([ecx])
        ...
        # @example
        #   vptestnmd opmask(k1, k2), xmm1, bcst(dword([ecx]), {1=>4})
        #   vptestnmd k1, xmm1, bcst(dword([ecx]), {1=>4})
        #   vptestnmd opmask(k1, k2), xmm1, xmm2
        #   vptestnmd k1, xmm1, xmm2
        #   vptestnmd opmask(k1, k2), ymm1, bcst(dword([ecx]), {1=>8})
        #   vptestnmd k1, ymm1, bcst(dword([ecx]), {1=>8})
        #   vptestnmd opmask(k1, k2), ymm1, ymm2
        #   vptestnmd k1, ymm1, ymm2
        #   vptestnmd opmask(k1, k2), zmm1, bcst(dword([ecx]), {1=>16})
        #   vptestnmd k1, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vptestnmq opmask(k1, k2), xmm1, bcst(qword([ecx]), {1=>2})
        #   vptestnmq k1, xmm1, bcst(qword([ecx]), {1=>2})
        #   vptestnmq opmask(k1, k2), xmm1, xmm2
        #   vptestnmq k1, xmm1, xmm2
        #   vptestnmq opmask(k1, k2), ymm1, bcst(qword([ecx]), {1=>4})
        #   vptestnmq k1, ymm1, bcst(qword([ecx]), {1=>4})
        #   vptestnmq opmask(k1, k2), ymm1, ymm2
        #   vptestnmq k1, ymm1, ymm2
        #   vptestnmq opmask(k1, k2), zmm1, bcst(qword([ecx]), {1=>8})
        #   vptestnmq k1, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vptestnmw opmask(k1, k2), xmm1, oword([ecx])
        #   vptestnmw k1, xmm1, oword([ecx])
        #   vptestnmw opmask(k1, k2), ymm1, ymm2
        #   vptestnmw k1, ymm1, ymm2
        #   vptestnmw opmask(k1, k2), ymm1, yword([ecx])
        #   vptestnmw k1, ymm1, yword([ecx])
        #   vptestnmw opmask(k1, k2), zmm1, zmm2
        #   vptestnmw k1, zmm1, zmm2
        #   vptestnmw opmask(k1, k2), zmm1, zword([ecx])
        #   vptestnmw k1, zmm1, zword([ecx])
        ...
        #   vpunpckhbw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpunpckhbw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpckhbw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpunpckhbw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpckhbw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpunpckhbw xmm0, xmm1, xmm2
        #   vpunpckhbw xmm0, xmm1, xmm2
        #   vpunpckhbw xmm0, xmm1, oword([ecx])
        #   vpunpckhbw xmm0, xmm1, oword([ecx])
        #   vpunpckhbw ymm0, ymm1, ymm2
        #   vpunpckhbw ymm0, ymm1, ymm2
        #   vpunpckhbw ymm0, ymm1, yword([ecx])
        #   vpunpckhbw ymm0, ymm1, yword([ecx])
        #   vpunpckhbw zmm0, zmm1, zmm2
        #   vpunpckhbw zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpunpckhdq opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpunpckhdq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpunpckhdq opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpunpckhdq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpckhdq opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpunpckhdq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpckhdq xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpunpckhdq xmm0, xmm1, xmm2
        #   vpunpckhdq xmm0, xmm1, xmm2
        #   vpunpckhdq xmm0, xmm1, oword([ecx])
        #   vpunpckhdq ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpunpckhdq ymm0, ymm1, ymm2
        #   vpunpckhdq ymm0, ymm1, ymm2
        #   vpunpckhdq ymm0, ymm1, yword([ecx])
        #   vpunpckhdq zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpunpckhqdq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpunpckhqdq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpunpckhqdq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpunpckhqdq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpckhqdq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpunpckhqdq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpckhqdq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpunpckhqdq xmm0, xmm1, xmm2
        #   vpunpckhqdq xmm0, xmm1, xmm2
        #   vpunpckhqdq xmm0, xmm1, oword([ecx])
        #   vpunpckhqdq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpunpckhqdq ymm0, ymm1, ymm2
        #   vpunpckhqdq ymm0, ymm1, ymm2
        #   vpunpckhqdq ymm0, ymm1, yword([ecx])
        #   vpunpckhqdq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpunpckhwd opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpunpckhwd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpckhwd opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpunpckhwd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpckhwd opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpunpckhwd xmm0, xmm1, xmm2
        #   vpunpckhwd xmm0, xmm1, xmm2
        #   vpunpckhwd xmm0, xmm1, oword([ecx])
        #   vpunpckhwd xmm0, xmm1, oword([ecx])
        #   vpunpckhwd ymm0, ymm1, ymm2
        #   vpunpckhwd ymm0, ymm1, ymm2
        #   vpunpckhwd ymm0, ymm1, yword([ecx])
        #   vpunpckhwd ymm0, ymm1, yword([ecx])
        #   vpunpckhwd zmm0, zmm1, zmm2
        #   vpunpckhwd zmm0, zmm1, zword([ecx])
        ...
        #   vpunpcklbw opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpunpcklbw opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpcklbw opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpunpcklbw opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpcklbw opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpunpcklbw xmm0, xmm1, xmm2
        #   vpunpcklbw xmm0, xmm1, xmm2
        #   vpunpcklbw xmm0, xmm1, oword([ecx])
        #   vpunpcklbw xmm0, xmm1, oword([ecx])
        #   vpunpcklbw ymm0, ymm1, ymm2
        #   vpunpcklbw ymm0, ymm1, ymm2
        #   vpunpcklbw ymm0, ymm1, yword([ecx])
        #   vpunpcklbw ymm0, ymm1, yword([ecx])
        #   vpunpcklbw zmm0, zmm1, zmm2
        #   vpunpcklbw zmm0, zmm1, zword([ecx])
        ...
        # @example
        #   vpunpckldq opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpunpckldq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpunpckldq opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpunpckldq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpckldq opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpunpckldq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpckldq xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpunpckldq xmm0, xmm1, xmm2
        #   vpunpckldq xmm0, xmm1, xmm2
        #   vpunpckldq xmm0, xmm1, oword([ecx])
        #   vpunpckldq ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpunpckldq ymm0, ymm1, ymm2
        #   vpunpckldq ymm0, ymm1, ymm2
        #   vpunpckldq ymm0, ymm1, yword([ecx])
        #   vpunpckldq zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpunpcklqdq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpunpcklqdq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpunpcklqdq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpunpcklqdq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpcklqdq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpunpcklqdq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpcklqdq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpunpcklqdq xmm0, xmm1, xmm2
        #   vpunpcklqdq xmm0, xmm1, xmm2
        #   vpunpcklqdq xmm0, xmm1, oword([ecx])
        #   vpunpcklqdq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpunpcklqdq ymm0, ymm1, ymm2
        #   vpunpcklqdq ymm0, ymm1, ymm2
        #   vpunpcklqdq ymm0, ymm1, yword([ecx])
        #   vpunpcklqdq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        #   vpunpcklwd opmask(xmm0, k1, zero: true), xmm1, oword([ecx])
        #   vpunpcklwd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpunpcklwd opmask(ymm0, k1, zero: true), ymm1, yword([ecx])
        #   vpunpcklwd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpunpcklwd opmask(zmm0, k1, zero: true), zmm1, zword([ecx])
        #   vpunpcklwd xmm0, xmm1, xmm2
        #   vpunpcklwd xmm0, xmm1, xmm2
        #   vpunpcklwd xmm0, xmm1, oword([ecx])
        #   vpunpcklwd xmm0, xmm1, oword([ecx])
        #   vpunpcklwd ymm0, ymm1, ymm2
        #   vpunpcklwd ymm0, ymm1, ymm2
        #   vpunpcklwd ymm0, ymm1, yword([ecx])
        #   vpunpcklwd ymm0, ymm1, yword([ecx])
        #   vpunpcklwd zmm0, zmm1, zmm2
        #   vpunpcklwd zmm0, zmm1, zword([ecx])
        ...
        #   vpxor xmm0, xmm1, oword([ecx])
        #   vpxor ymm0, ymm1, ymm2
        #   vpxor ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vpxord opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vpxord opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpxord opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vpxord opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpxord opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vpxord opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpxord xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vpxord xmm0, xmm1, xmm2
        #   vpxord ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vpxord ymm0, ymm1, ymm2
        #   vpxord zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vpxorq opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vpxorq opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vpxorq opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vpxorq opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vpxorq opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vpxorq opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vpxorq xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vpxorq xmm0, xmm1, xmm2
        #   vpxorq ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vpxorq ymm0, ymm1, ymm2
        #   vpxorq zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vrangepd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vrangepd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vrangepd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vrangepd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vrangepd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vrangepd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vrangepd xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vrangepd xmm0, xmm1, xmm2, 0x04
        #   vrangepd ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vrangepd ymm0, ymm1, ymm2, 0x04
        #   vrangepd zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vrangeps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vrangeps opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vrangeps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vrangeps opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vrangeps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vrangeps opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vrangeps xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vrangeps xmm0, xmm1, xmm2, 0x04
        #   vrangeps ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vrangeps ymm0, ymm1, ymm2, 0x04
        #   vrangeps zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        #   vrangesd opmask(xmm0, k1, zero: true), xmm1, qword([ecx]), 0x04
        #   vrangesd xmm0, xmm1, xmm2, 0x04
        #   vrangesd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vrangess opmask(xmm0, k1, zero: true), xmm1, dword([ecx]), 0x04
        #   vrangess xmm0, xmm1, xmm2, 0x04
        #   vrangess xmm0, xmm1, dword([ecx]), 0x04
        ...
        # @example
        #   vrcp14pd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vrcp14pd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vrcp14pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vrcp14pd opmask(xmm0, k1, zero: true), xmm1
        #   vrcp14pd opmask(ymm0, k1, zero: true), ymm1
        #   vrcp14pd opmask(zmm0, k1, zero: true), zmm1
        #   vrcp14pd xmm0, bcst(qword([ebx]), {1=>2})
        #   vrcp14pd xmm0, xmm1
        #   vrcp14pd ymm0, bcst(qword([ebx]), {1=>4})
        #   vrcp14pd ymm0, ymm1
        #   vrcp14pd zmm0, bcst(qword([ebx]), {1=>8})
        #   vrcp14pd zmm0, zmm1
        ...
        # @example
        #   vrcp14ps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vrcp14ps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vrcp14ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vrcp14ps opmask(xmm0, k1, zero: true), xmm1
        #   vrcp14ps opmask(ymm0, k1, zero: true), ymm1
        #   vrcp14ps opmask(zmm0, k1, zero: true), zmm1
        #   vrcp14ps xmm0, bcst(dword([ebx]), {1=>4})
        #   vrcp14ps xmm0, xmm1
        #   vrcp14ps ymm0, bcst(dword([ebx]), {1=>8})
        #   vrcp14ps ymm0, ymm1
        #   vrcp14ps zmm0, bcst(dword([ebx]), {1=>16})
        #   vrcp14ps zmm0, zmm1
        ...
        #   vrcp14sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vrcp14sd xmm0, xmm1, xmm2
        #   vrcp14sd xmm0, xmm1, qword([ecx])
        ...
        #   vrcp14ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vrcp14ss xmm0, xmm1, xmm2
        #   vrcp14ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vrcp28pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vrcp28pd opmask(zmm0, k1, zero: true), zmm1
        #   vrcp28pd zmm0, bcst(qword([ebx]), {1=>8})
        #   vrcp28pd zmm0, zmm1
        ...
        # @example
        #   vrcp28ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vrcp28ps opmask(zmm0, k1, zero: true), zmm1
        #   vrcp28ps zmm0, bcst(dword([ebx]), {1=>16})
        #   vrcp28ps zmm0, zmm1
        ...
        #   vrcp28sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vrcp28sd xmm0, xmm1, xmm2
        #   vrcp28sd xmm0, xmm1, qword([ecx])
        ...
        #   vrcp28ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vrcp28ss xmm0, xmm1, xmm2
        #   vrcp28ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vrcpph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vrcpph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vrcpph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vrcpph opmask(xmm0, k1, zero: true), xmm1
        #   vrcpph opmask(ymm0, k1, zero: true), ymm1
        #   vrcpph opmask(zmm0, k1, zero: true), zmm1
        #   vrcpph xmm0, bcst(word([ebx]), {1=>8})
        #   vrcpph xmm0, xmm1
        #   vrcpph ymm0, bcst(word([ebx]), {1=>16})
        #   vrcpph ymm0, ymm1
        #   vrcpph zmm0, bcst(word([ebx]), {1=>32})
        #   vrcpph zmm0, zmm1
        ...
        # @example
        #   vrcpps xmm0, xmm1
        #   vrcpps xmm0, oword([ebx])
        #   vrcpps ymm0, ymm1
        #   vrcpps ymm0, yword([ebx])
        ...
        #   vrcpsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vrcpsh xmm0, xmm1, xmm2
        #   vrcpsh xmm0, xmm1, word([ecx])
        ...
        # @example
        #   vreducepd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vreducepd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vreducepd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        ...
        #   vreducepd xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vreducepd xmm0, xmm1, 0x03
        #   vreducepd ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vreducepd ymm0, ymm1, 0x03
        #   vreducepd zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        ...
        # @example
        #   vreduceph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8}), 0x03
        #   vreduceph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16}), 0x03
        #   vreduceph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32}), 0x03
        ...
        #   vreduceph xmm0, bcst(word([ebx]), {1=>8}), 0x03
        #   vreduceph xmm0, xmm1, 0x03
        #   vreduceph ymm0, bcst(word([ebx]), {1=>16}), 0x03
        #   vreduceph ymm0, ymm1, 0x03
        #   vreduceph zmm0, bcst(word([ebx]), {1=>32}), 0x03
        ...
        # @example
        #   vreduceps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vreduceps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vreduceps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vreduceps xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vreduceps xmm0, xmm1, 0x03
        #   vreduceps ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vreduceps ymm0, ymm1, 0x03
        #   vreduceps zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vreducesd opmask(xmm0, k1, zero: true), xmm1, qword([ecx]), 0x04
        #   vreducesd xmm0, xmm1, xmm2, 0x04
        #   vreducesd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vreducesh opmask(xmm0, k1, zero: true), xmm1, word([ecx]), 0x04
        #   vreducesh xmm0, xmm1, xmm2, 0x04
        #   vreducesh xmm0, xmm1, word([ecx]), 0x04
        ...
        #   vreducess opmask(xmm0, k1, zero: true), xmm1, dword([ecx]), 0x04
        #   vreducess xmm0, xmm1, xmm2, 0x04
        #   vreducess xmm0, xmm1, dword([ecx]), 0x04
        ...
        # @example
        #   vrndscalepd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2}), 0x03
        #   vrndscalepd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4}), 0x03
        #   vrndscalepd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8}), 0x03
        ...
        #   vrndscalepd xmm0, bcst(qword([ebx]), {1=>2}), 0x03
        #   vrndscalepd xmm0, xmm1, 0x03
        #   vrndscalepd ymm0, bcst(qword([ebx]), {1=>4}), 0x03
        #   vrndscalepd ymm0, ymm1, 0x03
        #   vrndscalepd zmm0, bcst(qword([ebx]), {1=>8}), 0x03
        ...
        # @example
        #   vrndscaleph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8}), 0x03
        #   vrndscaleph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16}), 0x03
        #   vrndscaleph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32}), 0x03
        ...
        #   vrndscaleph xmm0, bcst(word([ebx]), {1=>8}), 0x03
        #   vrndscaleph xmm0, xmm1, 0x03
        #   vrndscaleph ymm0, bcst(word([ebx]), {1=>16}), 0x03
        #   vrndscaleph ymm0, ymm1, 0x03
        #   vrndscaleph zmm0, bcst(word([ebx]), {1=>32}), 0x03
        ...
        # @example
        #   vrndscaleps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4}), 0x03
        #   vrndscaleps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8}), 0x03
        #   vrndscaleps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vrndscaleps xmm0, bcst(dword([ebx]), {1=>4}), 0x03
        #   vrndscaleps xmm0, xmm1, 0x03
        #   vrndscaleps ymm0, bcst(dword([ebx]), {1=>8}), 0x03
        #   vrndscaleps ymm0, ymm1, 0x03
        #   vrndscaleps zmm0, bcst(dword([ebx]), {1=>16}), 0x03
        ...
        #   vrndscalesd opmask(xmm0, k1, zero: true), xmm1, qword([ecx]), 0x04
        #   vrndscalesd xmm0, xmm1, xmm2, 0x04
        #   vrndscalesd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vrndscalesh opmask(xmm0, k1, zero: true), xmm1, word([ecx]), 0x04
        #   vrndscalesh xmm0, xmm1, xmm2, 0x04
        #   vrndscalesh xmm0, xmm1, word([ecx]), 0x04
        ...
        #   vrndscaless opmask(xmm0, k1, zero: true), xmm1, dword([ecx]), 0x04
        #   vrndscaless xmm0, xmm1, xmm2, 0x04
        #   vrndscaless xmm0, xmm1, dword([ecx]), 0x04
        ...
        #   vroundpd xmm0, oword([ebx]), 0x03
        #   vroundpd ymm0, ymm1, 0x03
        #   vroundpd ymm0, yword([ebx]), 0x03
        ...
        #   vroundps xmm0, oword([ebx]), 0x03
        #   vroundps ymm0, ymm1, 0x03
        #   vroundps ymm0, yword([ebx]), 0x03
        ...
        #   vroundsd xmm0, xmm1, qword([ecx]), 0x04
        ...
        #   vroundss xmm0, xmm1, dword([ecx]), 0x04
        ...
        # @example
        #   vrsqrt14pd opmask(xmm0, k1, zero: true), bcst(qword([ebx]), {1=>2})
        #   vrsqrt14pd opmask(ymm0, k1, zero: true), bcst(qword([ebx]), {1=>4})
        #   vrsqrt14pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vrsqrt14pd opmask(xmm0, k1, zero: true), xmm1
        #   vrsqrt14pd opmask(ymm0, k1, zero: true), ymm1
        #   vrsqrt14pd opmask(zmm0, k1, zero: true), zmm1
        #   vrsqrt14pd xmm0, bcst(qword([ebx]), {1=>2})
        #   vrsqrt14pd xmm0, xmm1
        #   vrsqrt14pd ymm0, bcst(qword([ebx]), {1=>4})
        #   vrsqrt14pd ymm0, ymm1
        #   vrsqrt14pd zmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vrsqrt14ps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vrsqrt14ps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vrsqrt14ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vrsqrt14ps opmask(xmm0, k1, zero: true), xmm1
        #   vrsqrt14ps opmask(ymm0, k1, zero: true), ymm1
        #   vrsqrt14ps opmask(zmm0, k1, zero: true), zmm1
        #   vrsqrt14ps xmm0, bcst(dword([ebx]), {1=>4})
        #   vrsqrt14ps xmm0, xmm1
        #   vrsqrt14ps ymm0, bcst(dword([ebx]), {1=>8})
        #   vrsqrt14ps ymm0, ymm1
        #   vrsqrt14ps zmm0, bcst(dword([ebx]), {1=>16})
        ...
        #   vrsqrt14sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vrsqrt14sd xmm0, xmm1, xmm2
        #   vrsqrt14sd xmm0, xmm1, qword([ecx])
        ...
        #   vrsqrt14ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vrsqrt14ss xmm0, xmm1, xmm2
        #   vrsqrt14ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vrsqrt28pd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vrsqrt28pd opmask(zmm0, k1, zero: true), zmm1
        #   vrsqrt28pd zmm0, bcst(qword([ebx]), {1=>8})
        ...
        # @example
        #   vrsqrt28ps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vrsqrt28ps opmask(zmm0, k1, zero: true), zmm1
        #   vrsqrt28ps zmm0, bcst(dword([ebx]), {1=>16})
        ...
        #   vrsqrt28sd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vrsqrt28sd xmm0, xmm1, xmm2
        #   vrsqrt28sd xmm0, xmm1, qword([ecx])
        ...
        #   vrsqrt28ss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vrsqrt28ss xmm0, xmm1, xmm2
        #   vrsqrt28ss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vrsqrtph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vrsqrtph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vrsqrtph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vrsqrtph opmask(xmm0, k1, zero: true), xmm1
        #   vrsqrtph opmask(ymm0, k1, zero: true), ymm1
        #   vrsqrtph opmask(zmm0, k1, zero: true), zmm1
        #   vrsqrtph xmm0, bcst(word([ebx]), {1=>8})
        #   vrsqrtph xmm0, xmm1
        #   vrsqrtph ymm0, bcst(word([ebx]), {1=>16})
        #   vrsqrtph ymm0, ymm1
        #   vrsqrtph zmm0, bcst(word([ebx]), {1=>32})
        #   vrsqrtph zmm0, zmm1
        ...
        # @example
        #   vrsqrtps xmm0, xmm1
        #   vrsqrtps xmm0, oword([ebx])
        #   vrsqrtps ymm0, ymm1
        #   vrsqrtps ymm0, yword([ebx])
        ...
        #   vrsqrtsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vrsqrtsh xmm0, xmm1, xmm2
        #   vrsqrtsh xmm0, xmm1, word([ecx])
        ...
        # @example
        #   vscalefpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vscalefpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vscalefpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vscalefpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vscalefpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vscalefpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vscalefpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vscalefpd xmm0, xmm1, xmm2
        #   vscalefpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vscalefpd ymm0, ymm1, ymm2
        #   vscalefpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vscalefph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vscalefph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vscalefph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vscalefph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vscalefph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vscalefph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vscalefph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vscalefph xmm0, xmm1, xmm2
        #   vscalefph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vscalefph ymm0, ymm1, ymm2
        #   vscalefph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vscalefps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vscalefps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vscalefps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vscalefps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vscalefps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vscalefps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vscalefps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vscalefps xmm0, xmm1, xmm2
        #   vscalefps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vscalefps ymm0, ymm1, ymm2
        #   vscalefps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vscalefsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vscalefsd xmm0, xmm1, xmm2
        #   vscalefsd xmm0, xmm1, qword([ecx])
        ...
        #   vscalefsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vscalefsh xmm0, xmm1, xmm2
        #   vscalefsh xmm0, xmm1, word([ecx])
        ...
        #   vscalefss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vscalefss xmm0, xmm1, xmm2
        #   vscalefss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vscatterdpd opmask(dword([eax+xmm0*4]), k1), xmm1
        #   vscatterdpd opmask(dword([eax+xmm0*4]), k1), ymm1
        #   vscatterdpd opmask(dword([eax+ymm0*4]), k1), zmm1
        ...
        # @example
        #   vscatterdps opmask(dword([eax+xmm0*4]), k1), xmm1
        #   vscatterdps opmask(dword([eax+ymm0*4]), k1), ymm1
        #   vscatterdps opmask(dword([eax+zmm0*4]), k1), zmm1
        ...
        # @example
        #   vscatterpf0dpd opmask(dword([eax+ymm0*4]), k1)
        ...
        # @example
        #   vscatterpf0dps opmask(dword([eax+zmm0*4]), k1)
        ...
        # @example
        #   vscatterpf0qpd opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vscatterpf0qps opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vscatterpf1dpd opmask(dword([eax+ymm0*4]), k1)
        ...
        # @example
        #   vscatterpf1dps opmask(dword([eax+zmm0*4]), k1)
        ...
        # @example
        #   vscatterpf1qpd opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vscatterpf1qps opmask(qword([eax+zmm0*8]), k1)
        ...
        # @example
        #   vscatterqpd opmask(qword([eax+xmm0*8]), k1), xmm1
        #   vscatterqpd opmask(qword([eax+ymm0*8]), k1), ymm1
        #   vscatterqpd opmask(qword([eax+zmm0*8]), k1), zmm1
        ...
        # @example
        #   vscatterqps opmask(qword([eax+xmm0*8]), k1), xmm1
        #   vscatterqps opmask(qword([eax+ymm0*8]), k1), xmm1
        #   vscatterqps opmask(qword([eax+zmm0*8]), k1), ymm1
        ...
        # @example
        #   vshuff32x4 opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vshuff32x4 opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vshuff32x4 opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vshuff32x4 opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vshuff32x4 ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vshuff32x4 ymm0, ymm1, ymm2, 0x04
        #   vshuff32x4 zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   vshuff64x2 opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vshuff64x2 opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vshuff64x2 opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vshuff64x2 opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vshuff64x2 ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vshuff64x2 ymm0, ymm1, ymm2, 0x04
        #   vshuff64x2 zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vshufi32x4 opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vshufi32x4 opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vshufi32x4 opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vshufi32x4 opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vshufi32x4 ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vshufi32x4 ymm0, ymm1, ymm2, 0x04
        #   vshufi32x4 zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        # @example
        #   vshufi64x2 opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vshufi64x2 opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vshufi64x2 opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vshufi64x2 opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vshufi64x2 ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vshufi64x2 ymm0, ymm1, ymm2, 0x04
        #   vshufi64x2 zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vshufpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vshufpd opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vshufpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vshufpd opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vshufpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        #   vshufpd opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vshufpd xmm0, xmm1, bcst(qword([ecx]), {1=>2}), 0x04
        #   vshufpd xmm0, xmm1, xmm2, 0x04
        #   vshufpd xmm0, xmm1, xmm2, 0x04
        #   vshufpd xmm0, xmm1, oword([ecx]), 0x04
        #   vshufpd ymm0, ymm1, bcst(qword([ecx]), {1=>4}), 0x04
        #   vshufpd ymm0, ymm1, ymm2, 0x04
        #   vshufpd ymm0, ymm1, ymm2, 0x04
        #   vshufpd ymm0, ymm1, yword([ecx]), 0x04
        #   vshufpd zmm0, zmm1, bcst(qword([ecx]), {1=>8}), 0x04
        ...
        # @example
        #   vshufps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vshufps opmask(xmm0, k1, zero: true), xmm1, xmm2, 0x04
        #   vshufps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vshufps opmask(ymm0, k1, zero: true), ymm1, ymm2, 0x04
        #   vshufps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        #   vshufps opmask(zmm0, k1, zero: true), zmm1, zmm2, 0x04
        #   vshufps xmm0, xmm1, bcst(dword([ecx]), {1=>4}), 0x04
        #   vshufps xmm0, xmm1, xmm2, 0x04
        #   vshufps xmm0, xmm1, xmm2, 0x04
        #   vshufps xmm0, xmm1, oword([ecx]), 0x04
        #   vshufps ymm0, ymm1, bcst(dword([ecx]), {1=>8}), 0x04
        #   vshufps ymm0, ymm1, ymm2, 0x04
        #   vshufps ymm0, ymm1, ymm2, 0x04
        #   vshufps ymm0, ymm1, yword([ecx]), 0x04
        #   vshufps zmm0, zmm1, bcst(dword([ecx]), {1=>16}), 0x04
        ...
        #   vsm3rnds2 xmm0, xmm1, oword([ecx]), 0x04
        ...
        #   vsm4key4 xmm0, xmm1, oword([ecx])
        #   vsm4key4 ymm0, ymm1, ymm2
        #   vsm4key4 ymm0, ymm1, yword([ecx])
        ...
        #   vsm4rnds4 xmm0, xmm1, oword([ecx])
        #   vsm4rnds4 ymm0, ymm1, ymm2
        #   vsm4rnds4 ymm0, ymm1, yword([ecx])
        ...
        # @example
        #   vsqrtpd opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vsqrtpd opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vsqrtpd opmask(zmm0, k1, zero: true), bcst(qword([ebx]), {1=>8})
        #   vsqrtpd opmask(xmm0, k1, zero: true), xmm1
        #   vsqrtpd opmask(ymm0, k1, zero: true), ymm1
        #   vsqrtpd opmask(zmm0, k1, zero: true), zmm1
        #   vsqrtpd xmm0, bcst(dword([ebx]), {1=>4})
        #   vsqrtpd xmm0, xmm1
        #   vsqrtpd xmm0, xmm1
        #   vsqrtpd xmm0, oword([ebx])
        #   vsqrtpd ymm0, bcst(dword([ebx]), {1=>8})
        #   vsqrtpd ymm0, ymm1
        #   vsqrtpd ymm0, ymm1
        #   vsqrtpd ymm0, yword([ebx])
        #   vsqrtpd zmm0, bcst(qword([ebx]), {1=>8})
        #   vsqrtpd zmm0, zmm1
        ...
        # @example
        #   vsqrtph opmask(xmm0, k1, zero: true), bcst(word([ebx]), {1=>8})
        #   vsqrtph opmask(ymm0, k1, zero: true), bcst(word([ebx]), {1=>16})
        #   vsqrtph opmask(zmm0, k1, zero: true), bcst(word([ebx]), {1=>32})
        #   vsqrtph opmask(xmm0, k1, zero: true), xmm1
        #   vsqrtph opmask(ymm0, k1, zero: true), ymm1
        #   vsqrtph opmask(zmm0, k1, zero: true), zmm1
        #   vsqrtph xmm0, bcst(word([ebx]), {1=>8})
        #   vsqrtph xmm0, xmm1
        #   vsqrtph ymm0, bcst(word([ebx]), {1=>16})
        #   vsqrtph ymm0, ymm1
        #   vsqrtph zmm0, bcst(word([ebx]), {1=>32})
        #   vsqrtph zmm0, zmm1
        ...
        # @example
        #   vsqrtps opmask(xmm0, k1, zero: true), bcst(dword([ebx]), {1=>4})
        #   vsqrtps opmask(ymm0, k1, zero: true), bcst(dword([ebx]), {1=>8})
        #   vsqrtps opmask(zmm0, k1, zero: true), bcst(dword([ebx]), {1=>16})
        #   vsqrtps opmask(xmm0, k1, zero: true), xmm1
        #   vsqrtps opmask(ymm0, k1, zero: true), ymm1
        #   vsqrtps opmask(zmm0, k1, zero: true), zmm1
        #   vsqrtps xmm0, bcst(dword([ebx]), {1=>4})
        #   vsqrtps xmm0, xmm1
        #   vsqrtps xmm0, xmm1
        #   vsqrtps xmm0, oword([ebx])
        #   vsqrtps ymm0, bcst(dword([ebx]), {1=>8})
        #   vsqrtps ymm0, ymm1
        #   vsqrtps ymm0, ymm1
        #   vsqrtps ymm0, yword([ebx])
        #   vsqrtps zmm0, bcst(dword([ebx]), {1=>16})
        #   vsqrtps zmm0, zmm1
        ...
        #   vsqrtsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vsqrtsd xmm0, xmm1, xmm2
        #   vsqrtsd xmm0, xmm1, xmm2
        #   vsqrtsd xmm0, xmm1, qword([ecx])
        #   vsqrtsd xmm0, xmm1, qword([ecx])
        ...
        #   vsqrtsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vsqrtsh xmm0, xmm1, xmm2
        #   vsqrtsh xmm0, xmm1, word([ecx])
        ...
        #   vsqrtss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vsqrtss xmm0, xmm1, xmm2
        #   vsqrtss xmm0, xmm1, xmm2
        #   vsqrtss xmm0, xmm1, dword([ecx])
        #   vsqrtss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vsubpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vsubpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vsubpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vsubpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vsubpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vsubpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vsubpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vsubpd xmm0, xmm1, xmm2
        #   vsubpd xmm0, xmm1, xmm2
        #   vsubpd xmm0, xmm1, oword([ecx])
        #   vsubpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vsubpd ymm0, ymm1, ymm2
        #   vsubpd ymm0, ymm1, ymm2
        #   vsubpd ymm0, ymm1, yword([ecx])
        #   vsubpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vsubph opmask(xmm0, k1, zero: true), xmm1, bcst(word([ecx]), {1=>8})
        #   vsubph opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vsubph opmask(ymm0, k1, zero: true), ymm1, bcst(word([ecx]), {1=>16})
        #   vsubph opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vsubph opmask(zmm0, k1, zero: true), zmm1, bcst(word([ecx]), {1=>32})
        #   vsubph opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vsubph xmm0, xmm1, bcst(word([ecx]), {1=>8})
        #   vsubph xmm0, xmm1, xmm2
        #   vsubph ymm0, ymm1, bcst(word([ecx]), {1=>16})
        #   vsubph ymm0, ymm1, ymm2
        #   vsubph zmm0, zmm1, bcst(word([ecx]), {1=>32})
        ...
        # @example
        #   vsubps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vsubps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vsubps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vsubps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vsubps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vsubps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vsubps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vsubps xmm0, xmm1, xmm2
        #   vsubps xmm0, xmm1, xmm2
        #   vsubps xmm0, xmm1, oword([ecx])
        #   vsubps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vsubps ymm0, ymm1, ymm2
        #   vsubps ymm0, ymm1, ymm2
        #   vsubps ymm0, ymm1, yword([ecx])
        #   vsubps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   vsubsd opmask(xmm0, k1, zero: true), xmm1, qword([ecx])
        #   vsubsd xmm0, xmm1, xmm2
        #   vsubsd xmm0, xmm1, xmm2
        #   vsubsd xmm0, xmm1, qword([ecx])
        #   vsubsd xmm0, xmm1, qword([ecx])
        ...
        #   vsubsh opmask(xmm0, k1, zero: true), xmm1, word([ecx])
        #   vsubsh xmm0, xmm1, xmm2
        #   vsubsh xmm0, xmm1, word([ecx])
        ...
        #   vsubss opmask(xmm0, k1, zero: true), xmm1, dword([ecx])
        #   vsubss xmm0, xmm1, xmm2
        #   vsubss xmm0, xmm1, xmm2
        #   vsubss xmm0, xmm1, dword([ecx])
        #   vsubss xmm0, xmm1, dword([ecx])
        ...
        # @example
        #   vtestpd xmm0, xmm1
        #   vtestpd xmm0, oword([ebx])
        #   vtestpd ymm0, ymm1
        #   vtestpd ymm0, yword([ebx])
        ...
        # @example
        #   vtestps xmm0, xmm1
        #   vtestps xmm0, oword([ebx])
        #   vtestps ymm0, ymm1
        #   vtestps ymm0, yword([ebx])
        ...
        # @example
        #   vunpckhpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vunpckhpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vunpckhpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vunpckhpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vunpckhpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vunpckhpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vunpckhpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vunpckhpd xmm0, xmm1, xmm2
        #   vunpckhpd xmm0, xmm1, xmm2
        #   vunpckhpd xmm0, xmm1, oword([ecx])
        #   vunpckhpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vunpckhpd ymm0, ymm1, ymm2
        #   vunpckhpd ymm0, ymm1, ymm2
        #   vunpckhpd ymm0, ymm1, yword([ecx])
        #   vunpckhpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vunpckhps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vunpckhps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vunpckhps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vunpckhps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vunpckhps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vunpckhps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vunpckhps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vunpckhps xmm0, xmm1, xmm2
        #   vunpckhps xmm0, xmm1, xmm2
        #   vunpckhps xmm0, xmm1, oword([ecx])
        #   vunpckhps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vunpckhps ymm0, ymm1, ymm2
        #   vunpckhps ymm0, ymm1, ymm2
        #   vunpckhps ymm0, ymm1, yword([ecx])
        #   vunpckhps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vunpcklpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vunpcklpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vunpcklpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vunpcklpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vunpcklpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vunpcklpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vunpcklpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vunpcklpd xmm0, xmm1, xmm2
        #   vunpcklpd xmm0, xmm1, xmm2
        #   vunpcklpd xmm0, xmm1, oword([ecx])
        #   vunpcklpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vunpcklpd ymm0, ymm1, ymm2
        #   vunpcklpd ymm0, ymm1, ymm2
        #   vunpcklpd ymm0, ymm1, yword([ecx])
        #   vunpcklpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vunpcklps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vunpcklps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vunpcklps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vunpcklps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vunpcklps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vunpcklps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vunpcklps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vunpcklps xmm0, xmm1, xmm2
        #   vunpcklps xmm0, xmm1, xmm2
        #   vunpcklps xmm0, xmm1, oword([ecx])
        #   vunpcklps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vunpcklps ymm0, ymm1, ymm2
        #   vunpcklps ymm0, ymm1, ymm2
        #   vunpcklps ymm0, ymm1, yword([ecx])
        #   vunpcklps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        # @example
        #   vxorpd opmask(xmm0, k1, zero: true), xmm1, bcst(qword([ecx]), {1=>2})
        #   vxorpd opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vxorpd opmask(ymm0, k1, zero: true), ymm1, bcst(qword([ecx]), {1=>4})
        #   vxorpd opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vxorpd opmask(zmm0, k1, zero: true), zmm1, bcst(qword([ecx]), {1=>8})
        #   vxorpd opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vxorpd xmm0, xmm1, bcst(qword([ecx]), {1=>2})
        #   vxorpd xmm0, xmm1, xmm2
        #   vxorpd xmm0, xmm1, xmm2
        #   vxorpd xmm0, xmm1, oword([ecx])
        #   vxorpd ymm0, ymm1, bcst(qword([ecx]), {1=>4})
        #   vxorpd ymm0, ymm1, ymm2
        #   vxorpd ymm0, ymm1, ymm2
        #   vxorpd ymm0, ymm1, yword([ecx])
        #   vxorpd zmm0, zmm1, bcst(qword([ecx]), {1=>8})
        ...
        # @example
        #   vxorps opmask(xmm0, k1, zero: true), xmm1, bcst(dword([ecx]), {1=>4})
        #   vxorps opmask(xmm0, k1, zero: true), xmm1, xmm2
        #   vxorps opmask(ymm0, k1, zero: true), ymm1, bcst(dword([ecx]), {1=>8})
        #   vxorps opmask(ymm0, k1, zero: true), ymm1, ymm2
        #   vxorps opmask(zmm0, k1, zero: true), zmm1, bcst(dword([ecx]), {1=>16})
        #   vxorps opmask(zmm0, k1, zero: true), zmm1, zmm2
        #   vxorps xmm0, xmm1, bcst(dword([ecx]), {1=>4})
        #   vxorps xmm0, xmm1, xmm2
        #   vxorps xmm0, xmm1, xmm2
        #   vxorps xmm0, xmm1, oword([ecx])
        #   vxorps ymm0, ymm1, bcst(dword([ecx]), {1=>8})
        #   vxorps ymm0, ymm1, ymm2
        #   vxorps ymm0, ymm1, ymm2
        #   vxorps ymm0, ymm1, yword([ecx])
        #   vxorps zmm0, zmm1, bcst(dword([ecx]), {1=>16})
        ...
        #   xor byte([eax]), bl
        #   xor word([eax]), 0x02
        #   xor word([eax]), word(0x0002)
        #   xor word([eax]), bx
        #   xor dword([eax]), 0x02
        #   xor dword([eax]), dword(0x00000002)
        #   xor dword([eax]), ebx
