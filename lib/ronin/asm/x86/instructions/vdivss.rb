        ...
        class VDIVSS < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm && @operands[2].type == :xmm
              ...
              encoder.write_evex(mmm: 0b001, pp: 0b10, w: 0, ll: @operands[3], vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 1, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x5e) +
              encoder.write_modrm(3,@operands[0],@operands[2])
            elsif @operands.length == 4 && @operands[0].type == :xmm && @operands[1].type == :xmm && @operands[2].type == :xmm && @operands[3].type == :"{er}"
              encoder.write_evex(mmm: 0b001, pp: 0b10, w: 0, ll: @operands[3], vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 1, aaa: 0, z: 0) +
              encoder.write_opcode(0x5e) +
              encoder.write_modrm(3,@operands[0],@operands[2])
            else
