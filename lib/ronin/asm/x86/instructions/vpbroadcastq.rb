        ...
        class VPBROADCASTQ < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm
              ...
              encoder.write_evex(0b010,0b01,1,0,0,0,0b00,0,0,0,@operands[0],@operands[0],8) +
              encoder.write_opcode(0x59) +
              ...
              encoder.write_evex(0b010,0b01,1,1,0,0,0b00,0,0,0,@operands[0],@operands[0],8) +
              encoder.write_opcode(0x59) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :"zmm{k}{z}" && @operands[1].type == :mem64
              encoder.write_evex(0b010,0b01,1,2,0,0,0b00,0,0,0,@operands[0],@operands[0],8) +
              encoder.write_opcode(0x59) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
