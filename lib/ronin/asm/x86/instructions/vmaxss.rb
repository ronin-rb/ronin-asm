        ...
        class VMAXSS < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm && @operands[2].type == :xmm
              ...
              encoder.write_evex(0b001,0b10,0,0,@operands[1],0,0b00,0,0,0,@operands[0],@operands[0],4) +
              encoder.write_opcode(0x5f) +
              ...
              encoder.write_evex(0b001,0b10,0,nil,@operands[1],0,0b00,0,0,1,@operands[0],@operands[0],nil) +
              encoder.write_opcode(0x5f) +
              encoder.write_modrm(3,@operands[0],@operands[2],@operands)
