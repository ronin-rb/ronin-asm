        ...
        class VGF2P8MULB < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm && @operands[2].type == :xmm
              ...
              encoder.write_evex(0b010,0b01,0,0,@operands[1],0,0b00,0,0,0,@operands[0],@operands[0],16) +
              encoder.write_opcode(0xcf) +
              ...
              encoder.write_evex(0b010,0b01,0,1,@operands[1],0,0b00,0,0,0,@operands[0],@operands[0],32) +
              encoder.write_opcode(0xcf) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2],@operands)
              ...
              encoder.write_evex(0b010,0b01,0,2,@operands[1],0,0b00,0,0,0,@operands[0],@operands[0],64) +
              encoder.write_opcode(0xcf) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2],@operands)
