    ...
    module X86
      module Instructions
        ...
        class BLCFILL < Instruction
          ...
          #
          # Initializes the `blcfill` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:blcfill,*operands,**kwargs)
          end

          #
          # Encodes the `blcfill` instruction.
          #
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :reg32 && @operands[1].type == :reg32
              encoder.write_vex(:xop,0,0,0b01001,0b00,0,0,0,@operands[0]) +
