      ...
      module Instructions
        ...
        class VMOVLPS < Instruction
          ...
          def encode(encoder)
            ...
            when [:mem64, :xmm]
              encoder.write_evex(mmm: 0b001, pp: 0b00, w: 0, ll: 0b00, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: 0, z: 0, disp8xN: 8) +
              encoder.write_opcode(0x13) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
            when [:xmm, :xmm, :mem64]
            ...
            when [:xmm, :xmm, :mem64]
              encoder.write_evex(mmm: 0b001, pp: 0b00, w: 0, ll: 0b00, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: 0, z: 0, disp8xN: 8) +
              encoder.write_opcode(0x12) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
            else
