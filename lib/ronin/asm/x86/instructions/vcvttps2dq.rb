        ...
        class VCVTTPS2DQ < Instruction
          ...
          def encode(encoder)
            ...
            when [:"zmm{k}{z}", :zmm, :"{sae}"]
              encoder.write_evex(mmm: 0b001, pp: 0b10, w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 1, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x5b) +
              encoder.write_modrm(0b11,@operands[0],@operands[1])
            when [:zmm, :zmm, :"{sae}"]
              encoder.write_evex(mmm: 0b001, pp: 0b10, w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 1, aaa: 0, z: 0) +
              encoder.write_opcode(0x5b) +
              encoder.write_modrm(0b11,@operands[0],@operands[1])
            else
