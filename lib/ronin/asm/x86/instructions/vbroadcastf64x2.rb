        ...
        class VBROADCASTF64X2 < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"ymm{k}{z}" && @operands[1].type == :m128
              encoder.write_evex(0b010,0b01,1,1,0,0,0b00,0,0,0,@operands[0],@operands[0],16) +
              ...
              encoder.write_evex(0b010,0b01,1,2,0,0,0b00,0,0,0,@operands[0],@operands[0],16) +
              encoder.write_opcode(0x1a) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :ymm && @operands[1].type == :m128
              encoder.write_evex(0b010,0b01,1,1,0,0,0b00,0,0,0,0,0,16) +
              encoder.write_opcode(0x1a) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :zmm && @operands[1].type == :m128
              encoder.write_evex(0b010,0b01,1,2,0,0,0b00,0,0,0,0,0,16) +
              encoder.write_opcode(0x1a) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            else
