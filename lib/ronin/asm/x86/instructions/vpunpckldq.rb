        ...
        class VPUNPCKLDQ < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm && @operands[2].type == :"mem128/m32bcst"
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b00, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: @operands[0], disp8xN: 16) +
              ...
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b01, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: @operands[0], disp8xN: 32) +
              encoder.write_opcode(0x62) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
              ...
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b10, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: @operands[0], disp8xN: 64) +
              encoder.write_opcode(0x62) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
