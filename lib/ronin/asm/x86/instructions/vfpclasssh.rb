        ...
        class VFPCLASSSH < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"k{k}" && @operands[1].type == :xmm && @operands[2].type == :imm8
              encoder.write_evex(0b011,0b00,0,nil,0,0,0b00,0,0,0,@operands[0],0,nil) +
              ...
              encoder.write_evex(0b011,0b00,0,nil,0,0,0b00,0,0,0,@operands[0],0,4) +
              encoder.write_opcode(0x67) +
              ...
              encoder.write_evex(0b011,0b00,0,nil,0,0,0b00,0,0,0,0,0,4) +
              encoder.write_opcode(0x67) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands) +
              encoder.write_immediate(@operands[2],1)
            else
