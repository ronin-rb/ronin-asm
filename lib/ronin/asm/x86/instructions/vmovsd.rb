        ...
        class VMOVSD < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"m64{k}" && @operands[1].type == :xmm
              encoder.write_evex(0b001,0b11,1,nil,0,0,0b00,0,0,0,@operands[0],0,8) +
              ...
              encoder.write_evex(0b001,0b11,1,nil,0,0,0b00,0,0,0,@operands[0],@operands[0],8) +
              ...
              encoder.write_vex(:vex,nil,nil,0b00001,0b11,0,0,0,0) +
              encoder.write_opcode(0x10) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :xmm && @operands[1].type == :mem64
              encoder.write_evex(0b001,0b11,1,nil,0,0,0b00,0,0,0,0,0,8) +
              encoder.write_opcode(0x10) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
