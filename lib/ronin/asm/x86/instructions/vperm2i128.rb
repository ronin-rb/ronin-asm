    ...
    module X86
      module Instructions
        ...
        class VPERM2I128 < Instruction
          ...
          #
          # Initializes the `vperm2i128` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:vperm2i128,*operands,**kwargs)
          end

          #
          # Encodes the `vperm2i128` instruction.
          #
          ...
          #
          def encode(encoder)
            if @operands.length == 4 && @operands[0].type == :ymm && @operands[1].type == :ymm && @operands[2].type == :ymm && @operands[3].type == :imm8
