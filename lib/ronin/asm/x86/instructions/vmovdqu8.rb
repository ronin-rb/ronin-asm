        ...
        class VMOVDQU8 < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"m128{k}" && @operands[1].type == :xmm
              encoder.write_evex(0b001,0b11,0,0,0,0,0b00,0,0,0,@operands[0],0,16) +
              ...
              encoder.write_evex(0b001,0b11,0,1,0,0,0b00,0,0,0,@operands[0],0,32) +
              encoder.write_opcode(0x7f) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
              ...
              encoder.write_evex(0b001,0b11,0,2,0,0,0b00,0,0,0,@operands[0],0,64) +
              encoder.write_opcode(0x7f) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
            elsif @operands.length == 2 && @operands[0].type == :"zmm{k}{z}" && @operands[1].type == :zmm
              encoder.write_evex(0b001,0b11,0,2,0,0,0b00,0,0,0,@operands[0],@operands[0],nil) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(3,@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :m128
              encoder.write_evex(0b001,0b11,0,0,0,0,0b00,0,0,0,@operands[0],@operands[0],16) +
              encoder.write_opcode(0x6f) +
              ...
              encoder.write_evex(0b001,0b11,0,1,0,0,0b00,0,0,0,@operands[0],@operands[0],32) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :"zmm{k}{z}" && @operands[1].type == :m512
              encoder.write_evex(0b001,0b11,0,2,0,0,0b00,0,0,0,@operands[0],@operands[0],64) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b001,0b11,0,0,0,0,0b00,0,0,0,0,0,16) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b001,0b11,0,1,0,0,0b00,0,0,0,0,0,32) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :zmm && @operands[1].type == :zmm
              encoder.write_evex(0b001,0b11,0,2,0,0,0b00,0,0,0,0,0,nil) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(3,@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :zmm && @operands[1].type == :m512
              encoder.write_evex(0b001,0b11,0,2,0,0,0b00,0,0,0,0,0,64) +
              encoder.write_opcode(0x6f) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
