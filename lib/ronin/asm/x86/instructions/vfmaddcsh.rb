        ...
        class VFMADDCSH < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type_of?(:"xmm{k}{z}") && @operands[1].type_of?(:xmm) && @operands[2].type_of?(:xmm)
              ...
              encoder.write_evex(mmm: 0b110, pp: 0b10, ll: 0b00, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: @operands[0], z: @operands[0], disp8xN: 4) +
              encoder.write_opcode(0x57) +
              ...
              encoder.write_evex(mmm: 0b110, pp: 0b10, ll: 0b00, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: 0, z: 0, disp8xN: 4) +
              encoder.write_opcode(0x57) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
