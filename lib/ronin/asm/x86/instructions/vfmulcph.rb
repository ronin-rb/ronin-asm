        ...
        class VFMULCPH < Instruction
          ...
          def encode(encoder)
            ...
            when [:"zmm{k}{z}", :zmm, :zmm]
              encoder.write_evex(mmm: 0b110, pp: 0b10, w: 0, ll: 0b10, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0xd6) +
              encoder.write_modrm(0b11,@operands[0],@operands[2])
            ...
            when [:zmm, :zmm, :"mem512/mem32bcst"]
              ...
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
            when [:zmm, :zmm, :zmm]
              encoder.write_evex(mmm: 0b110, pp: 0b10, w: 0, ll: 0b10, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: 0, z: 0) +
              encoder.write_opcode(0xd6) +
              encoder.write_modrm(0b11,@operands[0],@operands[2])
