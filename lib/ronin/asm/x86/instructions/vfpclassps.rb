        ...
        class VFPCLASSPS < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"k{k}" && @operands[1].type == :"m128/m32bcst" && @operands[2].type == :imm8
              encoder.write_evex(0b011,0b01,0,0,0,0,0b00,0,0,@operands[1],@operands[0],0,16) +
              ...
              encoder.write_evex(0b011,0b01,0,1,0,0,0b00,0,0,@operands[1],@operands[0],0,32) +
              encoder.write_opcode(0x66) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands) +
              encoder.write_immediate(@operands[2],1)
              ...
              encoder.write_evex(0b011,0b01,0,2,0,0,0b00,0,0,@operands[1],@operands[0],0,64) +
              encoder.write_opcode(0x66) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands) +
              encoder.write_immediate(@operands[2],1)
              ...
              encoder.write_evex(0b011,0b01,0,0,0,0,0b00,0,0,0,@operands[0],0,nil) +
              encoder.write_opcode(0x66) +
              ...
              encoder.write_evex(0b011,0b01,0,1,0,0,0b00,0,0,0,@operands[0],0,nil) +
              encoder.write_opcode(0x66) +
              encoder.write_modrm(3,@operands[0],@operands[1],@operands) +
              encoder.write_immediate(@operands[2],1)
              ...
              encoder.write_evex(0b011,0b01,0,2,0,0,0b00,0,0,0,@operands[0],0,nil) +
              encoder.write_opcode(0x66) +
              encoder.write_modrm(3,@operands[0],@operands[1],@operands) +
              encoder.write_immediate(@operands[2],1)
