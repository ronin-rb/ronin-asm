        ...
        class VPMOVUSQW < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm
              ...
              encoder.write_evex(0b010,0b10,0,0,0,0,0b00,0,0,0,@operands[0],0,4) +
              encoder.write_opcode(0x14) +
              ...
              encoder.write_evex(0b010,0b10,0,1,0,0,0b00,0,0,0,@operands[0],0,8) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
              ...
              encoder.write_evex(0b010,0b10,0,2,0,0,0b00,0,0,0,@operands[0],0,16) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
              ...
              encoder.write_evex(0b010,0b10,0,0,0,0,0b00,0,0,0,0,0,4) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
            elsif @operands.length == 2 && @operands[0].type == :mem64 && @operands[1].type == :ymm
              encoder.write_evex(0b010,0b10,0,1,0,0,0b00,0,0,0,0,0,8) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
            elsif @operands.length == 2 && @operands[0].type == :m128 && @operands[1].type == :zmm
              encoder.write_evex(0b010,0b10,0,2,0,0,0b00,0,0,0,0,0,16) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
            else
