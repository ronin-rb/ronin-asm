        ...
        class VCVTPS2UDQ < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :"mem128/m32bcst"
              ...
              encoder.write_evex(mmm: 0b001, pp: 0b00, ll: @operands[2], w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 1, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x79) +
              encoder.write_modrm(0b11,@operands[0],@operands[1])
            elsif @operands.length == 3 && @operands[0].type == :zmm && @operands[1].type == :zmm && @operands[2].type == :"{er}"
              encoder.write_evex(mmm: 0b001, pp: 0b00, ll: @operands[2], w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 1, aaa: 0, z: 0) +
              encoder.write_opcode(0x79) +
              encoder.write_modrm(0b11,@operands[0],@operands[1])
            else
