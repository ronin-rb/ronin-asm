        ...
        class VCMPPH < Instruction
          ...
          def encode(encoder)
            ...
            when [:"k{k}", :zmm, :zmm, :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b00, ll: 0b10, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: @operands[0], z: 0) +
              encoder.write_opcode(0xc2) +
              encoder.write_modrm(0b11,@operands[0],@operands[2]) +
              encoder.write_immediate(@operands[3],1)
            when [:k, :zmm, :zmm, :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b00, ll: 0b10, w: 0, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: 0, z: 0) +
              encoder.write_opcode(0xc2) +
              encoder.write_modrm(0b11,@operands[0],@operands[2]) +
              encoder.write_immediate(@operands[3],1)
