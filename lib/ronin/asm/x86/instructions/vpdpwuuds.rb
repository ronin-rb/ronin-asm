        ...
        class VPDPWUUDS < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type_of?(:xmm) && @operands[1].type_of?(:xmm) && @operands[2].type_of?(:xmm)
              encoder.write_vex(type: :vex, w: 0, l: 0, m_mmmm: 0b00010, pp: 0b00, r: 0, x: 0, b: 0, vvvv: @operands[1]) +
              ...
              encoder.write_vex(type: :vex, w: 0, l: 1, m_mmmm: 0b00010, pp: 0b00, r: 0, x: 0, b: 0, vvvv: @operands[1]) +
              encoder.write_opcode(0xd3) +
              encoder.write_modrm(0b11,@operands[0],@operands[2])
