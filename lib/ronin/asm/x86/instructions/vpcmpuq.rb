        ...
        class VPCMPUQ < Instruction
          ...
          def encode(encoder)
            ...
            when [:"k{k}", :xmm, :"mem128/mem64bcst", :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b01, ll: 0b00, w: 1, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: 0, disp8xN: 16) +
            ...
            when [:"k{k}", :ymm, :"mem256/mem64bcst", :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b01, ll: 0b01, w: 1, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: 0, disp8xN: 32) +
              encoder.write_opcode(0x1e) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2]) +
              encoder.write_immediate(@operands[3],1)
            ...
            when [:"k{k}", :zmm, :"mem512/mem64bcst", :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b01, ll: 0b10, w: 1, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: 0, disp8xN: 64) +
              encoder.write_opcode(0x1e) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2]) +
              encoder.write_immediate(@operands[3],1)
