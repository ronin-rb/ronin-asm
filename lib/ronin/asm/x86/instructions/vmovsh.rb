        ...
        class VMOVSH < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"m16{k}" && @operands[1].type == :xmm
              encoder.write_evex(mmm: 0b101, pp: 0b10, w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: @operands[0], z: 0, disp8xN: 4) +
              ...
              encoder.write_evex(mmm: 0b101, pp: 0b10, w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: @operands[0], z: @operands[0], disp8xN: 4) +
              ...
              encoder.write_prefix(0x66,false) +
              encoder.write_evex(mmm: 0b101, pp: 0b10, w: 0, vvvv: 0, v: 0, rr: 0b00, _B: 0, x: 0, b: 0, aaa: 0, z: 0, disp8xN: 4) +
              encoder.write_opcode(0x10) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
