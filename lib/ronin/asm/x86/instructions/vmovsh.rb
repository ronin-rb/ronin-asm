    ...
    module X86
      module Instructions
        ...
        class VMOVSH < Instruction
          ...
          #
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"m16{k}" && @operands[1].type == :xmm
              encoder.write_evex(0b101,0b10,0,nil,0,0,0b00,0,0,0,@operands[0],0,4) +
              ...
              encoder.write_evex(0b101,0b10,0,nil,0,0,0b00,0,0,0,@operands[0],@operands[0],4) +
              ...
              encoder.write_prefix(0x66,false) +
              encoder.write_evex(0b101,0b10,0,nil,0,0,0b00,0,0,0,0,0,4) +
              encoder.write_opcode(0x10) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_opcode(0x11) +
              encoder.write_modrm(3,@operands[2],@operands[0],@operands)
