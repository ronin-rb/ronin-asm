        ...
        class VPOPCNTW < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm
              ...
              encoder.write_evex(0b010,0b01,1,0,0,0,0b00,0,0,0,@operands[0],@operands[0],16) +
              encoder.write_opcode(0x54) +
              ...
              encoder.write_evex(0b010,0b01,1,1,0,0,0b00,0,0,0,@operands[0],@operands[0],32) +
              encoder.write_opcode(0x54) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :"zmm{k}{z}" && @operands[1].type == :m512
              encoder.write_evex(0b010,0b01,1,2,0,0,0b00,0,0,0,@operands[0],@operands[0],64) +
              encoder.write_opcode(0x54) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b010,0b01,1,0,0,0,0b00,0,0,0,0,0,16) +
              encoder.write_opcode(0x54) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b010,0b01,1,1,0,0,0b00,0,0,0,0,0,32) +
              encoder.write_opcode(0x54) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b010,0b01,1,2,0,0,0b00,0,0,0,0,0,64) +
              encoder.write_opcode(0x54) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            else
