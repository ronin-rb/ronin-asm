        ...
        class VPCMPGTQ < Instruction
          ...
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :"k{k}" && @operands[1].type == :xmm && @operands[2].type == :"mem128/mem64bcst"
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, ll: 0b00, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: 0, disp8xN: 16) +
              ...
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, ll: 0b01, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: 0, disp8xN: 32) +
              encoder.write_opcode(0x37) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
              ...
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, ll: 0b10, vvvv: @operands[1], v: 0, rr: 0b00, _B: 0, x: 0, b: @operands[2], aaa: @operands[0], z: 0, disp8xN: 64) +
              encoder.write_opcode(0x37) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
