        ...
        class VCVTNEPS2BF16 < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :"m128/m32bcst"
              encoder.write_evex(0b010,0b10,0,0,0,0,0b00,0,0,@operands[1],@operands[0],@operands[0],16) +
              ...
              encoder.write_evex(0b010,0b10,0,1,0,0,0b00,0,0,@operands[1],@operands[0],@operands[0],32) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :"ymm{k}{z}" && @operands[1].type == :"m512/m32bcst"
              encoder.write_evex(0b010,0b10,0,2,0,0,0b00,0,0,@operands[1],@operands[0],@operands[0],64) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b010,0b10,0,0,0,0,0b00,0,0,@operands[1],0,0,16) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0].type == :xmm && @operands[1].type == :"m256/m32bcst"
              encoder.write_evex(0b010,0b10,0,1,0,0,0b00,0,0,@operands[1],0,0,32) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
              ...
              encoder.write_vex(:vex,0,0,0b00010,0b10,0,0,0,0) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(3,@operands[0],@operands[1],@operands)
              ...
              encoder.write_vex(:vex,0,1,0b00010,0b10,0,0,0,0) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(3,@operands[0],@operands[1],@operands)
              ...
              encoder.write_evex(0b010,0b10,0,2,0,0,0b00,0,0,@operands[1],0,0,64) +
              encoder.write_opcode(0x72) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
