      ...
      module Instructions
        ...
        class VPMOVUSQW < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"xmm{k}{z}" && @operands[1].type == :xmm
            ...
            elsif @operands.length == 2 && @operands[0].type == :"mem32{k}" && @operands[1].type == :xmm
              encoder.write_evex(mmm: 0b010, pp: 0b10, w: 0, ll: 0b00, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: 0, disp8xN: 4) +
              encoder.write_opcode(0x14) +
              ...
              encoder.write_opcode(0x14) +
              encoder.write_modrm(0b11,@operands[1],@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :"mem64{k}" && @operands[1].type == :ymm
              encoder.write_evex(mmm: 0b010, pp: 0b10, w: 0, ll: 0b01, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: 0, disp8xN: 8) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
              ...
              encoder.write_opcode(0x14) +
              encoder.write_modrm(0b11,@operands[1],@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :"mem128{k}" && @operands[1].type == :zmm
              encoder.write_evex(mmm: 0b010, pp: 0b10, w: 0, ll: 0b10, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: 0, disp8xN: 16) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
              ...
              encoder.write_evex(mmm: 0b010, pp: 0b10, w: 0, ll: 0b00, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: 0, z: 0, disp8xN: 4) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :mem64 && @operands[1].type == :ymm
              encoder.write_evex(mmm: 0b010, pp: 0b10, w: 0, ll: 0b01, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: 0, z: 0, disp8xN: 8) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :mem128 && @operands[1].type == :zmm
              encoder.write_evex(mmm: 0b010, pp: 0b10, w: 0, ll: 0b10, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: 0, z: 0, disp8xN: 16) +
              encoder.write_opcode(0x14) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
            else
