        ...
        class VCMPSS < Instruction
          ...
          def encode(encoder)
            if @operands.length == 4 && @operands[0].type == :"k{k}" && @operands[1].type == :xmm && @operands[2].type == :xmm && @operands[3].type == :imm8
              encoder.write_evex(mmm: 0b001, pp: 0b10, w: 0, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 0, aaa: @operands[0], z: 0) +
              ...
              encoder.write_evex(mmm: 0b001, pp: 0b10, ll: 0b00, w: 0, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 0, aaa: @operands[0], z: 0, disp8xN: 4) +
              encoder.write_opcode(0xc2) +
              ...
              encoder.write_evex(mmm: 0b001, pp: 0b10, w: 0, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 1, aaa: @operands[0], z: 0) +
              encoder.write_opcode(0xc2) +
              encoder.write_modrm(0b11,@operands[0],@operands[2]) +
