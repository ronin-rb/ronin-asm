    ...
    module X86_64
      module Instructions
        ...
        class INSERTQ < Instruction
          ...
          #
          # Initializes the `insertq` instruction.
          #
          ...
          #
          # Encodes the `insertq` instruction.
          #
          ...
          def encode(encoder)
            ...
            elsif @operands.length == 4 && @operands[0].type == :xmm && @operands[1].type == :xmm && @operands[2].type == :imm8 && @operands[3].type == :imm8
              encoder.write_prefix(0xf2,true) +
              encoder.write_rex(@operands, mandatory: false, w: 0, r: @operands[0], b: @operands[1]) +
              encoder.write_opcode(0x0f) +
