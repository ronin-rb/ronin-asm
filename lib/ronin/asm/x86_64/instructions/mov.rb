        ...
        class MOV < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :reg8 && @operands[1].type == :imm8
              ...
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0] == Registers::EAX && @operands[1].type == :moffs32
              ...
              encoder.write_opcode(0x8b) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0] == Registers::RAX && @operands[1].type == :moffs64
              ...
              encoder.write_opcode(0x89) +
              encoder.write_modrm(@operands[0],@operands[1],@operands[0],@operands)
            elsif @operands.length == 2 && @operands[0].type == :moffs32 && @operands[1] == Registers::EAX
              encoder.write_opcode(0xa3) +
              encoder.write_data_offset(@operands[0],4)
            elsif @operands.length == 2 && @operands[0].type == :moffs64 && @operands[1] == Registers::RAX
              encoder.write_rex(@operands, mandatory: true, w: 1) +
              encoder.write_opcode(0xa3) +
