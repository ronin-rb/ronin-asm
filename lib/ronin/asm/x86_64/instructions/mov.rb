      ...
      module Instructions
        ...
        class MOV < Instruction
          ...
          def initialize(*operands,**kwargs)
            ...
            @form = if @operands.length == 2 && @operands[0].type_of?(:reg8) && @operands[1].type_of?(:imm8)
                      [:reg8, :imm8]
                      ...
                      [:reg16, :mem16]
                    elsif @operands.length == 2 && @operands[0] == Registers::EAX && @operands[1].type_of?(:moffset32)
                      [:eax, :moffset32]
                      ...
                      [:reg32, :mem32]
                    elsif @operands.length == 2 && @operands[0] == Registers::RAX && @operands[1].type_of?(:moffset64)
                      [:rax, :moffset64]
                    elsif @operands.length == 2 && @operands[0].type_of?(:reg64) && @operands[1].type_of?(:imm32)
                      [:reg64, :imm32]
                    elsif @operands.length == 2 && @operands[0].type_of?(:reg64) && @operands[1].type_of?(:imm64)
                      [:reg64, :imm64]
