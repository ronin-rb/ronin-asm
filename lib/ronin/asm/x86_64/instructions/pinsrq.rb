      ...
      module Instructions
        ...
        class PINSRQ < Instruction
          ...
          def initialize(*operands,**kwargs)
            ...
            @form = if @operands.length == 3 && @operands[0].type_of?(:xmm) && @operands[1].type_of?(:reg64) && @operands[2].type_of?(:imm8)
                      [:xmm, :reg64, :imm8]
                    elsif @operands.length == 3 && @operands[0].type_of?(:xmm) && @operands[1].type_of?(:mem64) && @operands[2].type_of?(:imm8)
                      [:xmm, :mem64, :imm8]
                    else
