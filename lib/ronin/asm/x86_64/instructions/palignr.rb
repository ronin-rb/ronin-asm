    ...
    module X86_64
      module Instructions
        ...
        class PALIGNR < Instruction
          ...
          #
          # Initializes the `palignr` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:palignr,*operands,**kwargs)
          end

          #
          # Encodes the `palignr` instruction.
          #
          ...
          #
          def encode(encoder)
            if @operands.length == 3 && @operands[0].type == :mm && @operands[1].type == :mm && @operands[2].type == :imm8
            ...
            elsif @operands.length == 3 && @operands[0].type == :mm && @operands[1].type == :mem64 && @operands[2].type == :imm8
