        ...
        class VDIVSS < Instruction
          ...
          def encode(encoder)
            ...
            when [:"xmm{k}{z}", :xmm, :xmm, :"{er}"]
              encoder.write_evex(mmm: 0b001, pp: 0b10, ll: @operands[3], w: 0, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 1, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x5e) +
              encoder.write_modrm(0b11,@operands[0],@operands[2])
            when [:xmm, :xmm, :xmm, :"{er}"]
              encoder.write_evex(mmm: 0b001, pp: 0b10, ll: @operands[3], w: 0, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 1, aaa: 0, z: 0) +
              encoder.write_opcode(0x5e) +
              encoder.write_modrm(0b11,@operands[0],@operands[2])
            else
