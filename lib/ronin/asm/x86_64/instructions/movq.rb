    ...
    module X86_64
      module Instructions
        ...
        class MOVQ < Instruction
          ...
          #
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :reg64 && @operands[1].type == :mmx
              ...
              encoder.write_opcode(0x7e) +
              encoder.write_modrm(0b11,@operands[1],@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :mmx && @operands[1].type == :reg64
              encoder.write_rex(mandatory: true, w: 1, r: @operands[0], b: @operands[1]) +
              encoder.write_opcode(0x0f) +
              encoder.write_opcode(0x6e) +
              encoder.write_modrm(0b11,@operands[0],@operands[1])
            elsif @operands.length == 2 && @operands[0].type == :mmx && @operands[1].type == :mmx
              ...
              encoder.write_opcode(0x7e) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1])
            elsif @operands.length == 2 && @operands[0].type == :mem64 && @operands[1].type == :mmx
