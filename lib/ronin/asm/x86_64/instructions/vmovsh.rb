        ...
        class VMOVSH < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :"m16{k}" && @operands[1].type == :xmm
              ...
              encoder.write_evex(mmm: 0b101, pp: 0b10, w: 0, vvvv: @operands[1], v: "#<data CodeGen::X86::ISA::OperandIndex index=1>", rr: @operands[2], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x11) +
              ...
              encoder.write_evex(mmm: 0b101, pp: 0b10, w: 0, vvvv: @operands[1], v: "#<data CodeGen::X86::ISA::OperandIndex index=1>", rr: @operands[2], _B: @operands[0], x: @operands[0], b: 0, aaa: 0, z: 0) +
              encoder.write_opcode(0x11) +
              encoder.write_modrm(3,@operands[2],@operands[0],@operands)
            else
