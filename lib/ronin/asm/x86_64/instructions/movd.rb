      ...
      module Instructions
        ...
        class MOVD < Instruction
          ...
          def initialize(*operands,**kwargs)
            ...
            @form = if @operands.length == 2 && @operands[0].type_of?(:reg32) && @operands[1].type_of?(:mmx)
                      [:reg32, :mmx]
                    elsif @operands.length == 2 && @operands[0].type_of?(:reg32) && @operands[1].type_of?(:xmm)
                      [:reg32, :xmm]
                    elsif @operands.length == 2 && @operands[0].type_of?(:mmx) && @operands[1].type_of?(:reg32)
                      [:mmx, :reg32]
                    elsif @operands.length == 2 && @operands[0].type_of?(:mmx) && @operands[1].type_of?(:mem32)
                      [:mmx, :mem32]
                      ...
                      [:xmm, :mem32]
                    elsif @operands.length == 2 && @operands[0].type_of?(:mem32) && @operands[1].type_of?(:mmx)
                      [:mem32, :mmx]
