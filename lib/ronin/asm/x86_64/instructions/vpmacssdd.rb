    ...
    module X86_64
      module Instructions
        ...
        class VPMACSSDD < Instruction
          ...
          #
          # Initializes the `vpmacssdd` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:vpmacssdd,*operands,**kwargs)
          end

          #
          # Encodes the `vpmacssdd` instruction.
          #
          ...
          def encode(encoder)
            if @operands.length == 4 && @operands[0].type == :xmm && @operands[1].type == :xmm && @operands[2].type == :xmm && @operands[3].type == :xmm
              encoder.write_vex(type: :xop, l: 0, m_mmmm: 0b01000, pp: 0b00, r: @operands[0], b: @operands[2], vvvv: @operands[1]) +
              ...
              encoder.write_vex(type: :xop, l: 0, m_mmmm: 0b01000, pp: 0b00, r: @operands[0], x: @operands[2], b: @operands[2], vvvv: @operands[1]) +
              encoder.write_opcode(0x8e) +
