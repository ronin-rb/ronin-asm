  ...
  module ASM
    module X86_64
      module Instructions
        ...
        #
        class GF2P8AFFINEINVQB < Instruction

          #
          # Initializes the `gf2p8affineinvqb` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:gf2p8affineinvqb,*operands,**kwargs)
          end

          #
          # Encodes the `gf2p8affineinvqb` instruction.
          #
