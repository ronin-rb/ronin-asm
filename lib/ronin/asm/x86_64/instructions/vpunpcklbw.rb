        ...
        class VPUNPCKLBW < Instruction
          ...
          def encode(encoder)
            ...
            when [:"ymm{k}{z}", :ymm, :mem256]
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b01, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 0, aaa: @operands[0], z: @operands[0], disp8xN: 32) +
              encoder.write_opcode(0x60) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
            ...
            when [:"zmm{k}{z}", :zmm, :mem512]
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b10, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 0, aaa: @operands[0], z: @operands[0], disp8xN: 64) +
              encoder.write_opcode(0x60) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
            when [:xmm, :xmm, :xmm]
