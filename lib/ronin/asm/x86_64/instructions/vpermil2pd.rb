    ...
    module X86_64
      module Instructions
        ...
        class VPERMIL2PD < Instruction
          ...
          #
          def encode(encoder)
            if @operands.length == 5 && @operands[0].type == :xmm && @operands[1].type == :xmm && @operands[2].type == :xmm && @operands[3].type == :xmm && @operands[4].type == :imm8
              ...
              encoder.write_register_byte(@operands[3],@operands[4])
            elsif @operands.length == 5 && @operands[0].type == :ymm && @operands[1].type == :ymm && @operands[2].type == :ymm && @operands[3].type == :ymm && @operands[4].type == :imm8
