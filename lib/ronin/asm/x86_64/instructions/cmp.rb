    ...
    module X86_64
      module Instructions
        ...
        class CMP < Instruction
          ...
          #
          # Initializes the `cmp` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:cmp,*operands,**kwargs)
          end

          #
          # Encodes the `cmp` instruction.
          #
          ...
          #
          def encode(encoder)
            if @operands.length == 2 && @operands[0] == Registers::AL && @operands[1].type == :imm8
              ...
              encoder.write_modrm(3,7,@operands[0],@operands) +
              encoder.write_immediate(@operands[1],1)
            ...
            elsif @operands.length == 2 && @operands[0] == Registers::AX && @operands[1].type == :imm16
              ...
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0] == Registers::EAX && @operands[1].type == :imm32
              encoder.write_opcode(0x3d) +
              ...
              encoder.write_opcode(0x3b) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1],@operands)
            elsif @operands.length == 2 && @operands[0] == Registers::RAX && @operands[1].type == :imm32
              encoder.write_rex(@operands, mandatory: true, w: 1) +
              encoder.write_opcode(0x3d) +
              encoder.write_immediate(@operands[1],4)
              ...
              encoder.write_opcode(0x80) +
              encoder.write_modrm(@operands[0],7,@operands[0],@operands) +
              encoder.write_immediate(@operands[1],1)
