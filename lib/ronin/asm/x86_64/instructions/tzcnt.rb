    ...
    module X86_64
      module Instructions
        ...
        class TZCNT < Instruction
          ...
          #
          # Initializes the `tzcnt` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:tzcnt,*operands,**kwargs)
          end

          #
          # Encodes the `tzcnt` instruction.
          #
          ...
          #
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :reg16 && @operands[1].type == :reg16
