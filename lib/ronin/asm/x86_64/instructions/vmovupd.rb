      ...
      module Instructions
        ...
        class VMOVUPD < Instruction
          ...
          def encode(encoder)
            ...
            when [:"xmm{k}{z}", :xmm]
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b00, w: 1, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x11) +
            ...
            when [:"mem256{k}", :ymm]
              ...
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
            when [:"ymm{k}{z}", :ymm]
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b01, w: 1, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x11) +
              encoder.write_modrm(0b11,@operands[1],@operands[0])
            when [:"mem512{k}", :zmm]
              ...
              encoder.write_modrm(@operands[0],@operands[1],@operands[0])
            when [:"zmm{k}{z}", :zmm]
              encoder.write_evex(mmm: 0b001, pp: 0b01, ll: 0b10, w: 1, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 0, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x11) +
              encoder.write_modrm(0b11,@operands[1],@operands[0])
            when [:"xmm{k}{z}", :mem128]
