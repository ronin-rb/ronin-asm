    ...
    module X86_64
      module Instructions
        ...
        class SBB < Instruction
          ...
          #
          # Initializes the `sbb` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:sbb,*operands,**kwargs)
          end

          #
          # Encodes the `sbb` instruction.
          #
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0] == Registers::AL && @operands[1].type == :imm8
              ...
              encoder.write_modrm(3,3,@operands[0],@operands) +
              encoder.write_immediate(@operands[1],1)
              ...
              encoder.write_opcode(0x80) +
              encoder.write_modrm(@operands[0],3,@operands[0],@operands) +
              encoder.write_immediate(@operands[1],1)
