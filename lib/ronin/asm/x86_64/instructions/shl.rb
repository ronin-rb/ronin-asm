        ...
        class SHL < Instruction
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :reg8 && (@operands[1].kind_of?(Immediate) && @operands[1].value == 1)
              ...
              encoder.write_opcode(0xd3) +
              encoder.write_modrm(3,4,@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :reg64 && (@operands[1].kind_of?(Immediate) && @operands[1].value == 1)
              ...
              encoder.write_opcode(0xd3) +
              encoder.write_modrm(@operands[0],4,@operands[0])
            elsif @operands.length == 2 && @operands[0].type == :mem64 && (@operands[1].kind_of?(Immediate) && @operands[1].value == 1)
