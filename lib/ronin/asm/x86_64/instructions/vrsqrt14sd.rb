        ...
        class VRSQRT14SD < Instruction
          ...
          def encode(encoder)
            ...
            when [:"xmm{k}{z}", :xmm, :mem64]
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 0, aaa: @operands[0], z: @operands[0], disp8xN: 8) +
              encoder.write_opcode(0x4f) +
            ...
            when [:xmm, :xmm, :xmm]
              ...
              encoder.write_modrm(0b11,@operands[0],@operands[2])
            when [:xmm, :xmm, :mem64]
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, vvvv: @operands[1], v: @operands[1], rr: @operands[0], _B: @operands[2], x: @operands[2], b: 0, aaa: 0, z: 0, disp8xN: 8) +
              encoder.write_opcode(0x4f) +
              encoder.write_modrm(@operands[2],@operands[0],@operands[2])
            else
