    ...
    module X86_64
      module Instructions
        ...
        class KMOVB < Instruction
          ...
          #
          # Initializes the `kmovb` instruction.
          #
          ...
          def encode(encoder)
            if @operands.length == 2 && @operands[0].type == :k && @operands[1].type == :k
              encoder.write_vex(type: :vex, w: 0, l: 0, m_mmmm: 0b00001, pp: 0b01, r: @operands[0], b: @operands[0], vvvv: 0) +
              ...
              encoder.write_vex(type: :vex, w: 0, l: 0, m_mmmm: 0b00001, pp: 0b01, r: @operands[0], x: @operands[0], b: @operands[0], vvvv: 0) +
