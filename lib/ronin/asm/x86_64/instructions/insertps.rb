    ...
    module X86_64
      module Instructions
        ...
        class INSERTPS < Instruction
          ...
          #
          # Initializes the `insertps` instruction.
          #
          ...
          def initialize(*operands,**kwargs)
            super(:insertps,*operands,**kwargs)
          end

          #
          # Encodes the `insertps` instruction.
          #
          ...
          def encode(encoder)
            ...
            elsif @operands.length == 3 && @operands[0].type == :xmm && @operands[1].type == :mem32 && @operands[2].type == :imm8
              encoder.write_prefix(0x66,true) +
