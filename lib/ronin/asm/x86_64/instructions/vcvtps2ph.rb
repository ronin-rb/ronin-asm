        ...
        class VCVTPS2PH < Instruction
          ...
          def encode(encoder)
            ...
            when [:"ymm{k}{z}", :zmm, :"{sae}", :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b01, w: 0, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 1, aaa: @operands[0], z: @operands[0]) +
              encoder.write_opcode(0x1d) +
              encoder.write_modrm(0b11,@operands[1],@operands[0]) +
              encoder.write_immediate(@operands[3],1)
            when [:ymm, :zmm, :"{sae}", :imm8]
              encoder.write_evex(mmm: 0b011, pp: 0b01, w: 0, vvvv: 0, v: 0, rr: @operands[1], _B: @operands[0], x: @operands[0], b: 1, aaa: 0, z: 0) +
              encoder.write_opcode(0x1d) +
              encoder.write_modrm(0b11,@operands[1],@operands[0]) +
              encoder.write_immediate(@operands[3],1)
            else
