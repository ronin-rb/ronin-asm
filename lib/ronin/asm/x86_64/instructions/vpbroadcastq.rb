      ...
      module Instructions
        ...
        class VPBROADCASTQ < Instruction
          ...
          def initialize(*operands,**kwargs)
            ...
            @form = if @operands.length == 2 && @operands[0].type_of?(:"xmm{k}{z}") && @operands[1].type_of?(:reg64)
                      [:"xmm{k}{z}", :reg64]
                    elsif @operands.length == 2 && @operands[0].type_of?(:"ymm{k}{z}") && @operands[1].type_of?(:reg64)
                      [:"ymm{k}{z}", :reg64]
                    elsif @operands.length == 2 && @operands[0].type_of?(:"zmm{k}{z}") && @operands[1].type_of?(:reg64)
                      [:"zmm{k}{z}", :reg64]
                      ...
                      [:xmm, :mem64]
                    elsif @operands.length == 2 && @operands[0].type_of?(:ymm) && @operands[1].type_of?(:reg64)
                      [:ymm, :reg64]
                      ...
                      [:ymm, :mem64]
                    elsif @operands.length == 2 && @operands[0].type_of?(:zmm) && @operands[1].type_of?(:reg64)
                      [:zmm, :reg64]
          ...
          def encode(encoder)
            ...
            when [:"zmm{k}{z}", :xmm]
              ...
              encoder.write_modrm(0b11,@operands[0],@operands[1])
            when [:"xmm{k}{z}", :mem64]
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, ll: 0b00, vvvv: 0, v: 0, rr: @operands[0], _B: @operands[1], x: @operands[1], b: 0, aaa: @operands[0], z: @operands[0], disp8xN: 8) +
              encoder.write_opcode(0x59) +
            ...
            when [:xmm, :mem64]
              ...
              encoder.write_modrm(@operands[1],@operands[0],@operands[1])
            when [:xmm, :mem64]
              encoder.write_evex(mmm: 0b010, pp: 0b01, w: 1, ll: 0b00, vvvv: 0, v: 0, rr: @operands[0], _B: @operands[1], x: @operands[1], b: 0, aaa: 0, z: 0, disp8xN: 8) +
              encoder.write_opcode(0x59) +
              encoder.write_modrm(@operands[1],@operands[0],@operands[1])
            when [:ymm, :reg64]
