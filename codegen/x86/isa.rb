...
module CodeGen
  module X86
    ...
    module ISA
      ...
      #
      InstructionForm = Data.define(:gas_name, :isa_extension, :mmx_mode, :xmm_mode, :cancelling_inputs, :operands, :encodings) do
        ...
        def self.from_xml(node)
          new(
            gas_name: node['gas-name'],

            isa_extension: if (isa = node.at_xpath('ISA'))
                             isa['id'].to_sym
                           end,
      ...
      Operand = Data.define(:type, :input, :output, :extended_size) do
        ...
        # Opmask registers
        OPMASK_REG_TYPES = Set[:k, :"k{k}"]
        def opmask_register? = OPMASK_REG_TYPES.include?(type)
        ...
        # Register types
        REG_TYPES = Set[:r8, :r16, :r32] + SPECIFIC_REGISTERS + OPMASK_REG_TYPES + MMX_REG_TYPES + XMM_REG_TYPES + YMM_REG_TYPES + ZMM_REG_TYPES
        ...
        MEM_TYPES = Set[
          ...
          :m8,
          :m16, :"m16{k}",
          :m32, :"m32{k}", :"m32/m16bcst",
          :m64, :"m64{k}", :"m64/m16bcst", :"m64/m32bcst",
          :m128, :"m128{k}", :"m128/m16bcst", :"m128/m32bcst", :"m128/m64bcst",
          :m256, :"m256{k}", :"m256/m16bcst", :"m256/m32bcst", :"m256/m64bcst",
          :m512, :"m512{k}", :"m512/m16bcst", :"m512/m32bcst", :"m512/m64bcst",
          :moffs32
        ]
