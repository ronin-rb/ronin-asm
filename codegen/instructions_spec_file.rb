...
module CodeGen
  #
  # Base class for all instruction `spec/<arch>/instructions_spec.rb` files.
  #
  class InstructionsSpecFile < TemplateFile
    ...
    def initialize(instructions)
      ...
      super(File.join(self.class.output_dir,"instructions_spec.rb"))
    end
